...
factors given in [`IIOParam.setSourceSubsampling`](IIOParam.md#setSourceSubsampling(int,int,int,int)). The first pixel,
...
* ## Field Details
  ...
  + ### canSetSourceRenderSize
    ...
    `ImageReader`s that do not support setting of
    the source render size should set this value to
    `false`.
  + ### sourceRenderSize

    protected [Dimension](../../java/awt/Dimension.md "class in java.awt") sourceRenderSize
  ...
  + ### destination
    ...
    protected [BufferedImage](../../java/awt/image/BufferedImage.md "class in java.awt.image") destination
  ...
  + ### destinationBands
    ...
    The set of destination bands to be used, as an array of
    `int`s. By default, the value is `null`,
...
* ## Method Details
  ...
  + ### setDestinationType
    ...
    See Also:
    :   - [`IIOParam.getDestinationType()`](IIOParam.md#getDestinationType())
  + ### setDestination

    public void setDestination([BufferedImage](../../java/awt/image/BufferedImage.md "class in java.awt.image") destination)
    ...
    correspond to one of the `ImageTypeSpecifier`s
  ...
  + ### getDestination
    ...
    public [BufferedImage](../../java/awt/image/BufferedImage.md "class in java.awt.image") getDestination()
    ...
    See Also:
    :   - [`setDestination(java.awt.image.BufferedImage)`](#setDestination(java.awt.image.BufferedImage))
  + ### setDestinationBands
    ...
    See Also:
    :   - [`getDestinationBands()`](#getDestinationBands())
        - [`IIOParam.getSourceBands()`](IIOParam.md#getSourceBands())
  ...
  + ### getDestinationBands
    ...
    See Also:
    :   - [`setDestinationBands(int[])`](#setDestinationBands(int%5B%5D))
  + ### canSetSourceRenderSize
    ...
    See Also:
    :   - [`setSourceRenderSize(java.awt.Dimension)`](#setSourceRenderSize(java.awt.Dimension))
  + ### setSourceRenderSize

    public void setSourceRenderSize([Dimension](../../java/awt/Dimension.md "class in java.awt") size)
    ...
    See Also:
    :   - [`getSourceRenderSize()`](#getSourceRenderSize())
        - [`ImageReader.getWidth(int)`](ImageReader.md#getWidth(int))
        - [`ImageReader.getHeight(int)`](ImageReader.md#getHeight(int))
        - [`ImageReader.getAspectRatio(int)`](ImageReader.md#getAspectRatio(int))
  + ### getSourceRenderSize

    public [Dimension](../../java/awt/Dimension.md "class in java.awt") getSourceRenderSize()

    Returns the width and height of the source image as it
    will be rendered during decoding, if they have been set via the
    `setSourceRenderSize` method. A
    `null` value indicates that no setting has been made.
  ...
  + ### setSourceProgressivePasses
    ...
    :   `IllegalArgumentException` - if `minPass` is
        ...
        `minPass + numPasses - 1` is greater than
        `INTEGER.MAX_VALUE`.

    See Also:
    :   - [`getSourceMinProgressivePass()`](#getSourceMinProgressivePass())
        - [`getSourceMaxProgressivePass()`](#getSourceMaxProgressivePass())
  + ### getSourceMinProgressivePass
    ...
    See Also:
    :   - [`setSourceProgressivePasses(int, int)`](#setSourceProgressivePasses(int,int))
        - [`getSourceNumProgressivePasses()`](#getSourceNumProgressivePasses())
  + ### getSourceMaxProgressivePass
