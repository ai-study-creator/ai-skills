...
extends [ImageInputStream](ImageInputStream.md "interface in javax.imageio.stream"), [DataOutput](../../../../java.base/java/io/DataOutput.md "interface in java.io")

A seekable output stream interface for use by
`ImageWriter`s. Various output destinations, such as
`OutputStream`s and `File`s, as well as
...
* ## Method Summary
  ...
  This method is a synonym for [`writeShort`](#writeShort(int)).
...
* ## Method Details
  ...
  + ### writeBytes
    ...
    void writeBytes([String](../../../../java.base/java/lang/String.md "class in java.lang") s)
    throws [IOException](../../../../java.base/java/io/IOException.md "class in java.io")
  ...
  + ### writeChars
    ...
    void writeChars([String](../../../../java.base/java/lang/String.md "class in java.lang") s)
    throws [IOException](../../../../java.base/java/io/IOException.md "class in java.io")
  ...
  + ### writeUTF
    ...
    void writeUTF([String](../../../../java.base/java/lang/String.md "class in java.lang") s)
    throws [IOException](../../../../java.base/java/io/IOException.md "class in java.io")
