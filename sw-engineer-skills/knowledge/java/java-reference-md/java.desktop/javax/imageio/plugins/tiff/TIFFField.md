...
| --- | --- | --- | --- |
| `BYTE` [`TIFFTag.TIFF_BYTE`](TIFFTag.md#TIFF_BYTE) `byte` `"Byte"`| `ASCII` [`TIFFTag.TIFF_ASCII`](TIFFTag.md#TIFF_ASCII) `String` `"Ascii"`| `SHORT` [`TIFFTag.TIFF_SHORT`](TIFFTag.md#TIFF_SHORT) `char` `"Short"`| `LONG` [`TIFFTag.TIFF_LONG`](TIFFTag.md#TIFF_LONG) `long` `"Long"`| `RATIONAL` [`TIFFTag.TIFF_RATIONAL`](TIFFTag.md#TIFF_RATIONAL) `long[2]` {numerator, denominator} `"Rational"`| `SBYTE` [`TIFFTag.TIFF_SBYTE`](TIFFTag.md#TIFF_SBYTE) `byte` `"SByte"`| `UNDEFINED` [`TIFFTag.TIFF_UNDEFINED`](TIFFTag.md#TIFF_UNDEFINED) `byte` `"Undefined"`| `SSHORT` [`TIFFTag.TIFF_SSHORT`](TIFFTag.md#TIFF_SSHORT) `short` `"SShort"`| `SLONG` [`TIFFTag.TIFF_SLONG`](TIFFTag.md#TIFF_SLONG) `int` `"SLong"`| `SRATIONAL` [`TIFFTag.TIFF_SRATIONAL`](TIFFTag.md#TIFF_SRATIONAL) `int[2]` {numerator, denominator} `"SRational"`| `FLOAT` [`TIFFTag.TIFF_FLOAT`](TIFFTag.md#TIFF_FLOAT) `float` `"Float"`| `DOUBLE` [`TIFFTag.TIFF_DOUBLE`](TIFFTag.md#TIFF_DOUBLE) `double` `"Double"`| `IFD` [`TIFFTag.TIFF_IFD_POINTER`](TIFFTag.md#TIFF_IFD_POINTER) `long` `"IFDPointer"` | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | |
...
* ## Constructor Summary
  ...
  Constructs a data array using [`createArrayForType()`](#createArrayForType(int,int)) and invokes
  [`TIFFField(TIFFTag,int,int,Object)`](#%3Cinit%3E(javax.imageio.plugins.tiff.TIFFTag,int,int,java.lang.Object)) with the supplied
...
* ## Method Summary
  ...
  `createFromMetadataNode(TIFFTagSet tagSet,
  Node node)`
  ...
  Returns a TIFFTag.TIFF\_RATIONAL data item as a two-element array
  of ints.
...
* ## Constructor Details
  ...
  + ### TIFFField
    ...
    public TIFFField([TIFFTag](TIFFTag.md "class in javax.imageio.plugins.tiff") tag,
    int type,
    int count,
    ...
    [`tag.isDataTypeOK()`](TIFFTag.md#isDataTypeOK(int))
    ...
    returned by [`getDirectory()`](#getDirectory()) will be its contents.)

    Parameters:
    :   `tag` - The tag to associated with this field.
    :   `type` - One of the `TIFFTag.TIFF_*` constants
    ...
    :   `IllegalArgumentException` - if `type` is an unacceptable
    ...
    :   `IllegalArgumentException` - if `data` is an instance of
        a class incompatible with the specified type.
    :   `IllegalArgumentException` - if the size of the data array is wrong.
    :   `IllegalArgumentException` - if the type of the data array is
        `TIFF_LONG`, `TIFF_RATIONAL`, or `TIFF_IFD_POINTER`
        and any of the elements is negative or greater than `0xffffffff`.
  + ### TIFFField
    ...
    See Also:
    :   - [`TIFFField(TIFFTag,int,int,Object)`](#%3Cinit%3E(javax.imageio.plugins.tiff.TIFFTag,int,int,java.lang.Object))
  + ### TIFFField
    ...
    Constructs a `TIFFField` with a single non-negative integral
    value. The field will have type [`TIFF_SHORT`](TIFFTag.md#TIFF_SHORT)
    if `value` is in `[0,0xffff]`, and type
    [`TIFF_LONG`](TIFFTag.md#TIFF_LONG) if `value` is in
    `[0x10000,0xffffffff]`. The count of the field will be unity.
    ...
    Throws:
    :   `NullPointerException` - if `tag == null`.
    :   `IllegalArgumentException` - if `value` is not in
        `[0,0xffffffff]`.
    :   `IllegalArgumentException` - if `value` is in
        `[0,0xffff]` and `TIFF_SHORT` is an unacceptable type
        for the `TIFFTag`, or if `value` is in
        `[0x10000,0xffffffff]` and `TIFF_LONG` is an unacceptable
        type for the `TIFFTag`.
  + ### TIFFField

    public TIFFField([TIFFTag](TIFFTag.md "class in javax.imageio.plugins.tiff") tag,
    int type,
    long offset,
    [TIFFDirectory](TIFFDirectory.md "class in javax.imageio.plugins.tiff") dir)
    ...
    Parameters:
    :   `tag` - The tag to associated with this field.
    :   `type` - One of the constants `TIFFTag.TIFF_LONG` or
    ...
    :   `IllegalArgumentException` - if `type` is an unacceptable
        data type for the supplied `TIFFTag`.
    :   `IllegalArgumentException` - if `type` is neither
...
* ## Method Details
  ...
  + ### createFromMetadataNode
    ...
    public static [TIFFField](TIFFField.md "class in javax.imageio.plugins.tiff") createFromMetadataNode([TIFFTagSet](TIFFTagSet.md "class in javax.imageio.plugins.tiff") tagSet,
    ...
    Parameters:
    :   `tagSet` - The `TIFFTagSet` to which the
    ...
    Throws:
    :   `IllegalArgumentException` - If the `Node` parameter content
        does not adhere to the `TIFFField` element structure defined by
        the [TIFF native image metadata format specification](../../metadata/doc-files/tiff_metadata.md#ImageMetadata), or if the
        combination of node attributes and data is not legal per the
        [`TIFFField(TIFFTag,int,int,Object)`](#%3Cinit%3E(javax.imageio.plugins.tiff.TIFFTag,int,int,java.lang.Object)) constructor specification.
        Note that a cause might be set on such an exception.
  + ### getTag

    public [TIFFTag](TIFFTag.md "class in javax.imageio.plugins.tiff") getTag()
  ...
  + ### getTypeName
    ...
    public static [String](../../../../../java.base/java/lang/String.md "class in java.lang") getTypeName(int dataType)

    Returns the name of the supplied data type constant.

    Parameters:
    :   `dataType` - One of the `TIFFTag.TIFF_*` constants
        indicating the data type of the field as written to the TIFF stream.
  ...
  + ### getTypeByName
    ...
    public static int getTypeByName([String](../../../../../java.base/java/lang/String.md "class in java.lang") typeName)
    ...
    Returns:
    :   One of the `TIFFTag.TIFF_*` constants or
        `-1` if the name is not recognized.
  + ### createArrayForType

    public static [Object](../../../../../java.base/java/lang/Object.md "class in java.lang") createArrayForType(int dataType,
    int count)

    Creates an array appropriate for the indicated data type.

    Parameters:
    :   `dataType` - One of the `TIFFTag.TIFF_*` data type
        constants.
  ...
  + ### getAsNativeNode
    ...
    public [Node](../../../../../java.xml/org/w3c/dom/Node.md "interface in org.w3c.dom") getAsNativeNode()

    Returns the `TIFFField` as a node named either
    `"TIFFField"` or `"TIFFIFD"` as described in the
    TIFF native image metadata specification. The node will be named
    `"TIFFIFD"` if and only if [`hasDirectory()`](#hasDirectory()) returns
    `true` and the field's type is either [`TIFFTag.TIFF_LONG`](TIFFTag.md#TIFF_LONG)
    or [`TIFFTag.TIFF_IFD_POINTER`](TIFFTag.md#TIFF_IFD_POINTER).

    Returns:
    :   a `Node` named `"TIFFField"` or
        `"TIFFIFD"`.
  + ### isIntegral
  ...
  + ### getData
    ...
    public [Object](../../../../../java.base/java/lang/Object.md "class in java.lang") getData()
  ...
  + ### getAsBytes
    ...
    Throws:
    :   `ClassCastException` - if the field is not of type
  ...
  + ### getAsChars
    ...
    Returns:
    :   The data as an array of `char`s.
  ...
  + ### getAsShorts
    ...
    Returns:
    :   The data as an array of `short`s.
  ...
  + ### getAsLongs
    ...
    Returns:
    :   The data as an array of `long`s.
  ...
  + ### getAsFloats
    ...
    Returns:
    :   The data as an array of `float`s.
  ...
  + ### getAsDoubles
    ...
    Returns:
    :   The data as an array of `double`s.
  ...
  + ### getAsString
    ...
    public [String](../../../../../java.base/java/lang/String.md "class in java.lang") getAsString(int index)
  ...
  + ### getValueAsString
    ...
    public [String](../../../../../java.base/java/lang/String.md "class in java.lang") getValueAsString(int index)
    ...
    Throws:
    :   `ClassCastException` - if the field is not of one of the
        legal field types.
  + ### hasDirectory
  ...
  + ### getDirectory
    ...
    public [TIFFDirectory](TIFFDirectory.md "class in javax.imageio.plugins.tiff") getDirectory()
  ...
  + ### clone
    ...
    public [TIFFField](TIFFField.md "class in javax.imageio.plugins.tiff") clone()
