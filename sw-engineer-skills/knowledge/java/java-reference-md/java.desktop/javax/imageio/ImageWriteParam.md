...
extends [IIOParam](IIOParam.md "class in javax.imageio")
...
specified by [`IIOParam.setSourceSubsampling`](IIOParam.md#setSourceSubsampling(int,int,int,int)).
...
* ## Field Details
  ...
  + ### MODE\_DISABLED
    ...
    public static final int MODE\_DISABLED
    ...
    **not** be tiled, progressive, or compressed, and the
    ...
    :   - [`MODE_EXPLICIT`](#MODE_EXPLICIT)
        - [`MODE_COPY_FROM_METADATA`](#MODE_COPY_FROM_METADATA)
        - [`MODE_DEFAULT`](#MODE_DEFAULT)
        - [`setProgressiveMode(int)`](#setProgressiveMode(int))
        - [`getProgressiveMode()`](#getProgressiveMode())
        - [`setTilingMode(int)`](#setTilingMode(int))
        - [`getTilingMode()`](#getTilingMode())
        - [`setCompressionMode(int)`](#setCompressionMode(int))
        - [`getCompressionMode()`](#getCompressionMode())
        - [Constant Field Values](../../../constant-values.md#javax.imageio.ImageWriteParam.MODE_DISABLED)
  + ### MODE\_DEFAULT

    public static final int MODE\_DEFAULT
    ...
    :   - [`MODE_DISABLED`](#MODE_DISABLED)
        ...
        - [`setCompressionMode(int)`](#setCompressionMode(int))
        - [`getCompressionMode()`](#getCompressionMode())
        - [Constant Field Values](../../../constant-values.md#javax.imageio.ImageWriteParam.MODE_DEFAULT)
  + ### MODE\_EXPLICIT

    public static final int MODE\_EXPLICIT
    ...
    :   - [`MODE_DISABLED`](#MODE_DISABLED)
        ...
        - [`setCompressionMode(int)`](#setCompressionMode(int))
        - [`getCompressionMode()`](#getCompressionMode())
        - [Constant Field Values](../../../constant-values.md#javax.imageio.ImageWriteParam.MODE_EXPLICIT)
  + ### MODE\_COPY\_FROM\_METADATA

    public static final int MODE\_COPY\_FROM\_METADATA
    ...
    :   - [`MODE_DISABLED`](#MODE_DISABLED)
        ...
        - [`setCompressionMode(int)`](#setCompressionMode(int))
        - [`getCompressionMode()`](#getCompressionMode())
        - [Constant Field Values](../../../constant-values.md#javax.imageio.ImageWriteParam.MODE_COPY_FROM_METADATA)
  + ### canWriteTiles
  ...
  + ### preferredTileSizes
    ...
    protected [Dimension](../../java/awt/Dimension.md "class in java.awt")[] preferredTileSizes
    ...
    See Also:
    :   - [`getPreferredTileSizes()`](#getPreferredTileSizes())
  + ### tilingSet
  ...
  + ### compressionTypes
    ...
    protected [String](../../../java.base/java/lang/String.md "class in java.lang")[] compressionTypes
  ...
  + ### compressionType
    ...
    protected [String](../../../java.base/java/lang/String.md "class in java.lang") compressionType
...
* ## Constructor Details
  ...
  + ### ImageWriteParam
    ...
    Constructs an empty `ImageWriteParam`. It is up to
    the subclass to set up the instance variables properly.
  + ### ImageWriteParam

    public ImageWriteParam([Locale](../../../java.base/java/util/Locale.md "class in java.util") locale)
...
* ## Method Details
  ...
  + ### canWriteTiles
    ...
    See Also:
    :   - [`canOffsetTiles()`](#canOffsetTiles())
        - [`setTiling(int, int, int, int)`](#setTiling(int,int,int,int))
  + ### canOffsetTiles
  ...
  + ### setTilingMode
    ...
    - `MODE_DISABLED` - The image will not be tiled.
      `setTiling` will throw an
      `IllegalStateException`.- `MODE_DEFAULT` - The image will be tiled using
        default parameters. `setTiling` will throw an
        `IllegalStateException`.- `MODE_EXPLICIT` - The image will be tiled
          according to parameters given in the [`setTiling`](#setTiling(int,int,int,int))
          method. Any previously set tiling parameters are discarded.- `MODE_COPY_FROM_METADATA` - The image will
  ...
  + ### getPreferredTileSizes
    ...
    public [Dimension](../../java/awt/Dimension.md "class in java.awt")[] getPreferredTileSizes()
  ...
  + ### setTiling
    ...
    :   - [`canWriteTiles`](#canWriteTiles)
        ...
        - [`getTileGridXOffset()`](#getTileGridXOffset())
        - [`getTileGridYOffset()`](#getTileGridYOffset())
  + ### unsetTiling
  ...
  + ### setProgressiveMode
    ...
    - `MODE_DISABLED` - No progression. Use this to
      turn off progression.- `MODE_COPY_FROM_METADATA` - The output image
        will use whatever progression parameters are found in the
        metadata objects passed into the writer.- `MODE_DEFAULT` - The image will be written
  ...
  + ### setCompressionMode
    ...
    - `MODE_DISABLED` - If the mode is set to
      ...
      changed.- `MODE_EXPLICIT` - Compress using the
        compression type and quality settings specified in this
        `ImageWriteParam`. Any previously set compression
        parameters are discarded.- `MODE_COPY_FROM_METADATA` - Use whatever
          compression parameters are specified in metadata objects
          passed in to the writer.- `MODE_DEFAULT` - Use default compression
            parameters.
  ...
  + ### getCompressionTypes
    ...
    public [String](../../../java.base/java/lang/String.md "class in java.lang")[] getCompressionTypes()
    ...
    Returns:
    :   an array of `String`s containing the
  ...
  + ### setCompressionType
    ...
    public void setCompressionType([String](../../../java.base/java/lang/String.md "class in java.lang") compressionType)
    ...
    Parameters:
    :   `compressionType` - one of the `String`s returned
    ...
    :   - [`getCompressionTypes()`](#getCompressionTypes())
        ...
        - [`unsetCompression()`](#unsetCompression())
  + ### getCompressionType

    public [String](../../../java.base/java/lang/String.md "class in java.lang") getCompressionType()
    ...
    See Also:
    :   - [`setCompressionType(java.lang.String)`](#setCompressionType(java.lang.String))
  + ### unsetCompression
    ...
    See Also:
    :   - [`setCompressionType(java.lang.String)`](#setCompressionType(java.lang.String))
        - [`setCompressionQuality(float)`](#setCompressionQuality(float))
  + ### getLocalizedCompressionTypeName

    public [String](../../../java.base/java/lang/String.md "class in java.lang") getLocalizedCompressionTypeName()
  ...
  + ### getCompressionQualityDescriptions
    ...
    See Also:
    :   - [`getCompressionQualityValues()`](#getCompressionQualityValues())
  + ### getCompressionQualityValues
    ...
    with `getCompressionQualityDescriptions` as part of a user
    interface for setting or displaying the compression quality
    level. See [`getCompressionQualityDescriptions`](#getCompressionQualityDescriptions()) for more information.
    ...
    See Also:
    :   - [`getCompressionQualityDescriptions()`](#getCompressionQualityDescriptions())