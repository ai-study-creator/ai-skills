...
* `toggleSortOrder` — The view invokes this when the
  ...
  the user clicked a column header in a table.* One of the model change methods — The view invokes a model
...
* `RowSorterEvent.Type.SORT_ORDER_CHANGED` — notifies
  ...
  by a notification that the sort has changed.* `RowSorterEvent.Type.SORTED` — notifies listeners that
...
* ## Method Details
  ...
  + ### getModel
    ...
    public abstract [M](RowSorter.md "type parameter in RowSorter") getModel()
  ...
  + ### setSortKeys
    ...
    public abstract void setSortKeys([List](../../../java.base/java/util/List.md "interface in java.util")<? extends [RowSorter.SortKey](RowSorter.SortKey.md "class in javax.swing")> keys)
  ...
  + ### getSortKeys
    ...
    public abstract [List](../../../java.base/java/util/List.md "interface in java.util")<? extends [RowSorter.SortKey](RowSorter.SortKey.md "class in javax.swing")> getSortKeys()
  ...
  + ### getViewRowCount
    ...
    See Also:
    :   - [`getModelRowCount()`](#getModelRowCount())
  + ### getModelRowCount
    ...
    See Also:
    :   - [`getViewRowCount()`](#getViewRowCount())
  + ### modelStructureChanged
  ...
  + ### addRowSorterListener
    ...
    public void addRowSorterListener([RowSorterListener](event/RowSorterListener.md "interface in javax.swing.event") l)
  ...
  + ### removeRowSorterListener
    ...
    public void removeRowSorterListener([RowSorterListener](event/RowSorterListener.md "interface in javax.swing.event") l)
