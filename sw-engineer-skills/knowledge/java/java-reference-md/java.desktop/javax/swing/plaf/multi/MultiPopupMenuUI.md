...
* ## Method Details
  ...
  + ### isPopupTrigger
    ...
    public boolean isPopupTrigger([MouseEvent](../../../../java/awt/event/MouseEvent.md "class in java.awt.event") a)
  ...
  + ### getPopup
    ...
    public [Popup](../../Popup.md "class in javax.swing") getPopup([JPopupMenu](../../JPopupMenu.md "class in javax.swing") a,
    int b,
    int c)
