...
[Using the Multiplexing Look and Feel.](doc-files/multi_tsc.md)
...
* Classes
  ...
  [MultiButtonUI](MultiButtonUI.md "class in javax.swing.plaf.multi")

  A multiplexing UI used to combine `ButtonUI`s.

  [MultiColorChooserUI](MultiColorChooserUI.md "class in javax.swing.plaf.multi")

  A multiplexing UI used to combine `ColorChooserUI`s.

  [MultiComboBoxUI](MultiComboBoxUI.md "class in javax.swing.plaf.multi")

  A multiplexing UI used to combine `ComboBoxUI`s.

  [MultiDesktopIconUI](MultiDesktopIconUI.md "class in javax.swing.plaf.multi")

  A multiplexing UI used to combine `DesktopIconUI`s.

  [MultiDesktopPaneUI](MultiDesktopPaneUI.md "class in javax.swing.plaf.multi")

  A multiplexing UI used to combine `DesktopPaneUI`s.

  [MultiFileChooserUI](MultiFileChooserUI.md "class in javax.swing.plaf.multi")

  A multiplexing UI used to combine `FileChooserUI`s.

  [MultiInternalFrameUI](MultiInternalFrameUI.md "class in javax.swing.plaf.multi")

  A multiplexing UI used to combine `InternalFrameUI`s.

  [MultiLabelUI](MultiLabelUI.md "class in javax.swing.plaf.multi")

  A multiplexing UI used to combine `LabelUI`s.

  [MultiListUI](MultiListUI.md "class in javax.swing.plaf.multi")

  A multiplexing UI used to combine `ListUI`s.

  [MultiLookAndFeel](MultiLookAndFeel.md "class in javax.swing.plaf.multi")

  A multiplexing look and feel that allows more than one UI
  to be associated with a component at the same time.

  [MultiMenuBarUI](MultiMenuBarUI.md "class in javax.swing.plaf.multi")

  A multiplexing UI used to combine `MenuBarUI`s.

  [MultiMenuItemUI](MultiMenuItemUI.md "class in javax.swing.plaf.multi")

  A multiplexing UI used to combine `MenuItemUI`s.

  [MultiOptionPaneUI](MultiOptionPaneUI.md "class in javax.swing.plaf.multi")

  A multiplexing UI used to combine `OptionPaneUI`s.

  [MultiPanelUI](MultiPanelUI.md "class in javax.swing.plaf.multi")

  A multiplexing UI used to combine `PanelUI`s.

  [MultiPopupMenuUI](MultiPopupMenuUI.md "class in javax.swing.plaf.multi")

  A multiplexing UI used to combine `PopupMenuUI`s.

  [MultiProgressBarUI](MultiProgressBarUI.md "class in javax.swing.plaf.multi")

  A multiplexing UI used to combine `ProgressBarUI`s.

  [MultiRootPaneUI](MultiRootPaneUI.md "class in javax.swing.plaf.multi")

  A multiplexing UI used to combine `RootPaneUI`s.

  [MultiScrollBarUI](MultiScrollBarUI.md "class in javax.swing.plaf.multi")

  A multiplexing UI used to combine `ScrollBarUI`s.

  [MultiScrollPaneUI](MultiScrollPaneUI.md "class in javax.swing.plaf.multi")

  A multiplexing UI used to combine `ScrollPaneUI`s.

  [MultiSeparatorUI](MultiSeparatorUI.md "class in javax.swing.plaf.multi")

  A multiplexing UI used to combine `SeparatorUI`s.

  [MultiSliderUI](MultiSliderUI.md "class in javax.swing.plaf.multi")

  A multiplexing UI used to combine `SliderUI`s.

  [MultiSpinnerUI](MultiSpinnerUI.md "class in javax.swing.plaf.multi")

  A multiplexing UI used to combine `SpinnerUI`s.

  [MultiSplitPaneUI](MultiSplitPaneUI.md "class in javax.swing.plaf.multi")

  A multiplexing UI used to combine `SplitPaneUI`s.

  [MultiTabbedPaneUI](MultiTabbedPaneUI.md "class in javax.swing.plaf.multi")

  A multiplexing UI used to combine `TabbedPaneUI`s.

  [MultiTableHeaderUI](MultiTableHeaderUI.md "class in javax.swing.plaf.multi")

  A multiplexing UI used to combine `TableHeaderUI`s.

  [MultiTableUI](MultiTableUI.md "class in javax.swing.plaf.multi")

  A multiplexing UI used to combine `TableUI`s.

  [MultiTextUI](MultiTextUI.md "class in javax.swing.plaf.multi")

  A multiplexing UI used to combine `TextUI`s.

  [MultiToolBarUI](MultiToolBarUI.md "class in javax.swing.plaf.multi")

  A multiplexing UI used to combine `ToolBarUI`s.

  [MultiToolTipUI](MultiToolTipUI.md "class in javax.swing.plaf.multi")

  A multiplexing UI used to combine `ToolTipUI`s.

  [MultiTreeUI](MultiTreeUI.md "class in javax.swing.plaf.multi")

  A multiplexing UI used to combine `TreeUI`s.

  [MultiViewportUI](MultiViewportUI.md "class in javax.swing.plaf.multi")
