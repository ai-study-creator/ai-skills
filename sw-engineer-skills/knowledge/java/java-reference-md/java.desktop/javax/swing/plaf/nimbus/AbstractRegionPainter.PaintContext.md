...
* ## Constructor Details
  ...
  + ### PaintContext
    ...
    public PaintContext([Insets](../../../../java/awt/Insets.md "class in java.awt") insets,
    [Dimension](../../../../java/awt/Dimension.md "class in java.awt") canvasSize,
    boolean inverted)
  ...
  + ### PaintContext
    ...
    [Dimension](../../../../java/awt/Dimension.md "class in java.awt") canvasSize,
    boolean inverted,
    [AbstractRegionPainter.PaintContext.CacheMode](AbstractRegionPainter.PaintContext.CacheMode.md "enum class in javax.swing.plaf.nimbus") cacheMode,
    double maxH,
    double maxV)
    ...
    :   `maxH` - The maximum scale in the horizontal direction to use before punting and redrawing from scratch.
    ...
    :   `maxV` - The maximum scale in the vertical direction to use before punting and redrawing from scratch.
