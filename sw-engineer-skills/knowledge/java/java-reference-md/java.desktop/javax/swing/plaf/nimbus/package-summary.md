...
Nimbus uses instances of the [`Painter`](../../Painter.md "interface in javax.swing") interface to paint
...
altering the [`UIDefaults`](../../UIDefaults.md "class in javax.swing") table. Here's an example:
...
[primary colors](doc-files/properties.md#primaryColors). There
are also
[secondary colors](doc-files/properties.md#secondaryColors),
...
[`NimbusLookAndFeel.getDerivedColor(java.lang.String, float, float, float, int, boolean)`](NimbusLookAndFeel.md#getDerivedColor(java.lang.String,float,float,float,int,boolean))
...
* All Classes and InterfacesClassesEnum Classes
  ...
  [AbstractRegionPainter](AbstractRegionPainter.md "class in javax.swing.plaf.nimbus")

  Convenient base class for defining Painter instances for rendering a
  region or component in Nimbus.

  [AbstractRegionPainter.PaintContext](AbstractRegionPainter.PaintContext.md "class in javax.swing.plaf.nimbus")

  A class encapsulating state useful when painting.

  [AbstractRegionPainter.PaintContext.CacheMode](AbstractRegionPainter.PaintContext.CacheMode.md "enum class in javax.swing.plaf.nimbus")

  Cache mode.

  [NimbusLookAndFeel](NimbusLookAndFeel.md "class in javax.swing.plaf.nimbus")

  The NimbusLookAndFeel class.

  [NimbusStyle](NimbusStyle.md "class in javax.swing.plaf.nimbus")

  A SynthStyle implementation used by Nimbus.

  [State](State.md "class in javax.swing.plaf.nimbus")<T extends [JComponent](../../JComponent.md "class in javax.swing")>
