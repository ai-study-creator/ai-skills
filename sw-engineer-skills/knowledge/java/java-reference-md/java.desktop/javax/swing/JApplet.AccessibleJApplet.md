...
extends [Applet.AccessibleApplet](../../java/applet/Applet.AccessibleApplet.md "class in java.applet")
...
* ## Method Summary
  ...
  ### Methods inherited from class java.applet.[Applet.AccessibleApplet](../../java/applet/Applet.AccessibleApplet.md "class in java.applet")
