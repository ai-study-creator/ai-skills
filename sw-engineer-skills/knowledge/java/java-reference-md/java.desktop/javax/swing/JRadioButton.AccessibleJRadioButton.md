...
[javax.swing.JToggleButton.AccessibleJToggleButton](JToggleButton.AccessibleJToggleButton.md "class in javax.swing")
...
extends [JToggleButton.AccessibleJToggleButton](JToggleButton.AccessibleJToggleButton.md "class in javax.swing")

This class implements accessibility support for the
`JRadioButton` class. It provides an implementation of the
...
* ## Constructor Summary
  ...
  Constructs an `AccessibleJRadioButton`.
* ## Method Summary
  ...
  ### Methods inherited from class javax.swing.[JToggleButton.AccessibleJToggleButton](JToggleButton.AccessibleJToggleButton.md "class in javax.swing")
...
* ## Method Details
  ...
  + ### getAccessibleRole
    ...
    Overrides:
    :   `getAccessibleRole` in class `JToggleButton.AccessibleJToggleButton`
