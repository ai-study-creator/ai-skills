...
See the [`sum(javax.swing.Spring, javax.swing.Spring)`](#sum(javax.swing.Spring,javax.swing.Spring)) method for details.
...
* ## Field Details
  ...
  + ### UNSET
    ...
    See Also:
    :   - [Constant Field Values](../../../constant-values.md#javax.swing.Spring.UNSET)
* ## Constructor Details
  ...
  + ### Spring
    ...
    :   - [`constant(int)`](#constant(int))
        - [`constant(int, int, int)`](#constant(int,int,int))
        - [`max(javax.swing.Spring, javax.swing.Spring)`](#max(javax.swing.Spring,javax.swing.Spring))
        - [`minus(javax.swing.Spring)`](#minus(javax.swing.Spring))
        - [`sum(javax.swing.Spring, javax.swing.Spring)`](#sum(javax.swing.Spring,javax.swing.Spring))
        - [`SpringLayout.Constraints`](SpringLayout.Constraints.md "class in javax.swing")
* ## Method Details
  ...
  + ### constant
    ...
    public static [Spring](Spring.md "class in javax.swing") constant(int pref)
  ...
  + ### constant
    ...
    public static [Spring](Spring.md "class in javax.swing") constant(int min,
    int pref,
    int max)
  ...
  + ### minus
    ...
    public static [Spring](Spring.md "class in javax.swing") minus([Spring](Spring.md "class in javax.swing") s)
  ...
  + ### sum
    ...
    public static [Spring](Spring.md "class in javax.swing") sum([Spring](Spring.md "class in javax.swing") s1,
    [Spring](Spring.md "class in javax.swing") s2)

    Returns `s1+s2`: a spring representing `s1` and `s2`
    in series. In a sum, `s3`, of two springs, `s1` and `s2`,
    the *strains* of `s1`, `s2`, and `s3` are maintained
    at the same level (to within the precision implied by their integer *value*s).
    ...
    the sum is known, the *value*s of `s1` and `s2` are
    ...
    the *value*s of `s1` and `s2` is exactly equal to
    the *value* of `s3`.
  ...
  + ### max
    ...
    public static [Spring](Spring.md "class in javax.swing") max([Spring](Spring.md "class in javax.swing") s1,
    [Spring](Spring.md "class in javax.swing") s2)
  ...
  + ### scale
    ...
    public static [Spring](Spring.md "class in javax.swing") scale([Spring](Spring.md "class in javax.swing") s,
    float factor)
  ...
  + ### width
    ...
    public static [Spring](Spring.md "class in javax.swing") width([Component](../../java/awt/Component.md "class in java.awt") c)
  ...
  + ### height
    ...
    public static [Spring](Spring.md "class in javax.swing") height([Component](../../java/awt/Component.md "class in java.awt") c)
