...
objects of type `Person`. Only `Person`s
...
* ## Method Details
  ...
  + ### regexFilter
    ...
    public static <M,
    I> [RowFilter](RowFilter.md "class in javax.swing")<M,I> regexFilter([String](../../../java.base/java/lang/String.md "class in java.lang") regex,
    int... indices)
    ...
    The returned filter uses [`Matcher.find()`](../../../java.base/java/util/regex/Matcher.md#find())
    ...
    [`Pattern`](../../../java.base/java/util/regex/Pattern.md "class in java.util.regex") for a complete description of
    ...
    See Also:
    :   - [`Pattern`](../../../java.base/java/util/regex/Pattern.md "class in java.util.regex")
  + ### dateFilter

    public static <M,
    I> [RowFilter](RowFilter.md "class in javax.swing")<M,I> dateFilter([RowFilter.ComparisonType](RowFilter.ComparisonType.md "enum class in javax.swing") type,
    ...
    :   - [`Calendar`](../../../java.base/java/util/Calendar.md "class in java.util")
        - [`Date`](../../../java.base/java/util/Date.md "class in java.util")
  + ### numberFilter

    public static <M,
    I> [RowFilter](RowFilter.md "class in javax.swing")<M,I> numberFilter([RowFilter.ComparisonType](RowFilter.ComparisonType.md "enum class in javax.swing") type,
    [Number](../../../java.base/java/lang/Number.md "class in java.lang") number,
    int... indices)
  ...
  + ### orFilter
    ...
    public static <M,
    I> [RowFilter](RowFilter.md "class in javax.swing")<M,I> orFilter([Iterable](../../../java.base/java/lang/Iterable.md "interface in java.lang")<? extends [RowFilter](RowFilter.md "class in javax.swing")<? super M,? super I>> filters)
    ...
    See Also:
    :   - [`Arrays.asList(T...)`](../../../java.base/java/util/Arrays.md#asList(T...))
  + ### andFilter

    public static <M,
    I> [RowFilter](RowFilter.md "class in javax.swing")<M,I> andFilter([Iterable](../../../java.base/java/lang/Iterable.md "interface in java.lang")<? extends [RowFilter](RowFilter.md "class in javax.swing")<? super M,? super I>> filters)
  ...
  + ### notFilter
    ...
    public static <M,
    I> [RowFilter](RowFilter.md "class in javax.swing")<M,I> notFilter([RowFilter](RowFilter.md "class in javax.swing")<M,I> filter)
  ...
  + ### include
    ...
    public abstract boolean include([RowFilter.Entry](RowFilter.Entry.md "class in javax.swing")<? extends [M](RowFilter.md "type parameter in RowFilter"),? extends [I](RowFilter.md "type parameter in RowFilter")> entry)
