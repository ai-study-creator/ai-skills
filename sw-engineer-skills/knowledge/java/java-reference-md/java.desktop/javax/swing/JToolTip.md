...
* ## Method Details
  ...
  + ### getUI
    ...
    public [ToolTipUI](plaf/ToolTipUI.md "class in javax.swing.plaf") getUI()
  ...
  + ### setTipText
    ...
    [description](../../java/beans/BeanProperty.md#description())="Sets the text of the tooltip")
    public void setTipText([String](../../../java.base/java/lang/String.md "class in java.lang") tipText)
  ...
  + ### getTipText
    ...
    public [String](../../../java.base/java/lang/String.md "class in java.lang") getTipText()
  ...
  + ### setComponent
    ...
    [@BeanProperty](../../java/beans/BeanProperty.md "annotation interface in java.beans")([description](../../java/beans/BeanProperty.md#description())="Sets the component that the tooltip describes.")
    public void setComponent([JComponent](JComponent.md "class in javax.swing") c)
