...
* Discover and select print services based on their capabilities* Specify the format of print data* Submit print jobs to services that support the document type to be
      printed.

## Print Service Discovery

An application invokes the static methods of the abstract class
[`PrintServiceLookup`](PrintServiceLookup.md "class in javax.print") to locate print
...
the [`ServiceLoader`](../../../java.base/java/util/ServiceLoader.md "class in java.util") facility.

## Attribute Definitions

The [`javax.print.attribute`](attribute/package-summary.md) and [`javax.print.attribute.standard`](attribute/standard/package-summary.md)
...
Protocol, 1.1: Model and Semantics](http://www.ietf.org/rfc/rfc2911.txt), dated September 2000. The attributes
...
The [`DocFlavor`](DocFlavor.md "class in javax.print") class represents the print data
...
1. Chooses a `DocFlavor`.- Creates a set of attributes.- Locates a print service that can handle the print request as specified
       by the `DocFlavor` and the attribute set.- Creates a [`Doc`](Doc.md "interface in javax.print") object encapsulating the
         `DocFlavor` and the actual print data, which can take many forms
         including: a Postscript file, a JPEG image, a `URL`, or plain text.- Gets a print job, represented by
           [`DocPrintJob`](DocPrintJob.md "interface in javax.print"), from the print service.- Calls the print method of the print job.
...
* All Classes and InterfacesInterfacesClassesException Classes
  ...
  [AttributeException](AttributeException.md "interface in javax.print")
  ...
  [CancelablePrintJob](CancelablePrintJob.md "interface in javax.print")

  This interface is used by a printing application to cancel a print job.

  [Doc](Doc.md "interface in javax.print")
  ...
  which print data is supplied to a [`DocPrintJob`](DocPrintJob.md "interface in javax.print").

  [DocFlavor.BYTE\_ARRAY](DocFlavor.BYTE_ARRAY.md "class in javax.print")

  Class `DocFlavor.BYTE_ARRAY` provides predefined static constant
  `DocFlavor` objects for example doc flavors using a byte array
  (`byte[]`) as the print data representation class.

  [DocFlavor.CHAR\_ARRAY](DocFlavor.CHAR_ARRAY.md "class in javax.print")

  Class `DocFlavor.CHAR_ARRAY` provides predefined static constant
  `DocFlavor` objects for example doc flavors using a character array
  (`char[]`) as the print data representation class.

  [DocFlavor.INPUT\_STREAM](DocFlavor.INPUT_STREAM.md "class in javax.print")
  ...
  [DocFlavor.READER](DocFlavor.READER.md "class in javax.print")
  ...
  [DocFlavor.SERVICE\_FORMATTED](DocFlavor.SERVICE_FORMATTED.md "class in javax.print")
  ...
  [DocFlavor.STRING](DocFlavor.STRING.md "class in javax.print")
  ...
  [DocFlavor.URL](DocFlavor.URL.md "class in javax.print")

  Class `DocFlavor.URL` provides predefined static constant
  `DocFlavor` objects.

  [DocPrintJob](DocPrintJob.md "interface in javax.print")

  This interface represents a print job that can print a specified document
  with a set of job attributes.

  [FlavorException](FlavorException.md "interface in javax.print")

  Interface `FlavorException` is a mixin interface which a subclass of
  [`PrintException`](PrintException.md "class in javax.print") can implement to report an error
  condition involving a doc flavor or flavors (class [`DocFlavor`](DocFlavor.md "class in javax.print")).

  [MultiDoc](MultiDoc.md "interface in javax.print")

  Interface `MultiDoc` specifies the interface for an object that
  supplies more than one piece of print data for a Print Job.

  [MultiDocPrintJob](MultiDocPrintJob.md "interface in javax.print")
  ...
  [MultiDocPrintService](MultiDocPrintService.md "interface in javax.print")

  Interface `MultiPrintService` is the factory for a
  `MultiDocPrintJob`.

  [PrintException](PrintException.md "class in javax.print")
  ...
  [PrintServiceLookup](PrintServiceLookup.md "class in javax.print")
  ...
  [ServiceUI](ServiceUI.md "class in javax.print")
  ...
  [StreamPrintServiceFactory](StreamPrintServiceFactory.md "class in javax.print")
  ...
  [URIException](URIException.md "interface in javax.print")
