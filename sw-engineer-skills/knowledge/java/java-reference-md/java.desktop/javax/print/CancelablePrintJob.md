...
interface extends [`DocPrintJob`](DocPrintJob.md "interface in javax.print"). A `DocPrintJob` implementation
...
to deliver a [`PrintJobEvent.JOB_CANCELED`](event/PrintJobEvent.md#JOB_CANCELED) event to
