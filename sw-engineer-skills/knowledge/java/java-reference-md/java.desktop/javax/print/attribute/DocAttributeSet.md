...
[`DocAttribute`](DocAttribute.md "interface in javax.print.attribute"). In the Print Service API, the client uses
...
A `DocAttributeSet` is just an [`AttributeSet`](AttributeSet.md "interface in javax.print.attribute") whose
...
instances of interface [`DocAttribute`](DocAttribute.md "interface in javax.print.attribute"). The
...
* ## Method Details
  ...
  + ### add
    ...
    :   `ClassCastException` - if the `attribute` is not an instance of
        interface [`DocAttribute`](DocAttribute.md "interface in javax.print.attribute")
  ...
  + ### addAll
    ...
    :   `ClassCastException` - if some element in the specified set is not an
        instance of interface [`DocAttribute`](DocAttribute.md "interface in javax.print.attribute")
