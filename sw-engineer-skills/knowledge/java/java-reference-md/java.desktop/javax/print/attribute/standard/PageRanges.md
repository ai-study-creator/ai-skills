...
* If all the docs have the same page ranges specified, then any value of
  ...
  + `SINGLE_DOCUMENT` -- All the input docs will be combined
    ...
    output document will be printed.+ `SINGLE_DOCUMENT_NEW_SHEET` -- All the input docs will be
      ...
      ranges of that output document will be printed.+ `SEPARATE_DOCUMENTS_UNCOLLATED_COPIES` -- For each separate
        input doc, the specified page ranges will be printed.+ `SEPARATE_DOCUMENTS_COLLATED_COPIES` -- For each separate input
          doc, the specified page ranges will be printed.
  + `SEPARATE_DOCUMENTS_UNCOLLATED_COPIES` -- For each separate
    input doc, its own specified page ranges will be printed.+ `SEPARATE_DOCUMENTS_COLLATED_COPIES` -- For each separate input
...
See Also:
:   * [Serialized Form](../../../../../serialized-form.md#javax.print.attribute.standard.PageRanges)
...
* ## Constructor Details
  ...
  + ### PageRanges
    ...
    [`SetOfIntegerSyntax`](../SetOfIntegerSyntax.md "class in javax.print.attribute") for an explanation of array
    form.
  ...
  + ### PageRanges
    ...
    public PageRanges([String](../../../../../java.base/java/lang/String.md "class in java.lang") members)

    Construct a new page ranges attribute with the given members in string
    form. See class [`SetOfIntegerSyntax`](../SetOfIntegerSyntax.md "class in javax.print.attribute") for
...
* ## Method Details
  ...
  + ### equals
    ...
    1. `object` is not `null`.+ `object` is an instance of class `PageRanges`.+ This page ranges attribute's members and `object`'s members
           are the same.
    ...
    Returns:
    :   `true` if `object` is equivalent to this page ranges
  ...
  + ### getCategory
    ...
    For class `PageRanges`, the category is class
    `PageRanges` itself.
