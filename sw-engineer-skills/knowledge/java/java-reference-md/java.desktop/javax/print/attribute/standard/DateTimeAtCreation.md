...
then use the [`Date`](../../../../../java.base/java/util/Date.md "class in java.util") object to construct the DateTimeAtCreation
...
See Also:
:   * [Serialized Form](../../../../../serialized-form.md#javax.print.attribute.standard.DateTimeAtCreation)
...
* ## Constructor Details
  ...
  + ### DateTimeAtCreation
    ...
    public DateTimeAtCreation([Date](../../../../../java.base/java/util/Date.md "class in java.util") dateTime)
...
* ## Method Details
  ...
  + ### equals
    ...
    be true:
    1. `object` is not `null`.+ `object` is an instance of class `DateTimeAtCreation`.+ This date-time at creation attribute's [`Date`](../../../../../java.base/java/util/Date.md "class in java.util")
