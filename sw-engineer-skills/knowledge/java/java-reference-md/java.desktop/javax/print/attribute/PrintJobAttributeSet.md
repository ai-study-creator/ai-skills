...
[`PrintJobAttribute`](PrintJobAttribute.md "interface in javax.print.attribute"). In the Print Service API, a
service uses a `PrintJobAttributeSet` to report the status of a print
job.

A `PrintJobAttributeSet` is just an [`AttributeSet`](AttributeSet.md "interface in javax.print.attribute")
...
instances of interface [`PrintJobAttribute`](PrintJobAttribute.md "interface in javax.print.attribute"). The
...
* ## Method Details
  ...
  + ### add
    ...
    :   `ClassCastException` - if the `attribute` is not an instance of
        interface [`PrintJobAttribute`](PrintJobAttribute.md "interface in javax.print.attribute")
  ...
  + ### addAll
    ...
    :   `ClassCastException` - if some element in the specified set is not an
        instance of interface [`PrintJobAttribute`](PrintJobAttribute.md "interface in javax.print.attribute")
