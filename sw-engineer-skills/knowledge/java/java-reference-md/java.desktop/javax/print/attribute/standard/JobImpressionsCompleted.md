...
The `JobImpressionsCompleted` attribute describes the progress of the
job. This attribute is intended to be a counter. That is, the
`JobImpressionsCompleted` value for a job that has not started
...
`JobImpressionsCompleted` value is the final value for the job.
...
:   * [`JobImpressions`](JobImpressions.md "class in javax.print.attribute.standard")
    ...
    * [Serialized Form](../../../../../serialized-form.md#javax.print.attribute.standard.JobImpressionsCompleted)
...
* ## Method Details
  ...
  + ### equals
    ...
    1. `object` is not `null`.+ `object` is an instance of class
         `JobImpressionsCompleted`.+ This job impressions completed attribute's value and
