...
`PrinterMessageFromOperator` attribute, not more than one instance. A
new `PrinterMessageFromOperator` attribute replaces an existing
`PrinterMessageFromOperator` attribute, if any. In other words,
`PrinterMessageFromOperator` is not intended to be a history log. If it
wishes, the client can detect changes to a Print Service's
`PrinterMessageFromOperator` attribute and maintain the client's own
history log of the `PrinterMessageFromOperator` attribute values.
...
See Also:
:   * [Serialized Form](../../../../../serialized-form.md#javax.print.attribute.standard.PrinterMessageFromOperator)
...
* ## Constructor Details
  ...
  + ### PrinterMessageFromOperator
    ...
    public PrinterMessageFromOperator([String](../../../../../java.base/java/lang/String.md "class in java.lang") message,
...
* ## Method Details
  ...
  + ### equals
    ...
    1. `object` is not `null`.+ `object` is an instance of class
         `PrinterMessageFromOperator`.+ This printer message from operator attribute's underlying string
           and `object`'s underlying string are equal.+ This printer message from operator attribute's locale and
