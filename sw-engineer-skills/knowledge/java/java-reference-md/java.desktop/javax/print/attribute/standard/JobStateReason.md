...
set directly. Rather, a [`JobStateReasons`](JobStateReasons.md "class in javax.print.attribute.standard") attribute
appears in the Print Job's attribute set. The
[`JobStateReasons`](JobStateReasons.md "class in javax.print.attribute.standard") attribute contains zero, one, or more
...
[`JobStateReasons`](JobStateReasons.md "class in javax.print.attribute.standard") attribute when the corresponding
...
See Also:
:   * [Serialized Form](../../../../../serialized-form.md#javax.print.attribute.standard.JobStateReason)
...
* ## Field Summary
  ...
  The value of the job's [`JobHoldUntil`](JobHoldUntil.md "class in javax.print.attribute.standard") attribute was
  ...
  The job is in the `PROCESSING` state, but more specifically, the
  ...
  The job is in the `PENDING_HELD`, `PENDING`, or
  `PROCESSING` state, but more specifically, the printer has
  ...
  The value of the printer's [`PrinterState`](PrinterState.md "class in javax.print.attribute.standard") attribute ia
  `STOPPED`.
  ...
  The value of the printer's [`PrinterStateReasons`](PrinterStateReasons.md "class in javax.print.attribute.standard") attribute contains a
  [`PrinterStateReason`](PrinterStateReason.md "class in javax.print.attribute.standard") value of
  `STOPPED_PARTLY`.
...
* ## Field Details
  ...
  + ### JOB\_INCOMING
    ...
    public static final [JobStateReason](JobStateReason.md "class in javax.print.attribute.standard") JOB\_INCOMING

    The printer has created the Print Job, but the printer has not finished
    accessing or accepting all the print data yet.
  + ### JOB\_DATA\_INSUFFICIENT

    public static final [JobStateReason](JobStateReason.md "class in javax.print.attribute.standard") JOB\_DATA\_INSUFFICIENT

    The printer has created the Print Job, but the printer is expecting
    additional print data before it can move the job into the
    `PROCESSING` state. If a printer starts processing before it has
    received all data, the printer removes the `JOB_DATA_INSUFFICIENT`
    reason, but the `JOB_INCOMING` reason remains. If a printer starts
    processing after it has received all data, the printer removes the
    `JOB_DATA_INSUFFICIENT` and `JOB_INCOMING` reasons at the
    same time.
  + ### DOCUMENT\_ACCESS\_ERROR

    public static final [JobStateReason](JobStateReason.md "class in javax.print.attribute.standard") DOCUMENT\_ACCESS\_ERROR

    The printer could not access one or more documents passed by reference
    (i.e., the print data representation object is a `URL`). This
    ...
    the printer aborts the job and moves the job to the `ABORTED` job
    state or prints all documents that are accessible and moves the job to
    the `COMPLETED` job state and adds the
    `COMPLETED_WITH_ERRORS` reason to the job's
    [`JobStateReasons`](JobStateReasons.md "class in javax.print.attribute.standard") attribute depends on
    implementation and/or site policy. This value should be supported if the
    printer supports doc flavors with `URL` print data representation
    objects.
  + ### SUBMISSION\_INTERRUPTED

    public static final [JobStateReason](JobStateReason.md "class in javax.print.attribute.standard") SUBMISSION\_INTERRUPTED
  ...
  + ### JOB\_OUTGOING
    ...
    public static final [JobStateReason](JobStateReason.md "class in javax.print.attribute.standard") JOB\_OUTGOING

    The printer is transmitting the job to the output device.
  + ### JOB\_HOLD\_UNTIL\_SPECIFIED

    public static final [JobStateReason](JobStateReason.md "class in javax.print.attribute.standard") JOB\_HOLD\_UNTIL\_SPECIFIED
    ...
    [`JobHoldUntil`](JobHoldUntil.md "class in javax.print.attribute.standard") job template attribute is supported.
  + ### RESOURCES\_ARE\_NOT\_READY

    public static final [JobStateReason](JobStateReason.md "class in javax.print.attribute.standard") RESOURCES\_ARE\_NOT\_READY
    ...
    be moved to the `PENDING_HELD` state, depending on implementation
    and/or job scheduling policy.
  + ### PRINTER\_STOPPED\_PARTLY

    public static final [JobStateReason](JobStateReason.md "class in javax.print.attribute.standard") PRINTER\_STOPPED\_PARTLY
  ...
  + ### PRINTER\_STOPPED
    ...
    public static final [JobStateReason](JobStateReason.md "class in javax.print.attribute.standard") PRINTER\_STOPPED

    The value of the printer's [`PrinterState`](PrinterState.md "class in javax.print.attribute.standard") attribute ia
    `STOPPED`.
  + ### JOB\_INTERPRETING

    public static final [JobStateReason](JobStateReason.md "class in javax.print.attribute.standard") JOB\_INTERPRETING

    The job is in the `PROCESSING` state, but more specifically, the
    printer ia interpreting the document data.
  + ### JOB\_QUEUED

    public static final [JobStateReason](JobStateReason.md "class in javax.print.attribute.standard") JOB\_QUEUED

    The job is in the `PROCESSING` state, but more specifically, the
    printer has queued the document data.
  + ### JOB\_TRANSFORMING

    public static final [JobStateReason](JobStateReason.md "class in javax.print.attribute.standard") JOB\_TRANSFORMING

    The job is in the `PROCESSING` state, but more specifically, the
    printer is interpreting document data and producing another electronic
    representation.
  + ### JOB\_QUEUED\_FOR\_MARKER

    public static final [JobStateReason](JobStateReason.md "class in javax.print.attribute.standard") JOB\_QUEUED\_FOR\_MARKER

    The job is in the `PENDING_HELD`, `PENDING`, or
    `PROCESSING` state, but more specifically, the printer has
    completed enough processing of the document to be able to start marking
    and the job is waiting for the marker. Systems that require human
    intervention to release jobs put the job into the `PENDING_HELD`
    job state. Systems that automatically select a job to use the marker put
    the job into the `PENDING` job state or keep the job in the
  ...
  + ### JOB\_PRINTING
    ...
    public static final [JobStateReason](JobStateReason.md "class in javax.print.attribute.standard") JOB\_PRINTING
  ...
  + ### JOB\_CANCELED\_BY\_USER
    ...
    public static final [JobStateReason](JobStateReason.md "class in javax.print.attribute.standard") JOB\_CANCELED\_BY\_USER
    ...
    supported.
  + ### JOB\_CANCELED\_BY\_OPERATOR

    public static final [JobStateReason](JobStateReason.md "class in javax.print.attribute.standard") JOB\_CANCELED\_BY\_OPERATOR
  ...
  + ### JOB\_CANCELED\_AT\_DEVICE

    public static final [JobStateReason](JobStateReason.md "class in javax.print.attribute.standard") JOB\_CANCELED\_AT\_DEVICE
  ...
  + ### ABORTED\_BY\_SYSTEM
    ...
    public static final [JobStateReason](JobStateReason.md "class in javax.print.attribute.standard") ABORTED\_BY\_SYSTEM
    ...
    in the `PENDING_HELD` state, so that a user or operator can
    manually try the job again. This value should be supported.
  + ### UNSUPPORTED\_COMPRESSION

    public static final [JobStateReason](JobStateReason.md "class in javax.print.attribute.standard") UNSUPPORTED\_COMPRESSION

    The job was aborted by the system because the printer determined while
    attempting to decompress the document's data that the compression is
    actually not among those supported by the printer. This value must be
    supported, since [`Compression`](Compression.md "class in javax.print.attribute.standard") is a required doc
    description attribute.
  + ### COMPRESSION\_ERROR

    public static final [JobStateReason](JobStateReason.md "class in javax.print.attribute.standard") COMPRESSION\_ERROR
  ...
  + ### UNSUPPORTED\_DOCUMENT\_FORMAT

    public static final [JobStateReason](JobStateReason.md "class in javax.print.attribute.standard") UNSUPPORTED\_DOCUMENT\_FORMAT

    The job was aborted by the system because the document data's document
    format (doc flavor) is not among those supported by the printer. If the
    client specifies a doc flavor with a MIME type of
    `"application/octet-stream"`, the printer may abort the job if the
  ...
  + ### DOCUMENT\_FORMAT\_ERROR

    public static final [JobStateReason](JobStateReason.md "class in javax.print.attribute.standard") DOCUMENT\_FORMAT\_ERROR
  ...
  + ### PROCESSING\_TO\_STOP\_POINT

    public static final [JobStateReason](JobStateReason.md "class in javax.print.attribute.standard") PROCESSING\_TO\_STOP\_POINT
    ...
    the `PROCESSING` or `PROCESSING_STOPPED` job states, the
    ...
    `PROCESSING` or `PROCESSING_STOPPED` state. After all the
  ...
  + ### SERVICE\_OFF\_LINE
    ...
    public static final [JobStateReason](JobStateReason.md "class in javax.print.attribute.standard") SERVICE\_OFF\_LINE

    The printer is off-line and accepting no jobs. All `PENDING` jobs
    are put into the `PENDING_HELD` state. This situation could be true
    if the service's or document transform's input is impaired or broken.
  + ### JOB\_COMPLETED\_SUCCESSFULLY

    public static final [JobStateReason](JobStateReason.md "class in javax.print.attribute.standard") JOB\_COMPLETED\_SUCCESSFULLY

    The job completed successfully. This value should be supported.
  + ### JOB\_COMPLETED\_WITH\_WARNINGS

    public static final [JobStateReason](JobStateReason.md "class in javax.print.attribute.standard") JOB\_COMPLETED\_WITH\_WARNINGS

    The job completed with warnings. This value should be supported if the
    implementation detects warnings.
  + ### JOB\_COMPLETED\_WITH\_ERRORS

    public static final [JobStateReason](JobStateReason.md "class in javax.print.attribute.standard") JOB\_COMPLETED\_WITH\_ERRORS
  ...
  + ### JOB\_RESTARTABLE
    ...
    public static final [JobStateReason](JobStateReason.md "class in javax.print.attribute.standard") JOB\_RESTARTABLE

    This job is retained and is currently able to be restarted. If
    `JOB_RESTARTABLE` is contained in the job's
    [`JobStateReasons`](JobStateReasons.md "class in javax.print.attribute.standard") attribute, then the printer must
    accept a request to restart that job. This value should be supported if
    restarting jobs is supported. *[The capability for restarting jobs is
    not in the Java Print Service API at present.]*
  + ### QUEUED\_IN\_DEVICE

    public static final [JobStateReason](JobStateReason.md "class in javax.print.attribute.standard") QUEUED\_IN\_DEVICE

    The job has been forwarded to a device or print system that is unable to
    send back status. The printer sets the job's [`JobState`](JobState.md "class in javax.print.attribute.standard")
    attribute to `COMPLETED` and adds the `QUEUED_IN_DEVICE`
    reason to the job's [`JobStateReasons`](JobStateReasons.md "class in javax.print.attribute.standard") attribute to
