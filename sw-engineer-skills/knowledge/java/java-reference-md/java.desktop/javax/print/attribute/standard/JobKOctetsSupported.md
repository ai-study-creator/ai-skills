...
See Also:
:   * [Serialized Form](../../../../../serialized-form.md#javax.print.attribute.standard.JobKOctetsSupported)
...
* ## Method Details
  ...
  + ### equals
    ...
    must be true:
    1. `object` is not `null`.+ `object` is an instance of class `JobKOctetsSupported`.+ This job K octets supported attribute's members and
