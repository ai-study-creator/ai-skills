...
extends [AccessibleTable](AccessibleTable.md "interface in javax.accessibility")
...
[`AccessibleContext.getAccessibleTable()`](AccessibleContext.md#getAccessibleTable()) method. If the return value is
...
* ## Method Summary
  ...
  ### Methods inherited from interface javax.accessibility.[AccessibleTable](AccessibleTable.md "interface in javax.accessibility")
...
* ## Method Details
  ...
  + ### getAccessibleRow
    ...
    Parameters:
    :   `index` - the zero-based index in the table. The index is the table
