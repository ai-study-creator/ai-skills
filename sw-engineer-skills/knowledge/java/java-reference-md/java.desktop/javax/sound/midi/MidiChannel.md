...
A `MidiChannel` object represents a single MIDI channel. Generally,
...
A [`Synthesizer`](Synthesizer.md "interface in javax.sound.midi") object has a collection of `MidiChannels`,
...
See Also:
:   * [`Synthesizer.getChannels()`](Synthesizer.md#getChannels())
...
* ## Method Details
  ...
  + ### noteOn
    ...
    zero, this method instead acts like [`noteOff(int)`](#noteOff(int)), terminating
    the note.
    ...
    See Also:
    :   - [`noteOff(int, int)`](#noteOff(int,int))
  + ### noteOff
    ...
    [`controlChange`](#controlChange(int,int))) is down, the effect of
    ...
    See Also:
    :   - [`noteOff(int)`](#noteOff(int))
        - [`noteOn(int, int)`](#noteOn(int,int))
  ...
  + ### setPolyPressure
    ...
    Parameters:
    :   `noteNumber` - the MIDI note number, from 0 to 127 (60 = Middle C)
    :   `pressure` - value for the specified key, from 0 to 127
        (127 = maximum pressure)

    See Also:
    :   - [`getPolyPressure(int)`](#getPolyPressure(int))
  + ### getPolyPressure
    ...
    See Also:
    :   - [`setPolyPressure(int, int)`](#setPolyPressure(int,int))
  + ### setChannelPressure
    ...
    described under [`setPolyPressure`](#setPolyPressure(int,int)).
    ...
    See Also:
    :   - [`setPolyPressure(int, int)`](#setPolyPressure(int,int))
        - [`getChannelPressure()`](#getChannelPressure())
  + ### getChannelPressure
    ...
    See Also:
    :   - [`setChannelPressure(int)`](#setChannelPressure(int))
  + ### controlChange
    ...
    `controlChange` was successful, use `getController`.

    Parameters:
    :   `controller` - the controller number (0 to 127; see the MIDI 1.0
        Specification for the interpretation)
    :   `value` - the value to which the specified controller is changed
        (0 to 127)

    See Also:
    :   - [`getController(int)`](#getController(int))
  + ### getController
    ...
    See Also:
    :   - [`controlChange(int, int)`](#controlChange(int,int))
  + ### programChange
    ...
    See Also:
    :   - [`programChange(int, int)`](#programChange(int,int))
  ...
  + ### programChange
    ...
    :   `program` - the program (patch) to use in the specified bank
        (0 to 127)

    See Also:
    :   - [`programChange(int)`](#programChange(int))
        - [`getProgram()`](#getProgram())
  + ### getProgram
    ...
    See Also:
    :   - [`Patch.getProgram()`](Patch.md#getProgram())
        - [`Synthesizer.loadInstrument(javax.sound.midi.Instrument)`](Synthesizer.md#loadInstrument(javax.sound.midi.Instrument))
        - [`programChange(int)`](#programChange(int))
  + ### setPitchBend
  ...
  + ### getPitchBend
    ...
    8192. Calling `setPitchBend` will have no effect then.

    Returns:
    :   bend amount, as a nonnegative 14-bit value (8192 = no bend)

    See Also:
    :   - [`setPitchBend(int)`](#setPitchBend(int))
  + ### resetAllControllers
  ...
  + ### allNotesOff
    ...
    (see [`controlChange`](#controlChange(int,int))) is down, the effect
  ...
  + ### localControl
    ...
    Parameters:
    :   `on` - `true` to turn local control on, `false` to turn
        local control off
  ...
  + ### setMono
    ...
    Parameters:
    :   `on` - `true` to turn mono mode on, `false` to turn it
  ...
  + ### getMono
    ...
    Returns:
    :   `true` if mono mode is on, otherwise `false` (meaning
        poly mode is on)

    See Also:
    :   - [`setMono(boolean)`](#setMono(boolean))
  + ### setOmni
    ...
    Parameters:
    :   `on` - `true` to turn omni mode on, `false` to turn it
        off
  ...
  + ### getOmni
    ...
    Returns:
    :   `true` if omni mode is on, otherwise `false` (meaning
        omni mode is off)

    See Also:
    :   - [`setOmni(boolean)`](#setOmni(boolean))
  + ### setMute

    void setMute(boolean mute)

    Sets the mute state for this channel. A value of `true` means the
    channel is to be muted, `false` means the channel can sound (if
    other channels are not soloed).

    Unlike [`allSoundOff()`](#allSoundOff()), this method applies to only a specific
    ...
    See Also:
    :   - [`getMute()`](#getMute())
        - [`setSolo(boolean)`](#setSolo(boolean))
  + ### getMute
    ...
    See Also:
    :   - [`setMute(boolean)`](#setMute(boolean))
  + ### setSolo

    void setSolo(boolean soloState)

    Sets the solo state for this channel. If `solo` is `true`
