...
* ## Method Details
  ...
  + ### create
    ...
    [RenderedImage](../RenderedImage.md "interface in java.awt.image") create([ParameterBlock](ParameterBlock.md "class in java.awt.image.renderable") paramBlock,
    ...
    Parameters:
    :   `paramBlock` - a ParameterBlock containing sources and parameters
