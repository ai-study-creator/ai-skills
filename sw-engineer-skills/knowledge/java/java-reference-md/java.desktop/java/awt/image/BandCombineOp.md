...
implements [RasterOp](RasterOp.md "interface in java.awt.image")
...
* ## Constructor Details
  ...
  + ### BandCombineOp
    ...
    :   `hints` - The `RenderingHints` object for this operation.
...
* ## Method Details
  ...
  + ### filter
    ...
    public [WritableRaster](WritableRaster.md "class in java.awt.image") filter([Raster](Raster.md "class in java.awt.image") src,
