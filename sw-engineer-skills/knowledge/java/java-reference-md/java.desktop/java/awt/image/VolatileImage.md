...
by using the [`Component.createVolatileImage`](../Component.md#createVolatileImage(int,int)) or
[`GraphicsConfiguration.createCompatibleVolatileImage(int, int)`](../GraphicsConfiguration.md#createCompatibleVolatileImage(int,int)) methods.
...
Note that this class subclasses from the [`Image`](../Image.md "class in java.awt") class, which
includes methods that take an [`ImageObserver`](ImageObserver.md "interface in java.awt.image") parameter for
asynchronous notifications as information is received from
a potential [`ImageProducer`](ImageProducer.md "interface in java.awt.image"). Since this `VolatileImage`
...
* ## Field Details
  ...
  + ### IMAGE\_OK
    ...
    public static final int IMAGE\_OK

    Validated image is ready to use as-is.

    See Also:
    :   - [Constant Field Values](../../../../constant-values.md#java.awt.image.VolatileImage.IMAGE_OK)
  + ### IMAGE\_RESTORED

    public static final int IMAGE\_RESTORED

    Validated image has been restored and is now ready to use.
    Note that restoration causes contents of the image to be lost.

    See Also:
    :   - [Constant Field Values](../../../../constant-values.md#java.awt.image.VolatileImage.IMAGE_RESTORED)
  + ### IMAGE\_INCOMPATIBLE

    public static final int IMAGE\_INCOMPATIBLE
    ...
    See Also:
    :   - [Constant Field Values](../../../../constant-values.md#java.awt.image.VolatileImage.IMAGE_INCOMPATIBLE)
  + ### transparency
    ...
    See Also:
    :   - [`GraphicsConfiguration.createCompatibleVolatileImage(int, int,int)`](../GraphicsConfiguration.md#createCompatibleVolatileImage(int,int,int))
        - [`GraphicsConfiguration.createCompatibleVolatileImage(int, int,ImageCapabilities,int)`](../GraphicsConfiguration.md#createCompatibleVolatileImage(int,int,java.awt.ImageCapabilities,int))
...
* ## Method Details
  ...
  + ### getSnapshot
    ...
    public abstract [BufferedImage](BufferedImage.md "class in java.awt.image") getSnapshot()
    ...
    Returns:
    :   a [`BufferedImage`](BufferedImage.md "class in java.awt.image") representation of this
        `VolatileImage`
  ...
  + ### getSource
    ...
    Returns:
    :   an [`ImageProducer`](ImageProducer.md "interface in java.awt.image") that can be used to produce the
  ...
  + ### createGraphics
    ...
    public abstract [Graphics2D](../Graphics2D.md "class in java.awt") createGraphics()
  ...
  + ### validate
    ...
    public abstract int validate([GraphicsConfiguration](../GraphicsConfiguration.md "class in java.awt") gc)
  ...
  + ### getCapabilities
    ...
    public abstract [ImageCapabilities](../ImageCapabilities.md "class in java.awt") getCapabilities()
