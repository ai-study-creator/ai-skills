...
[`TYPE_FLOAT`](DataBuffer.md#TYPE_FLOAT),
[`TYPE_DOUBLE`](DataBuffer.md#TYPE_DOUBLE),
...
* ## Method Summary
  ...
  with the
  [`getDataElements(int, int, Object, DataBuffer)`](#getDataElements(int,int,java.lang.Object,java.awt.image.DataBuffer)) and
...
* ## Method Details
  ...
  + ### getNumDataElements
    ...
    :   - [`SampleModel.getNumDataElements()`](SampleModel.md#getNumDataElements())
        - [`SampleModel.getNumBands()`](SampleModel.md#getNumBands())
  + ### getDataElements
