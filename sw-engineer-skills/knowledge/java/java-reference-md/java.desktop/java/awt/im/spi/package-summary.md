...
`InputMethodDescriptor` implementations during AWT initialization. It
...
* Related Packages
  ...
  [java.awt.im](../package-summary.md)
...
* Interfaces
  ...
  [InputMethod](InputMethod.md "interface in java.awt.im.spi")

  Defines the interface for an input method that supports complex text input.

  [InputMethodContext](InputMethodContext.md "interface in java.awt.im.spi")

  Provides methods that input methods
  can use to communicate with their client components or to request
  other services.

  [InputMethodDescriptor](InputMethodDescriptor.md "interface in java.awt.im.spi")
