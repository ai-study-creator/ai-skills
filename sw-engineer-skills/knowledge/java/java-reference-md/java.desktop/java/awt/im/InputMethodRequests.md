...
* *on-the-spot* input, where the composed text is displayed as part
  of the text component's text body.* *below-the-spot* input, where the composed text is displayed in
...
See Also:
:   * [`Component.getInputMethodRequests()`](../Component.md#getInputMethodRequests())
...
* ## Method Details
  ...
  + ### getTextLocation
    ...
    [Rectangle](../Rectangle.md "class in java.awt") getTextLocation([TextHitInfo](../font/TextHitInfo.md "class in java.awt.font") offset)
  ...
  + ### getLocationOffset
    ...
    [TextHitInfo](../font/TextHitInfo.md "class in java.awt.font") getLocationOffset(int x,
    int y)
  ...
  + ### getCommittedText
    ...
    [AttributedCharacterIterator](../../../../java.base/java/text/AttributedCharacterIterator.md "interface in java.text") getCommittedText(int beginIndex,
    int endIndex,
    [AttributedCharacterIterator.Attribute](../../../../java.base/java/text/AttributedCharacterIterator.Attribute.md "class in java.text")[] attributes)
  ...
  + ### cancelLatestCommittedText
    ...
    [AttributedCharacterIterator](../../../../java.base/java/text/AttributedCharacterIterator.md "interface in java.text") cancelLatestCommittedText([AttributedCharacterIterator.Attribute](../../../../java.base/java/text/AttributedCharacterIterator.Attribute.md "class in java.text")[] attributes)
  ...
  + ### getSelectedText
    ...
    [AttributedCharacterIterator](../../../../java.base/java/text/AttributedCharacterIterator.md "interface in java.text") getSelectedText([AttributedCharacterIterator.Attribute](../../../../java.base/java/text/AttributedCharacterIterator.Attribute.md "class in java.text")[] attributes)
