...
programming language, using the interfaces in the [`java.awt.im.spi`](spi/package-summary.md) package,
...
* ## Constructor Details
  ...
  + ### InputContext
    ...
    calling [`getInstance()`](#getInstance()).
* ## Method Details

  + ### getInstance

    public static [InputContext](InputContext.md "class in java.awt.im") getInstance()
  ...
  + ### selectInputMethod
    ...
    public boolean selectInputMethod([Locale](../../../../java.base/java/util/Locale.md "class in java.util") locale)
    ...
    - Otherwise, an input method or keyboard layout that supports the requested
      locale is selected in an implementation dependent way.Before switching away from an input method, any currently uncommitted text
  ...
  + ### getLocale
    ...
    [`InputMethod.getLocale()`](spi/InputMethod.md#getLocale()) method returns null.
  ...
  + ### setCharacterSubsets
    ...
    public void setCharacterSubsets([Character.Subset](../../../../java.base/java/lang/Character.Subset.md "class in java.lang")[] subsets)
  ...
  + ### dispatchEvent
    ...
    public void dispatchEvent([AWTEvent](../AWTEvent.md "class in java.awt") event)
  ...
  + ### removeNotify
    ...
    public void removeNotify([Component](../Component.md "class in java.awt") client)
  ...
  + ### getInputMethodControlObject
    ...
    public [Object](../../../../java.base/java/lang/Object.md "class in java.lang") getInputMethodControlObject()
