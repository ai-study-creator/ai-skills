...
and many printers in an instance of [`GraphicsEnvironment`](GraphicsEnvironment.md "class in java.awt"). Each
graphics device has one or more [`GraphicsConfiguration`](GraphicsConfiguration.md "class in java.awt") objects
...
* ## Method Summary
  ...
  criteria defined in the [`GraphicsConfigTemplate`](GraphicsConfigTemplate.md "class in java.awt").
...
* ## Field Details
  ...
  + ### TYPE\_RASTER\_SCREEN

    public static final int TYPE\_RASTER\_SCREEN

    Device is a raster screen.

    See Also:
    :   - [Constant Field Values](../../../constant-values.md#java.awt.GraphicsDevice.TYPE_RASTER_SCREEN)
  + ### TYPE\_PRINTER

    public static final int TYPE\_PRINTER

    Device is a printer.

    See Also:
    :   - [Constant Field Values](../../../constant-values.md#java.awt.GraphicsDevice.TYPE_PRINTER)
  + ### TYPE\_IMAGE\_BUFFER

    public static final int TYPE\_IMAGE\_BUFFER

    Device is an image buffer. This buffer can reside in device
    or system memory but it is not physically viewable by the user.

    See Also:
    :   - [Constant Field Values](../../../constant-values.md#java.awt.GraphicsDevice.TYPE_IMAGE_BUFFER)
* ## Constructor Details
  ...
  + ### GraphicsDevice
    ...
    :   - [`GraphicsEnvironment.getScreenDevices()`](GraphicsEnvironment.md#getScreenDevices())
        - [`GraphicsEnvironment.getDefaultScreenDevice()`](GraphicsEnvironment.md#getDefaultScreenDevice())
        - [`GraphicsConfiguration.getDevice()`](GraphicsConfiguration.md#getDevice())
* ## Method Details
  ...
  + ### getType
    ...
    :   the type of this `GraphicsDevice`, which can
        either be TYPE\_RASTER\_SCREEN, TYPE\_PRINTER or TYPE\_IMAGE\_BUFFER.

    See Also:
    :   - [`TYPE_RASTER_SCREEN`](#TYPE_RASTER_SCREEN)
        - [`TYPE_PRINTER`](#TYPE_PRINTER)
        - [`TYPE_IMAGE_BUFFER`](#TYPE_IMAGE_BUFFER)
  + ### getIDstring

    public abstract [String](../../../java.base/java/lang/String.md "class in java.lang") getIDstring()
    ...
    [`getProperty`](../../../java.base/java/lang/System.md#getProperty(java.lang.String)) method of the
  ...
  + ### getConfigurations
    ...
    public abstract [GraphicsConfiguration](GraphicsConfiguration.md "class in java.awt")[] getConfigurations()
  ...
  + ### getDefaultConfiguration
    ...
    public abstract [GraphicsConfiguration](GraphicsConfiguration.md "class in java.awt") getDefaultConfiguration()
  ...
  + ### getBestConfiguration
    ...
    public [GraphicsConfiguration](GraphicsConfiguration.md "class in java.awt") getBestConfiguration([GraphicsConfigTemplate](GraphicsConfigTemplate.md "class in java.awt") gct)
  ...
  + ### setFullScreenWindow
    ...
    public void setFullScreenWindow([Window](Window.md "class in java.awt") w)
    ...
    - Windows cannot overlap the full-screen window. All other application
      windows will always appear beneath the full-screen window in the Z-order.- There can be only one full-screen window on a device at any time,
        so calling this method while there is an existing full-screen Window
        will cause the existing full-screen window to
        return to windowed mode.- Input method windows are disabled. It is advisable to call
    ...
    :   - [`isFullScreenSupported()`](#isFullScreenSupported())
        ...
        - [`setDisplayMode(java.awt.DisplayMode)`](#setDisplayMode(java.awt.DisplayMode))
        - [`Component.enableInputMethods(boolean)`](Component.md#enableInputMethods(boolean))
        - [`Component.setVisible(boolean)`](Component.md#setVisible(boolean))
        - [`Frame.setUndecorated(boolean)`](Frame.md#setUndecorated(boolean))
        - [`Dialog.setUndecorated(boolean)`](Dialog.md#setUndecorated(boolean))
  + ### getFullScreenWindow

    public [Window](Window.md "class in java.awt") getFullScreenWindow()
    ...
    See Also:
    :   - [`setFullScreenWindow(Window)`](#setFullScreenWindow(java.awt.Window))
  + ### isDisplayChangeSupported
    ...
    full-screen exclusive mode (i.e., if [`isFullScreenSupported()`](#isFullScreenSupported())
    returns `true` and the application has already entered
    full-screen mode using [`setFullScreenWindow(java.awt.Window)`](#setFullScreenWindow(java.awt.Window))).
    ...
    :   - [`isFullScreenSupported()`](#isFullScreenSupported())
        - [`setDisplayMode(java.awt.DisplayMode)`](#setDisplayMode(java.awt.DisplayMode))
        - [`setFullScreenWindow(java.awt.Window)`](#setFullScreenWindow(java.awt.Window))
  + ### setDisplayMode

    public void setDisplayMode([DisplayMode](DisplayMode.md "class in java.awt") dm)

    Sets the display mode of this graphics device. This is only allowed
    if [`isDisplayChangeSupported()`](#isDisplayChangeSupported()) returns `true` and may
    require first entering full-screen exclusive mode using
    [`setFullScreenWindow(java.awt.Window)`](#setFullScreenWindow(java.awt.Window)) providing that full-screen exclusive mode is
    supported (i.e., [`isFullScreenSupported()`](#isFullScreenSupported()) returns
    `true`).

    The display mode must be one of the display modes returned by
    [`getDisplayModes()`](#getDisplayModes()), with one exception: passing a display mode
    with [`DisplayMode.REFRESH_RATE_UNKNOWN`](DisplayMode.md#REFRESH_RATE_UNKNOWN) refresh rate will result in
    selecting a display mode from the list of available display modes with
    matching width, height and bit depth.
    However, passing a display mode with [`DisplayMode.BIT_DEPTH_MULTI`](DisplayMode.md#BIT_DEPTH_MULTI)
    ...
    :   - [`getDisplayMode()`](#getDisplayMode())
        - [`getDisplayModes()`](#getDisplayModes())
        - [`isDisplayChangeSupported()`](#isDisplayChangeSupported())
  + ### getDisplayMode

    public [DisplayMode](DisplayMode.md "class in java.awt") getDisplayMode()

    Returns the current display mode of this
    `GraphicsDevice`.
    The returned display mode is allowed to have a refresh rate
    [`DisplayMode.REFRESH_RATE_UNKNOWN`](DisplayMode.md#REFRESH_RATE_UNKNOWN) if it is indeterminate.
    Likewise, the returned display mode is allowed to have a bit depth
    [`DisplayMode.BIT_DEPTH_MULTI`](DisplayMode.md#BIT_DEPTH_MULTI) if it is indeterminate or if multiple
    ...
    See Also:
    :   - [`setDisplayMode(DisplayMode)`](#setDisplayMode(java.awt.DisplayMode))
  + ### getDisplayModes

    public [DisplayMode](DisplayMode.md "class in java.awt")[] getDisplayModes()
  ...
  + ### getAvailableAcceleratedMemory
    ...
    inquiry methods on the [`ImageCapabilities`](ImageCapabilities.md "class in java.awt") object
    ...
    See Also:
    :   - [`Image.flush()`](Image.md#flush())
        - [`ImageCapabilities.isAccelerated()`](ImageCapabilities.md#isAccelerated())
  + ### isWindowTranslucencySupported

    public boolean isWindowTranslucencySupported([GraphicsDevice.WindowTranslucency](GraphicsDevice.WindowTranslucency.md "enum class in java.awt") translucencyKind)
