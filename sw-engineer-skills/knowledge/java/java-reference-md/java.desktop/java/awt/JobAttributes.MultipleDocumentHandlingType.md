...
* ## Field Summary
  ...
  `static final JobAttributes.MultipleDocumentHandlingType`
...
* ## Field Details
  ...
  + ### SEPARATE\_DOCUMENTS\_COLLATED\_COPIES
    ...
    public static final [JobAttributes.MultipleDocumentHandlingType](JobAttributes.MultipleDocumentHandlingType.md "class in java.awt") SEPARATE\_DOCUMENTS\_COLLATED\_COPIES

    The `MultipleDocumentHandlingType` instance to use for specifying
    that the job should be divided into separate, collated copies.
  + ### SEPARATE\_DOCUMENTS\_UNCOLLATED\_COPIES

    public static final [JobAttributes.MultipleDocumentHandlingType](JobAttributes.MultipleDocumentHandlingType.md "class in java.awt") SEPARATE\_DOCUMENTS\_UNCOLLATED\_COPIES
