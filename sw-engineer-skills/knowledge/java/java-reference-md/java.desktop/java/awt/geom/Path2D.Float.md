...
public static non-sealed class Path2D.Float
...
See Also:
:   * [Serialized Form](../../../../serialized-form.md#java.awt.geom.Path2D.Float)
...
* ## Constructor Details
  ...
  + ### Float
    ...
    public Float([Shape](../Shape.md "interface in java.awt") s)
...
* ## Method Details
  ...
  + ### moveTo
    ...
    See Also:
    :   - [`Path2D.moveTo(double, double)`](Path2D.md#moveTo(double,double))
  + ### lineTo
  ...
  + ### lineTo
    ...
    See Also:
    :   - [`Path2D.lineTo(double, double)`](Path2D.md#lineTo(double,double))
  + ### quadTo
  ...
  + ### quadTo
    ...
    See Also:
    :   - [`Path2D.quadTo(double, double, double, double)`](Path2D.md#quadTo(double,double,double,double))
  + ### curveTo
  ...
  + ### curveTo
    ...
    See Also:
    :   - [`Path2D.curveTo(double, double, double, double, double, double)`](Path2D.md#curveTo(double,double,double,double,double,double))
  + ### append
