...
* ## Method Summary
  ...
  Returns the framing [`Rectangle2D`](Rectangle2D.md "class in java.awt.geom")
  ...
  Sets the location and size of the framing rectangle of this
  `Shape` to the specified [`Point2D`](Point2D.md "class in java.awt.geom") and
  [`Dimension2D`](Dimension2D.md "class in java.awt.geom"), respectively.
...
* ## Method Details
  ...
  + ### getFrame
    ...
    public [Rectangle2D](Rectangle2D.md "class in java.awt.geom") getFrame()
    ...
    See Also:
    :   - [`setFrame(double, double, double, double)`](#setFrame(double,double,double,double))
        - [`setFrame(Point2D, Dimension2D)`](#setFrame(java.awt.geom.Point2D,java.awt.geom.Dimension2D))
        - [`setFrame(Rectangle2D)`](#setFrame(java.awt.geom.Rectangle2D))
  + ### isEmpty
  ...
  + ### setFrame
    ...
    public void setFrame([Point2D](Point2D.md "class in java.awt.geom") loc,
    [Dimension2D](Dimension2D.md "class in java.awt.geom") size)

    Sets the location and size of the framing rectangle of this
    `Shape` to the specified [`Point2D`](Point2D.md "class in java.awt.geom") and
    [`Dimension2D`](Dimension2D.md "class in java.awt.geom"), respectively. The framing rectangle is used
  ...
  + ### setFrame
    ...
    public void setFrame([Rectangle2D](Rectangle2D.md "class in java.awt.geom") r)
  ...
  + ### setFrameFromDiagonal
    ...
    public void setFrameFromDiagonal([Point2D](Point2D.md "class in java.awt.geom") p1,
  ...
  + ### setFrameFromCenter
    ...
    public void setFrameFromCenter([Point2D](Point2D.md "class in java.awt.geom") center,
    [Point2D](Point2D.md "class in java.awt.geom") corner)
  ...
  + ### getPathIterator
    ...
    Only SEG\_MOVETO, SEG\_LINETO, and SEG\_CLOSE point types will
    ...
    An optional [`AffineTransform`](AffineTransform.md "class in java.awt.geom") can
