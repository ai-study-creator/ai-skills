...
See Also:
:   * [`KeyboardFocusManager.addKeyEventPostProcessor(java.awt.KeyEventPostProcessor)`](KeyboardFocusManager.md#addKeyEventPostProcessor(java.awt.KeyEventPostProcessor))
    * [`KeyboardFocusManager.removeKeyEventPostProcessor(java.awt.KeyEventPostProcessor)`](KeyboardFocusManager.md#removeKeyEventPostProcessor(java.awt.KeyEventPostProcessor))
...
* ## Method Details
  ...
  + ### postProcessKeyEvent
    ...
    boolean postProcessKeyEvent([KeyEvent](event/KeyEvent.md "class in java.awt.event") e)
