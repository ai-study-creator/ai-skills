...
implements [Map](../../../java.base/java/util/Map.md "interface in java.util")<[Object](../../../java.base/java/lang/Object.md "class in java.lang"),[Object](../../../java.base/java/lang/Object.md "class in java.lang")>, [Cloneable](../../../java.base/java/lang/Cloneable.md "interface in java.lang")

The `RenderingHints` class defines and manages collections of
keys and associated values which allow an application to provide input
into the choice of algorithms used by other classes which perform
rendering and image manipulation services.
The [`Graphics2D`](Graphics2D.md "class in java.awt") class, and classes that implement
[`BufferedImageOp`](image/BufferedImageOp.md "interface in java.awt.image") and
[`RasterOp`](image/RasterOp.md "interface in java.awt.image") all provide methods to get and
...
the screen, or to [`BufferedImage`](image/BufferedImage.md "class in java.awt.image") objects,
or while printing.
...
subclass the associated [`RenderingHints.Key`](RenderingHints.Key.md "class in java.awt") class.
...
* ## Field Summary
  ...
  to the [`KEY_ANTIALIASING`](#KEY_ANTIALIASING) hint or a default chosen by the
  implementation.
  ...
  size whether to apply [`VALUE_TEXT_ANTIALIAS_ON`](#VALUE_TEXT_ANTIALIAS_ON) or
  [`VALUE_TEXT_ANTIALIAS_OFF`](#VALUE_TEXT_ANTIALIAS_OFF).
...
* ## Field Details
  ...
  + ### KEY\_ANTIALIASING
    ...
    public static final [RenderingHints.Key](RenderingHints.Key.md "class in java.awt") KEY\_ANTIALIASING

    Antialiasing hint key.
    The `ANTIALIASING` hint controls whether or not the
    geometry rendering methods of a [`Graphics2D`](Graphics2D.md "class in java.awt") object
    ...
    - [`VALUE_ANTIALIAS_ON`](#VALUE_ANTIALIAS_ON)- [`VALUE_ANTIALIAS_OFF`](#VALUE_ANTIALIAS_OFF)- [`VALUE_ANTIALIAS_DEFAULT`](#VALUE_ANTIALIAS_DEFAULT)
  + ### VALUE\_ANTIALIAS\_ON

    public static final [Object](../../../java.base/java/lang/Object.md "class in java.lang") VALUE\_ANTIALIAS\_ON

    Antialiasing hint value -- rendering is done with antialiasing.

    See Also:
    :   - [`KEY_ANTIALIASING`](#KEY_ANTIALIASING)
  + ### VALUE\_ANTIALIAS\_OFF

    public static final [Object](../../../java.base/java/lang/Object.md "class in java.lang") VALUE\_ANTIALIAS\_OFF
  ...
  + ### VALUE\_ANTIALIAS\_DEFAULT
    ...
    public static final [Object](../../../java.base/java/lang/Object.md "class in java.lang") VALUE\_ANTIALIAS\_DEFAULT
  ...
  + ### KEY\_RENDERING
    ...
    public static final [RenderingHints.Key](RenderingHints.Key.md "class in java.awt") KEY\_RENDERING
    ...
    The allowable values for this hint are
    - [`VALUE_RENDER_SPEED`](#VALUE_RENDER_SPEED)- [`VALUE_RENDER_QUALITY`](#VALUE_RENDER_QUALITY)- [`VALUE_RENDER_DEFAULT`](#VALUE_RENDER_DEFAULT)
  + ### VALUE\_RENDER\_SPEED

    public static final [Object](../../../java.base/java/lang/Object.md "class in java.lang") VALUE\_RENDER\_SPEED
  ...
  + ### VALUE\_RENDER\_QUALITY
    ...
    public static final [Object](../../../java.base/java/lang/Object.md "class in java.lang") VALUE\_RENDER\_QUALITY
  ...
  + ### VALUE\_RENDER\_DEFAULT
    ...
    public static final [Object](../../../java.base/java/lang/Object.md "class in java.lang") VALUE\_RENDER\_DEFAULT
  ...
  + ### KEY\_DITHERING
    ...
    public static final [RenderingHints.Key](RenderingHints.Key.md "class in java.awt") KEY\_DITHERING
    ...
    The allowable values for this hint are
    - [`VALUE_DITHER_DISABLE`](#VALUE_DITHER_DISABLE)- [`VALUE_DITHER_ENABLE`](#VALUE_DITHER_ENABLE)- [`VALUE_DITHER_DEFAULT`](#VALUE_DITHER_DEFAULT)
  + ### VALUE\_DITHER\_DISABLE

    public static final [Object](../../../java.base/java/lang/Object.md "class in java.lang") VALUE\_DITHER\_DISABLE

    Dithering hint value -- do not dither when rendering geometry.

    See Also:
    :   - [`KEY_DITHERING`](#KEY_DITHERING)
  + ### VALUE\_DITHER\_ENABLE

    public static final [Object](../../../java.base/java/lang/Object.md "class in java.lang") VALUE\_DITHER\_ENABLE

    Dithering hint value -- dither when rendering geometry, if needed.

    See Also:
    :   - [`KEY_DITHERING`](#KEY_DITHERING)
  + ### VALUE\_DITHER\_DEFAULT

    public static final [Object](../../../java.base/java/lang/Object.md "class in java.lang") VALUE\_DITHER\_DEFAULT
  ...
  + ### KEY\_TEXT\_ANTIALIASING
    ...
    public static final [RenderingHints.Key](RenderingHints.Key.md "class in java.awt") KEY\_TEXT\_ANTIALIASING
    ...
    [`KEY_ANTIALIASING`](#KEY_ANTIALIASING) hint key.

    The allowable values for this hint are
    - [`VALUE_TEXT_ANTIALIAS_ON`](#VALUE_TEXT_ANTIALIAS_ON)- [`VALUE_TEXT_ANTIALIAS_OFF`](#VALUE_TEXT_ANTIALIAS_OFF)- [`VALUE_TEXT_ANTIALIAS_DEFAULT`](#VALUE_TEXT_ANTIALIAS_DEFAULT)- [`VALUE_TEXT_ANTIALIAS_GASP`](#VALUE_TEXT_ANTIALIAS_GASP)- [`VALUE_TEXT_ANTIALIAS_LCD_HRGB`](#VALUE_TEXT_ANTIALIAS_LCD_HRGB)- [`VALUE_TEXT_ANTIALIAS_LCD_HBGR`](#VALUE_TEXT_ANTIALIAS_LCD_HBGR)- [`VALUE_TEXT_ANTIALIAS_LCD_VRGB`](#VALUE_TEXT_ANTIALIAS_LCD_VRGB)- [`VALUE_TEXT_ANTIALIAS_LCD_VBGR`](#VALUE_TEXT_ANTIALIAS_LCD_VBGR)
  + ### VALUE\_TEXT\_ANTIALIAS\_ON

    public static final [Object](../../../java.base/java/lang/Object.md "class in java.lang") VALUE\_TEXT\_ANTIALIAS\_ON

    Text antialiasing hint value -- text rendering is done with
    some form of antialiasing.

    See Also:
    :   - [`KEY_TEXT_ANTIALIASING`](#KEY_TEXT_ANTIALIASING)
  + ### VALUE\_TEXT\_ANTIALIAS\_OFF

    public static final [Object](../../../java.base/java/lang/Object.md "class in java.lang") VALUE\_TEXT\_ANTIALIAS\_OFF
    ...
    See Also:
    :   - [`KEY_TEXT_ANTIALIASING`](#KEY_TEXT_ANTIALIASING)
  + ### VALUE\_TEXT\_ANTIALIAS\_DEFAULT

    public static final [Object](../../../java.base/java/lang/Object.md "class in java.lang") VALUE\_TEXT\_ANTIALIAS\_DEFAULT
    ...
    See Also:
    :   - [`KEY_TEXT_ANTIALIASING`](#KEY_TEXT_ANTIALIASING)
  + ### VALUE\_TEXT\_ANTIALIAS\_GASP

    public static final [Object](../../../java.base/java/lang/Object.md "class in java.lang") VALUE\_TEXT\_ANTIALIAS\_GASP
    ...
    *Note:*A font designer will typically carefully hint a font for
    ...
    See Also:
    :   - [`KEY_TEXT_ANTIALIASING`](#KEY_TEXT_ANTIALIASING)
  + ### VALUE\_TEXT\_ANTIALIAS\_LCD\_HRGB

    public static final [Object](../../../java.base/java/lang/Object.md "class in java.lang") VALUE\_TEXT\_ANTIALIAS\_LCD\_HRGB
    ...
    *Notes:*  
    ...
    [`VALUE_TEXT_ANTIALIAS_ON`](#VALUE_TEXT_ANTIALIAS_ON)
    ...
    See Also:
    :   - [`KEY_TEXT_ANTIALIASING`](#KEY_TEXT_ANTIALIASING)
  + ### VALUE\_TEXT\_ANTIALIAS\_LCD\_HBGR

    public static final [Object](../../../java.base/java/lang/Object.md "class in java.lang") VALUE\_TEXT\_ANTIALIAS\_LCD\_HBGR
    ...
    Selecting this hint for displays with one of the other LCD subpixel
    configurations will likely result in unfocused text.
    See [`VALUE_TEXT_ANTIALIAS_LCD_HRGB`](#VALUE_TEXT_ANTIALIAS_LCD_HRGB),
    ...
    See Also:
    :   - [`KEY_TEXT_ANTIALIASING`](#KEY_TEXT_ANTIALIASING)
  + ### VALUE\_TEXT\_ANTIALIAS\_LCD\_VRGB

    public static final [Object](../../../java.base/java/lang/Object.md "class in java.lang") VALUE\_TEXT\_ANTIALIAS\_LCD\_VRGB
    ...
    See Also:
    :   - [`KEY_TEXT_ANTIALIASING`](#KEY_TEXT_ANTIALIASING)
  + ### VALUE\_TEXT\_ANTIALIAS\_LCD\_VBGR

    public static final [Object](../../../java.base/java/lang/Object.md "class in java.lang") VALUE\_TEXT\_ANTIALIAS\_LCD\_VBGR
    ...
    See Also:
    :   - [`KEY_TEXT_ANTIALIASING`](#KEY_TEXT_ANTIALIASING)
  + ### KEY\_TEXT\_LCD\_CONTRAST

    public static final [RenderingHints.Key](RenderingHints.Key.md "class in java.awt") KEY\_TEXT\_LCD\_CONTRAST
    ...
    - Values should be a positive integer in the range 100 to 250.- A lower value (eg 100) corresponds to higher contrast text when
        displaying dark text on a light background.- A higher value (eg 200) corresponds to lower contrast text when
          displaying dark text on a light background.- A typical useful value is in the narrow range 140-180.- If no value is specified, a system or implementation default value
              will be applied.The default value can be expected to be adequate for most purposes,
  ...
  + ### KEY\_FRACTIONALMETRICS
    ...
    public static final [RenderingHints.Key](RenderingHints.Key.md "class in java.awt") KEY\_FRACTIONALMETRICS
    ...
    - [`VALUE_FRACTIONALMETRICS_OFF`](#VALUE_FRACTIONALMETRICS_OFF)- [`VALUE_FRACTIONALMETRICS_ON`](#VALUE_FRACTIONALMETRICS_ON)- [`VALUE_FRACTIONALMETRICS_DEFAULT`](#VALUE_FRACTIONALMETRICS_DEFAULT)
  + ### VALUE\_FRACTIONALMETRICS\_OFF

    public static final [Object](../../../java.base/java/lang/Object.md "class in java.lang") VALUE\_FRACTIONALMETRICS\_OFF
  ...
  + ### VALUE\_FRACTIONALMETRICS\_ON

    public static final [Object](../../../java.base/java/lang/Object.md "class in java.lang") VALUE\_FRACTIONALMETRICS\_ON
    ...
    See Also:
    :   - [`KEY_FRACTIONALMETRICS`](#KEY_FRACTIONALMETRICS)
  + ### VALUE\_FRACTIONALMETRICS\_DEFAULT

    public static final [Object](../../../java.base/java/lang/Object.md "class in java.lang") VALUE\_FRACTIONALMETRICS\_DEFAULT
  ...
  + ### KEY\_INTERPOLATION
    ...
    public static final [RenderingHints.Key](RenderingHints.Key.md "class in java.awt") KEY\_INTERPOLATION
    ...
    The allowable values for this hint are
    - [`VALUE_INTERPOLATION_NEAREST_NEIGHBOR`](#VALUE_INTERPOLATION_NEAREST_NEIGHBOR)- [`VALUE_INTERPOLATION_BILINEAR`](#VALUE_INTERPOLATION_BILINEAR)- [`VALUE_INTERPOLATION_BICUBIC`](#VALUE_INTERPOLATION_BICUBIC)
  + ### VALUE\_INTERPOLATION\_NEAREST\_NEIGHBOR

    public static final [Object](../../../java.base/java/lang/Object.md "class in java.lang") VALUE\_INTERPOLATION\_NEAREST\_NEIGHBOR
    ...
    See Also:
    :   - [`KEY_INTERPOLATION`](#KEY_INTERPOLATION)
  + ### VALUE\_INTERPOLATION\_BILINEAR

    public static final [Object](../../../java.base/java/lang/Object.md "class in java.lang") VALUE\_INTERPOLATION\_BILINEAR
    ...
    See Also:
    :   - [`KEY_INTERPOLATION`](#KEY_INTERPOLATION)
  + ### VALUE\_INTERPOLATION\_BICUBIC

    public static final [Object](../../../java.base/java/lang/Object.md "class in java.lang") VALUE\_INTERPOLATION\_BICUBIC
    ...
    used in the [`BILINEAR`](#VALUE_INTERPOLATION_BILINEAR)
  ...
  + ### KEY\_ALPHA\_INTERPOLATION
    ...
    public static final [RenderingHints.Key](RenderingHints.Key.md "class in java.awt") KEY\_ALPHA\_INTERPOLATION
    ...
    The allowable values for this hint are
    - [`VALUE_ALPHA_INTERPOLATION_SPEED`](#VALUE_ALPHA_INTERPOLATION_SPEED)- [`VALUE_ALPHA_INTERPOLATION_QUALITY`](#VALUE_ALPHA_INTERPOLATION_QUALITY)- [`VALUE_ALPHA_INTERPOLATION_DEFAULT`](#VALUE_ALPHA_INTERPOLATION_DEFAULT)
  + ### VALUE\_ALPHA\_INTERPOLATION\_SPEED

    public static final [Object](../../../java.base/java/lang/Object.md "class in java.lang") VALUE\_ALPHA\_INTERPOLATION\_SPEED

    Alpha interpolation hint value -- alpha blending algorithms
    are chosen with a preference for calculation speed.

    See Also:
    :   - [`KEY_ALPHA_INTERPOLATION`](#KEY_ALPHA_INTERPOLATION)
  + ### VALUE\_ALPHA\_INTERPOLATION\_QUALITY

    public static final [Object](../../../java.base/java/lang/Object.md "class in java.lang") VALUE\_ALPHA\_INTERPOLATION\_QUALITY
  ...
  + ### VALUE\_ALPHA\_INTERPOLATION\_DEFAULT
    ...
    public static final [Object](../../../java.base/java/lang/Object.md "class in java.lang") VALUE\_ALPHA\_INTERPOLATION\_DEFAULT
  ...
  + ### KEY\_COLOR\_RENDERING
    ...
    public static final [RenderingHints.Key](RenderingHints.Key.md "class in java.awt") KEY\_COLOR\_RENDERING
    ...
    The allowable values for this hint are
    - [`VALUE_COLOR_RENDER_SPEED`](#VALUE_COLOR_RENDER_SPEED)- [`VALUE_COLOR_RENDER_QUALITY`](#VALUE_COLOR_RENDER_QUALITY)- [`VALUE_COLOR_RENDER_DEFAULT`](#VALUE_COLOR_RENDER_DEFAULT)
  + ### VALUE\_COLOR\_RENDER\_SPEED

    public static final [Object](../../../java.base/java/lang/Object.md "class in java.lang") VALUE\_COLOR\_RENDER\_SPEED

    Color rendering hint value -- perform the fastest color
    conversion to the format of the output device.

    See Also:
    :   - [`KEY_COLOR_RENDERING`](#KEY_COLOR_RENDERING)
  + ### VALUE\_COLOR\_RENDER\_QUALITY

    public static final [Object](../../../java.base/java/lang/Object.md "class in java.lang") VALUE\_COLOR\_RENDER\_QUALITY
    ...
    See Also:
    :   - [`KEY_COLOR_RENDERING`](#KEY_COLOR_RENDERING)
  + ### VALUE\_COLOR\_RENDER\_DEFAULT

    public static final [Object](../../../java.base/java/lang/Object.md "class in java.lang") VALUE\_COLOR\_RENDER\_DEFAULT
    ...
    See Also:
    :   - [`KEY_COLOR_RENDERING`](#KEY_COLOR_RENDERING)
  + ### KEY\_STROKE\_CONTROL

    public static final [RenderingHints.Key](RenderingHints.Key.md "class in java.awt") KEY\_STROKE\_CONTROL
    ...
    The allowable values for this hint are
    - [`VALUE_STROKE_NORMALIZE`](#VALUE_STROKE_NORMALIZE)- [`VALUE_STROKE_PURE`](#VALUE_STROKE_PURE)- [`VALUE_STROKE_DEFAULT`](#VALUE_STROKE_DEFAULT)

    Since:
    :   1.3
  + ### VALUE\_STROKE\_DEFAULT

    public static final [Object](../../../java.base/java/lang/Object.md "class in java.lang") VALUE\_STROKE\_DEFAULT
    ...
    See Also:
    :   - [`KEY_STROKE_CONTROL`](#KEY_STROKE_CONTROL)
  + ### VALUE\_STROKE\_NORMALIZE

    public static final [Object](../../../java.base/java/lang/Object.md "class in java.lang") VALUE\_STROKE\_NORMALIZE
  ...
  + ### VALUE\_STROKE\_PURE
    ...
    public static final [Object](../../../java.base/java/lang/Object.md "class in java.lang") VALUE\_STROKE\_PURE
    ...
    See Also:
    :   - [`KEY_STROKE_CONTROL`](#KEY_STROKE_CONTROL)
  + ### KEY\_RESOLUTION\_VARIANT

    public static final [RenderingHints.Key](RenderingHints.Key.md "class in java.awt") KEY\_RESOLUTION\_VARIANT

    Image resolution variant hint key.
    The `RESOLUTION_VARIANT` hint controls which image resolution
    variant should be chosen for image drawing.
    - [`VALUE_RESOLUTION_VARIANT_DEFAULT`](#VALUE_RESOLUTION_VARIANT_DEFAULT)- [`VALUE_RESOLUTION_VARIANT_BASE`](#VALUE_RESOLUTION_VARIANT_BASE)- [`VALUE_RESOLUTION_VARIANT_SIZE_FIT`](#VALUE_RESOLUTION_VARIANT_SIZE_FIT)- [`VALUE_RESOLUTION_VARIANT_DPI_FIT`](#VALUE_RESOLUTION_VARIANT_DPI_FIT)

    Since:
    :   9
  + ### VALUE\_RESOLUTION\_VARIANT\_DEFAULT

    public static final [Object](../../../java.base/java/lang/Object.md "class in java.lang") VALUE\_RESOLUTION\_VARIANT\_DEFAULT
    ...
    See Also:
    :   - [`KEY_RESOLUTION_VARIANT`](#KEY_RESOLUTION_VARIANT)
  + ### VALUE\_RESOLUTION\_VARIANT\_BASE

    public static final [Object](../../../java.base/java/lang/Object.md "class in java.lang") VALUE\_RESOLUTION\_VARIANT\_BASE
    ...
    See Also:
    :   - [`KEY_RESOLUTION_VARIANT`](#KEY_RESOLUTION_VARIANT)
  + ### VALUE\_RESOLUTION\_VARIANT\_SIZE\_FIT

    public static final [Object](../../../java.base/java/lang/Object.md "class in java.lang") VALUE\_RESOLUTION\_VARIANT\_SIZE\_FIT
    ...
    See Also:
    :   - [`KEY_RESOLUTION_VARIANT`](#KEY_RESOLUTION_VARIANT)
  + ### VALUE\_RESOLUTION\_VARIANT\_DPI\_FIT

    public static final [Object](../../../java.base/java/lang/Object.md "class in java.lang") VALUE\_RESOLUTION\_VARIANT\_DPI\_FIT
...
* ## Constructor Details
  ...
  + ### RenderingHints
    ...
    public RenderingHints([Map](../../../java.base/java/util/Map.md "interface in java.util")<[RenderingHints.Key](RenderingHints.Key.md "class in java.awt"),?> init)
  ...
  + ### RenderingHints
    ...
    public RenderingHints([RenderingHints.Key](RenderingHints.Key.md "class in java.awt") key,
...
* ## Method Details
  ...
  + ### put
    ...
    :   `IllegalArgumentException` - if the
        [`Key.isCompatibleValue()`](RenderingHints.Key.md#isCompatibleValue(java.lang.Object))
  ...
  + ### add
    ...
    public void add([RenderingHints](RenderingHints.md "class in java.awt") hints)
  ...
  + ### putAll
    ...
    public void putAll([Map](../../../java.base/java/util/Map.md "interface in java.util")<?,?> m)
  ...
  + ### entrySet
    ...
    in the `Set`. If the `RenderingHints` is modified while
    while an iteration over the `Set` is in progress,
  ...
  + ### hashCode
    ...
    See Also:
    :   - [`Map.Entry.hashCode()`](../../../java.base/java/util/Map.Entry.md#hashCode())
        - [`Object.hashCode()`](../../../java.base/java/lang/Object.md#hashCode())
        - [`Object.equals(Object)`](../../../java.base/java/lang/Object.md#equals(java.lang.Object))
