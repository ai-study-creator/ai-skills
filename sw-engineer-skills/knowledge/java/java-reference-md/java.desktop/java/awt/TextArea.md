...
public non-sealed class TextArea
...
![A TextArea showing the word
 'Hello!'](doc-files/TextArea-1.gif)
...
See Also:
:   * [Serialized Form](../../../serialized-form.md#java.awt.TextArea)
...
* ## Field Details
  ...
  + ### SCROLLBARS\_BOTH
    ...
    public static final int SCROLLBARS\_BOTH
    ...
    See Also:
    :   - [Constant Field Values](../../../constant-values.md#java.awt.TextArea.SCROLLBARS_BOTH)
  + ### SCROLLBARS\_VERTICAL\_ONLY

    public static final int SCROLLBARS\_VERTICAL\_ONLY
    ...
    See Also:
    :   - [Constant Field Values](../../../constant-values.md#java.awt.TextArea.SCROLLBARS_VERTICAL_ONLY)
  + ### SCROLLBARS\_HORIZONTAL\_ONLY

    public static final int SCROLLBARS\_HORIZONTAL\_ONLY
    ...
    See Also:
    :   - [Constant Field Values](../../../constant-values.md#java.awt.TextArea.SCROLLBARS_HORIZONTAL_ONLY)
  + ### SCROLLBARS\_NONE

    public static final int SCROLLBARS\_NONE
    ...
    See Also:
    :   - [Constant Field Values](../../../constant-values.md#java.awt.TextArea.SCROLLBARS_NONE)
* ## Constructor Details
  ...
  + ### TextArea
    ...
    [`SCROLLBARS_BOTH`](#SCROLLBARS_BOTH), so both vertical and horizontal
  ...
  + ### TextArea
    ...
    public TextArea([String](../../../java.base/java/lang/String.md "class in java.lang") text)
    throws [HeadlessException](HeadlessException.md "class in java.awt")
  ...
  + ### TextArea
    ...
    scrollbar visibility equal to [`SCROLLBARS_BOTH`](#SCROLLBARS_BOTH), so both
  ...
  + ### TextArea
    ...
    `scrollbars` argument:
    - `SCROLLBARS_BOTH`,- `SCROLLBARS_VERTICAL_ONLY`,- `SCROLLBARS_HORIZONTAL_ONLY`,- `SCROLLBARS_NONE`.Any other value for the
    `scrollbars` argument is invalid and will result in
    this text area being created with scrollbar visibility equal to
    the default value of [`SCROLLBARS_BOTH`](#SCROLLBARS_BOTH).
...
* ## Method Details
  ...
  + ### insert
    ...
    See Also:
    :   - [`TextComponent.setText(java.lang.String)`](TextComponent.md#setText(java.lang.String))
        - [`replaceRange(java.lang.String, int, int)`](#replaceRange(java.lang.String,int,int))
        - [`append(java.lang.String)`](#append(java.lang.String))
  + ### insertText

    [@Deprecated](../../../java.base/java/lang/Deprecated.md "annotation interface in java.lang")
    public void insertText([String](../../../java.base/java/lang/String.md "class in java.lang") str,
    int pos)
  ...
  + ### appendText
    ...
    [@Deprecated](../../../java.base/java/lang/Deprecated.md "annotation interface in java.lang")
    public void appendText([String](../../../java.base/java/lang/String.md "class in java.lang") str)
  ...
  + ### replaceText
    ...
    [@Deprecated](../../../java.base/java/lang/Deprecated.md "annotation interface in java.lang")
    public void replaceText([String](../../../java.base/java/lang/String.md "class in java.lang") str,
    int start,
    int end)
  ...
  + ### getScrollbarVisibility
    ...
    See Also:
    :   - [`SCROLLBARS_BOTH`](#SCROLLBARS_BOTH)
        - [`SCROLLBARS_VERTICAL_ONLY`](#SCROLLBARS_VERTICAL_ONLY)
        - [`SCROLLBARS_HORIZONTAL_ONLY`](#SCROLLBARS_HORIZONTAL_ONLY)
        - [`SCROLLBARS_NONE`](#SCROLLBARS_NONE)
        - [`TextArea(java.lang.String, int, int, int)`](#%3Cinit%3E(java.lang.String,int,int,int))
  + ### getPreferredSize
