...
an instance of [`GridBagConstraints`](GridBagConstraints.md "class in java.awt"). The constraints object
...
[`ComponentOrientation`](ComponentOrientation.md "class in java.awt") property. For horizontal left-to-right
...
![The following text describes this graphic (Figure 1).](doc-files/GridBagLayout-baseline.png)
...
* A panel that starts in row 0 and ends in row 1. The panel
  ...
  row 1.* Two buttons, each with a baseline-resize behavior of
...
* Resizable components positioned above the baseline can only
  ...
  baseline can never grow more than 100 units.* Similarly, resizable components positioned below the baseline can
    only grow as high as the difference between the display height and the
    baseline.* Resizable components positioned on the baseline with a
      ...
      the component is not resized.* Components positioned on the baseline that do not have a
...
![The preceding text describes this graphic (Figure 2).](doc-files/GridBagLayout-1.gif)

Figure 2: Horizontal, Left-to-Right

![The preceding text describes this graphic (Figure 3).](doc-files/GridBagLayout-2.gif)
...
* Button1, Button2, Button3: `weightx = 1.0`* Button4: `weightx = 1.0`,
    `gridwidth = GridBagConstraints.REMAINDER`* Button5: `gridwidth = GridBagConstraints.REMAINDER`* Button6: `gridwidth = GridBagConstraints.RELATIVE`* Button7: `gridwidth = GridBagConstraints.REMAINDER`* Button8: `gridheight = 2`,
            `weighty = 1.0`* Button9, Button 10:
...
:   * [`GridBagConstraints`](GridBagConstraints.md "class in java.awt")
    ...
    * [Serialized Form](../../../serialized-form.md#java.awt.GridBagLayout)
...
* ## Method Summary
  ...
  compatibility only; new code should call [`arrangeGrid`](#arrangeGrid(java.awt.Container)) instead.
  ...
  This method is obsolete and supplied for backwards
  compatibility only; new code should call [`getLayoutInfo`](#getLayoutInfo(java.awt.Container,int)) instead.
  ...
  This method is obsolete and supplied for backwards
  compatibility only; new code should call [`getMinSize`](#getMinSize(java.awt.Container,java.awt.GridBagLayoutInfo)) instead.
...
* ## Field Details
  ...
  + ### MAXGRIDSIZE
    ...
    See Also:
    :   - [Constant Field Values](../../../constant-values.md#java.awt.GridBagLayout.MAXGRIDSIZE)
  + ### MINSIZE
    ...
    See Also:
    :   - [Constant Field Values](../../../constant-values.md#java.awt.GridBagLayout.MINSIZE)
  + ### PREFERREDSIZE
    ...
    See Also:
    :   - [Constant Field Values](../../../constant-values.md#java.awt.GridBagLayout.PREFERREDSIZE)
  + ### comptable

    protected [Hashtable](../../../java.base/java/util/Hashtable.md "class in java.util")<[Component](Component.md "class in java.awt"),[GridBagConstraints](GridBagConstraints.md "class in java.awt")> comptable
  ...
  + ### defaultConstraints
    ...
    protected [GridBagConstraints](GridBagConstraints.md "class in java.awt") defaultConstraints
    ...
    See Also:
    :   - [`getConstraints(Component)`](#getConstraints(java.awt.Component))
        - [`setConstraints(Component, GridBagConstraints)`](#setConstraints(java.awt.Component,java.awt.GridBagConstraints))
        - [`lookupConstraints(Component)`](#lookupConstraints(java.awt.Component))
  + ### layoutInfo

    protected [GridBagLayoutInfo](GridBagLayoutInfo.md "class in java.awt") layoutInfo
    ...
    See Also:
    :   - [`getLayoutInfo(Container, int)`](#getLayoutInfo(java.awt.Container,int))
  + ### columnWidths
...
* ## Method Details
  ...
  + ### setConstraints
    ...
    public void setConstraints([Component](Component.md "class in java.awt") comp,
    [GridBagConstraints](GridBagConstraints.md "class in java.awt") constraints)
  ...
  + ### getConstraints
    ...
    public [GridBagConstraints](GridBagConstraints.md "class in java.awt") getConstraints([Component](Component.md "class in java.awt") comp)
  ...
  + ### lookupConstraints
    ...
    protected [GridBagConstraints](GridBagConstraints.md "class in java.awt") lookupConstraints([Component](Component.md "class in java.awt") comp)
  ...
  + ### getLayoutOrigin
    ...
    public [Point](Point.md "class in java.awt") getLayoutOrigin()
  ...
  + ### location
    ...
    public [Point](Point.md "class in java.awt") location(int x,
    int y)
  ...
  + ### maximumLayoutSize
    ...
    :   - [`Container`](Container.md "class in java.awt")
        - [`minimumLayoutSize(Container)`](#minimumLayoutSize(java.awt.Container))
        - [`preferredLayoutSize(Container)`](#preferredLayoutSize(java.awt.Container))
  + ### getLayoutAlignmentX
  ...
  + ### getLayoutInfo
    ...
    protected [GridBagLayoutInfo](GridBagLayoutInfo.md "class in java.awt") getLayoutInfo([Container](Container.md "class in java.awt") parent,
    int sizeflag)

    Fills in an instance of `GridBagLayoutInfo` for the
    current set of managed children. This requires three passes through the
    set of children:
    1. Figure out the dimensions of the layout grid.+ Determine which cells the components occupy.+ Distribute the weights and min sizes among the rows/columns.This also caches the minsizes for all the children when they are
  ...
  + ### adjustForGravity
    ...
    protected void adjustForGravity([GridBagConstraints](GridBagConstraints.md "class in java.awt") constraints,
  ...
  + ### AdjustForGravity
    ...
    This method is obsolete and supplied for backwards
    compatibility only; new code should call [`adjustForGravity`](#adjustForGravity(java.awt.GridBagConstraints,java.awt.Rectangle)) instead.
  ...
  + ### getMinSize
    ...
    protected [Dimension](Dimension.md "class in java.awt") getMinSize([Container](Container.md "class in java.awt") parent,
    [GridBagLayoutInfo](GridBagLayoutInfo.md "class in java.awt") info)
  ...
  + ### arrangeGrid
    ...
    protected void arrangeGrid([Container](Container.md "class in java.awt") parent)
