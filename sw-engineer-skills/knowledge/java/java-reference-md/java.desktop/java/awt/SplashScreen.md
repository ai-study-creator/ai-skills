...
`manifest.mf`/`-splash:` option for all image types irrespective of
HiDPI and Non-HiDPI.
...
can exist, and it may be obtained by using the [`getSplashScreen()`](#getSplashScreen())
...
* ## Method Summary
  ...
  Creates a graphics context (as a [`Graphics2D`](Graphics2D.md "class in java.awt") object) for the splash
  ...
  Returns the bounds of the splash screen window as a [`Rectangle`](Rectangle.md "class in java.awt").
  ...
  Returns the size of the splash screen window as a [`Dimension`](Dimension.md "class in java.awt").
...
* ## Method Details
  ...
  + ### getSplashScreen
    ...
    public static [SplashScreen](SplashScreen.md "class in java.awt") getSplashScreen()

    Returns the `SplashScreen` object used for
    Java startup splash screen control on systems that support display.

    Returns:
    :   the [`SplashScreen`](SplashScreen.md "class in java.awt") instance, or `null` if there is
  ...
  + ### setImageURL
    ...
    public void setImageURL([URL](../../../java.base/java/net/URL.md "class in java.net") imageURL)
  ...
  + ### getSize
    ...
    Returns:
    :   a [`Dimension`](Dimension.md "class in java.awt") object indicating the splash screen size
  ...
  + ### isVisible
    ...
    be hidden using [`close()`](#close()), it is also hidden automatically when
