...
![The following text describes the
 graphic](doc-files/Choice-1.gif)
...
See Also:
:   * [Serialized Form](../../../serialized-form.md#java.awt.Choice)
...
* ## Constructor Details
  ...
  + ### Choice
    ...
    :   - [`GraphicsEnvironment.isHeadless()`](GraphicsEnvironment.md#isHeadless())
        ...
        - [`select(java.lang.String)`](#select(java.lang.String))
* ## Method Details
  ...
  + ### insert
    ...
    public void insert([String](../../../java.base/java/lang/String.md "class in java.lang") item,
    int index)
  ...
  + ### select
    ...
    public void select([String](../../../java.base/java/lang/String.md "class in java.lang") str)
  ...
  + ### getItemListeners
    ...
    Returns:
    :   all of this choice's `ItemListener`s
  ...
  + ### processItemEvent
    ...
    :   - [`ItemEvent`](event/ItemEvent.md "class in java.awt.event")
        - [`ItemListener`](event/ItemListener.md "interface in java.awt.event")
        - [`addItemListener(ItemListener)`](#addItemListener(java.awt.event.ItemListener))
