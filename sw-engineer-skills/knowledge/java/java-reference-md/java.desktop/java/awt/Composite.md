...
[`Graphics2D`](Graphics2D.md "class in java.awt") context, it combines a shape, text, or an image
...
[`AWTPermission`](AWTPermission.md "class in java.awt"). The permission check will occur when such
a custom object is passed to the `setComposite` method
of a `Graphics2D` retrieved from a [`Component`](Component.md "class in java.awt").

See Also:
:   * [`AlphaComposite`](AlphaComposite.md "class in java.awt")
    * [`CompositeContext`](CompositeContext.md "interface in java.awt")
    * [`Graphics2D.setComposite(java.awt.Composite)`](Graphics2D.md#setComposite(java.awt.Composite))
...
* ## Method Details
  ...
  + ### createContext
    ...
    [CompositeContext](CompositeContext.md "interface in java.awt") createContext([ColorModel](image/ColorModel.md "class in java.awt.image") srcColorModel,
    ...
    Returns:
    :   the `CompositeContext` object used to perform the
