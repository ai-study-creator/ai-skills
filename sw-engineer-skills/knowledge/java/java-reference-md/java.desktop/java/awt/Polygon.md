...
:   * [`Shape`](Shape.md "interface in java.awt")
    * [Serialized Form](../../../serialized-form.md#java.awt.Polygon)
...
* ## Method Summary
  ...
  Determines whether the specified [`Point`](Point.md "class in java.awt") is inside this
  `Polygon`.
...
* ## Field Details
  ...
  + ### bounds
    ...
    protected [Rectangle](Rectangle.md "class in java.awt") bounds
...
* ## Method Details
  ...
  + ### getBounds
    ...
    Gets the bounding box of this `Polygon`.
    The bounding box is the smallest [`Rectangle`](Rectangle.md "class in java.awt") whose
  ...
  + ### getBoundingBox
    ...
    public [Rectangle](Rectangle.md "class in java.awt") getBoundingBox()
  ...
  + ### contains
    ...
    public boolean contains([Point2D](geom/Point2D.md "class in java.awt.geom") p)
  ...
  + ### intersects
    ...
    public boolean intersects([Rectangle2D](geom/Rectangle2D.md "class in java.awt.geom") r)
  ...
  + ### contains
    ...
    public boolean contains([Rectangle2D](geom/Rectangle2D.md "class in java.awt.geom") r)
  ...
  + ### getPathIterator
    ...
    public [PathIterator](geom/PathIterator.md "interface in java.awt.geom") getPathIterator([AffineTransform](geom/AffineTransform.md "class in java.awt.geom") at)

    Returns an iterator object that iterates along the boundary of this
    `Polygon` and provides access to the geometry
    of the outline of this `Polygon`. An optional
    [`AffineTransform`](geom/AffineTransform.md "class in java.awt.geom") can be specified so that the coordinates
    ...
    Returns:
    :   a [`PathIterator`](geom/PathIterator.md "interface in java.awt.geom") object that provides access to the
  ...
  + ### getPathIterator
    ...
    Returns an iterator object that iterates along the boundary of
    the `Shape` and provides access to the geometry of the
    outline of the `Shape`. Only SEG\_MOVETO, SEG\_LINETO, and
    SEG\_CLOSE point types are returned by the iterator.
