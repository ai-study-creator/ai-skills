...
* ## Field Summary
  ...
  `static final PageAttributes.OriginType`
...
* ## Field Details
  ...
  + ### PHYSICAL
    ...
    public static final [PageAttributes.OriginType](PageAttributes.OriginType.md "class in java.awt") PHYSICAL

    The OriginType instance to use for specifying a physical origin.
  + ### PRINTABLE

    public static final [PageAttributes.OriginType](PageAttributes.OriginType.md "class in java.awt") PRINTABLE
