...
instances are produced by [`Font`](../Font.md "class in java.awt") and are applicable
to a specific glyph in a particular `Font`.

Glyphs are either STANDARD, LIGATURE, COMBINING, or COMPONENT.

* STANDARD glyphs are commonly used to represent single characters.* LIGATURE glyphs are used to represent sequences of characters.* COMPONENT glyphs in a [`GlyphVector`](GlyphVector.md "class in java.awt.font") do not correspond to a
      particular character in a text model. Instead, COMPONENT glyphs are
      added for typographical reasons, such as Arabic justification.* COMBINING glyphs embellish STANDARD or LIGATURE glyphs, such
...
* ## Field Details
  ...
  + ### STANDARD
    ...
    See Also:
    :   - [Constant Field Values](../../../../constant-values.md#java.awt.font.GlyphMetrics.STANDARD)
  + ### LIGATURE
    ...
    See Also:
    :   - [Constant Field Values](../../../../constant-values.md#java.awt.font.GlyphMetrics.LIGATURE)
  + ### COMBINING
    ...
    See Also:
    :   - [Constant Field Values](../../../../constant-values.md#java.awt.font.GlyphMetrics.COMBINING)
  + ### COMPONENT
    ...
    See Also:
    :   - [Constant Field Values](../../../../constant-values.md#java.awt.font.GlyphMetrics.COMPONENT)
  + ### WHITESPACE
    ...
    See Also:
    :   - [Constant Field Values](../../../../constant-values.md#java.awt.font.GlyphMetrics.WHITESPACE)
* ## Constructor Details
...
* ## Method Details
  ...
  + ### getBounds2D
    ...
    Returns:
    :   a [`Rectangle2D`](../geom/Rectangle2D.md "class in java.awt.geom") that is the bounds of the glyph.
  + ### getLSB
