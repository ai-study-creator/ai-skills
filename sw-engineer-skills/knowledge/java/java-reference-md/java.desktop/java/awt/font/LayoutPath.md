...
* ## Method Details
  ...
  + ### pointToPath
    ...
    public abstract boolean pointToPath([Point2D](../geom/Point2D.md "class in java.awt.geom") point,
    [Point2D](../geom/Point2D.md "class in java.awt.geom") location)
  ...
  + ### pathToPoint
    ...
    public abstract void pathToPoint([Point2D](../geom/Point2D.md "class in java.awt.geom") location,
    boolean preceding,
