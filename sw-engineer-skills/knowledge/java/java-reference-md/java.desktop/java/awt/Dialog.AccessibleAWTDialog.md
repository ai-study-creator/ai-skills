...
extends [Window.AccessibleAWTWindow](Window.AccessibleAWTWindow.md "class in java.awt")
...
See Also:
:   * [Serialized Form](../../../serialized-form.md#java.awt.Dialog.AccessibleAWTDialog)
...
* ## Constructor Summary
  ...
  Constructs an `AccessibleAWTDialog`.
* ## Method Summary
...
* ## Method Details
  ...
  + ### getAccessibleRole
    ...
    Overrides:
    :   `getAccessibleRole` in class `Window.AccessibleAWTWindow`
  ...
  + ### getAccessibleStateSet
    ...
    Overrides:
    :   `getAccessibleStateSet` in class `Window.AccessibleAWTWindow`
