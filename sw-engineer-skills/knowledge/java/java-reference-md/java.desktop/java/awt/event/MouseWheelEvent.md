...
extends [MouseEvent](MouseEvent.md "class in java.awt.event")
...
The [`getWheelRotation()`](#getWheelRotation()) method returns the integer number
...
class provides the [`getPreciseWheelRotation()`](#getPreciseWheelRotation()) method which returns
a double number of "clicks" in case a partial rotation occurred.
The [`getPreciseWheelRotation()`](#getPreciseWheelRotation()) method is useful if a mouse supports
...
:   * [`MouseWheelListener`](MouseWheelListener.md "interface in java.awt.event")
    ...
    * [`ScrollPane.setWheelScrollingEnabled(boolean)`](../ScrollPane.md#setWheelScrollingEnabled(boolean))
    * [`JScrollPane`](../../../javax/swing/JScrollPane.md "class in javax.swing")
    * [`JScrollPane.setWheelScrollingEnabled(boolean)`](../../../javax/swing/JScrollPane.md#setWheelScrollingEnabled(boolean))
    * [Serialized Form](../../../../serialized-form.md#java.awt.event.MouseWheelEvent)
...
* ## Field Summary
  ...
  ### Fields inherited from class java.awt.event.[MouseEvent](MouseEvent.md "class in java.awt.event")
...
* ## Method Summary
  ...
  ### Methods inherited from class java.awt.event.[MouseEvent](MouseEvent.md "class in java.awt.event")
...
* ## Field Details
  ...
  + ### WHEEL\_UNIT\_SCROLL
    ...
    public static final int WHEEL\_UNIT\_SCROLL

    Constant representing scrolling by "units" (like scrolling with the
    arrow keys)

    See Also:
    :   - [`getScrollType()`](#getScrollType())
        - [Constant Field Values](../../../../constant-values.md#java.awt.event.MouseWheelEvent.WHEEL_UNIT_SCROLL)
  + ### WHEEL\_BLOCK\_SCROLL

    [@Native](../../../../java.base/java/lang/annotation/Native.md "annotation interface in java.lang.annotation")
    public static final int WHEEL\_BLOCK\_SCROLL
    ...
    See Also:
    :   - [`getScrollType()`](#getScrollType())
        - [Constant Field Values](../../../../constant-values.md#java.awt.event.MouseWheelEvent.WHEEL_BLOCK_SCROLL)
* ## Constructor Details

  + ### MouseWheelEvent

    public MouseWheelEvent([Component](../Component.md "class in java.awt") source,
    int id,
    long when,
    int modifiers,
    int x,
    ...
    See Also:
    :   - [`MouseEvent(java.awt.Component, int, long, int, int, int, int, boolean)`](MouseEvent.md#%3Cinit%3E(java.awt.Component,int,long,int,int,int,int,boolean))
        - [`MouseEvent(java.awt.Component, int, long, int, int, int, int, int, int, boolean, int)`](MouseEvent.md#%3Cinit%3E(java.awt.Component,int,long,int,int,int,int,int,int,boolean,int))
  + ### MouseWheelEvent
  ...
  + ### MouseWheelEvent
    ...
    :   `modifiers` - the modifier keys down during event
        (shift, ctrl, alt, meta)
    :   `x` - the horizontal `x` coordinate for the
        mouse location
    :   `y` - the vertical `y` coordinate for the
        mouse location
    :   `xAbs` - the absolute horizontal `x` coordinate for
        the mouse location
    :   `yAbs` - the absolute vertical `y` coordinate for
        the mouse location
    :   `clickCount` - the number of mouse clicks associated with the event
    :   `popupTrigger` - a boolean value, `true` if this event is a trigger
        for a popup-menu
    :   `scrollType` - the type of scrolling which should take place in
        response to this event; valid values are
        `WHEEL_UNIT_SCROLL` and
...
* ## Method Details
  ...
  + ### getScrollType
    ...
    - MouseWheelEvent.WHEEL\_UNIT\_SCROLL- MouseWheelEvent.WHEEL\_BLOCK\_SCROLL

    Returns:
    :   either MouseWheelEvent.WHEEL\_UNIT\_SCROLL or
        MouseWheelEvent.WHEEL\_BLOCK\_SCROLL, depending on the configuration of
        the native platform.

    See Also:
    :   - [`Adjustable.getUnitIncrement()`](../Adjustable.md#getUnitIncrement())
        - [`Adjustable.getBlockIncrement()`](../Adjustable.md#getBlockIncrement())
        - [`Scrollable.getScrollableUnitIncrement(java.awt.Rectangle, int, int)`](../../../javax/swing/Scrollable.md#getScrollableUnitIncrement(java.awt.Rectangle,int,int))
        - [`Scrollable.getScrollableBlockIncrement(java.awt.Rectangle, int, int)`](../../../javax/swing/Scrollable.md#getScrollableBlockIncrement(java.awt.Rectangle,int,int))
  + ### getScrollAmount
  ...
  + ### getWheelRotation
    ...
    See Also:
    :   - [`getPreciseWheelRotation()`](#getPreciseWheelRotation())
  + ### getPreciseWheelRotation
  ...
  + ### getUnitsToScroll
    ...
    MouseWheelEvent.WHEEL\_UNIT\_SCROLL, and should only be called if
    `getScrollType` returns MouseWheelEvent.WHEEL\_UNIT\_SCROLL.
    ...
    :   - [`getScrollType()`](#getScrollType())
        ...
        - [`Adjustable.getUnitIncrement()`](../Adjustable.md#getUnitIncrement())
        - [`Scrollable`](../../../javax/swing/Scrollable.md "interface in javax.swing")
        - [`Scrollable.getScrollableUnitIncrement(java.awt.Rectangle, int, int)`](../../../javax/swing/Scrollable.md#getScrollableUnitIncrement(java.awt.Rectangle,int,int))
        - [`ScrollPane`](../ScrollPane.md "class in java.awt")
        - [`ScrollPane.setWheelScrollingEnabled(boolean)`](../ScrollPane.md#setWheelScrollingEnabled(boolean))
        - [`JScrollPane`](../../../javax/swing/JScrollPane.md "class in javax.swing")
