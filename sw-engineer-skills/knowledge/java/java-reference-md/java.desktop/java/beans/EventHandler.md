...
See Also:
:   * [`Proxy`](../../../java.base/java/lang/reflect/Proxy.md "class in java.lang.reflect")
    * [`EventObject`](../../../java.base/java/util/EventObject.md "class in java.util")
...
* ## Constructor Details
  ...
  + ### EventHandler
    ...
    [@ConstructorProperties](ConstructorProperties.md "annotation interface in java.beans")({"target","action","eventPropertyName","listenerMethodName"})
    public EventHandler([Object](../../../java.base/java/lang/Object.md "class in java.lang") target,
    [String](../../../java.base/java/lang/String.md "class in java.lang") action,
    [String](../../../java.base/java/lang/String.md "class in java.lang") eventPropertyName,
    ...
    [`the general version of create`](#create(java.lang.Class,java.lang.Object,java.lang.String,java.lang.String)) for a complete description of
    ...
    :   - [`EventHandler`](EventHandler.md "class in java.beans")
        - [`create(Class, Object, String, String, String)`](#create(java.lang.Class,java.lang.Object,java.lang.String,java.lang.String,java.lang.String))
        - [`getTarget()`](#getTarget())
        - [`getAction()`](#getAction())
        - [`getEventPropertyName()`](#getEventPropertyName())
        - [`getListenerMethodName()`](#getListenerMethodName())
* ## Method Details
  ...
  + ### getTarget
    ...
    See Also:
    :   - [`EventHandler(Object, String, String, String)`](#%3Cinit%3E(java.lang.Object,java.lang.String,java.lang.String,java.lang.String))
  + ### getAction

    public [String](../../../java.base/java/lang/String.md "class in java.lang") getAction()
  ...
  + ### getEventPropertyName
    ...
    public [String](../../../java.base/java/lang/String.md "class in java.lang") getEventPropertyName()
  ...
  + ### getListenerMethodName
    ...
    public [String](../../../java.base/java/lang/String.md "class in java.lang") getListenerMethodName()
  ...
  + ### create
    ...
    public static <T> T create([Class](../../../java.base/java/lang/Class.md "class in java.lang")<T> listenerInterface,
    ...
    *all* of the methods in the listener interface apply
    ...
    :   `NullPointerException` - if `target` is null
    :   `NullPointerException` - if `action` is null
    :   `IllegalArgumentException` - if creating a Proxy for
        `listenerInterface` fails for any of the restrictions
        specified by [`Proxy.newProxyInstance(java.lang.ClassLoader, java.lang.Class<?>[], java.lang.reflect.InvocationHandler)`](../../../java.base/java/lang/reflect/Proxy.md#newProxyInstance(java.lang.ClassLoader,java.lang.Class%5B%5D,java.lang.reflect.InvocationHandler))

    See Also:
    :   - [`create(Class, Object, String, String)`](#create(java.lang.Class,java.lang.Object,java.lang.String,java.lang.String))
        - [`Proxy.newProxyInstance(java.lang.ClassLoader, java.lang.Class<?>[], java.lang.reflect.InvocationHandler)`](../../../java.base/java/lang/reflect/Proxy.md#newProxyInstance(java.lang.ClassLoader,java.lang.Class%5B%5D,java.lang.reflect.InvocationHandler))
  + ### create
