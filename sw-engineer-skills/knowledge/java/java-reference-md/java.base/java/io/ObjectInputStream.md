...
implements [ObjectInput](ObjectInput.md "interface in java.io"), [ObjectStreamConstants](ObjectStreamConstants.md "interface in java.io")
...
[`ObjectInputFilter`](ObjectInputFilter.md "interface in java.io") describes how to use filters and
[`ObjectInputFilter.Config`](ObjectInputFilter.Config.md "class in java.io") describes how to configure the filter and filter factory.
Each stream has an optional deserialization filter
to check the classes and resource limits during deserialization.
The JVM-wide filter factory ensures that a filter can be set on every [`ObjectInputStream`](ObjectInputStream.md "class in java.io")
and every object read from the stream can be checked.
The [ObjectInputStream constructors](#%3Cinit%3E()) invoke the filter factory
to select the initial filter which may be updated or replaced by [`setObjectInputFilter(java.io.ObjectInputFilter)`](#setObjectInputFilter(java.io.ObjectInputFilter)).

If an ObjectInputStream has a filter, the [`ObjectInputFilter`](ObjectInputFilter.md "interface in java.io") can check that
...
"Serialization of Records"](../../../../specs/serialization/serial-arch.md#serialization-of-records) for additional information.
...
:   * [`DataInput`](DataInput.md "interface in java.io")
    ...
    * [Java Object Serialization Specification, Section 3, "Object Input Classes"](../../../../specs/serialization/input.md)
...
* ## Method Summary
  ...
  ### Methods inherited from interface java.io.[ObjectInput](ObjectInput.md "interface in java.io")
...
* ## Constructor Details
  ...
  + ### ObjectInputStream
    ...
    public ObjectInputStream([InputStream](InputStream.md "class in java.io") in)
    ...
    by invoking the serial filter factory returned from [`ObjectInputFilter.Config.getSerialFilterFactory()`](ObjectInputFilter.Config.md#getSerialFilterFactory())
    with `null` for the current filter
    and the [static JVM-wide filter](ObjectInputFilter.Config.md#getSerialFilter()) for the requested filter.
    If the serial filter or serial filter factory properties are invalid
    an [`IllegalStateException`](../lang/IllegalStateException.md "class in java.lang") is thrown.
    ...
    :   `IllegalStateException` - if the initialization of [`ObjectInputFilter.Config`](ObjectInputFilter.Config.md "class in java.io")
        fails due to invalid serial filter or serial filter factory properties.
    :   `NullPointerException` - if `in` is `null`

    See Also:
    :   - [`ObjectInputStream()`](#%3Cinit%3E())
        - [`readFields()`](#readFields())
        - [`ObjectOutputStream(OutputStream)`](ObjectOutputStream.md#%3Cinit%3E(java.io.OutputStream))
  + ### ObjectInputStream
...
* ## Method Details
  ...
  + ### readObject
    ...
    public final [Object](../lang/Object.md "class in java.lang") readObject()
    throws [IOException](IOException.md "class in java.io"),
    ...
    See [`setObjectInputFilter`](#setObjectInputFilter(java.io.ObjectInputFilter)) for details.
  ...
  + ### readObjectOverride
    ...
    protected [Object](../lang/Object.md "class in java.lang") readObjectOverride()
    throws [IOException](IOException.md "class in java.io"),
    [ClassNotFoundException](../lang/ClassNotFoundException.md "class in java.lang")
  ...
  + ### readUnshared
    ...
    public [Object](../lang/Object.md "class in java.lang") readUnshared()
    throws [IOException](IOException.md "class in java.io"),
    [ClassNotFoundException](../lang/ClassNotFoundException.md "class in java.lang")
    ...
    - If readUnshared is called to deserialize a back-reference (the
      ...
      thrown.- If readUnshared returns successfully, then any subsequent attempts
        to deserialize back-references to the stream handle deserialized
        by readUnshared will cause an ObjectStreamException to be thrown.Deserializing an object via readUnshared invalidates the stream handle
  ...
  + ### readFields
    ...
    public [ObjectInputStream.GetField](ObjectInputStream.GetField.md "class in java.io") readFields()
    throws [IOException](IOException.md "class in java.io"),
    [ClassNotFoundException](../lang/ClassNotFoundException.md "class in java.lang")
  ...
  + ### registerValidation
    ...
    public void registerValidation([ObjectInputValidation](ObjectInputValidation.md "interface in java.io") obj,
    int prio)
    throws [NotActiveException](NotActiveException.md "class in java.io"),
  ...
  + ### resolveClass
    ...
    protected [Class](../lang/Class.md "class in java.lang")<?> resolveClass([ObjectStreamClass](ObjectStreamClass.md "class in java.io") desc)
    throws [IOException](IOException.md "class in java.io"),
    [ClassNotFoundException](../lang/ClassNotFoundException.md "class in java.lang")
    ...
    and an [`InvalidClassException`](InvalidClassException.md "class in java.io") is thrown.
    ...
    class loader](../lang/ClassLoader.md#getPlatformClassLoader()) nor its ancestor; otherwise, `loader` is the
  ...
  + ### resolveProxyClass
    ...
    protected [Class](../lang/Class.md "class in java.lang")<?> resolveProxyClass([String](../lang/String.md "class in java.lang")[] interfaces)
    throws [IOException](IOException.md "class in java.io"),
    [ClassNotFoundException](../lang/ClassNotFoundException.md "class in java.lang")
    ...
    *platform class loader*.
    ...
    See Also:
    :   - [`ObjectOutputStream.annotateProxyClass(Class)`](ObjectOutputStream.md#annotateProxyClass(java.lang.Class))
  + ### resolveObject

    protected [Object](../lang/Object.md "class in java.lang") resolveObject([Object](../lang/Object.md "class in java.lang") obj)
    throws [IOException](IOException.md "class in java.io")
  ...
  + ### enableResolveObject
    ...
    enabled, the [`resolveObject(java.lang.Object)`](#resolveObject(java.lang.Object)) method is called for every object being
    deserialized.
  ...
  + ### readClassDescriptor
    ...
    protected [ObjectStreamClass](ObjectStreamClass.md "class in java.io") readClassDescriptor()
    throws [IOException](IOException.md "class in java.io"),
    [ClassNotFoundException](../lang/ClassNotFoundException.md "class in java.lang")
    ...
    See Also:
    :   - [`ObjectOutputStream.writeClassDescriptor(java.io.ObjectStreamClass)`](ObjectOutputStream.md#writeClassDescriptor(java.io.ObjectStreamClass))
  + ### read
  ...
  + ### read
    ...
    See Also:
    :   - [`DataInputStream.readFully(byte[],int,int)`](DataInputStream.md#readFully(byte%5B%5D,int,int))
  + ### available
  ...
  + ### readUTF
    ...
    public [String](../lang/String.md "class in java.lang") readUTF()
    throws [IOException](IOException.md "class in java.io")
  ...
  + ### getObjectInputFilter
    ...
    public final [ObjectInputFilter](ObjectInputFilter.md "interface in java.io") getObjectInputFilter()

    Returns the deserialization filter for this stream.
    The filter is the result of invoking the
    [`JVM-wide filter factory`](ObjectInputFilter.Config.md#getSerialFilterFactory())
    either by the [constructor](#%3Cinit%3E()) or the most recent invocation of
    [`setObjectInputFilter`](#setObjectInputFilter(java.io.ObjectInputFilter)).
  ...
  + ### setObjectInputFilter
    ...
    public final void setObjectInputFilter([ObjectInputFilter](ObjectInputFilter.md "interface in java.io") filter)

    Set the deserialization filter for the stream.
    The deserialization filter is set to the filter returned by invoking the
    [JVM-wide filter factory](ObjectInputFilter.Config.md#getSerialFilterFactory())
    with the [current filter](#getObjectInputFilter()) and the `filter` parameter.
    The current filter was set in the
    [ObjectInputStream constructors](#%3Cinit%3E()) by invoking the
    [JVM-wide filter factory](ObjectInputFilter.Config.md#getSerialFilterFactory()) and may be `null`.
    [setObjectInputFilter(ObjectInputFilter)](#setObjectInputFilter(java.io.ObjectInputFilter)) This method} can be called
    once and only once before reading any objects from the stream;
    for example, by calling [`readObject()`](#readObject()) or [`readUnshared()`](#readUnshared()).

    It is not permitted to replace a `non-null` filter with a `null` filter.
    If the [current filter](#getObjectInputFilter()) is `non-null`,
    the value returned from the filter factory must be `non-null`.

    The filter's [`checkInput`](ObjectInputFilter.md#checkInput(java.io.ObjectInputFilter.FilterInfo)) method is called
    ...
    If the filter returns [`Status.REJECTED`](ObjectInputFilter.Status.md#REJECTED),
    `null` or throws a [`RuntimeException`](../lang/RuntimeException.md "class in java.lang"),
    the active `readObject` or `readUnshared`
    throws [`InvalidClassException`](InvalidClassException.md "class in java.io"), otherwise deserialization
    ...
    :   `IllegalStateException` - if an object has been read,
        ...
        [current filter](#getObjectInputFilter()) is non-null, or
