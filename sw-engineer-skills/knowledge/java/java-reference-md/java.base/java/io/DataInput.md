...
* Characters in the range `'\u0001'` to
  `'\u007F'` are represented by a single byte.* The null character `'\u0000'` and characters
    in the range `'\u0080'` to `'\u07FF'` are
    represented by a pair of bytes.* Characters in the range `'\u0800'`
...
* The null byte `'\u0000'` is encoded in 2-byte format
  ...
  embedded nulls.* Only the 1-byte, 2-byte, and 3-byte formats are used.* [Supplementary characters](../lang/Character.md#unicode)
...
* ## Method Details
  ...
  + ### readFully
    ...
    - `b.length`
      ...
      case a normal return is made.- End of
  ...
  + ### readFully
    ...
    - `len` bytes
      ...
      a normal return is made.- End of file
  ...
  + ### readLine
    ...
    [String](../lang/String.md "class in java.lang") readLine()
    throws [IOException](IOException.md "class in java.io")
  ...
  + ### readUTF
    ...
    [String](../lang/String.md "class in java.lang") readUTF()
    throws [IOException](IOException.md "class in java.io")
