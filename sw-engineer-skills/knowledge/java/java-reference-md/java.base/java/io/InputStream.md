...
implements [Closeable](Closeable.md "interface in java.io")
...
* ## Method Details
  ...
  + ### nullInputStream
    ...
    public static [InputStream](InputStream.md "class in java.io") nullInputStream()
  ...
  + ### skip
    ...
    See Also:
    :   - [`skipNBytes(long)`](#skipNBytes(long))
  + ### skipNBytes
  ...
  + ### available
    ...
    [`IOException`](IOException.md "class in java.io") if this input stream has been closed by invoking the
    [`close()`](#close()) method.
  ...
  + ### reset
    ...
    - If the method `markSupported` returns
      ...
      * If the method `mark` has not been called since
        ...
        `IOException` might be thrown.* If such an `IOException` is not thrown, then the
          ...
          the time of the call to `reset`.- If the method `markSupported` returns
        `false`, then:
        * The call to `reset` may throw an
          `IOException`.* If an `IOException` is not thrown, then the stream
