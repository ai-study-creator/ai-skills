...
[java.security.BasicPermission](BasicPermission.md "class in java.security")
...
extends [BasicPermission](BasicPermission.md "class in java.security")
...
guard access to the [`AccessControlContext`](AccessControlContext.md "class in java.security"), [`Policy`](Policy.md "class in java.security"),
[`Provider`](Provider.md "class in java.security"), [`Security`](Security.md "class in java.security"), [`Signer`](Signer.md "class in java.security"), and [`Identity`](Identity.md "class in java.security")
objects.
...
associated with classes that have been deprecated: [`Identity`](Identity.md "class in java.security"),
[`IdentityScope`](IdentityScope.md "class in java.security"), [`Signer`](Signer.md "class in java.security"). Use of them is discouraged. See the
...
:   * [`BasicPermission`](BasicPermission.md "class in java.security")
    ...
    * [Serialized Form](../../../serialized-form.md#java.security.SecurityPermission)
...
* ## Method Summary
  ...
  ### Methods inherited from class java.security.[BasicPermission](BasicPermission.md "class in java.security")
...
* ## Constructor Details
  ...
  + ### SecurityPermission
    ...
    public SecurityPermission([String](../lang/String.md "class in java.lang") name)
