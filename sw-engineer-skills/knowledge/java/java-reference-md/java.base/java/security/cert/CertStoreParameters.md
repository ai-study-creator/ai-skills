...
to one of the [`CertStore.getInstance`](CertStore.md#getInstance(java.lang.String,java.security.cert.CertStoreParameters)) methods.
...
See Also:
:   * [`CertStore.getInstance(java.lang.String, java.security.cert.CertStoreParameters)`](CertStore.md#getInstance(java.lang.String,java.security.cert.CertStoreParameters))
