...
[`Certificates`](X509Certificate.md "class in java.security.cert") and v2
[`CRLs`](X509CRL.md "class in java.security.cert") (Certificate Revocation
...
* ## Method Details
  ...
  + ### getCriticalExtensionOIDs
    ...
    [Set](../../util/Set.md "interface in java.util")<[String](../../lang/String.md "class in java.lang")> getCriticalExtensionOIDs()
  ...
  + ### getNonCriticalExtensionOIDs
    ...
    [Set](../../util/Set.md "interface in java.util")<[String](../../lang/String.md "class in java.lang")> getNonCriticalExtensionOIDs()
  ...
  + ### getExtensionValue
    ...
    byte[] getExtensionValue([String](../../lang/String.md "class in java.lang") oid)
