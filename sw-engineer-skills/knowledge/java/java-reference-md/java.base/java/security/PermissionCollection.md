...
* add a permission to the collection using the `add` method.* check to see if a particular permission is implied in the
    collection, using the `implies` method.* enumerate all the permissions, using the `elements` method.
...
:   * [`Permission`](Permission.md "class in java.security")
    ...
    * [Serialized Form](../../../serialized-form.md#java.security.PermissionCollection)
...
* ## Method Details
  ...
  + ### add
    ...
    public abstract void add([Permission](Permission.md "class in java.security") permission)
    ...
    Throws:
    :   `SecurityException` - if this `PermissionCollection`
  ...
  + ### elements
    ...
    public abstract [Enumeration](../util/Enumeration.md "interface in java.util")<[Permission](Permission.md "class in java.security")> elements()
    ...
    See Also:
    :   - [`elementsAsStream()`](#elementsAsStream())
  + ### elementsAsStream

    public [Stream](../util/stream/Stream.md "interface in java.util.stream")<[Permission](Permission.md "class in java.security")> elementsAsStream()

    Returns a stream of all the Permission objects in the collection.

    The collection should not be modified (see [`add(java.security.Permission)`](#add(java.security.Permission))) during the
  ...
  + ### isReadOnly
    ...
    Returns:
    :   `true` if this `PermissionCollection` object is
