...
* to decide whether an access to a critical system
  ...
  currently in effect,* to mark code as being "privileged", thus affecting subsequent
    access determinations, and* to obtain a "snapshot" of the current calling context so
      access-control decisions from a different context can be made with
      respect to the saved context.

The [`checkPermission`](#checkPermission(java.security.Permission)) method
...
(see [`doPrivileged`](#doPrivileged(java.security.PrivilegedAction)) and below).
...
The [`getContext`](#getContext()) method and
...
* ## Method Details
  ...
  + ### doPrivileged
    ...
    public static <T> T doPrivileged([PrivilegedAction](PrivilegedAction.md "interface in java.security")<T> action)
    ...
    `AccessControlContext` will be ignored while the action is
    performed.
    ...
    See Also:
    :   - [`doPrivileged(PrivilegedAction,AccessControlContext)`](#doPrivileged(java.security.PrivilegedAction,java.security.AccessControlContext))
        - [`doPrivileged(PrivilegedExceptionAction)`](#doPrivileged(java.security.PrivilegedExceptionAction))
        - [`doPrivilegedWithCombiner(PrivilegedAction)`](#doPrivilegedWithCombiner(java.security.PrivilegedAction))
        - [`DomainCombiner`](DomainCombiner.md "interface in java.security")
  + ### doPrivilegedWithCombiner

    public static <T> T doPrivilegedWithCombiner([PrivilegedAction](PrivilegedAction.md "interface in java.security")<T> action)
    ...
    See Also:
    :   - [`doPrivileged(PrivilegedAction)`](#doPrivileged(java.security.PrivilegedAction))
        - [`DomainCombiner`](DomainCombiner.md "interface in java.security")
  + ### doPrivileged

    public static <T> T doPrivileged([PrivilegedAction](PrivilegedAction.md "interface in java.security")<T> action,
    [AccessControlContext](AccessControlContext.md "class in java.security") context)
    ...
    [`SecurityPermission`](SecurityPermission.md "class in java.security"), then the action is performed
    with no permissions.
    ...
    See Also:
    :   - [`doPrivileged(PrivilegedAction)`](#doPrivileged(java.security.PrivilegedAction))
        - [`doPrivileged(PrivilegedExceptionAction,AccessControlContext)`](#doPrivileged(java.security.PrivilegedExceptionAction,java.security.AccessControlContext))
  + ### doPrivileged

    public static <T> T doPrivileged([PrivilegedAction](PrivilegedAction.md "interface in java.security")<T> action,
    [AccessControlContext](AccessControlContext.md "class in java.security") context,
    [Permission](Permission.md "class in java.security")... perms)
  ...
  + ### doPrivileged
    ...
    public static <T> T doPrivileged([PrivilegedExceptionAction](PrivilegedExceptionAction.md "interface in java.security")<T> action)
    throws [PrivilegedActionException](PrivilegedActionException.md "class in java.security")
    ...
    :   - [`doPrivileged(PrivilegedAction)`](#doPrivileged(java.security.PrivilegedAction))
        - [`doPrivileged(PrivilegedExceptionAction,AccessControlContext)`](#doPrivileged(java.security.PrivilegedExceptionAction,java.security.AccessControlContext))
        - [`doPrivilegedWithCombiner(PrivilegedExceptionAction)`](#doPrivilegedWithCombiner(java.security.PrivilegedExceptionAction))
        - [`DomainCombiner`](DomainCombiner.md "interface in java.security")
  + ### doPrivilegedWithCombiner

    public static <T> T doPrivilegedWithCombiner([PrivilegedExceptionAction](PrivilegedExceptionAction.md "interface in java.security")<T> action)
    throws [PrivilegedActionException](PrivilegedActionException.md "class in java.security")
  ...
  + ### getContext
    ...
    public static [AccessControlContext](AccessControlContext.md "class in java.security") getContext()
  ...
  + ### checkPermission
    ...
    public static void checkPermission([Permission](Permission.md "class in java.security") perm)
    ...
    `getPermission` method of the `AccessControlException`
    returns the `Permission` object instance (`perm`}.
