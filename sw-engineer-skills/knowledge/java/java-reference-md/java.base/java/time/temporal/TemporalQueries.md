...
This class provides common implementations of [`TemporalQuery`](TemporalQuery.md "interface in java.time.temporal").
...
* ## Method Details
  ...
  + ### zoneId
    ...
    public static [TemporalQuery](TemporalQuery.md "interface in java.time.temporal")<[ZoneId](../ZoneId.md "class in java.time")> zoneId()
    ...
    Thus a [`ZonedDateTime`](../ZonedDateTime.md "class in java.time") will return the result of `getZone()`,
    but an [`OffsetDateTime`](../OffsetDateTime.md "class in java.time") will return null.

    In most cases, applications should use [`zone()`](#zone()) as this query is too strict.
  ...
  + ### chronology
    ...
    public static [TemporalQuery](TemporalQuery.md "interface in java.time.temporal")<[Chronology](../chrono/Chronology.md "interface in java.time.chrono")> chronology()
    ...
    The method [`Chronology.from(TemporalAccessor)`](../chrono/Chronology.md#from(java.time.temporal.TemporalAccessor)) can be used as a
  ...
  + ### precision
    ...
    public static [TemporalQuery](TemporalQuery.md "interface in java.time.temporal")<[TemporalUnit](TemporalUnit.md "interface in java.time.temporal")> precision()
  ...
  + ### zone
    ...
    public static [TemporalQuery](TemporalQuery.md "interface in java.time.temporal")<[ZoneId](../ZoneId.md "class in java.time")> zone()

    A lenient query for the `ZoneId`, falling back to the `ZoneOffset`.

    This queries a `TemporalAccessor` for the zone.
    It first tries to obtain the zone, using [`zoneId()`](#zoneId()).
    If that is not found it tries to obtain the [`offset()`](#offset()).
    Thus a [`ZonedDateTime`](../ZonedDateTime.md "class in java.time") will return the result of `getZone()`,
    while an [`OffsetDateTime`](../OffsetDateTime.md "class in java.time") will return the result of `getOffset()`.

    In most cases, applications should use this query rather than `#zoneId()`.

    The method [`ZoneId.from(TemporalAccessor)`](../ZoneId.md#from(java.time.temporal.TemporalAccessor)) can be used as a
  ...
  + ### offset
    ...
    public static [TemporalQuery](TemporalQuery.md "interface in java.time.temporal")<[ZoneOffset](../ZoneOffset.md "class in java.time")> offset()
    ...
    The query implementation examines the [`OFFSET_SECONDS`](ChronoField.md#OFFSET_SECONDS)
    field and uses it to create a `ZoneOffset`.

    The method [`ZoneOffset.from(TemporalAccessor)`](../ZoneOffset.md#from(java.time.temporal.TemporalAccessor)) can be used as a
  ...
  + ### localDate
    ...
    public static [TemporalQuery](TemporalQuery.md "interface in java.time.temporal")<[LocalDate](../LocalDate.md "class in java.time")> localDate()
    ...
    The query implementation examines the [`EPOCH_DAY`](ChronoField.md#EPOCH_DAY)
    field and uses it to create a `LocalDate`.

    The method [`LocalDate.from(TemporalAccessor)`](../LocalDate.md#from(java.time.temporal.TemporalAccessor)) can be used as a
  ...
  + ### localTime
    ...
    public static [TemporalQuery](TemporalQuery.md "interface in java.time.temporal")<[LocalTime](../LocalTime.md "class in java.time")> localTime()
    ...
    The query implementation examines the [`NANO_OF_DAY`](ChronoField.md#NANO_OF_DAY)
    field and uses it to create a `LocalTime`.

    The method [`LocalTime.from(TemporalAccessor)`](../LocalTime.md#from(java.time.temporal.TemporalAccessor)) can be used as a
