...
purpose of providing [`TemporalField`](TemporalField.md "interface in java.time.temporal") instances.

WeekFields provides five fields,
[`dayOfWeek()`](#dayOfWeek()), [`weekOfMonth()`](#weekOfMonth()), [`weekOfYear()`](#weekOfYear()),
[`weekOfWeekBasedYear()`](#weekOfWeekBasedYear()), and [`weekBasedYear()`](#weekBasedYear())
that provide access to the values from any [temporal object](Temporal.md "interface in java.time.temporal").

The computations for day-of-week, week-of-month, and week-of-year are based
on the [proleptic-year](ChronoField.md#YEAR),
[month-of-year](ChronoField.md#MONTH_OF_YEAR),
[day-of-month](ChronoField.md#DAY_OF_MONTH), and
[ISO day-of-week](ChronoField.md#DAY_OF_WEEK) which are based on the
[epoch-day](ChronoField.md#EPOCH_DAY) and the chronology.
The values may not be aligned with the [year-of-Era](ChronoField.md#YEAR_OF_ERA)
depending on the Chronology.

A week is defined by:

* The first day-of-week.
  For example, the ISO-8601 standard considers Monday to be the first day-of-week.* The minimal number of days in the first week.
...
[`week-of-week-based-year`](#weekOfWeekBasedYear()) and one for
[`week-based-year`](#weekBasedYear()). In a week-based-year, each week
...
See Also:
:   * [Serialized Form](../../../../serialized-form.md#java.time.temporal.WeekFields)
...
* ## Field Details
  ...
  + ### ISO
    ...
    public static final [WeekFields](WeekFields.md "class in java.time.temporal") ISO
  ...
  + ### SUNDAY\_START
    ...
    public static final [WeekFields](WeekFields.md "class in java.time.temporal") SUNDAY\_START
...
* ## Method Details
  ...
  + ### of
    ...
    public static [WeekFields](WeekFields.md "class in java.time.temporal") of([Locale](../../util/Locale.md "class in java.util") locale)
  ...
  + ### of
    ...
    public static [WeekFields](WeekFields.md "class in java.time.temporal") of([DayOfWeek](../DayOfWeek.md "enum class in java.time") firstDayOfWeek,
    int minimalDaysInFirstWeek)
  ...
  + ### getFirstDayOfWeek
    ...
    public [DayOfWeek](../DayOfWeek.md "enum class in java.time") getFirstDayOfWeek()
  ...
  + ### dayOfWeek
    ...
    public [TemporalField](TemporalField.md "interface in java.time.temporal") dayOfWeek()

    Returns a field to access the day of week based on this `WeekFields`.

    This is similar to [`ChronoField.DAY_OF_WEEK`](ChronoField.md#DAY_OF_WEEK) but uses values for
  ...
  + ### weekOfMonth
    ...
    public [TemporalField](TemporalField.md "interface in java.time.temporal") weekOfMonth()

    Returns a field to access the week of month based on this `WeekFields`.

    This represents the concept of the count of weeks within the month where weeks
    start on a fixed day-of-week, such as Monday.
    This field is typically used with [`dayOfWeek()`](#dayOfWeek()).

    Week one (1) is the week starting on the [`getFirstDayOfWeek()`](#getFirstDayOfWeek())
    where there are at least [`getMinimalDaysInFirstWeek()`](#getMinimalDaysInFirstWeek()) days in the month.
    ...
    In [strict mode](../format/ResolverStyle.md#STRICT), all four fields are
    validated against their range of valid values. The week-of-month field
    is validated to ensure that the resulting month is the month requested.

    In [smart mode](../format/ResolverStyle.md#SMART), all four fields are
    validated against their range of valid values. The week-of-month field
    is validated from 0 to 6, meaning that the resulting date can be in a
    different month to that specified.

    In [lenient mode](../format/ResolverStyle.md#LENIENT), the year and day-of-week
  ...
  + ### weekOfYear
    ...
    public [TemporalField](TemporalField.md "interface in java.time.temporal") weekOfYear()
    ...
    Week one(1) is the week starting on the [`getFirstDayOfWeek()`](#getFirstDayOfWeek())
    where there are at least [`getMinimalDaysInFirstWeek()`](#getMinimalDaysInFirstWeek()) days in the year.
  ...
  + ### weekOfWeekBasedYear
    ...
    public [TemporalField](TemporalField.md "interface in java.time.temporal") weekOfWeekBasedYear()

    Returns a field to access the week of a week-based-year based on this `WeekFields`.

    This represents the concept of the count of weeks within the year where weeks
    start on a fixed day-of-week, such as Monday and each week belongs to exactly one year.
    This field is typically used with [`dayOfWeek()`](#dayOfWeek()) and
  ...
  + ### weekBasedYear
    ...
    public [TemporalField](TemporalField.md "interface in java.time.temporal") weekBasedYear()
  ...
  + ### equals
    ...
    public boolean equals([Object](../../lang/Object.md "class in java.lang") object)
