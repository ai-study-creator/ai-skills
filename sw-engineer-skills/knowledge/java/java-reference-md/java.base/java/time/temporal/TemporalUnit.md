...
See [`Period`](../Period.md "class in java.time") for a class that represents an amount in terms of the common units.

The most commonly used units are defined in [`ChronoUnit`](ChronoUnit.md "enum class in java.time.temporal").
Further units are supplied in [`IsoFields`](IsoFields.md "class in java.time.temporal").
...
* ## Method Details
  ...
  + ### getDuration
    ...
    [Duration](../Duration.md "class in java.time") getDuration()
    ...
    To determine if the duration is an estimate, use [`isDurationEstimated()`](#isDurationEstimated()).
  ...
  + ### isSupportedBy
    ...
    default boolean isSupportedBy([Temporal](Temporal.md "interface in java.time.temporal") temporal)
  ...
  + ### addTo
    ...
    <R extends [Temporal](Temporal.md "interface in java.time.temporal")> R addTo(R temporal,
    long amount)
  ...
  + ### between
    ...
    long between([Temporal](Temporal.md "interface in java.time.temporal") temporal1Inclusive,
