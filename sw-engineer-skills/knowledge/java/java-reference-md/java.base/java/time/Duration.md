...
implements [TemporalAmount](temporal/TemporalAmount.md "interface in java.time.temporal"), [Comparable](../lang/Comparable.md "interface in java.lang")<[Duration](Duration.md "class in java.time")>, [Serializable](../io/Serializable.md "interface in java.io")

A time-based amount of time, such as '34.5 seconds'.

This class models a quantity or amount of time in terms of seconds and nanoseconds.
It can be accessed using other duration-based units, such as minutes and hours.
In addition, the [`DAYS`](temporal/ChronoUnit.md#DAYS) unit can be used and is treated as
exactly equal to 24 hours, thus ignoring daylight savings effects.
See [`Period`](Period.md "class in java.time") for the date-based equivalent to this class.

A physical duration could be of infinite length.
For practicality, the duration is stored with constraints similar to [`Instant`](Instant.md "class in java.time").
...
most applications.
See [`Instant`](Instant.md "class in java.time") for a discussion as to the meaning of the second and time-scales.
...
See Also:
:   * [Serialized Form](../../../serialized-form.md#java.time.Duration)
...
* ## Field Details
  ...
  + ### ZERO
    ...
    public static final [Duration](Duration.md "class in java.time") ZERO
...
* ## Method Details
  ...
  + ### ofDays
    ...
    public static [Duration](Duration.md "class in java.time") ofDays(long days)
  ...
  + ### ofHours
    ...
    public static [Duration](Duration.md "class in java.time") ofHours(long hours)
  ...
  + ### ofMinutes
    ...
    public static [Duration](Duration.md "class in java.time") ofMinutes(long minutes)
  ...
  + ### ofSeconds
    ...
    public static [Duration](Duration.md "class in java.time") ofSeconds(long seconds)
  ...
  + ### ofMillis
    ...
    public static [Duration](Duration.md "class in java.time") ofMillis(long millis)
  ...
  + ### ofNanos
    ...
    public static [Duration](Duration.md "class in java.time") ofNanos(long nanos)
  ...
  + ### of
    ...
    public static [Duration](Duration.md "class in java.time") of(long amount,
    ...
    The unit must either have an [exact duration](temporal/TemporalUnit.md#isDurationEstimated()) or
    be [`ChronoUnit.DAYS`](temporal/ChronoUnit.md#DAYS) which is treated as 24 hours. Other units throw an exception.
  ...
  + ### from
    ...
    public static [Duration](Duration.md "class in java.time") from([TemporalAmount](temporal/TemporalAmount.md "interface in java.time.temporal") amount)
    ...
    the [duration](temporal/TemporalUnit.md#getDuration()) of the unit to
    calculate the total `Duration`.
    Only a subset of units are accepted by this method. The unit must either
    have an [exact duration](temporal/TemporalUnit.md#isDurationEstimated())
    or be [`ChronoUnit.DAYS`](temporal/ChronoUnit.md#DAYS) which is treated as 24 hours.
  ...
  + ### parse
    ...
    public static [Duration](Duration.md "class in java.time") parse([CharSequence](../lang/CharSequence.md "interface in java.lang") text)
  ...
  + ### between
    ...
    public static [Duration](Duration.md "class in java.time") between([Temporal](temporal/Temporal.md "interface in java.time.temporal") startInclusive,
    [Temporal](temporal/Temporal.md "interface in java.time.temporal") endExclusive)
    ...
    The specified temporal objects must support the [`SECONDS`](temporal/ChronoUnit.md#SECONDS) unit.
    For full accuracy, either the [`NANOS`](temporal/ChronoUnit.md#NANOS) unit or the
    [`NANO_OF_SECOND`](temporal/ChronoField.md#NANO_OF_SECOND) field should be supported.

    The result of this method can be a negative period if the end is before the start.
    To guarantee to obtain a positive duration call [`abs()`](#abs()) on the result.
  ...
  + ### get
    ...
    [`SECONDS`](temporal/ChronoUnit.md#SECONDS) and [`NANOS`](temporal/ChronoUnit.md#NANOS).
  ...
  + ### getUnits
    ...
    The supported units are [`SECONDS`](temporal/ChronoUnit.md#SECONDS),
    and [`NANOS`](temporal/ChronoUnit.md#NANOS).
  ...
  + ### getSeconds
    ...
    The total duration is defined by calling this method and [`getNano()`](#getNano()).
  ...
  + ### getNano
    ...
    The nanoseconds part is a value from 0 to 999,999,999 that is an adjustment to
    the length in seconds.
    The total duration is defined by calling this method and [`getSeconds()`](#getSeconds()).
  ...
  + ### withSeconds
    ...
    public [Duration](Duration.md "class in java.time") withSeconds(long seconds)
  ...
  + ### withNanos
    ...
    public [Duration](Duration.md "class in java.time") withNanos(int nanoOfSecond)
  ...
  + ### plus
    ...
    public [Duration](Duration.md "class in java.time") plus([Duration](Duration.md "class in java.time") duration)
  ...
  + ### plus
    ...
    public [Duration](Duration.md "class in java.time") plus(long amountToAdd,
    [TemporalUnit](temporal/TemporalUnit.md "interface in java.time.temporal") unit)
  ...
  + ### plusDays
    ...
    public [Duration](Duration.md "class in java.time") plusDays(long daysToAdd)
  ...
  + ### plusHours
    ...
    public [Duration](Duration.md "class in java.time") plusHours(long hoursToAdd)
  ...
  + ### plusMinutes
    ...
    public [Duration](Duration.md "class in java.time") plusMinutes(long minutesToAdd)
  ...
  + ### plusSeconds
    ...
    public [Duration](Duration.md "class in java.time") plusSeconds(long secondsToAdd)
  ...
  + ### plusMillis
    ...
    public [Duration](Duration.md "class in java.time") plusMillis(long millisToAdd)
  ...
  + ### plusNanos
    ...
    public [Duration](Duration.md "class in java.time") plusNanos(long nanosToAdd)
  ...
  + ### minus
    ...
    public [Duration](Duration.md "class in java.time") minus([Duration](Duration.md "class in java.time") duration)
  ...
  + ### minus
    ...
    public [Duration](Duration.md "class in java.time") minus(long amountToSubtract,
    [TemporalUnit](temporal/TemporalUnit.md "interface in java.time.temporal") unit)
  ...
  + ### minusDays
    ...
    public [Duration](Duration.md "class in java.time") minusDays(long daysToSubtract)
  ...
  + ### minusHours
    ...
    public [Duration](Duration.md "class in java.time") minusHours(long hoursToSubtract)
  ...
  + ### minusMinutes
    ...
    public [Duration](Duration.md "class in java.time") minusMinutes(long minutesToSubtract)
  ...
  + ### minusSeconds
    ...
    public [Duration](Duration.md "class in java.time") minusSeconds(long secondsToSubtract)
  ...
  + ### minusMillis
    ...
    public [Duration](Duration.md "class in java.time") minusMillis(long millisToSubtract)
  ...
  + ### minusNanos
    ...
    public [Duration](Duration.md "class in java.time") minusNanos(long nanosToSubtract)
  ...
  + ### multipliedBy
    ...
    public [Duration](Duration.md "class in java.time") multipliedBy(long multiplicand)
  ...
  + ### dividedBy
    ...
    public [Duration](Duration.md "class in java.time") dividedBy(long divisor)
  ...
  + ### dividedBy
    ...
    public long dividedBy([Duration](Duration.md "class in java.time") divisor)
  ...
  + ### negated
    ...
    public [Duration](Duration.md "class in java.time") negated()
  ...
  + ### abs
    ...
    public [Duration](Duration.md "class in java.time") abs()
  ...
  + ### toHoursPart
    ...
    This returns the number of remaining hours when dividing [`toHours()`](#toHours())
    by hours in a day.
    This is based on the standard definition of a day as 24 hours.
  ...
  + ### toMinutesPart
    ...
    This returns the number of remaining minutes when dividing [`toMinutes()`](#toMinutes())
  ...
  + ### toSecondsPart
    ...
    This returns the remaining seconds when dividing [`toSeconds()`](#toSeconds())
  ...
  + ### toMillisPart
    ...
    The nanoseconds part is a value from 0 to 999,999,999 that is an adjustment to
    the length in seconds.
    The total duration is defined by calling [`getNano()`](#getNano()) and [`getSeconds()`](#getSeconds()).
  ...
  + ### truncatedTo
    ...
    public [Duration](Duration.md "class in java.time") truncatedTo([TemporalUnit](temporal/TemporalUnit.md "interface in java.time.temporal") unit)
    ...
    This includes all
    [time-based units on `ChronoUnit`](temporal/ChronoUnit.md#isTimeBased())
    and [`DAYS`](temporal/ChronoUnit.md#DAYS). Other ChronoUnits throw an exception.
  ...
  + ### compareTo
    ...
    public int compareTo([Duration](Duration.md "class in java.time") otherDuration)
    ...
    Returns:
    :   the comparator value, that is less than zero if this duration is less than `otherDuration`,
