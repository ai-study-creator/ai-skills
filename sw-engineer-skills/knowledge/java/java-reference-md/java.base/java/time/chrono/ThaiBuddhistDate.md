...
This date operates using the [Thai Buddhist calendar](ThaiBuddhistChronology.md "class in java.time.chrono").
...
See Also:
:   * [Serialized Form](../../../../serialized-form.md#java.time.chrono.ThaiBuddhistDate)
...
* ## Method Details
  ...
  + ### now
    ...
    public static [ThaiBuddhistDate](ThaiBuddhistDate.md "class in java.time.chrono") now()
  ...
  + ### now
    ...
    public static [ThaiBuddhistDate](ThaiBuddhistDate.md "class in java.time.chrono") now([ZoneId](../ZoneId.md "class in java.time") zone)
  ...
  + ### now
    ...
    public static [ThaiBuddhistDate](ThaiBuddhistDate.md "class in java.time.chrono") now([Clock](../Clock.md "class in java.time") clock)
  ...
  + ### of
    ...
    public static [ThaiBuddhistDate](ThaiBuddhistDate.md "class in java.time.chrono") of(int prolepticYear,
    int month,
    int dayOfMonth)
  ...
  + ### from
    ...
    public static [ThaiBuddhistDate](ThaiBuddhistDate.md "class in java.time.chrono") from([TemporalAccessor](../temporal/TemporalAccessor.md "interface in java.time.temporal") temporal)
  ...
  + ### getChronology
    ...
    public [ThaiBuddhistChronology](ThaiBuddhistChronology.md "class in java.time.chrono") getChronology()
  ...
  + ### getEra
    ...
    public [ThaiBuddhistEra](ThaiBuddhistEra.md "enum class in java.time.chrono") getEra()

    Gets the era applicable at this date.

    The Thai Buddhist calendar system has two eras, 'BE' and 'BEFORE\_BE',
    defined by [`ThaiBuddhistEra`](ThaiBuddhistEra.md "enum class in java.time.chrono").
  ...
  + ### with
    ...
    public [ThaiBuddhistDate](ThaiBuddhistDate.md "class in java.time.chrono") with([TemporalField](../temporal/TemporalField.md "interface in java.time.temporal") field,
    long newValue)
  ...
  + ### with
    ...
    public [ThaiBuddhistDate](ThaiBuddhistDate.md "class in java.time.chrono") with([TemporalAdjuster](../temporal/TemporalAdjuster.md "interface in java.time.temporal") adjuster)
  ...
  + ### plus
    ...
    public [ThaiBuddhistDate](ThaiBuddhistDate.md "class in java.time.chrono") plus([TemporalAmount](../temporal/TemporalAmount.md "interface in java.time.temporal") amount)
  ...
  + ### minus
    ...
    public [ThaiBuddhistDate](ThaiBuddhistDate.md "class in java.time.chrono") minus([TemporalAmount](../temporal/TemporalAmount.md "interface in java.time.temporal") amount)
  ...
  + ### plus
    ...
    public [ThaiBuddhistDate](ThaiBuddhistDate.md "class in java.time.chrono") plus(long amountToAdd,
  ...
  + ### minus
    ...
    public [ThaiBuddhistDate](ThaiBuddhistDate.md "class in java.time.chrono") minus(long amountToSubtract,
    [TemporalUnit](../temporal/TemporalUnit.md "interface in java.time.temporal") unit)
  ...
  + ### atTime
    ...
    public final [ChronoLocalDateTime](ChronoLocalDateTime.md "interface in java.time.chrono")<[ThaiBuddhistDate](ThaiBuddhistDate.md "class in java.time.chrono")> atTime([LocalTime](../LocalTime.md "class in java.time") localTime)
