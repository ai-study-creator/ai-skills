...
* era - There are two eras, the current 'Republic' (ERA\_ROC) and the previous era (ERA\_BEFORE\_ROC).* year-of-era - The year-of-era for the current era increases uniformly from the epoch at year one.
    For the previous era the year increases from one as time goes backwards.
    The value for the current era is equal to the ISO proleptic-year minus 1911.* proleptic-year - The proleptic year is the same as the year-of-era for the
      current era. For the previous era, years have zero, then negative values.
      The value is equal to the ISO proleptic-year minus 1911.* month-of-year - The Minguo month-of-year exactly matches ISO.* day-of-month - The Minguo day-of-month exactly matches ISO.* day-of-year - The Minguo day-of-year exactly matches ISO.* leap-year - The Minguo leap-year pattern exactly matches ISO, such that the two calendars
...
See Also:
:   * [Serialized Form](../../../../serialized-form.md#java.time.chrono.MinguoChronology)
...
* ## Field Details
  ...
  + ### INSTANCE
    ...
    public static final [MinguoChronology](MinguoChronology.md "class in java.time.chrono") INSTANCE
...
* ## Method Details
  ...
  + ### date
    ...
    public [MinguoDate](MinguoDate.md "class in java.time.chrono") date([Era](Era.md "interface in java.time.chrono") era,
    int yearOfEra,
    int month,
    int dayOfMonth)
  ...
  + ### date
    ...
    public [MinguoDate](MinguoDate.md "class in java.time.chrono") date(int prolepticYear,
    int month,
    int dayOfMonth)
  ...
  + ### dateYearDay
    ...
    public [MinguoDate](MinguoDate.md "class in java.time.chrono") dateYearDay([Era](Era.md "interface in java.time.chrono") era,
    int yearOfEra,
    int dayOfYear)
  ...
  + ### dateYearDay
    ...
    public [MinguoDate](MinguoDate.md "class in java.time.chrono") dateYearDay(int prolepticYear,
    int dayOfYear)
  ...
  + ### dateEpochDay
    ...
    public [MinguoDate](MinguoDate.md "class in java.time.chrono") dateEpochDay(long epochDay)
  ...
  + ### dateNow
    ...
    public [MinguoDate](MinguoDate.md "class in java.time.chrono") dateNow()
  ...
  + ### dateNow
    ...
    public [MinguoDate](MinguoDate.md "class in java.time.chrono") dateNow([ZoneId](../ZoneId.md "class in java.time") zone)
  ...
  + ### dateNow
    ...
    public [MinguoDate](MinguoDate.md "class in java.time.chrono") dateNow([Clock](../Clock.md "class in java.time") clock)
  ...
  + ### date
    ...
    public [MinguoDate](MinguoDate.md "class in java.time.chrono") date([TemporalAccessor](../temporal/TemporalAccessor.md "interface in java.time.temporal") temporal)
  ...
  + ### localDateTime
    ...
    public [ChronoLocalDateTime](ChronoLocalDateTime.md "interface in java.time.chrono")<[MinguoDate](MinguoDate.md "class in java.time.chrono")> localDateTime([TemporalAccessor](../temporal/TemporalAccessor.md "interface in java.time.temporal") temporal)
  ...
  + ### zonedDateTime
    ...
    public [ChronoZonedDateTime](ChronoZonedDateTime.md "interface in java.time.chrono")<[MinguoDate](MinguoDate.md "class in java.time.chrono")> zonedDateTime([TemporalAccessor](../temporal/TemporalAccessor.md "interface in java.time.temporal") temporal)
  ...
  + ### zonedDateTime
    ...
    public [ChronoZonedDateTime](ChronoZonedDateTime.md "interface in java.time.chrono")<[MinguoDate](MinguoDate.md "class in java.time.chrono")> zonedDateTime([Instant](../Instant.md "class in java.time") instant,
  ...
  + ### eraOf
    ...
    public [MinguoEra](MinguoEra.md "enum class in java.time.chrono") eraOf(int eraValue)
  ...
  + ### resolveDate
    ...
    public [MinguoDate](MinguoDate.md "class in java.time.chrono") resolveDate([Map](../../util/Map.md "interface in java.util")<[TemporalField](../temporal/TemporalField.md "interface in java.time.temporal"),[Long](../../lang/Long.md "class in java.lang")> fieldValues,
