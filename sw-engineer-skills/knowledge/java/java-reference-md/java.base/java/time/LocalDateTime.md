...
See Also:
:   * [Serialized Form](../../../serialized-form.md#java.time.LocalDateTime)
...
* ## Method Summary
  ...
  ### Methods inherited from interface java.time.chrono.[ChronoLocalDateTime](chrono/ChronoLocalDateTime.md "interface in java.time.chrono")
...
* ## Field Details
  ...
  + ### MIN
    ...
    public static final [LocalDateTime](LocalDateTime.md "class in java.time") MIN

    The minimum supported `LocalDateTime`, '-999999999-01-01T00:00:00'.
    This is the local date-time of midnight at the start of the minimum date.
    This combines [`LocalDate.MIN`](LocalDate.md#MIN) and [`LocalTime.MIN`](LocalTime.md#MIN).
    This could be used by an application as a "far past" date-time.
  + ### MAX

    public static final [LocalDateTime](LocalDateTime.md "class in java.time") MAX

    The maximum supported `LocalDateTime`, '+999999999-12-31T23:59:59.999999999'.
    This is the local date-time just before midnight at the end of the maximum date.
    This combines [`LocalDate.MAX`](LocalDate.md#MAX) and [`LocalTime.MAX`](LocalTime.md#MAX).
    This could be used by an application as a "far future" date-time.
* ## Method Details

  + ### now

    public static [LocalDateTime](LocalDateTime.md "class in java.time") now()
  ...
  + ### now
    ...
    public static [LocalDateTime](LocalDateTime.md "class in java.time") now([ZoneId](ZoneId.md "class in java.time") zone)
  ...
  + ### now
    ...
    public static [LocalDateTime](LocalDateTime.md "class in java.time") now([Clock](Clock.md "class in java.time") clock)
  ...
  + ### of
    ...
    public static [LocalDateTime](LocalDateTime.md "class in java.time") of(int year,
  ...
  + ### of
    ...
    public static [LocalDateTime](LocalDateTime.md "class in java.time") of([LocalDate](LocalDate.md "class in java.time") date,
  ...
  + ### ofInstant
    ...
    public static [LocalDateTime](LocalDateTime.md "class in java.time") ofInstant([Instant](Instant.md "class in java.time") instant,
  ...
  + ### ofEpochSecond
    ...
    public static [LocalDateTime](LocalDateTime.md "class in java.time") ofEpochSecond(long epochSecond,
    int nanoOfSecond,
    ...
    This allows the [`epoch-second`](temporal/ChronoField.md#INSTANT_SECONDS) field
  ...
  + ### from
    ...
    public static [LocalDateTime](LocalDateTime.md "class in java.time") from([TemporalAccessor](temporal/TemporalAccessor.md "interface in java.time.temporal") temporal)
  ...
  + ### parse
    ...
    public static [LocalDateTime](LocalDateTime.md "class in java.time") parse([CharSequence](../lang/CharSequence.md "interface in java.lang") text)

    Obtains an instance of `LocalDateTime` from a text string such as `2007-12-03T10:15:30`.

    The string must represent a valid date-time and is parsed using
    [`DateTimeFormatter.ISO_LOCAL_DATE_TIME`](format/DateTimeFormatter.md#ISO_LOCAL_DATE_TIME).
  ...
  + ### with
    ...
    public [LocalDateTime](LocalDateTime.md "class in java.time") with([TemporalAdjuster](temporal/TemporalAdjuster.md "interface in java.time.temporal") adjuster)
  ...
  + ### with
    ...
    public [LocalDateTime](LocalDateTime.md "class in java.time") with([TemporalField](temporal/TemporalField.md "interface in java.time.temporal") field,
    long newValue)
    ...
    The [`supported fields`](#isSupported(java.time.temporal.TemporalField)) will behave as per
    the matching method on [`LocalDate`](LocalDate.md#with(java.time.temporal.TemporalField,long))
    or [`LocalTime`](LocalTime.md#with(java.time.temporal.TemporalField,long)).
    All other `ChronoField` instances will throw an `UnsupportedTemporalTypeException`.
  ...
  + ### withYear
    ...
    public [LocalDateTime](LocalDateTime.md "class in java.time") withYear(int year)
  ...
  + ### withMonth
    ...
    public [LocalDateTime](LocalDateTime.md "class in java.time") withMonth(int month)
  ...
  + ### withDayOfMonth
    ...
    public [LocalDateTime](LocalDateTime.md "class in java.time") withDayOfMonth(int dayOfMonth)
  ...
  + ### withDayOfYear
    ...
    public [LocalDateTime](LocalDateTime.md "class in java.time") withDayOfYear(int dayOfYear)
  ...
  + ### withHour
    ...
    public [LocalDateTime](LocalDateTime.md "class in java.time") withHour(int hour)
  ...
  + ### withMinute
    ...
    public [LocalDateTime](LocalDateTime.md "class in java.time") withMinute(int minute)
  ...
  + ### withSecond
    ...
    public [LocalDateTime](LocalDateTime.md "class in java.time") withSecond(int second)
  ...
  + ### withNano
    ...
    public [LocalDateTime](LocalDateTime.md "class in java.time") withNano(int nanoOfSecond)
  ...
  + ### truncatedTo
    ...
    public [LocalDateTime](LocalDateTime.md "class in java.time") truncatedTo([TemporalUnit](temporal/TemporalUnit.md "interface in java.time.temporal") unit)
  ...
  + ### plus
    ...
    public [LocalDateTime](LocalDateTime.md "class in java.time") plus([TemporalAmount](temporal/TemporalAmount.md "interface in java.time.temporal") amountToAdd)
  ...
  + ### plus
    ...
    public [LocalDateTime](LocalDateTime.md "class in java.time") plus(long amountToAdd,
    ...
    Date units are added as per [`LocalDate.plus(long, TemporalUnit)`](LocalDate.md#plus(long,java.time.temporal.TemporalUnit)).
    Time units are added as per [`LocalTime.plus(long, TemporalUnit)`](LocalTime.md#plus(long,java.time.temporal.TemporalUnit)) with
    any overflow in days added equivalent to using [`plusDays(long)`](#plusDays(long)).
  ...
  + ### plusYears
    ...
    public [LocalDateTime](LocalDateTime.md "class in java.time") plusYears(long years)
  ...
  + ### plusMonths
    ...
    public [LocalDateTime](LocalDateTime.md "class in java.time") plusMonths(long months)
  ...
  + ### plusWeeks
    ...
    public [LocalDateTime](LocalDateTime.md "class in java.time") plusWeeks(long weeks)
  ...
  + ### plusDays
    ...
    public [LocalDateTime](LocalDateTime.md "class in java.time") plusDays(long days)
  ...
  + ### plusHours
    ...
    public [LocalDateTime](LocalDateTime.md "class in java.time") plusHours(long hours)
  ...
  + ### plusMinutes
    ...
    public [LocalDateTime](LocalDateTime.md "class in java.time") plusMinutes(long minutes)
  ...
  + ### plusSeconds
    ...
    public [LocalDateTime](LocalDateTime.md "class in java.time") plusSeconds(long seconds)
  ...
  + ### plusNanos
    ...
    public [LocalDateTime](LocalDateTime.md "class in java.time") plusNanos(long nanos)
  ...
  + ### minus
    ...
    public [LocalDateTime](LocalDateTime.md "class in java.time") minus([TemporalAmount](temporal/TemporalAmount.md "interface in java.time.temporal") amountToSubtract)
  ...
  + ### minus
    ...
    public [LocalDateTime](LocalDateTime.md "class in java.time") minus(long amountToSubtract,
    [TemporalUnit](temporal/TemporalUnit.md "interface in java.time.temporal") unit)
  ...
  + ### minusYears
    ...
    public [LocalDateTime](LocalDateTime.md "class in java.time") minusYears(long years)
  ...
  + ### minusMonths
    ...
    public [LocalDateTime](LocalDateTime.md "class in java.time") minusMonths(long months)
  ...
  + ### minusWeeks
    ...
    public [LocalDateTime](LocalDateTime.md "class in java.time") minusWeeks(long weeks)
  ...
  + ### minusDays
    ...
    public [LocalDateTime](LocalDateTime.md "class in java.time") minusDays(long days)
  ...
  + ### minusHours
    ...
    public [LocalDateTime](LocalDateTime.md "class in java.time") minusHours(long hours)
  ...
  + ### minusMinutes
    ...
    public [LocalDateTime](LocalDateTime.md "class in java.time") minusMinutes(long minutes)
  ...
  + ### minusSeconds
    ...
    public [LocalDateTime](LocalDateTime.md "class in java.time") minusSeconds(long seconds)
  ...
  + ### minusNanos
    ...
    public [LocalDateTime](LocalDateTime.md "class in java.time") minusNanos(long nanos)
  ...
  + ### until
    ...
    `LocalDateTime` using [`from(TemporalAccessor)`](#from(java.time.temporal.TemporalAccessor)).
  ...
  + ### atZone
    ...
    [`ZonedDateTime.withLaterOffsetAtOverlap()`](ZonedDateTime.md#withLaterOffsetAtOverlap()) on the result of this method.
    To throw an exception when there is a gap or overlap, use
    [`ZonedDateTime.ofStrict(LocalDateTime, ZoneOffset, ZoneId)`](ZonedDateTime.md#ofStrict(java.time.LocalDateTime,java.time.ZoneOffset,java.time.ZoneId)).
  ...
  + ### compareTo
    ...
    public int compareTo([ChronoLocalDateTime](chrono/ChronoLocalDateTime.md "interface in java.time.chrono")<?> other)
    ...
    chronology is also considered, see [`ChronoLocalDateTime.compareTo(java.time.chrono.ChronoLocalDateTime<?>)`](chrono/ChronoLocalDateTime.md#compareTo(java.time.chrono.ChronoLocalDateTime)).
  ...
  + ### isAfter
    ...
    public boolean isAfter([ChronoLocalDateTime](chrono/ChronoLocalDateTime.md "interface in java.time.chrono")<?> other)
    ...
    This is different from the comparison in [`compareTo(ChronoLocalDateTime)`](#compareTo(java.time.chrono.ChronoLocalDateTime)),
    but is the same approach as [`ChronoLocalDateTime.timeLineOrder()`](chrono/ChronoLocalDateTime.md#timeLineOrder()).
  ...
  + ### isBefore
    ...
    public boolean isBefore([ChronoLocalDateTime](chrono/ChronoLocalDateTime.md "interface in java.time.chrono")<?> other)
  ...
  + ### isEqual
    ...
    public boolean isEqual([ChronoLocalDateTime](chrono/ChronoLocalDateTime.md "interface in java.time.chrono")<?> other)
