...
implements [Comparable](../lang/Comparable.md "interface in java.lang")<[IntBuffer](IntBuffer.md "class in java.nio")>
...
* Absolute and relative [`get`](#get()) and
  [`put`](#put(int)) methods that read and write
  single ints;
* Absolute and relative [`bulk get`](#get(int%5B%5D))
  methods that transfer contiguous sequences of ints from this buffer
  into an array;
* Absolute and relative [`bulk put`](#put(int%5B%5D))
...
Int buffers can be created either by [`allocation`](#allocate(int)), which allocates space for the buffer's
content, by [`wrapping`](#wrap(int%5B%5D)) an existing
int array into a buffer, or by creating a
[*view*](ByteBuffer.md#views) of an existing byte buffer.

Like a byte buffer, an int buffer is either [*direct* or *non-direct*](ByteBuffer.md#direct). A
...
an int buffer is direct may be determined by invoking the [`isDirect`](#isDirect()) method.
...
on a [read-only](Buffer.md#isReadOnly()) IntBuffer. The
methods [array](#array()) and [arrayOffset](#arrayOffset())
throw an [UnsupportedOperationException](../lang/UnsupportedOperationException.md "class in java.lang") if the IntBuffer is
not backed by an [accessible int array](Buffer.md#hasArray())
...
* ## Method Details
  ...
  + ### allocate
    ...
    public static [IntBuffer](IntBuffer.md "class in java.nio") allocate(int capacity)
  ...
  + ### wrap
    ...
    public static [IntBuffer](IntBuffer.md "class in java.nio") wrap(int[] array,
    int offset,
    int length)
  ...
  + ### slice
    ...
    public abstract [IntBuffer](IntBuffer.md "class in java.nio") slice()
  ...
  + ### slice
    ...
    public abstract [IntBuffer](IntBuffer.md "class in java.nio") slice(int index,
    int length)
  ...
  + ### duplicate
    ...
    public abstract [IntBuffer](IntBuffer.md "class in java.nio") duplicate()
  ...
  + ### asReadOnlyBuffer
    ...
    public abstract [IntBuffer](IntBuffer.md "class in java.nio") asReadOnlyBuffer()
  ...
  + ### put
    ...
    public abstract [IntBuffer](IntBuffer.md "class in java.nio") put(int i)
  ...
  + ### put
    ...
    public abstract [IntBuffer](IntBuffer.md "class in java.nio") put(int index,
    int i)
  ...
  + ### get
    ...
    public [IntBuffer](IntBuffer.md "class in java.nio") get(int[] dst,
    int offset,
    int length)
    ...
    ints are transferred and a [`BufferUnderflowException`](BufferUnderflowException.md "class in java.nio") is
    thrown.
  ...
  + ### get
    ...
    public [IntBuffer](IntBuffer.md "class in java.nio") get(int index,
    int[] dst,
    int offset,
    int length)
    ...
    Parameters:
    :   `index` - The index in this buffer from which the first int will be
        read; must be non-negative and less than `limit()`
    :   `dst` - The destination array
    :   `offset` - The offset within the array of the first int to be
        written; must be non-negative and less than
        `dst.length`
    :   `length` - The number of ints to be written to the given array;
  ...
  + ### put
    ...
    public [IntBuffer](IntBuffer.md "class in java.nio") put([IntBuffer](IntBuffer.md "class in java.nio") src)
    ...
    then no ints are transferred and a [`BufferOverflowException`](BufferOverflowException.md "class in java.nio") is thrown.
  ...
  + ### put
    ...
    public [IntBuffer](IntBuffer.md "class in java.nio") put(int index,
    [IntBuffer](IntBuffer.md "class in java.nio") src,
    int offset,
    int length)
    ...
    Parameters:
    :   `index` - The index in this buffer at which the first int will be
        written; must be non-negative and less than `limit()`
    :   `src` - The buffer from which ints are to be read
    :   `offset` - The index within the source buffer of the first int to be
        read; must be non-negative and less than `src.limit()`
    :   `length` - The number of ints to be read from the given buffer;
        must be non-negative and no larger than the smaller of
  ...
  + ### put
    ...
    public [IntBuffer](IntBuffer.md "class in java.nio") put(int[] src,
    int offset,
    int length)
    ...
    `length` `>` `remaining()`, then no
    ints are transferred and a [`BufferOverflowException`](BufferOverflowException.md "class in java.nio") is
    thrown.
  ...
  + ### put
    ...
    public final [IntBuffer](IntBuffer.md "class in java.nio") put(int[] src)
  ...
  + ### position
    ...
    public final [IntBuffer](IntBuffer.md "class in java.nio") position(int newPosition)
  ...
  + ### limit
    ...
    public final [IntBuffer](IntBuffer.md "class in java.nio") limit(int newLimit)
  ...
  + ### mark
    ...
    public final [IntBuffer](IntBuffer.md "class in java.nio") mark()
  ...
  + ### reset
    ...
    public final [IntBuffer](IntBuffer.md "class in java.nio") reset()
  ...
  + ### clear
    ...
    public final [IntBuffer](IntBuffer.md "class in java.nio") clear()
  ...
  + ### flip
    ...
    public final [IntBuffer](IntBuffer.md "class in java.nio") flip()
  ...
  + ### rewind
    ...
    public final [IntBuffer](IntBuffer.md "class in java.nio") rewind()
  ...
  + ### compact
    ...
    public abstract [IntBuffer](IntBuffer.md "class in java.nio") compact()
  ...
  + ### compareTo
    ...
    public int compareTo([IntBuffer](IntBuffer.md "class in java.nio") that)
    ...
    [`Integer.compare(int,int)`](../lang/Integer.md#compare(int,int)).
  ...
  + ### mismatch
    ...
    public int mismatch([IntBuffer](IntBuffer.md "class in java.nio") that)
  ...
  + ### order
    ...
    wrapping an existing `int` array is the [`native order`](ByteOrder.md#nativeOrder()) of the underlying
    hardware. The byte order of an int buffer created as a [view](ByteBuffer.md#views) of a byte buffer is that of the
