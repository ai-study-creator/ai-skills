...
Package [java.nio.charset.spi](package-summary.md)
...
loader`](../../../lang/Thread.md#getContextClassLoader()).
...
* ## Constructor Details
  ...
  + ### CharsetProvider
    ...
    :   `SecurityException` - If a security manager has been installed and it denies
        [`RuntimePermission`](../../../lang/RuntimePermission.md "class in java.lang")`("charsetProvider")`
* ## Method Details

  + ### charsets

    public abstract [Iterator](../../../util/Iterator.md "interface in java.util")<[Charset](../Charset.md "class in java.nio.charset")> charsets()

    Creates an iterator that iterates over the charsets supported by this
    provider. This method is used in the implementation of the [`Charset.availableCharsets`](../Charset.md#availableCharsets())
    method.
  ...
  + ### charsetForName
    ...
    public abstract [Charset](../Charset.md "class in java.nio.charset") charsetForName([String](../../../lang/String.md "class in java.lang") charsetName)
