...
implements [Comparable](../lang/Comparable.md "interface in java.lang")<[CharBuffer](CharBuffer.md "class in java.nio")>, [Appendable](../lang/Appendable.md "interface in java.lang"), [CharSequence](../lang/CharSequence.md "interface in java.lang"), [Readable](../lang/Readable.md "interface in java.lang")
...
* Absolute and relative [`get`](#get()) and
  [`put`](#put(char)) methods that read and write
  single chars;
* Absolute and relative [`bulk get`](#get(char%5B%5D))
  methods that transfer contiguous sequences of chars from this buffer
  into an array;
* Absolute and relative [`bulk put`](#put(char%5B%5D))
...
Char buffers can be created either by [`allocation`](#allocate(int)), which allocates space for the buffer's
content, by [`wrapping`](#wrap(char%5B%5D)) an existing
char array or string into a buffer, or by creating a
[*view*](ByteBuffer.md#views) of an existing byte buffer.

Like a byte buffer, a char buffer is either [*direct* or *non-direct*](ByteBuffer.md#direct). A
...
a char buffer is direct may be determined by invoking the [`isDirect`](#isDirect()) method.

This class implements the [`CharSequence`](../lang/CharSequence.md "interface in java.lang") interface so that
character buffers may be used wherever character sequences are accepted, for
example in the regular-expression package [`java.util.regex`](../util/regex/package-summary.md).
...
on a [read-only](Buffer.md#isReadOnly()) CharBuffer. The
methods [array](#array()) and [arrayOffset](#arrayOffset())
throw an [UnsupportedOperationException](../lang/UnsupportedOperationException.md "class in java.lang") if the CharBuffer is
not backed by an [accessible char array](Buffer.md#hasArray())
...
* ## Method Summary
  ...
  ### Methods inherited from interface java.lang.[CharSequence](../lang/CharSequence.md "interface in java.lang")
...
* ## Method Details
  ...
  + ### allocate
    ...
    public static [CharBuffer](CharBuffer.md "class in java.nio") allocate(int capacity)
  ...
  + ### wrap
    ...
    public static [CharBuffer](CharBuffer.md "class in java.nio") wrap(char[] array,
    int offset,
    int length)
  ...
  + ### read
    ...
    public int read([CharBuffer](CharBuffer.md "class in java.nio") target)
  ...
  + ### wrap
    ...
    public static [CharBuffer](CharBuffer.md "class in java.nio") wrap([CharSequence](../lang/CharSequence.md "interface in java.lang") csq,
    int start,
    int end)
  ...
  + ### slice
    ...
    public abstract [CharBuffer](CharBuffer.md "class in java.nio") slice()
  ...
  + ### slice
    ...
    public abstract [CharBuffer](CharBuffer.md "class in java.nio") slice(int index,
    int length)
  ...
  + ### duplicate
    ...
    public abstract [CharBuffer](CharBuffer.md "class in java.nio") duplicate()
  ...
  + ### asReadOnlyBuffer
    ...
    public abstract [CharBuffer](CharBuffer.md "class in java.nio") asReadOnlyBuffer()
  ...
  + ### put
    ...
    public abstract [CharBuffer](CharBuffer.md "class in java.nio") put(char c)
  ...
  + ### put
    ...
    public abstract [CharBuffer](CharBuffer.md "class in java.nio") put(int index,
    char c)
  ...
  + ### get
    ...
    public [CharBuffer](CharBuffer.md "class in java.nio") get(char[] dst,
    int offset,
    int length)
    ...
    chars are transferred and a [`BufferUnderflowException`](BufferUnderflowException.md "class in java.nio") is
    thrown.
  ...
  + ### get
    ...
    public [CharBuffer](CharBuffer.md "class in java.nio") get(int index,
    char[] dst,
    int offset,
    int length)
    ...
    Parameters:
    :   `index` - The index in this buffer from which the first char will be
        read; must be non-negative and less than `limit()`
    :   `dst` - The destination array
    :   `offset` - The offset within the array of the first char to be
        written; must be non-negative and less than
        `dst.length`
    :   `length` - The number of chars to be written to the given array;
  ...
  + ### put
    ...
    public [CharBuffer](CharBuffer.md "class in java.nio") put([CharBuffer](CharBuffer.md "class in java.nio") src)
    ...
    then no chars are transferred and a [`BufferOverflowException`](BufferOverflowException.md "class in java.nio") is thrown.
  ...
  + ### put
    ...
    public [CharBuffer](CharBuffer.md "class in java.nio") put(int index,
    [CharBuffer](CharBuffer.md "class in java.nio") src,
    int offset,
    int length)
    ...
    Parameters:
    :   `index` - The index in this buffer at which the first char will be
        written; must be non-negative and less than `limit()`
    :   `src` - The buffer from which chars are to be read
    :   `offset` - The index within the source buffer of the first char to be
        read; must be non-negative and less than `src.limit()`
    :   `length` - The number of chars to be read from the given buffer;
        must be non-negative and no larger than the smaller of
  ...
  + ### put
    ...
    public [CharBuffer](CharBuffer.md "class in java.nio") put(char[] src,
    int offset,
    int length)
    ...
    `length` `>` `remaining()`, then no
    chars are transferred and a [`BufferOverflowException`](BufferOverflowException.md "class in java.nio") is
    thrown.
  ...
  + ### put
    ...
    public final [CharBuffer](CharBuffer.md "class in java.nio") put(char[] src)
  ...
  + ### put
    ...
    public [CharBuffer](CharBuffer.md "class in java.nio") put([String](../lang/String.md "class in java.lang") src,
    int start,
    int end)
  ...
  + ### put
    ...
    public final [CharBuffer](CharBuffer.md "class in java.nio") put([String](../lang/String.md "class in java.lang") src)
  ...
  + ### position
    ...
    public final [CharBuffer](CharBuffer.md "class in java.nio") position(int newPosition)
  ...
  + ### limit
    ...
    public final [CharBuffer](CharBuffer.md "class in java.nio") limit(int newLimit)
  ...
  + ### mark
    ...
    public final [CharBuffer](CharBuffer.md "class in java.nio") mark()
  ...
  + ### reset
    ...
    public final [CharBuffer](CharBuffer.md "class in java.nio") reset()
  ...
  + ### clear
    ...
    public final [CharBuffer](CharBuffer.md "class in java.nio") clear()
  ...
  + ### flip
    ...
    public final [CharBuffer](CharBuffer.md "class in java.nio") flip()
  ...
  + ### rewind
    ...
    public final [CharBuffer](CharBuffer.md "class in java.nio") rewind()
  ...
  + ### compact
    ...
    public abstract [CharBuffer](CharBuffer.md "class in java.nio") compact()
  ...
  + ### compareTo
    ...
    public int compareTo([CharBuffer](CharBuffer.md "class in java.nio") that)
    ...
    [`Character.compare(char,char)`](../lang/Character.md#compare(char,char)).
  ...
  + ### mismatch
    ...
    public int mismatch([CharBuffer](CharBuffer.md "class in java.nio") that)
  ...
  + ### isEmpty
    ...
    Returns:
    :   `true` if there are `0` remaining characters,
        otherwise `false`
  ...
  + ### subSequence
    ...
    public abstract [CharBuffer](CharBuffer.md "class in java.nio") subSequence(int start,
    int end)
  ...
  + ### append
    ...
    public [CharBuffer](CharBuffer.md "class in java.nio") append([CharSequence](../lang/CharSequence.md "interface in java.lang") csq)
    ...
    appended. For instance, invoking the [`toString`](#toString()) method of a character buffer will return a subsequence whose
  ...
  + ### append
    ...
    public [CharBuffer](CharBuffer.md "class in java.nio") append(char c)
  ...
  + ### order
    ...
    wrapping an existing `char` array is the [`native order`](ByteOrder.md#nativeOrder()) of the underlying
    hardware. The byte order of a char buffer created as a [view](ByteBuffer.md#views) of a byte buffer is that of the
  ...
  + ### chars
    ...
    [surrogate code point](../lang/Character.md#unicode) is passed
    through uninterpreted.

    The stream binds to this sequence when the terminal stream operation
    commences (specifically, for mutable sequences the spliterator for the
    stream is [*late-binding*](../../../java.base/java/lang/../util/Spliterator.md#binding)).
