...
implements [Comparable](../lang/Comparable.md "interface in java.lang")<[DoubleBuffer](DoubleBuffer.md "class in java.nio")>
...
* Absolute and relative [`get`](#get()) and
  [`put`](#put(double)) methods that read and write
  single doubles;
* Absolute and relative [`bulk get`](#get(double%5B%5D))
  methods that transfer contiguous sequences of doubles from this buffer
  into an array;
* Absolute and relative [`bulk put`](#put(double%5B%5D))
...
Double buffers can be created either by [`allocation`](#allocate(int)), which allocates space for the buffer's
content, by [`wrapping`](#wrap(double%5B%5D)) an existing
double array into a buffer, or by creating a
[*view*](ByteBuffer.md#views) of an existing byte buffer.

Like a byte buffer, a double buffer is either [*direct* or *non-direct*](ByteBuffer.md#direct). A
...
a double buffer is direct may be determined by invoking the [`isDirect`](#isDirect()) method.
...
on a [read-only](Buffer.md#isReadOnly()) DoubleBuffer. The
methods [array](#array()) and [arrayOffset](#arrayOffset())
throw an [UnsupportedOperationException](../lang/UnsupportedOperationException.md "class in java.lang") if the DoubleBuffer is
not backed by an [accessible double array](Buffer.md#hasArray())
...
* ## Method Details
  ...
  + ### allocate
    ...
    public static [DoubleBuffer](DoubleBuffer.md "class in java.nio") allocate(int capacity)
  ...
  + ### wrap
    ...
    public static [DoubleBuffer](DoubleBuffer.md "class in java.nio") wrap(double[] array,
    int offset,
    int length)
  ...
  + ### slice
    ...
    public abstract [DoubleBuffer](DoubleBuffer.md "class in java.nio") slice()
  ...
  + ### slice
    ...
    public abstract [DoubleBuffer](DoubleBuffer.md "class in java.nio") slice(int index,
    int length)
  ...
  + ### duplicate
    ...
    public abstract [DoubleBuffer](DoubleBuffer.md "class in java.nio") duplicate()
  ...
  + ### asReadOnlyBuffer
    ...
    public abstract [DoubleBuffer](DoubleBuffer.md "class in java.nio") asReadOnlyBuffer()
  ...
  + ### put
    ...
    public abstract [DoubleBuffer](DoubleBuffer.md "class in java.nio") put(double d)
  ...
  + ### put
    ...
    public abstract [DoubleBuffer](DoubleBuffer.md "class in java.nio") put(int index,
    double d)
  ...
  + ### get
    ...
    public [DoubleBuffer](DoubleBuffer.md "class in java.nio") get(double[] dst,
    int offset,
    int length)
    ...
    doubles are transferred and a [`BufferUnderflowException`](BufferUnderflowException.md "class in java.nio") is
    thrown.
  ...
  + ### get
    ...
    public [DoubleBuffer](DoubleBuffer.md "class in java.nio") get(int index,
    double[] dst,
    int offset,
    int length)
    ...
    Parameters:
    :   `index` - The index in this buffer from which the first double will be
        read; must be non-negative and less than `limit()`
    :   `dst` - The destination array
    :   `offset` - The offset within the array of the first double to be
        written; must be non-negative and less than
        `dst.length`
    :   `length` - The number of doubles to be written to the given array;
  ...
  + ### put
    ...
    public [DoubleBuffer](DoubleBuffer.md "class in java.nio") put([DoubleBuffer](DoubleBuffer.md "class in java.nio") src)
    ...
    then no doubles are transferred and a [`BufferOverflowException`](BufferOverflowException.md "class in java.nio") is thrown.
  ...
  + ### put
    ...
    public [DoubleBuffer](DoubleBuffer.md "class in java.nio") put(int index,
    [DoubleBuffer](DoubleBuffer.md "class in java.nio") src,
    int offset,
    int length)
    ...
    Parameters:
    :   `index` - The index in this buffer at which the first double will be
        written; must be non-negative and less than `limit()`
    :   `src` - The buffer from which doubles are to be read
    :   `offset` - The index within the source buffer of the first double to be
        read; must be non-negative and less than `src.limit()`
    :   `length` - The number of doubles to be read from the given buffer;
        must be non-negative and no larger than the smaller of
  ...
  + ### put
    ...
    public [DoubleBuffer](DoubleBuffer.md "class in java.nio") put(double[] src,
    int offset,
    int length)
    ...
    `length` `>` `remaining()`, then no
    doubles are transferred and a [`BufferOverflowException`](BufferOverflowException.md "class in java.nio") is
    thrown.
  ...
  + ### put
    ...
    public final [DoubleBuffer](DoubleBuffer.md "class in java.nio") put(double[] src)
  ...
  + ### position
    ...
    public final [DoubleBuffer](DoubleBuffer.md "class in java.nio") position(int newPosition)
  ...
  + ### limit
    ...
    public final [DoubleBuffer](DoubleBuffer.md "class in java.nio") limit(int newLimit)
  ...
  + ### mark
    ...
    public final [DoubleBuffer](DoubleBuffer.md "class in java.nio") mark()
  ...
  + ### reset
    ...
    public final [DoubleBuffer](DoubleBuffer.md "class in java.nio") reset()
  ...
  + ### clear
    ...
    public final [DoubleBuffer](DoubleBuffer.md "class in java.nio") clear()
  ...
  + ### flip
    ...
    public final [DoubleBuffer](DoubleBuffer.md "class in java.nio") flip()
  ...
  + ### rewind
    ...
    public final [DoubleBuffer](DoubleBuffer.md "class in java.nio") rewind()
  ...
  + ### compact
    ...
    public abstract [DoubleBuffer](DoubleBuffer.md "class in java.nio") compact()
  ...
  + ### equals
    ...
    3. The two sequences of remaining elements, considered
       ...
       equal, unlike [`Double.equals(Object)`](../lang/Double.md#equals(java.lang.Object)).
  ...
  + ### compareTo
    ...
    public int compareTo([DoubleBuffer](DoubleBuffer.md "class in java.nio") that)
    ...
    [`Double.compare(double,double)`](../lang/Double.md#compare(double,double)), except that
  ...
  + ### mismatch
    ...
    public int mismatch([DoubleBuffer](DoubleBuffer.md "class in java.nio") that)
  ...
  + ### order
    ...
    wrapping an existing `double` array is the [`native order`](ByteOrder.md#nativeOrder()) of the underlying
    hardware. The byte order of a double buffer created as a [view](ByteBuffer.md#views) of a byte buffer is that of the
