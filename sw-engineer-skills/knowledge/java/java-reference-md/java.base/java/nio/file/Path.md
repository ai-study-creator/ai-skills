...
extends [Comparable](../../lang/Comparable.md "interface in java.lang")<[Path](Path.md "interface in java.nio.file")>, [Iterable](../../lang/Iterable.md "interface in java.lang")<[Path](Path.md "interface in java.nio.file")>, [Watchable](Watchable.md "interface in java.nio.file")
...
file system. `Path` defines the [`getFileName`](#getFileName()),
[`getParent`](#getParent()), [`getRoot`](#getRoot()), and [`subpath`](#subpath(int,int)) methods to access the path components or a subsequence of its name
elements.

In addition to accessing the components of a path, a `Path` also
defines the [`resolve`](#resolve(java.nio.file.Path)) and [`resolveSibling`](#resolveSibling(java.nio.file.Path)) methods to combine paths. The [`relativize`](#relativize(java.nio.file.Path))
method that can be used to construct a relative path between two paths.
Paths can be [`compared`](#compareTo(java.nio.file.Path)), and tested against each other using
the [`startsWith`](#startsWith(java.nio.file.Path)) and [`endsWith`](#endsWith(java.nio.file.Path)) methods.

This interface extends [`Watchable`](Watchable.md "interface in java.nio.file") interface so that a directory
located by a path can be [`registered`](#register(java.nio.file.WatchService,java.nio.file.WatchEvent.Kind%5B%5D,java.nio.file.WatchEvent.Modifier...)) with a [`WatchService`](WatchService.md "interface in java.nio.file") and entries in the directory watched.
...
Paths may be used with the [`Files`](Files.md "class in java.nio.file") class to operate on files,
directories, and other types of files. For example, suppose we want a [`BufferedReader`](../../io/BufferedReader.md "class in java.io") to read text from a file "`access.log`". The
...
Paths associated with the default [`provider`](spi/FileSystemProvider.md "class in java.nio.file.spi") are generally interoperable
with the [`java.io.File`](../../io/File.md "class in java.io") class. Paths created by other
providers are unlikely to be interoperable with the abstract path names
represented by `java.io.File`. The [`toPath`](../../io/File.md#toPath())
...
addition, the [`toFile`](#toFile()) method is useful to construct a `File` from the `String` representation of a `Path`.
...
* ## Method Summary
  ...
  the given path string, in exactly the manner specified by the [`endsWith(Path)`](#endsWith(java.nio.file.Path)) method.
  ...
  this `Path` in exactly the manner specified by the [`resolve`](#resolve(java.nio.file.Path)) method.
  ...
  Converts a given path string to a `Path` and resolves it against
  this path's [`parent`](#getParent()) path in exactly the manner
  specified by the [`resolveSibling`](#resolveSibling(java.nio.file.Path)) method.

  `default Path`

  `resolveSibling(Path other)`

  Resolves the given path against this path's [`parent`](#getParent())
  path.
  ...
  the given path string, in exactly the manner specified by the [`startsWith(Path)`](#startsWith(java.nio.file.Path)) method.
  ...
  Returns a [`File`](../../io/File.md "class in java.io") object representing this path.
...
* ## Method Details
  ...
  + ### of
    ...
    static [Path](Path.md "interface in java.nio.file") of([String](../../lang/String.md "class in java.lang") first,
    ...
    [`name-separator`](FileSystem.md#getSeparator()) as the separator.
    ...
    The `Path` is obtained by invoking the [`getPath`](FileSystem.md#getPath(java.lang.String,java.lang.String...)) method of the [`default`](FileSystems.md#getDefault()) [`FileSystem`](FileSystem.md "class in java.nio.file").
  ...
  + ### of
    ...
    static [Path](Path.md "interface in java.nio.file") of([URI](../../net/URI.md "class in java.net") uri)

    Returns a `Path` by converting a URI.

    This method iterates over the [`installed`](spi/FileSystemProvider.md#installedProviders()) providers to locate the provider that is identified by the
    URI [`scheme`](../../net/URI.md#getScheme()) of the given URI. URI schemes are
    compared without regard to case. If the provider is found then its [`getPath`](spi/FileSystemProvider.md#getPath(java.net.URI)) method is invoked to convert the
    URI.
    ...
    [`default`](FileSystems.md#getDefault()) file system.

    The default provider provides a similar *round-trip* guarantee
    to the [`File`](../../io/File.md "class in java.io") class. For a given `Path` *p* it
    is guaranteed that
    > `Path.of(`*p*`.`[`toUri`](#toUri())`()).equals(`
  ...
  + ### getFileSystem
    ...
    [FileSystem](FileSystem.md "class in java.nio.file") getFileSystem()
  ...
  + ### getRoot
    ...
    [Path](Path.md "interface in java.nio.file") getRoot()
  ...
  + ### getFileName
    ...
    [Path](Path.md "interface in java.nio.file") getFileName()
  ...
  + ### getParent
    ...
    [Path](Path.md "interface in java.nio.file") getParent()
  ...
  + ### getName
    ...
    [Path](Path.md "interface in java.nio.file") getName(int index)
  ...
  + ### subpath
    ...
    [Path](Path.md "interface in java.nio.file") subpath(int beginIndex,
    int endIndex)
  ...
  + ### startsWith
    ...
    boolean startsWith([Path](Path.md "interface in java.nio.file") other)
  ...
  + ### startsWith
    ...
    default boolean startsWith([String](../../lang/String.md "class in java.lang") other)

    Tests if this path starts with a `Path`, constructed by converting
    the given path string, in exactly the manner specified by the [`startsWith(Path)`](#startsWith(java.nio.file.Path)) method. On UNIX for example, the path
  ...
  + ### endsWith
    ...
    boolean endsWith([Path](Path.md "interface in java.nio.file") other)
  ...
  + ### endsWith
    ...
    default boolean endsWith([String](../../lang/String.md "class in java.lang") other)

    Tests if this path ends with a `Path`, constructed by converting
    the given path string, in exactly the manner specified by the [`endsWith(Path)`](#endsWith(java.nio.file.Path)) method. On UNIX for example, the path
  ...
  + ### normalize
    ...
    [Path](Path.md "interface in java.nio.file") normalize()
    ...
    *redundant* name elements. In many file systems, the "`.`"
    ...
    See Also:
    :   - [`getParent()`](#getParent())
        - [`toRealPath(java.nio.file.LinkOption...)`](#toRealPath(java.nio.file.LinkOption...))
  + ### resolve

    [Path](Path.md "interface in java.nio.file") resolve([Path](Path.md "interface in java.nio.file") other)
    ...
    *joins* the given path to this path and returns a resulting path
    that [`ends`](#endsWith(java.nio.file.Path)) with the given path. Where the given path has
    ...
    See Also:
    :   - [`relativize(java.nio.file.Path)`](#relativize(java.nio.file.Path))
  + ### resolve

    default [Path](Path.md "interface in java.nio.file") resolve([String](../../lang/String.md "class in java.lang") other)

    Converts a given path string to a `Path` and resolves it against
    this `Path` in exactly the manner specified by the [`resolve`](#resolve(java.nio.file.Path)) method. For example, suppose that the name
  ...
  + ### resolveSibling
    ...
    default [Path](Path.md "interface in java.nio.file") resolveSibling([Path](Path.md "interface in java.nio.file") other)
    ...
    or `other` is [`absolute`](#isAbsolute()), then this method
  ...
  + ### resolveSibling
    ...
    default [Path](Path.md "interface in java.nio.file") resolveSibling([String](../../lang/String.md "class in java.lang") other)
  ...
  + ### relativize
    ...
    [Path](Path.md "interface in java.nio.file") relativize([Path](Path.md "interface in java.nio.file") other)

    Constructs a relative path between this path and a given path.

    Relativization is the inverse of [`resolution`](#resolve(java.nio.file.Path)).
    This method attempts to construct a [`relative`](#isAbsolute()) path
    that when [`resolved`](#resolve(java.nio.file.Path)) against this path, yields a
    ...
    [`equal`](#equals(java.lang.Object)) then an *empty path* is returned.
    ...
    *q*, where *q* does not have a root component,
    ...
    the [`same`](Files.md#isSameFile(java.nio.file.Path,java.nio.file.Path)) file as `other` is implementation
  ...
  + ### toUri
    ...
    [URI](../../net/URI.md "class in java.net") toUri()

    Returns a URI to represent this path.

    This method constructs an absolute [`URI`](../../net/URI.md "class in java.net") with a [`scheme`](../../net/URI.md#getScheme()) equal to the URI scheme that identifies the
    provider. The exact form of the scheme specific part is highly provider
    dependent.

    In the case of the default provider, the URI is hierarchical with
    a [`path`](../../net/URI.md#getPath()) component that is absolute. The query and
    fragment components are undefined. Whether the authority component is
    defined or not is implementation dependent. There is no guarantee that
    the `URI` may be used to construct a [`java.io.File`](../../io/File.md "class in java.io").
    ...
    to the [`File`](../../io/File.md "class in java.io") class. For a given `Path` *p* it
    is guaranteed that
    > [`Path.of`](#of(java.net.URI))`(`*p*`.toUri()).equals(`*p*
    ...
    *compound* URI that encodes the URI of the enclosing file system.
    ...
    Throws:
    :   `IOError` - if an I/O error occurs obtaining the absolute path, or where a
  ...
  + ### toAbsolutePath
    ...
    [Path](Path.md "interface in java.nio.file") toAbsolutePath()

    Returns a `Path` object representing the absolute path of this
    path.

    If this path is already [`absolute`](#isAbsolute()) then this
    ...
    :   `SecurityException` - In the case of the default provider, a security manager
        ...
        manager's [`checkPropertyAccess`](../../lang/SecurityManager.md#checkPropertyAccess(java.lang.String)) method is invoked to check access to the
        system property `user.dir`
  + ### toRealPath

    [Path](Path.md "interface in java.nio.file") toRealPath([LinkOption](LinkOption.md "enum class in java.nio.file")... options)
    ...
    path that locates the [`same`](Files.md#isSameFile(java.nio.file.Path,java.nio.file.Path)) file as this path, but
    ...
    target. If the option [`NOFOLLOW_LINKS`](LinkOption.md#NOFOLLOW_LINKS) is
    ...
    :   `SecurityException` - In the case of the default provider, and a security manager
        is installed, its [`checkRead`](../../lang/SecurityManager.md#checkRead(java.lang.String))
        method is invoked to check read access to the file, and where
        this path is not absolute, its [`checkPropertyAccess`](../../lang/SecurityManager.md#checkPropertyAccess(java.lang.String)) method is invoked to check access to the
        system property `user.dir`
  + ### toFile

    default [File](../../io/File.md "class in java.io") toFile()

    Returns a [`File`](../../io/File.md "class in java.io") object representing this path. Where this `Path` is associated with the default provider, then this method is
    equivalent to returning a `File` object constructed with the
    `String` representation of this path.

    If this path was created by invoking the `File` [`toPath`](../../io/File.md#toPath()) method then there is no guarantee that the `File` object returned by this method is [`equal`](#equals(java.lang.Object)) to the
    original `File`.
  ...
  + ### register
    ...
    - [`ENTRY_CREATE`](StandardWatchEventKinds.md#ENTRY_CREATE) -
      entry created or moved into the directory
    - [`ENTRY_DELETE`](StandardWatchEventKinds.md#ENTRY_DELETE) -
      entry deleted or moved out of the directory
    - [`ENTRY_MODIFY`](StandardWatchEventKinds.md#ENTRY_MODIFY) -
      entry in directory was modified

    The [`context`](WatchEvent.md#context()) for these events is the
    relative path between the directory located by this path, and the path
    that locates the directory entry that is created, deleted, or modified.

    The set of events may include additional implementation specific
    event that are not defined by the enum [`StandardWatchEventKinds`](StandardWatchEventKinds.md "class in java.nio.file")
  ...
  + ### register
    ...
    default [WatchKey](WatchKey.md "interface in java.nio.file") register([WatchService](WatchService.md "interface in java.nio.file") watcher,
    [WatchEvent.Kind](WatchEvent.Kind.md "interface in java.nio.file")<?>... events)
    throws [IOException](../../io/IOException.md "class in java.io")
  ...
  + ### iterator
    ...
    default [Iterator](../../util/Iterator.md "interface in java.util")<[Path](Path.md "interface in java.nio.file")> iterator()
    ...
    is the name of the file or directory denoted by this path. The [`root`](#getRoot()) component, if present, is not returned by the iterator.
  ...
  + ### compareTo
    ...
    int compareTo([Path](Path.md "interface in java.nio.file") other)
    ...
    Returns:
    :   zero if the argument is [`equal`](#equals(java.lang.Object)) to this path, a
  ...
  + ### equals
    ...
    boolean equals([Object](../../lang/Object.md "class in java.lang") other)
    ...
    [`isSameFile`](Files.md#isSameFile(java.nio.file.Path,java.nio.file.Path)) method may be used to check if two
  ...
  + ### hashCode
    ...
    satisfies the general contract of the [`Object.hashCode`](../../lang/Object.md#hashCode()) method.
  ...
  + ### toString
    ...
    [`getPath`](FileSystem.md#getPath(java.lang.String,java.lang.String...)) method then the path string returned
    by this method may differ from the original String used to create the path.

    The returned path string uses the default name [`separator`](FileSystem.md#getSeparator()) to separate names in the path.
