...
extends [Closeable](../../io/Closeable.md "interface in java.io"), [Iterable](../../lang/Iterable.md "interface in java.lang")<T>
...
its [`hasNext`](../../util/Iterator.md#hasNext()) method is guaranteed to read-ahead by
...
because the stream has been [`closed`](../../io/Closeable.md#close()). The `Iterator` does
not support the [`remove`](../../util/Iterator.md#remove()) operation.
...
throw [`DirectoryIteratorException`](DirectoryIteratorException.md "class in java.nio.file") with the [`IOException`](../../io/IOException.md "class in java.io") as the
...
See Also:
:   * [`Files.newDirectoryStream(Path)`](Files.md#newDirectoryStream(java.nio.file.Path))
...
* ## Method Details
  ...
  + ### iterator
    ...
    [Iterator](../../util/Iterator.md "interface in java.util")<[T](DirectoryStream.md "type parameter in DirectoryStream")> iterator()
