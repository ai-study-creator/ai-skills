...
instances are intended to receive formatted output from a [`Formatter`](../util/Formatter.md "class in java.util").

The characters to be appended should be valid Unicode characters as
described in [Unicode Character
Representation](Character.md#unicode). Note that supplementary characters may be composed of
...
* ## Method Details
  ...
  + ### append
    ...
    [Appendable](Appendable.md "interface in java.lang") append([CharSequence](CharSequence.md "interface in java.lang") csq)
  ...
  + ### append
    ...
    [Appendable](Appendable.md "interface in java.lang") append(char c)
    throws [IOException](../io/IOException.md "class in java.io")
