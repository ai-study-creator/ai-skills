...
[conversion](#asType(java.lang.invoke.MethodType)),
[insertion](#bindTo(java.lang.Object)),
[deletion](MethodHandles.md#dropArguments(java.lang.invoke.MethodHandle,int,java.util.List)),
and [substitution](MethodHandles.md#filterArguments(java.lang.invoke.MethodHandle,int,java.lang.invoke.MethodHandle...)).
...
the method handle's own [type descriptor](#type()).

Every method handle reports its type descriptor via the [`type`](#type()) accessor.
This type descriptor is a [`MethodType`](MethodType.md "class in java.lang.invoke") object,
...
called [`invokeExact`](#invokeExact(java.lang.Object...)) and [`invoke`](#invoke(java.lang.Object...)).
...
which may be visible via the [`Object.getClass`](../Object.md#getClass())
...
must be a valid argument to the receiver's [`asType`](#asType(java.lang.invoke.MethodType)) method.
...
as if by a call to [`asType`](#asType(java.lang.invoke.MethodType)),
...
But if a match fails, the JVM will throw a [`WrongMethodTypeException`](WrongMethodTypeException.md "class in java.lang.invoke"),
...
[when the method handle is created](MethodHandles.Lookup.md#access).
...
[`MethodHandles.Lookup`](MethodHandles.Lookup.md "class in java.lang.invoke").
For example, a static method handle can be obtained
from [`Lookup.findStatic`](MethodHandles.Lookup.md#findStatic(java.lang.Class,java.lang.String,java.lang.invoke.MethodType)).
There are also conversion methods from Core Reflection API objects,
such as [`Lookup.unreflect`](MethodHandles.Lookup.md#unreflect(java.lang.reflect.Method)).
...
constant pool entry.
(For full details on method handle constants, see sections and of the Java Virtual Machine
Specification.)

Method handles produced by lookups or constant loads from methods or
constructors with the variable arity modifier bit (`0x0080`)
have a corresponding variable arity, as if they were defined with
the help of [`asVarargsCollector`](#asVarargsCollector(java.lang.Class))
or [`withVarargs`](#withVarargs(boolean)).
...
be a method which calls [`Objects.equals`](../../util/Objects.md#equals(java.lang.Object,java.lang.Object))
on its arguments, and asserts that the result is true.

## Exceptions

The methods `invokeExact` and `invoke` are declared
to throw [`Throwable`](../Throwable.md "class in java.lang"),
...
Using factory methods in the [`Lookup`](MethodHandles.Lookup.md "class in java.lang.invoke") API,
any class member represented by a Core Reflection API object
can be converted to a behaviorally equivalent method handle.
For example, a reflective [`Method`](../reflect/Method.md "class in java.lang.reflect") can
...
invoked via [`java.lang.reflect.Method.invoke`](../reflect/Method.md#invoke(java.lang.Object,java.lang.Object...)).
...
use [`MethodHandles.exactInvoker`](MethodHandles.md#exactInvoker(java.lang.invoke.MethodType)),
or [`MethodHandles.invoker`](MethodHandles.md#invoker(java.lang.invoke.MethodType)).
The [`Lookup.findVirtual`](MethodHandles.Lookup.md#findVirtual(java.lang.Class,java.lang.String,java.lang.invoke.MethodType))
...
* Method types range over all possible arities,
  from no arguments to up to the [maximum number](MethodHandle.md#maxarity) of allowed arguments.
...
Attempts to create method handles with impossible method types lead to an [`IllegalArgumentException`](../IllegalArgumentException.md "class in java.lang").
...
* ## Method Summary
  ...
  to the method handle, as if via an inexact [`invoke`](#invoke(java.lang.Object...)) from a call site
  ...
  supports [variable arity](#asVarargsCollector(java.lang.Class)) calls.
  ...
  Adapts this method handle to be [variable arity](#asVarargsCollector(java.lang.Class))
  if the boolean flag is true, else [fixed arity](#asFixedArity()).
...
* ## Method Details
  ...
  + ### invokeExact
    ...
    public final [Object](../Object.md "class in java.lang") invokeExact([Object](../Object.md "class in java.lang")... args)
    ...
    [`java.lang.reflect.Method.invoke`](../reflect/Method.md#invoke(java.lang.Object,java.lang.Object...)), via JNI,
    or indirectly via [`Lookup.unreflect`](MethodHandles.Lookup.md#unreflect(java.lang.reflect.Method)),
  ...
  + ### invoke
    ...
    public final [Object](../Object.md "class in java.lang") invoke([Object](../Object.md "class in java.lang")... args)
    throws [Throwable](../Throwable.md "class in java.lang")
    ...
    the call proceeds as if by [`invokeExact`](#invokeExact(java.lang.Object...)).

    Otherwise, the call proceeds as if this method handle were first
    adjusted by calling [`asType`](#asType(java.lang.invoke.MethodType)) to adjust this method handle
    to the required type, and then the call proceeds as if by
    [`invokeExact`](#invokeExact(java.lang.Object...)) on the adjusted method handle.
    ...
    if the callee is not a [variable arity collector](#asVarargsCollector(java.lang.Class)).
  ...
  + ### invokeWithArguments
    ...
    public [Object](../Object.md "class in java.lang") invokeWithArguments([Object](../Object.md "class in java.lang")... arguments)
    throws [Throwable](../Throwable.md "class in java.lang")
    ...
    - If `N` is greater than `M`, perform the following
      ...
      * Check that this method handle has variable arity with a
        [trailing parameter](MethodType.md#lastParameterType())
      ...
      * Adjust the type `TN` by changing the `N`th
        parameter type from `Object` to `A[]`.- Force the original target method handle `MH0` to the
    ...
    Unlike the [`generic`](#invoke(java.lang.Object...)) invocation mode, which can
    ...
    of the [rules for variable-arity invocation](#asVarargsCollector(java.lang.Class)).

    Because of the action of the `asType` step, the following argument
    conversions are applied as necessary:
    - reference casting- unboxing- widening primitive conversions- variable arity conversion
    ...
    See Also:
    :   - [`MethodHandles.spreadInvoker(java.lang.invoke.MethodType, int)`](MethodHandles.md#spreadInvoker(java.lang.invoke.MethodType,int))
  + ### invokeWithArguments

    public [Object](../Object.md "class in java.lang") invokeWithArguments([List](../../util/List.md "interface in java.util")<?> arguments)
    throws [Throwable](../Throwable.md "class in java.lang")
    ...
    See [`invokeWithArguments(Object[])`](#invokeWithArguments(java.lang.Object...)) for details.
  ...
  + ### asType
    ...
    public final [MethodHandle](MethodHandle.md "class in java.lang.invoke") asType([MethodType](MethodType.md "class in java.lang.invoke") newType)
    ...
    - Convert the incoming argument list to match the original
      method handle's argument list.- Invoke the original method handle on the converted argument list.- Convert any result returned by the original method handle
          to the return type of new method handle.

    This method provides the crucial behavioral difference between
    [`invokeExact`](#invokeExact(java.lang.Object...)) and plain, inexact [`invoke`](#invoke(java.lang.Object...)).
    The two methods
    perform the same steps when the caller's type descriptor exactly matches
    the callee's, but when the types differ, plain [`invoke`](#invoke(java.lang.Object...))
    ...
    [described elsewhere](#asVarargsCollector(java.lang.Class)).
    ...
    *T0*`=this.type().returnType()` and *T1*`=newType.returnType()`.
    ...
    - If *T0* and *T1* are references, then a cast to *T1* is applied.
      ...
      This is because a dynamic value of null can convert to any reference type.)- If *T0* and *T1* are primitives, then a Java method invocation
        conversion (JLS ) is applied, if one exists.
        (Specifically, *T0* must convert to *T1* by a widening primitive conversion.)- If *T0* is a primitive and *T1* a reference,
          a Java casting conversion (JLS ) is applied if one exists.
          (Specifically, the value is boxed from *T0* to its wrapper class,
          which is then widened as needed to *T1*.)- If *T0* is a reference and *T1* a primitive, an unboxing
            conversion will be applied at runtime, possibly followed
            by a Java method invocation conversion (JLS )
            on the primitive value. (These are the primitive widening conversions.)
            *T0* must be a wrapper class or a supertype of one.
            (In the case where *T0* is Object, these are the conversions
            allowed by [`java.lang.reflect.Method.invoke`](../reflect/Method.md#invoke(java.lang.Object,java.lang.Object...)).)
            ...
            primitive value can be widened to *T1*.- If the return type *T1* is marked as void, any returned value is discarded- If the return type *T0* is void and *T1* a reference, a null value is introduced.- If the return type *T0* is void and *T1* a primitive,
                  a zero value is introduced.(*Note:* Both *T0* and *T1* may be regarded as static types,
    ...
    causing a [`NullPointerException`](../NullPointerException.md "class in java.lang").
    An unboxing operation or a reference cast may also fail on a reference
    to an object of the wrong type,
    causing a [`ClassCastException`](../ClassCastException.md "class in java.lang").
    ...
    See Also:
    :   - [`MethodHandles.explicitCastArguments(java.lang.invoke.MethodHandle, java.lang.invoke.MethodType)`](MethodHandles.md#explicitCastArguments(java.lang.invoke.MethodHandle,java.lang.invoke.MethodType))
  + ### asSpreader

    public [MethodHandle](MethodHandle.md "class in java.lang.invoke") asSpreader([Class](../Class.md "class in java.lang")<?> arrayType,
    int arrayLength)
    ...
    if the array is `null` and throw an [`IllegalArgumentException`](../IllegalArgumentException.md "class in java.lang")
    ...
    See Also:
    :   - [`asCollector(java.lang.Class<?>, int)`](#asCollector(java.lang.Class,int))
  + ### asSpreader

    public [MethodHandle](MethodHandle.md "class in java.lang.invoke") asSpreader(int spreadArgPos,
    [Class](../Class.md "class in java.lang")<?> arrayType,
    int arrayLength)
    ...
    This method behaves very much like [`asSpreader(Class, int)`](#asSpreader(java.lang.Class,int)), but accepts an additional `spreadArgPos`
    ...
    See Also:
    :   - [`asSpreader(Class, int)`](#asSpreader(java.lang.Class,int))
  + ### withVarargs

    public [MethodHandle](MethodHandle.md "class in java.lang.invoke") withVarargs(boolean makeVarargs)
    ...
    See Also:
    :   - [`asVarargsCollector(java.lang.Class<?>)`](#asVarargsCollector(java.lang.Class))
        - [`asFixedArity()`](#asFixedArity())
  + ### asCollector

    public [MethodHandle](MethodHandle.md "class in java.lang.invoke") asCollector([Class](../Class.md "class in java.lang")<?> arrayType,
    int arrayLength)
    ...
    [last parameter type](MethodType.md#lastParameterType())
    ...
    number of collected arguments, use [`asVarargsCollector`](#asVarargsCollector(java.lang.Class))
    or [`withVarargs`](#withVarargs(boolean)) instead.
    ...
    *Note:* The resulting adapter is never a [variable-arity method handle](#asVarargsCollector(java.lang.Class)), even if the original target method handle was.
    ...
    See Also:
    :   - [`asSpreader(java.lang.Class<?>, int)`](#asSpreader(java.lang.Class,int))
        - [`asVarargsCollector(java.lang.Class<?>)`](#asVarargsCollector(java.lang.Class))
  + ### asCollector

    public [MethodHandle](MethodHandle.md "class in java.lang.invoke") asCollector(int collectArgPos,
    [Class](../Class.md "class in java.lang")<?> arrayType,
    int arrayLength)
    ...
    *target*, the current method handle. The type of the adapter will be the same as the type of the target,
    ...
    This method behaves very much like [`asCollector(Class, int)`](#asCollector(java.lang.Class,int)), but differs in that its `collectArgPos` argument indicates at which position in the parameter list arguments should be collected. This
    index is zero-based.
    ...
    See Also:
    :   - [`asCollector(Class, int)`](#asCollector(java.lang.Class,int))
  + ### asVarargsCollector

    public [MethodHandle](MethodHandle.md "class in java.lang.invoke") asVarargsCollector([Class](../Class.md "class in java.lang")<?> arrayType)
    ...
    When called with [`invokeExact`](#invokeExact(java.lang.Object...)), the adapter invokes
    the target with no argument changes.
    (*Note:* This behavior is different from a
    [fixed arity collector](#asCollector(java.lang.Class,int)),
    since it accepts a whole array of indeterminate length,
    rather than a fixed number of arguments.)

    When called with plain, inexact [`invoke`](#invoke(java.lang.Object...)), if the caller
    ...
    as if by [`asType`](#asType(java.lang.invoke.MethodType)) on a fixed arity
    method handle.
    ...
    temporarily adapted with a [fixed arity collector](#asCollector(java.lang.Class,int))
    ...
    The behavior of [`asType`](#asType(java.lang.invoke.MethodType)) is also specialized for
    ...
    use [`asCollector`](#asCollector(java.lang.Class,int)) instead.
    ...
    *Discussion:*
    ...
    See Also:
    :   - [`asCollector(java.lang.Class<?>, int)`](#asCollector(java.lang.Class,int))
        - [`isVarargsCollector()`](#isVarargsCollector())
        - [`withVarargs(boolean)`](#withVarargs(boolean))
        - [`asFixedArity()`](#asFixedArity())
  + ### isVarargsCollector
    ...
    - a call to [asVarargsCollector](#asVarargsCollector(java.lang.Class))- a call to a [lookup method](MethodHandles.Lookup.md "class in java.lang.invoke")
        which resolves to a variable arity Java method or constructor- an `ldc` instruction of a `CONSTANT_MethodHandle`
  ...
  + ### asFixedArity
    ...
    public [MethodHandle](MethodHandle.md "class in java.lang.invoke") asFixedArity()

    Makes a *fixed arity* method handle which is otherwise
    equivalent to the current method handle.

    If the current method handle is not of
    [variable arity](#asVarargsCollector(java.lang.Class)),
  ...
  + ### bindTo
    ...
    public [MethodHandle](MethodHandle.md "class in java.lang.invoke") bindTo([Object](../Object.md "class in java.lang") x)
    ...
    *Note:* The resulting adapter is never a [variable-arity method handle](#asVarargsCollector(java.lang.Class)), even if the original target method handle was.
    ...
    See Also:
    :   - [`MethodHandles.insertArguments(java.lang.invoke.MethodHandle, int, java.lang.Object...)`](MethodHandles.md#insertArguments(java.lang.invoke.MethodHandle,int,java.lang.Object...))
  + ### describeConstable

    public [Optional](../../util/Optional.md "class in java.util")<[MethodHandleDesc](../constant/MethodHandleDesc.md "interface in java.lang.constant")> describeConstable()
