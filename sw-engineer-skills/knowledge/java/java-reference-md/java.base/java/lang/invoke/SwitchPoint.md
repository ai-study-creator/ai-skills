...
*Implementation Note:*
A switch point behaves as if implemented on top of [`MutableCallSite`](MutableCallSite.md "class in java.lang.invoke"),
...
* ## Method Details
  ...
  + ### hasBeenInvalidated
    ...
    *Discussion:*
    ...
    [`constant`](MethodHandles.md#constant(java.lang.Class,java.lang.Object)) true and false method handles.

    Returns:
    :   true if this switch point has been invalidated
  + ### guardWithTest

    public [MethodHandle](MethodHandle.md "class in java.lang.invoke") guardWithTest([MethodHandle](MethodHandle.md "class in java.lang.invoke") target,
    ...
    See Also:
    :   - [`MethodHandles.guardWithTest(java.lang.invoke.MethodHandle, java.lang.invoke.MethodHandle, java.lang.invoke.MethodHandle)`](MethodHandles.md#guardWithTest(java.lang.invoke.MethodHandle,java.lang.invoke.MethodHandle,java.lang.invoke.MethodHandle))
  + ### invalidateAll

    public static void invalidateAll([SwitchPoint](SwitchPoint.md "class in java.lang.invoke")[] switchPoints)
    ...
    *Implementation Note:*
    ...
    a private [`MutableCallSite`](MutableCallSite.md "class in java.lang.invoke") to publish the state of a switch point.
    In such an implementation, the `invalidateAll` method can
    simply change the call site's target, and issue one call to
    [synchronize](MutableCallSite.md#syncAll(java.lang.invoke.MutableCallSite%5B%5D)) all the
    private call sites.
