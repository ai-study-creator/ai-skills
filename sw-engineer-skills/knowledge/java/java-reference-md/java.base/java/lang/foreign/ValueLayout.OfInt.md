...
public static sealed interface ValueLayout.OfInt
...
`OfInt` is a preview API of the Java platform.

Programs can only use `OfInt` when preview features are enabled.
...
:   * [`ValueLayout.JAVA_INT`](ValueLayout.md#JAVA_INT)[PREVIEW](ValueLayout.md#preview-java.lang.foreign.ValueLayout)
    * [`ValueLayout.JAVA_INT_UNALIGNED`](ValueLayout.md#JAVA_INT_UNALIGNED)[PREVIEW](ValueLayout.md#preview-java.lang.foreign.ValueLayout)
...
* ## Method Details
  ...
  + ### withName
    ...
    [ValueLayout.OfInt](ValueLayout.OfInt.md "interface in java.lang.foreign")[PREVIEW](#preview-java.lang.foreign.ValueLayout.OfInt) withName([String](../String.md "class in java.lang") name)
  ...
  + ### withoutName
    ...
    [ValueLayout.OfInt](ValueLayout.OfInt.md "interface in java.lang.foreign")[PREVIEW](#preview-java.lang.foreign.ValueLayout.OfInt) withoutName()
  ...
  + ### withByteAlignment
    ...
    [ValueLayout.OfInt](ValueLayout.OfInt.md "interface in java.lang.foreign")[PREVIEW](#preview-java.lang.foreign.ValueLayout.OfInt) withByteAlignment(long byteAlignment)
  ...
  + ### withOrder
    ...
    [ValueLayout.OfInt](ValueLayout.OfInt.md "interface in java.lang.foreign")[PREVIEW](#preview-java.lang.foreign.ValueLayout.OfInt) withOrder([ByteOrder](../../nio/ByteOrder.md "class in java.nio") order)
