...
A layer is created from a graph of modules in a [`Configuration`](module/Configuration.md "class in java.lang.module")
and a function that maps each module to a [`ClassLoader`](ClassLoader.md "class in java.lang").
...
Creating a layer creates a [`Module`](Module.md "class in java.lang") object for each [`ResolvedModule`](module/ResolvedModule.md "class in java.lang.module") in the configuration. For each resolved module that is
[`read`](module/ResolvedModule.md#reads()), the `Module` [`reads`](Module.md#canRead(java.lang.Module)) the corresponding run-time `Module`, which may
be in the same layer or a [`parent`](#parents()) layer.

The [`defineModulesWithOneLoader`](#defineModulesWithOneLoader(java.lang.module.Configuration,java.lang.ClassLoader)) and
[`defineModulesWithManyLoaders`](#defineModulesWithManyLoaders(java.lang.module.Configuration,java.lang.ClassLoader)) methods
...
class loader. The [`defineModules`](#defineModules(java.lang.module.Configuration,java.util.function.Function)) method is for more
...
there can be more than one parent layer or where a [`Controller`](ModuleLayer.Controller.md "class in java.lang") is needed to control modules in the layer
...
other class loaders that are [built-in](ClassLoader.md#builtinLoaders) into the Java virtual machine. The boot layer will often be
the [`parent`](#parents()) when creating additional layers.

Each `Module` in a layer is created so that it [`exports`](Module.md#isExported(java.lang.String)) and [`opens`](Module.md#isOpen(java.lang.String))
the packages described by its [`ModuleDescriptor`](module/ModuleDescriptor.md "class in java.lang.module"). Qualified exports
...
* If module `X` exports a package to `Y`, and if the
  ...
  `Y` is located as if by invoking [`findModule`](#findModule(java.lang.String)) to find the module in the layer or its parent layers. If
...
[`automatic`](module/ModuleDescriptor.md#isAutomatic()) modules receive special
...
See Also:
:   * [`Module.getLayer()`](Module.md#getLayer())
...
* ## Method Summary
  ...
  layer, the [parent](#parents()) layers.
...
* ## Method Details
  ...
  + ### defineModulesWithOneLoader
    ...
    public [ModuleLayer](ModuleLayer.md "class in java.lang") defineModulesWithOneLoader([Configuration](module/Configuration.md "class in java.lang.module") cf,
    [ClassLoader](ClassLoader.md "class in java.lang") parentLoader)

    Creates a new module layer, with this layer as its parent, by defining the
    modules in the given `Configuration` to the Java virtual machine.
    This method creates one class loader and defines all modules to that
    class loader. The [`parent`](ClassLoader.md#getParent()) of each class
    loader is the given parent class loader. This method works exactly as
    specified by the static [`defineModulesWithOneLoader`](#defineModulesWithOneLoader(java.lang.module.Configuration,java.util.List,java.lang.ClassLoader)) method when invoked with this layer as the
    ...
    :   `parentLoader` - The parent class loader for the class loader created by this
    ...
    Throws:
    :   `IllegalArgumentException` - If the given configuration has more than one parent or the parent
        of the configuration is not the configuration for this layer
    :   `LayerInstantiationException` - If the layer cannot be created for any of the reasons specified
        by the static `defineModulesWithOneLoader` method
    :   `SecurityException` - If `RuntimePermission("createClassLoader")` or
        `RuntimePermission("getClassLoader")` is denied by
        the security manager

    See Also:
    :   - [`findLoader(java.lang.String)`](#findLoader(java.lang.String))
  + ### defineModulesWithManyLoaders

    public [ModuleLayer](ModuleLayer.md "class in java.lang") defineModulesWithManyLoaders([Configuration](module/Configuration.md "class in java.lang.module") cf,
    [ClassLoader](ClassLoader.md "class in java.lang") parentLoader)

    Creates a new module layer, with this layer as its parent, by defining the
    modules in the given `Configuration` to the Java virtual machine.
    Each module is defined to its own [`ClassLoader`](ClassLoader.md "class in java.lang") created by this
    method. The [`parent`](ClassLoader.md#getParent()) of each class loader
    is the given parent class loader. This method works exactly as specified
    by the static [`defineModulesWithManyLoaders`](#defineModulesWithManyLoaders(java.lang.module.Configuration,java.util.List,java.lang.ClassLoader)) method when invoked with this layer as the
    parent. In other words, if this layer is `thisLayer` then this
    method is equivalent to invoking:
    ...
    Parameters:
    :   `cf` - The configuration for the layer
    :   `parentLoader` - The parent class loader for each of the class loaders created by
  ...
  + ### defineModules
    ...
    public [ModuleLayer](ModuleLayer.md "class in java.lang") defineModules([Configuration](module/Configuration.md "class in java.lang.module") cf,
    [Function](../util/function/Function.md "interface in java.util.function")<[String](String.md "class in java.lang"),[ClassLoader](ClassLoader.md "class in java.lang")> clf)

    Creates a new module layer, with this layer as its parent, by defining the
    modules in the given `Configuration` to the Java virtual machine.
    Each module is mapped, by name, to its class loader by means of the
    given function. This method works exactly as specified by the static
    [`defineModules`](#defineModules(java.lang.module.Configuration,java.util.List,java.util.function.Function))
    ...
    :   `SecurityException` - If `RuntimePermission("getClassLoader")` is denied by
        the security manager
  + ### defineModulesWithOneLoader

    public static [ModuleLayer.Controller](ModuleLayer.Controller.md "class in java.lang") defineModulesWithOneLoader([Configuration](module/Configuration.md "class in java.lang.module") cf,
    [List](../util/List.md "interface in java.util")<[ModuleLayer](ModuleLayer.md "class in java.lang")> parentLayers,
    [ClassLoader](ClassLoader.md "class in java.lang") parentLoader)
    ...
    delegation* when loading classes from modules. If the [`loadClass`](ClassLoader.md#loadClass(java.lang.String,boolean)) method is invoked to
    ...
    ([`getResource`](ClassLoader.md#getResource(java.lang.String)), [`getResources`](ClassLoader.md#getResources(java.lang.String)), and other resource
    ...
    Throws:
    :   `IllegalArgumentException` - If the parent(s) of the given configuration do not match the
        configuration of the parent layers, including order
    :   `LayerInstantiationException` - If all modules cannot be defined to the same class loader for any
  ...
  + ### defineModulesWithManyLoaders
    ...
    public static [ModuleLayer.Controller](ModuleLayer.Controller.md "class in java.lang") defineModulesWithManyLoaders([Configuration](module/Configuration.md "class in java.lang.module") cf,
    [List](../util/List.md "interface in java.util")<[ModuleLayer](ModuleLayer.md "class in java.lang")> parentLayers,
    [ClassLoader](ClassLoader.md "class in java.lang") parentLoader)
    ...
    its own [`ClassLoader`](ClassLoader.md "class in java.lang") created by this method. The [`parent`](ClassLoader.md#getParent()) of each class loader is the given parent
    class loader.
    ...
    :   `IllegalArgumentException` - If the parent(s) of the given configuration do not match the
        configuration of the parent layers, including order
    :   `LayerInstantiationException` - If the layer cannot be created because the configuration contains
  ...
  + ### defineModules
    ...
    public static [ModuleLayer.Controller](ModuleLayer.Controller.md "class in java.lang") defineModules([Configuration](module/Configuration.md "class in java.lang.module") cf,
    [List](../util/List.md "interface in java.util")<[ModuleLayer](ModuleLayer.md "class in java.lang")> parentLayers,
    [Function](../util/function/Function.md "interface in java.util.function")<[String](String.md "class in java.lang"),[ClassLoader](ClassLoader.md "class in java.lang")> clf)
    ...
    [`parallel-capable`](ClassLoader.md#registerAsParallelCapable()) so as to
    ...
    returns `null` or the [platform class loader](ClassLoader.md#getPlatformClassLoader()).
  ...
  + ### configuration
    ...
    public [Configuration](module/Configuration.md "class in java.lang.module") configuration()
  ...
  + ### parents
    ...
    public [List](../util/List.md "interface in java.util")<[ModuleLayer](ModuleLayer.md "class in java.lang")> parents()

    Returns an unmodifiable list of this layer's parents, in search
    order. If this is the [empty layer](#empty()) then an
  ...
  + ### modules
    ...
    public [Set](../util/Set.md "interface in java.util")<[Module](Module.md "class in java.lang")> modules()
  ...
  + ### findModule
    ...
    public [Optional](../util/Optional.md "class in java.util")<[Module](Module.md "class in java.lang")> findModule([String](String.md "class in java.lang") name)

    Returns the module with the given name in this layer, or if not in this
    layer, the [parent](#parents()) layers. Finding a module in
    ...
    Returns:
    :   The module with the given name or an empty `Optional`
        if there isn't a module with this name in this layer or any
        parent layer
  + ### findLoader

    public [ClassLoader](ClassLoader.md "class in java.lang") findLoader([String](String.md "class in java.lang") name)

    Returns the `ClassLoader` for the module with the given name. If
    a module of the given name is not in this layer then the [`parent`](#parents()) layers are searched in the manner specified by [`findModule`](#findModule(java.lang.String)).
    ...
    Throws:
    :   `IllegalArgumentException` - if a module of the given name is not
  ...
  + ### empty
    ...
    public static [ModuleLayer](ModuleLayer.md "class in java.lang") empty()
  ...
  + ### boot
    ...
    public static [ModuleLayer](ModuleLayer.md "class in java.lang") boot()
