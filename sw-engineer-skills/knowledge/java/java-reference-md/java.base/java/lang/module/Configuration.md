...
A configuration that is the result of [resolution](package-summary.md#resolution) or resolution with [service binding](#service-binding).
...
are of type [`ResolvedModule`](ResolvedModule.md "class in java.lang.module") and the edges represent the readability
amongst the modules. `Configuration` defines the [`modules()`](#modules()) method to get the set of resolved modules in the graph. `ResolvedModule` defines the [`reads()`](ResolvedModule.md#reads()) method to
get the set of modules that a resolved module reads. The modules that are
read may be in the same configuration or may be in [`parent`](#parents())
configurations.

Configuration defines the [`resolve`](#resolve(java.lang.module.ModuleFinder,java.util.List,java.lang.module.ModuleFinder,java.util.Collection)) method to resolve a collection of root modules, and the [`resolveAndBind`](#resolveAndBind(java.lang.module.ModuleFinder,java.util.List,java.lang.module.ModuleFinder,java.util.Collection))
...
Each [`layer`](../ModuleLayer.md "class in java.lang") of modules in the Java virtual
machine is created from a configuration. The configuration for the [`boot`](../ModuleLayer.md#boot()) layer is obtained by invoking `ModuleLayer.boot().configuration()`. The configuration for the boot layer
will often be the parent when creating new configurations.

## Example

The following example uses the [`resolve`](#resolve(java.lang.module.ModuleFinder,java.lang.module.ModuleFinder,java.util.Collection)) method to resolve a
...
* ## Method Summary
  ...
  configuration, the [parent](#parents()) configurations.
...
* ## Method Details
  ...
  + ### resolve
    ...
    public [Configuration](Configuration.md "class in java.lang.module") resolve([ModuleFinder](ModuleFinder.md "interface in java.lang.module") before,
    [ModuleFinder](ModuleFinder.md "interface in java.lang.module") after,
    [Collection](../../util/Collection.md "interface in java.util")<[String](../String.md "class in java.lang")> roots)

    Resolves a collection of root modules, with this configuration as its
    parent, to create a new configuration. This method works exactly as
    specified by the static [`resolve`](#resolve(java.lang.module.ModuleFinder,java.util.List,java.lang.module.ModuleFinder,java.util.Collection))
    ...
    :   `after` - The *after* module finder to locate modules when not
        located by the `before` module finder or in parent
        configurations
    :   `roots` - The possibly-empty collection of module names of the modules
        to resolve
    ...
    Throws:
    :   `FindException` - If resolution fails for any of the observability-related reasons
        specified by the static `resolve` method
    :   `ResolutionException` - If resolution fails any of the consistency checks specified by
        the static `resolve` method
    :   `SecurityException` - If locating a module is denied by the security manager
  + ### resolveAndBind

    public [Configuration](Configuration.md "class in java.lang.module") resolveAndBind([ModuleFinder](ModuleFinder.md "interface in java.lang.module") before,
    [ModuleFinder](ModuleFinder.md "interface in java.lang.module") after,
    [Collection](../../util/Collection.md "interface in java.util")<[String](../String.md "class in java.lang")> roots)

    Resolves a collection of root modules, with service binding, and with
    this configuration as its parent, to create a new configuration.
    This method works exactly as specified by the static [`resolveAndBind`](#resolveAndBind(java.lang.module.ModuleFinder,java.util.List,java.lang.module.ModuleFinder,java.util.Collection)) method when invoked with this configuration
  ...
  + ### resolve
    ...
    public static [Configuration](Configuration.md "class in java.lang.module") resolve([ModuleFinder](ModuleFinder.md "interface in java.lang.module") before,
    [List](../../util/List.md "interface in java.util")<[Configuration](Configuration.md "class in java.lang.module")> parents,
    [ModuleFinder](ModuleFinder.md "interface in java.lang.module") after,
    [Collection](../../util/Collection.md "interface in java.util")<[String](../String.md "class in java.lang")> roots)
    ...
    configuration as if by invoking the [`findModule`](#findModule(java.lang.String)) method on each parent in iteration order. If not found then
    ...
    *observability-related* reasons:
    ...
    Throws:
    :   `FindException` - If resolution fails for any of observability-related reasons
        specified above
    :   `ResolutionException` - If resolution fails for any of the consistency checks specified
        above
    :   `IllegalArgumentException` - If the list of parents is empty, or the list has two or more
        parents with modules for different target operating systems,
        architectures, or versions
    :   `SecurityException` - If locating a module is denied by the security manager
  + ### resolveAndBind

    public static [Configuration](Configuration.md "class in java.lang.module") resolveAndBind([ModuleFinder](ModuleFinder.md "interface in java.lang.module") before,
    [List](../../util/List.md "interface in java.util")<[Configuration](Configuration.md "class in java.lang.module")> parents,
    [ModuleFinder](ModuleFinder.md "interface in java.lang.module") after,
    [Collection](../../util/Collection.md "interface in java.util")<[String](../String.md "class in java.lang")> roots)
    ...
    This method works exactly as specified by [`resolve`](#resolve(java.lang.module.ModuleFinder,java.util.List,java.lang.module.ModuleFinder,java.util.Collection)) except that the graph of resolved modules is augmented
    ...
    all modules in the parent configurations, with [`service dependences`](ModuleDescriptor.md#uses()) are then examined. All modules found by the given
    module finders that [`provide`](ModuleDescriptor.md#provides()) an
  ...
  + ### empty
    ...
    public static [Configuration](Configuration.md "class in java.lang.module") empty()
  ...
  + ### parents
    ...
    public [List](../../util/List.md "interface in java.util")<[Configuration](Configuration.md "class in java.lang.module")> parents()

    Returns an unmodifiable list of this configuration's parents, in search
    order. If this is the [empty configuration](#empty()) then an
  ...
  + ### modules
    ...
    public [Set](../../util/Set.md "interface in java.util")<[ResolvedModule](ResolvedModule.md "class in java.lang.module")> modules()
  ...
  + ### findModule
    ...
    public [Optional](../../util/Optional.md "class in java.util")<[ResolvedModule](ResolvedModule.md "class in java.lang.module")> findModule([String](../String.md "class in java.lang") name)
    ...
    Returns:
    :   The resolved module with the given name or an empty `Optional` if there isn't a module with this name in this
