...
* ## Field Details
  ...
  + ### NULLORDER
    ...
    See Also:
    :   - [Constant Field Values](../../../constant-values.md#java.text.CollationElementIterator.NULLORDER)
* ## Method Details
  ...
  + ### setText
    ...
    public void setText([String](../lang/String.md "class in java.lang") source)
  ...
  + ### setText
    ...
    public void setText([CharacterIterator](CharacterIterator.md "interface in java.text") source)
