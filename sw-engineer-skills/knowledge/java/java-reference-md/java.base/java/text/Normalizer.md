...
* ## Method Details
  ...
  + ### normalize
    ...
    public static [String](../lang/String.md "class in java.lang") normalize([CharSequence](../lang/CharSequence.md "interface in java.lang") src,
    [Normalizer.Form](Normalizer.Form.md "enum class in java.text") form)
    ...
    :   `form` - The normalization form; one of
        [`Normalizer.Form.NFC`](Normalizer.Form.md#NFC),
        [`Normalizer.Form.NFD`](Normalizer.Form.md#NFD),
        [`Normalizer.Form.NFKC`](Normalizer.Form.md#NFKC),
        [`Normalizer.Form.NFKD`](Normalizer.Form.md#NFKD)
  ...
  + ### isNormalized
    ...
    public static boolean isNormalized([CharSequence](../lang/CharSequence.md "interface in java.lang") src,
    [Normalizer.Form](Normalizer.Form.md "enum class in java.text") form)
