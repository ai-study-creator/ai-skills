...
[`CookieManager`](CookieManager.md "class in java.net") will call `CookieStore.add` to save cookies
...
* ## Method Details
  ...
  + ### add
    ...
    void add([URI](URI.md "class in java.net") uri,
    ...
    See Also:
    :   - [`get(java.net.URI)`](#get(java.net.URI))
  + ### get

    [List](../util/List.md "interface in java.util")<[HttpCookie](HttpCookie.md "class in java.net")> get([URI](URI.md "class in java.net") uri)
    ...
    See Also:
    :   - [`add(java.net.URI, java.net.HttpCookie)`](#add(java.net.URI,java.net.HttpCookie))
  + ### getCookies

    [List](../util/List.md "interface in java.util")<[HttpCookie](HttpCookie.md "class in java.net")> getCookies()
  ...
  + ### getURIs
    ...
    [List](../util/List.md "interface in java.util")<[URI](URI.md "class in java.net")> getURIs()
  ...
  + ### remove
    ...
    boolean remove([URI](URI.md "class in java.net") uri,
    [HttpCookie](HttpCookie.md "class in java.net") cookie)
