...
implements [Comparable](../lang/Comparable.md "interface in java.lang")<[URI](URI.md "class in java.net")>, [Serializable](../io/Serializable.md "interface in java.io")
...
| other | The Unicode characters that are not in the US-ASCII character set, are not control characters (according to the [`Character.isISOControl`](../lang/Character.md#isISOControl(char)) method), and are not space characters (according to the [`Character.isSpaceChar`](../lang/Character.md#isSpaceChar(char)) method)  *(**Deviation from RFC 2396**, which is limited to US-ASCII)* |
...
* A sequence of escaped octets is *decoded* by
  ...
  decoding any encoded non-US-ASCII characters. If a [decoding error](../nio/charset/CharsetDecoder.md#ce) occurs
...
* The [single-argument
  ...
  are present.
* The [multi-argument constructors](#%3Cinit%3E(java.lang.String,java.lang.String,java.lang.String,int,java.lang.String,java.lang.String,java.lang.String)) quote illegal characters as
  required by the components in which they appear. The percent character
  (`'%'`) is always quoted by these constructors. Any *other*
  characters are preserved.
* The [`getRawUserInfo`](#getRawUserInfo()), [`getRawPath`](#getRawPath()), [`getRawQuery`](#getRawQuery()), [`getRawFragment`](#getRawFragment()), [`getRawAuthority`](#getRawAuthority()), and [`getRawSchemeSpecificPart`](#getRawSchemeSpecificPart()) methods return the
  values of their corresponding components in raw form, without interpreting
  any escaped octets. The strings returned by these methods may contain
  both escaped octets and *other* characters, and will not contain any
  illegal characters.
* The [`getUserInfo`](#getUserInfo()), [`getPath`](#getPath()), [`getQuery`](#getQuery()), [`getFragment`](#getFragment()), [`getAuthority`](#getAuthority()), and [`getSchemeSpecificPart`](#getSchemeSpecificPart()) methods decode any escaped
...
differences between this class and the [`URL`](URL.md "class in java.net") class.
...
An instance of the [`URL`](URL.md "class in java.net") class, by contrast, represents the
...
:   * [*RFC 2279: UTF-8, a
    ...
    * [URISyntaxException](URISyntaxException.md)
    * [Serialized Form](../../../serialized-form.md#java.net.URI)
...
* ## Constructor Details
  ...
  + ### URI
    ...
    public URI([String](../lang/String.md "class in java.lang") str)
    ...
    - Empty relative paths are permitted; this seems to be the
      ...
      and the given fragment, and can be usefully [resolved](#resolve-frag) against a base URI.- IPv4 addresses in host components are parsed rigorously, as
  ...
  + ### URI
    ...
    public URI([String](../lang/String.md "class in java.lang") scheme,
    ...
    [String](../lang/String.md "class in java.lang") fragment)
    throws [URISyntaxException](URISyntaxException.md "class in java.net")
    ...
    The resulting URI string is then parsed as if by invoking the [`URI(String)`](#%3Cinit%3E(java.lang.String)) constructor and then invoking the [`parseServerAuthority()`](#parseServerAuthority()) method upon the result; this may cause a [`URISyntaxException`](URISyntaxException.md "class in java.net") to be thrown.
  ...
  + ### URI
    ...
    > `new` [`URI`](#%3Cinit%3E(java.lang.String,java.lang.String,java.lang.String,int,java.lang.String,java.lang.String,java.lang.String))`(scheme, null, host, -1, path, null, fragment);`
  ...
  + ### URI
    ...
    public URI([String](../lang/String.md "class in java.lang") scheme,
    [String](../lang/String.md "class in java.lang") ssp,
    [String](../lang/String.md "class in java.lang") fragment)
    throws [URISyntaxException](URISyntaxException.md "class in java.net")
    ...
    URI instance as if by invoking the [`URI(String)`](#%3Cinit%3E(java.lang.String)) constructor;
    this may cause a [`URISyntaxException`](URISyntaxException.md "class in java.net") to be thrown.
...
* ## Method Details
  ...
  + ### create
    ...
    public static [URI](URI.md "class in java.net") create([String](../lang/String.md "class in java.lang") str)

    Creates a URI by parsing the given string.

    This convenience factory method works as if by invoking the [`URI(String)`](#%3Cinit%3E(java.lang.String)) constructor; any [`URISyntaxException`](URISyntaxException.md "class in java.net") thrown by the
    constructor is caught and wrapped in a new [`IllegalArgumentException`](../lang/IllegalArgumentException.md "class in java.lang") object, which is then thrown.
    ...
    [`URISyntaxException`](URISyntaxException.md "class in java.net") directly, should be used in situations where a
  ...
  + ### parseServerAuthority
    ...
    public [URI](URI.md "class in java.net") parseServerAuthority()
    throws [URISyntaxException](URISyntaxException.md "class in java.net")
  ...
  + ### normalize
    ...
    public [URI](URI.md "class in java.net") normalize()
  ...
  + ### resolve
    ...
    public [URI](URI.md "class in java.net") resolve([URI](URI.md "class in java.net") uri)
  ...
  + ### resolve
    ...
    public [URI](URI.md "class in java.net") resolve([String](../lang/String.md "class in java.lang") str)

    Constructs a new URI by parsing the given string and then resolving it
    against this URI.

    This convenience method works as if invoking it were equivalent to
    evaluating the expression [`resolve`](#resolve(java.net.URI))`(URI.`[`create`](#create(java.lang.String))`(str))`.
  ...
  + ### relativize
    ...
    public [URI](URI.md "class in java.net") relativize([URI](URI.md "class in java.net") uri)
  ...
  + ### toURL
    ...
    public [URL](URL.md "class in java.net") toURL()
  ...
  + ### getScheme
    ...
    public [String](../lang/String.md "class in java.lang") getScheme()
  ...
  + ### getRawSchemeSpecificPart
    ...
    public [String](../lang/String.md "class in java.lang") getRawSchemeSpecificPart()
  ...
  + ### getSchemeSpecificPart
    ...
    public [String](../lang/String.md "class in java.lang") getSchemeSpecificPart()
  ...
  + ### getRawAuthority
    ...
    public [String](../lang/String.md "class in java.lang") getRawAuthority()
  ...
  + ### getRawUserInfo
    ...
    public [String](../lang/String.md "class in java.lang") getRawUserInfo()
  ...
  + ### getRawPath
    ...
    public [String](../lang/String.md "class in java.lang") getRawPath()
  ...
  + ### getRawQuery
    ...
    public [String](../lang/String.md "class in java.lang") getRawQuery()
  ...
  + ### getRawFragment
    ...
    public [String](../lang/String.md "class in java.lang") getRawFragment()
  ...
  + ### getFragment
    ...
    public [String](../lang/String.md "class in java.lang") getFragment()
  ...
  + ### hashCode
    ...
    [`Object.hashCode`](../lang/Object.md#hashCode()) method.
  ...
  + ### compareTo
    ...
    public int compareTo([URI](URI.md "class in java.net") that)
    ...
    ordering as defined by the [`String.compareTo`](../lang/String.md#compareTo(java.lang.String)) method. String components that are subject to
    ...
    This method satisfies the general contract of the [`Comparable.compareTo`](../lang/Comparable.md#compareTo(T))
    method.
  ...
  + ### toASCIIString
    ...
    public [String](../lang/String.md "class in java.lang") toASCIIString()
