...
implements [Spliterator.OfDouble](Spliterator.OfDouble.md "interface in java.util")
...
implement [`tryAdvance`](Spliterator.OfDouble.md#tryAdvance(java.util.function.DoubleConsumer)). The extending class should override
[`forEachRemaining`](Spliterator.OfDouble.md#forEachRemaining(java.util.function.DoubleConsumer))
...
See Also:
:   * [`Spliterators.spliterator(java.util.PrimitiveIterator.OfDouble, long, int)`](Spliterators.md#spliterator(java.util.PrimitiveIterator.OfDouble,long,int))
...
* ## Constructor Summary
  ...
  `AbstractDoubleSpliterator(long est,
...
* ## Method Summary
  ...
  ### Methods inherited from interface java.util.[Spliterator.OfDouble](Spliterator.OfDouble.md "interface in java.util")
...
* ## Method Details
  ...
  + ### trySplit
    ...
    public [Spliterator.OfDouble](Spliterator.OfDouble.md "interface in java.util") trySplit()
