...
"MyResources\_de" it may contain "Abbrechen".
...
[`getBundle`](#getBundle(java.lang.String,java.util.Locale))
method:
...
by code in the module by calling the [`getBundle(String)`](#getBundle(java.lang.String))
or [`getBundle(String, Locale)`](#getBundle(java.lang.String,java.util.Locale)) method.

### Resource bundles as service providers

Resource bundles can be deployed in one or more *service provider modules*
and they can be located using [`ServiceLoader`](ServiceLoader.md "class in java.util").
A [service](spi/ResourceBundleProvider.md "interface in java.util.spi") interface or class must be
...
Refer to [`ResourceBundleProvider`](spi/ResourceBundleProvider.md "interface in java.util.spi") for developing resource bundle
...
A [resource bundle provider](spi/ResourceBundleProvider.md "interface in java.util.spi") can
provide resource bundles in any format such XML which replaces the need
of [`ResourceBundle.Control`](ResourceBundle.Control.md "class in java.util").
...
in [`Module.getResourceAsStream(String)`](../lang/Module.md#getResourceAsStream(java.lang.String)).

The `getBundle` factory methods with no `Control` parameter
locate and load resource bundles from
[service providers](spi/ResourceBundleProvider.md "interface in java.util.spi").
It may continue the search as if calling [`Module.getResourceAsStream(String)`](../lang/Module.md#getResourceAsStream(java.lang.String))
to find the named resource from a given module and calling
[`ClassLoader.getResourceAsStream(String)`](../lang/ClassLoader.md#getResourceAsStream(java.lang.String)); refer to
...
If the caller module is a [resource bundle
provider](spi/ResourceBundleProvider.md#obtain-resource-bundle), it does not fall back to the class loader search.
...
[system class loader](../lang/ClassLoader.md#getSystemClassLoader()).

### Resource bundles in automatic modules

A common format of resource bundles is in [.properties](PropertyResourceBundle.md "class in java.util") file format. Typically `.properties` resource bundles
are packaged in a JAR file. Resource bundle only JAR file can be readily
deployed as an [automatic module](../lang/module/ModuleFinder.md#automatic-modules). For example, if the JAR file contains the
...
The [`ResourceBundle.Control`](ResourceBundle.Control.md "class in java.util") class provides information necessary
...
[`getBundle`](#getBundle(java.lang.String,java.util.Locale,java.lang.ClassLoader,java.util.ResourceBundle.Control))
...
methods that take no [`ResourceBundle.Control`](ResourceBundle.Control.md "class in java.util") instance, their  [default behavior](#default_behavior) of resource bundle loading
can be modified with custom [`ResourceBundleControlProvider`](spi/ResourceBundleControlProvider.md "interface in java.util.spi") implementations.
If any of the
providers provides a [`ResourceBundle.Control`](ResourceBundle.Control.md "class in java.util") for the given base name, that [`ResourceBundle.Control`](ResourceBundle.Control.md "class in java.util") will be used instead of the default [`ResourceBundle.Control`](ResourceBundle.Control.md "class in java.util"). If there is
more than one service provider for supporting the same base name,
the first one returned from [`ServiceLoader`](ServiceLoader.md "class in java.util") will be used.
A custom [`ResourceBundle.Control`](ResourceBundle.Control.md "class in java.util") implementation is ignored by named modules.
...
descriptions of the [`getBundle` factory method](#getBundle(java.lang.String,java.util.Locale,java.lang.ClassLoader,java.util.ResourceBundle.Control)), [`clearCache`](#clearCache(java.lang.ClassLoader)), [`ResourceBundle.Control.getTimeToLive`](ResourceBundle.Control.md#getTimeToLive(java.lang.String,java.util.Locale)), and [`ResourceBundle.Control.needsReload`](ResourceBundle.Control.md#needsReload(java.lang.String,java.util.Locale,java.lang.String,java.lang.ClassLoader,java.util.ResourceBundle,long)) for details.
...
* ## Nested Class Summary
  ...
  that are invoked by the [`ResourceBundle.getBundle`](#getBundle(java.lang.String,java.util.Locale,java.lang.ClassLoader,java.util.ResourceBundle.Control)) factory
...
* ## Field Details
  ...
  + ### parent
    ...
    protected [ResourceBundle](ResourceBundle.md "class in java.util") parent

    The parent bundle of this bundle.
    The parent bundle is searched by [`getObject`](#getObject(java.lang.String))
...
* ## Method Details
  ...
  + ### getBaseBundleName
    ...
    public [String](../lang/String.md "class in java.lang") getBaseBundleName()
    ...
    See Also:
    :   - [`getBundle(java.lang.String, java.util.Locale, java.lang.ClassLoader)`](#getBundle(java.lang.String,java.util.Locale,java.lang.ClassLoader))
  + ### getString

    public final [String](../lang/String.md "class in java.lang") getString([String](../lang/String.md "class in java.lang") key)
  ...
  + ### getStringArray
    ...
    public final [String](../lang/String.md "class in java.lang")[] getStringArray([String](../lang/String.md "class in java.lang") key)
  ...
  + ### getObject
    ...
    public final [Object](../lang/Object.md "class in java.lang") getObject([String](../lang/String.md "class in java.lang") key)

    Gets an object for the given key from this resource bundle or one of its parents.
    This method first tries to obtain the object from this resource bundle using
    [`handleGetObject`](#handleGetObject(java.lang.String)).
  ...
  + ### getLocale
    ...
    public [Locale](Locale.md "class in java.util") getLocale()
  ...
  + ### setParent
    ...
    protected void setParent([ResourceBundle](ResourceBundle.md "class in java.util") parent)
  ...
  + ### getBundle
    ...
    public static final [ResourceBundle](ResourceBundle.md "class in java.util") getBundle([String](../lang/String.md "class in java.lang") baseName)
    ...
    See Also:
    :   - [Resource Bundle Search and Loading Strategy](#default_behavior)
        - [Resource Bundles and Named Modules](#resource-bundle-modules)
  + ### getBundle

    public static final [ResourceBundle](ResourceBundle.md "class in java.util") getBundle([String](../lang/String.md "class in java.lang") baseName,
    [ResourceBundle.Control](ResourceBundle.Control.md "class in java.util") control)
    ...
    privileges of `ResourceBundle`. See [`getBundle`](#getBundle(java.lang.String,java.util.Locale,java.lang.ClassLoader,java.util.ResourceBundle.Control)) for the
  ...
  + ### getBundle
    ...
    public static [ResourceBundle](ResourceBundle.md "class in java.util") getBundle([String](../lang/String.md "class in java.lang") baseName,
    [Module](../lang/Module.md "class in java.lang") module)
  ...
  + ### getBundle
    ...
    public static [ResourceBundle](ResourceBundle.md "class in java.util") getBundle([String](../lang/String.md "class in java.lang") baseName,
    [Locale](Locale.md "class in java.util") targetLocale,
    [Module](../lang/Module.md "class in java.lang") module)
    ...
    [service provider](spi/ResourceBundleProvider.md "interface in java.util.spi"), the caller module
    must have an appropriate *uses* clause in its *module descriptor*
    to declare that the module uses of [`ResourceBundleProvider`](spi/ResourceBundleProvider.md "interface in java.util.spi")
    for the named resource bundle.
    Otherwise, it will load the resource bundles that are local in the
    given module as if calling [`Module.getResourceAsStream(String)`](../lang/Module.md#getResourceAsStream(java.lang.String))
    or that are visible to the class loader of the given module
    as if calling [`ClassLoader.getResourceAsStream(String)`](../lang/ClassLoader.md#getResourceAsStream(java.lang.String)).
    When the resource bundle is loaded from the specified module, it is
    subject to the encapsulation rules specified by
    [`Module.getResourceAsStream`](../lang/Module.md#getResourceAsStream(java.lang.String)).

    If the given `module` is an unnamed module, then this method is
    equivalent to calling [`getBundle(baseName, targetLocale, module.getClassLoader()`](#getBundle(java.lang.String,java.util.Locale,java.lang.ClassLoader)) to load
    resource bundles that are visible to the class loader of the given
    unnamed module. Custom [`ResourceBundleControlProvider`](spi/ResourceBundleControlProvider.md "interface in java.util.spi")
  ...
  + ### getBundle
    ...
    where `control` is the default instance of [`ResourceBundle.Control`](ResourceBundle.Control.md "class in java.util") unless
    a `Control` instance is provided by
    [`ResourceBundleControlProvider`](spi/ResourceBundleControlProvider.md "interface in java.util.spi") SPI. Refer to the
    description of [modifying the default
    behavior](#modify_default_behavior). The following describes the default behavior.

    **Resource Bundle Search and Loading Strategy**

    `getBundle` uses the base name, the specified locale, and
    the default locale (obtained from [`Locale.getDefault`](Locale.md#getDefault())) to generate a sequence of *candidate bundle names*. If the specified
    ...
    "Latn, country "US" and variant "WINDOWS\_VISTA", and bundle base name
    ...
    > of [`getCandidateLocales`](ResourceBundle.Control.md#getCandidateLocales(java.lang.String,java.util.Locale)) for details.

    `getBundle` then iterates over the candidate bundle names
    to find the first one for which it can *instantiate* an actual
    resource bundle. It uses the default controls' [`getFormats`](ResourceBundle.Control.md#getFormats(java.lang.String)) method, which generates two bundle names for each generated
    ...
    - First, it attempts to load a class using the generated class name.
      ...
      bundle*.- Otherwise, `getBundle` attempts to locate a property
        resource file using the generated properties file name. It generates a
        path name from the candidate bundle name by replacing all "." characters
        with "/" and appending the string ".properties". It attempts to find a
        "resource" with this name using [`ClassLoader.getResource`](../lang/ClassLoader.md#getResource(java.lang.String)). (Note that a "resource" in the sense of
        `getResource` has nothing to do with the contents of a
        resource bundle, it is just a container of data, such as a file.) If it
        finds a "resource", it attempts to create a new [`PropertyResourceBundle`](PropertyResourceBundle.md "class in java.util") instance from its contents. If successful, this
    ...
    bundle is found, the default control's [`getFallbackLocale`](ResourceBundle.Control.md#getFallbackLocale(java.lang.String,java.util.Locale)) method is called, which returns the current default
    ...
    bundle's [`setParent`](#setParent(java.util.ResourceBundle)) method
    ...
    **Example:**
    ...
    - MyResources.class- MyResources.properties- MyResources\_fr.properties- MyResources\_fr\_CH.class- MyResources\_fr\_CH.properties- MyResources\_en.properties- MyResources\_es\_ES.classThe contents of all files are valid (that is, public non-abstract
    ...
    | --- | --- |
    | Locale("fr", "CH") | MyResources\_fr\_CH.class, parent MyResources\_fr.properties, parent MyResources.class |
    | Locale("fr", "FR") | MyResources\_fr.properties, parent MyResources.class |
    | Locale("de", "DE") | MyResources\_en.properties, parent MyResources.class |
    | Locale("en", "US") | MyResources\_en.properties, parent MyResources.class |
    | Locale("es", "ES") | MyResources\_es\_ES.class, parent MyResources.class |

    The file MyResources\_fr\_CH.properties is never used because it is
    hidden by the MyResources\_fr\_CH.class. Likewise, MyResources.properties
  ...
  + ### getBundle
    ...
    Returns a resource bundle using the specified base name, target
    locale, class loader and control. Unlike the [`getBundle`](#getBundle(java.lang.String,java.util.Locale,java.lang.ClassLoader))
    ...
    1. This factory method looks up the resource bundle in the cache for
    ...
    2. The [`control.getFormats`](ResourceBundle.Control.md#getFormats(java.lang.String)) method is called to get resource bundle formats
       to produce bundle or resource names. The strings
       `"java.class"` and `"java.properties"`
       designate class-based and [property](PropertyResourceBundle.md "class in java.util")-based resource bundles, respectively. Other strings
       starting with `"java."` are reserved for future extensions
       and must not be used for application-defined formats. Other strings
       designate application-defined formats.
    3. The [`control.getCandidateLocales`](ResourceBundle.Control.md#getCandidateLocales(java.lang.String,java.util.Locale)) method is called with the target
       locale to get a list of *candidate `Locale`s* for
       which resource bundles are searched.
    4. The [`control.newBundle`](ResourceBundle.Control.md#newBundle(java.lang.String,java.util.Locale,java.lang.String,java.lang.ClassLoader,boolean)) method is called to
    ...
    5. If the previous step has found no resource bundle, proceed to
    ...
    6. The [`control.getFallbackLocale`](ResourceBundle.Control.md#getFallbackLocale(java.lang.String,java.util.Locale)) method is called to get a fallback
    ...
    7. At this point, we have found a resource bundle that's not the
       base bundle. If this bundle set its parent during its instantiation,
       it is returned to the caller. Otherwise, its [parent chain](./ResourceBundle.md#parent_chain) is
    ...
    method looks up the cache before calling the [`control.newBundle`](ResourceBundle.Control.md#newBundle(java.lang.String,java.util.Locale,java.lang.String,java.lang.ClassLoader,boolean)) method. If the time-to-live period of the
    resource bundle found in the cache has expired, the factory method
    calls the [`control.needsReload`](ResourceBundle.Control.md#needsReload(java.lang.String,java.util.Locale,java.lang.String,java.lang.ClassLoader,java.util.ResourceBundle,long))
    ...
    [`control.getTimeToLive`](ResourceBundle.Control.md#getTimeToLive(java.lang.String,java.util.Locale)) for details.

    The following is an example of the bundle loading process with the
    default `ResourceBundle.Control` implementation.

    Conditions:
    - Base bundle name: `foo.bar.Messages`- Requested `Locale`: [`Locale.ITALY`](Locale.md#ITALY)
      - Default `Locale`: [`Locale.FRENCH`](Locale.md#FRENCH)
    ...
    - class `foo.bar.Messages_it_IT`- file `foo/bar/Messages_it_IT.properties`- class `foo.bar.Messages_it`
    ...
    because it's the base bundle. `getBundle` calls [`control.getFallbackLocale("foo.bar.Messages", Locale.ITALY)`](ResourceBundle.Control.md#getFallbackLocale(java.lang.String,java.util.Locale)) which
  ...
  + ### clearCache
    ...
    See Also:
    :   - [`ResourceBundle.Control.getTimeToLive(String,Locale)`](ResourceBundle.Control.md#getTimeToLive(java.lang.String,java.util.Locale))
  + ### clearCache

    public static final void clearCache([ClassLoader](../lang/ClassLoader.md "class in java.lang") loader)
  ...
  + ### handleGetObject
    ...
    protected abstract [Object](../lang/Object.md "class in java.lang") handleGetObject([String](../lang/String.md "class in java.lang") key)
  ...
  + ### getKeys
    ...
    public abstract [Enumeration](Enumeration.md "interface in java.util")<[String](../lang/String.md "class in java.lang")> getKeys()
  ...
  + ### containsKey
    ...
    public boolean containsKey([String](../lang/String.md "class in java.lang") key)
  ...
  + ### keySet
    ...
    public [Set](Set.md "interface in java.util")<[String](../lang/String.md "class in java.lang")> keySet()
  ...
  + ### handleKeySet
    ...
    for the ones for which the [`handleGetObject`](#handleGetObject(java.lang.String)) method returns `null`. Once the
