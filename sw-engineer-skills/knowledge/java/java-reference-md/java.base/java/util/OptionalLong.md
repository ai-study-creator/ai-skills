...
value are provided, such as [`orElse()`](#orElse(long))
(returns a default value if no value is present) and
[`ifPresent()`](#ifPresent(java.util.function.LongConsumer)) (performs an
...
* ## Method Summary
  ...
  If a value is present, returns a sequential [`LongStream`](stream/LongStream.md "interface in java.util.stream") containing
...
* ## Method Details
  ...
  + ### empty
    ...
    public static [OptionalLong](OptionalLong.md "class in java.util") empty()
  ...
  + ### of
    ...
    public static [OptionalLong](OptionalLong.md "class in java.util") of(long value)
  ...
  + ### ifPresent
    ...
    public void ifPresent([LongConsumer](function/LongConsumer.md "interface in java.util.function") action)
  ...
  + ### ifPresentOrElse
    ...
    public void ifPresentOrElse([LongConsumer](function/LongConsumer.md "interface in java.util.function") action,
  ...
  + ### stream
    ...
    public [LongStream](stream/LongStream.md "interface in java.util.stream") stream()
  ...
  + ### orElseGet
    ...
    public long orElseGet([LongSupplier](function/LongSupplier.md "interface in java.util.function") supplier)
  ...
  + ### orElseThrow
    ...
    public <X extends [Throwable](../lang/Throwable.md "class in java.lang")> long orElseThrow([Supplier](function/Supplier.md "interface in java.util.function")<? extends X> exceptionSupplier)
    throws X
  ...
  + ### equals
    ...
    - it is also an `OptionalLong` and;- both instances have no value present or;- the present values are "equal to" each other via `==`.
