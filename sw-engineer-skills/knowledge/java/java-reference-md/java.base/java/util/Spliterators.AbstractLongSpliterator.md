...
implements [Spliterator.OfLong](Spliterator.OfLong.md "interface in java.util")

An abstract `Spliterator.OfLong` that implements `trySplit`
to permit limited parallelism.

To implement a spliterator an extending class need only
implement [`tryAdvance`](Spliterator.OfLong.md#tryAdvance(java.util.function.LongConsumer)). The extending class should override
[`forEachRemaining`](Spliterator.OfLong.md#forEachRemaining(java.util.function.LongConsumer))
...
See Also:
:   * [`Spliterators.spliterator(java.util.PrimitiveIterator.OfLong, long, int)`](Spliterators.md#spliterator(java.util.PrimitiveIterator.OfLong,long,int))
...
* ## Constructor Summary
  ...
  `AbstractLongSpliterator(long est,
...
* ## Method Summary
  ...
  ### Methods inherited from interface java.util.[Spliterator.OfLong](Spliterator.OfLong.md "interface in java.util")
...
* ## Method Details
  ...
  + ### trySplit
    ...
    public [Spliterator.OfLong](Spliterator.OfLong.md "interface in java.util") trySplit()
