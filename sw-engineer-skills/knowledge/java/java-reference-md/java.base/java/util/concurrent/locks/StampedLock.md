...
* **Writing.** Method [`writeLock()`](#writeLock()) possibly blocks
  waiting for exclusive access, returning a stamp that can be used
  in method [`unlockWrite(long)`](#unlockWrite(long)) to release the lock. Untimed and
  timed versions of `tryWriteLock` are also provided. When
  the lock is held in write mode, no read locks may be obtained,
  and all optimistic read validations will fail.* **Reading.** Method [`readLock()`](#readLock()) possibly blocks
    waiting for non-exclusive access, returning a stamp that can be
    used in method [`unlockRead(long)`](#unlockRead(long)) to release the lock. Untimed
    and timed versions of `tryReadLock` are also provided.* **Optimistic Reading.** Method [`tryOptimisticRead()`](#tryOptimisticRead())
      returns a non-zero stamp only if the lock is not currently held in
      write mode. Method [`validate(long)`](#validate(long)) returns true if the lock has not
...
conversions across the three modes. For example, method [`tryConvertToWriteLock(long)`](#tryConvertToWriteLock(long)) attempts to "upgrade" a mode, returning
...
Like [`Semaphore`](../Semaphore.md "class in java.util.concurrent"), but unlike most
[`Lock`](Lock.md "interface in java.util.concurrent.locks") implementations, StampedLocks have no notion of ownership.
...
modes, this class does not directly implement the [`Lock`](Lock.md "interface in java.util.concurrent.locks") or
[`ReadWriteLock`](ReadWriteLock.md "interface in java.util.concurrent.locks") interfaces. However, a StampedLock may be
viewed [`asReadLock()`](#asReadLock()), [`asWriteLock()`](#asWriteLock()), or [`asReadWriteLock()`](#asReadWriteLock()) in applications requiring only the associated
...
See Also:
:   * [Serialized Form](../../../../../serialized-form.md#java.util.concurrent.locks.StampedLock)
...
* ## Method Summary
  ...
  Returns a plain [`Lock`](Lock.md "interface in java.util.concurrent.locks") view of this StampedLock in which
  the [`Lock.lock()`](Lock.md#lock()) method is mapped to [`readLock()`](#readLock()),
  ...
  Returns a [`ReadWriteLock`](ReadWriteLock.md "interface in java.util.concurrent.locks") view of this StampedLock in
  which the [`ReadWriteLock.readLock()`](ReadWriteLock.md#readLock()) method is mapped to
  [`asReadLock()`](#asReadLock()), and [`ReadWriteLock.writeLock()`](ReadWriteLock.md#writeLock()) to
  ...
  Returns a plain [`Lock`](Lock.md "interface in java.util.concurrent.locks") view of this StampedLock in which
  the [`Lock.lock()`](Lock.md#lock()) method is mapped to [`writeLock()`](#writeLock()),
  and similarly for other methods.
...
* ## Method Details
  ...
  + ### tryWriteLock
    ...
    for method [`Lock.tryLock(long,TimeUnit)`](Lock.md#tryLock(long,java.util.concurrent.TimeUnit)).
  ...
  + ### writeLockInterruptibly
    ...
    for method [`Lock.lockInterruptibly()`](Lock.md#lockInterruptibly()).
  ...
  + ### validate
    ...
    obtained from [`tryOptimisticRead()`](#tryOptimisticRead()) or a locking method
  ...
  + ### isWriteLockStamp
    ...
    [`tryConvertToWriteLock(long)`](#tryConvertToWriteLock(long)), for example:
    ...
    Returns:
    :   `true` if the stamp was returned by a successful
  ...
  + ### isReadLockStamp
    ...
    Tells whether a stamp represents holding a lock non-exclusively.
    This method may be useful in conjunction with
    [`tryConvertToReadLock(long)`](#tryConvertToReadLock(long)), for example:
  ...
  + ### isLockStamp
    ...
    Tells whether a stamp represents holding a lock.
    This method may be useful in conjunction with
    [`tryConvertToReadLock(long)`](#tryConvertToReadLock(long)) and [`tryConvertToWriteLock(long)`](#tryConvertToWriteLock(long)),
    for example:
  ...
  + ### isOptimisticReadStamp
    ...
    :   `true` if the stamp was returned by a successful
        ...
        [`tryOptimisticRead()`](#tryOptimisticRead()) or
        [`tryConvertToOptimisticRead(long)`](#tryConvertToOptimisticRead(long))
  ...
  + ### asReadLock
    ...
    public [Lock](Lock.md "interface in java.util.concurrent.locks") asReadLock()

    Returns a plain [`Lock`](Lock.md "interface in java.util.concurrent.locks") view of this StampedLock in which
    the [`Lock.lock()`](Lock.md#lock()) method is mapped to [`readLock()`](#readLock()),
    and similarly for other methods. The returned Lock does not
    support a [`Condition`](Condition.md "interface in java.util.concurrent.locks"); method [`Lock.newCondition()`](Lock.md#newCondition())
  ...
  + ### asWriteLock
    ...
    public [Lock](Lock.md "interface in java.util.concurrent.locks") asWriteLock()
  ...
  + ### asReadWriteLock
    ...
    public [ReadWriteLock](ReadWriteLock.md "interface in java.util.concurrent.locks") asReadWriteLock()
