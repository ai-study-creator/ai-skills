...
[java.util.concurrent.ForkJoinTask](ForkJoinTask.md "class in java.util.concurrent")<T>

java.util.concurrent.CountedCompleter<T>

Type Parameters:
:   `T` - the type of the result of the completer
...
extends [ForkJoinTask](ForkJoinTask.md "class in java.util.concurrent")<T>
...
components (such as [`CompletionHandler`](../../nio/channels/CompletionHandler.md "interface in java.nio.channels"))
except that multiple *pending* completions may be necessary
to trigger the completion action [`onCompletion(CountedCompleter)`](#onCompletion(java.util.concurrent.CountedCompleter)),
not just one.
Unless initialized otherwise, the [pending
count](#getPendingCount()) starts at zero, but may be (atomically) changed using
methods [`setPendingCount(int)`](#setPendingCount(int)), [`addToPendingCount(int)`](#addToPendingCount(int)), and
[`compareAndSetPendingCount(int, int)`](#compareAndSetPendingCount(int,int)). Upon invocation of [`tryComplete()`](#tryComplete()), if the pending action count is nonzero, it is
decremented; otherwise, the completion action is performed, and if
this completer itself has a completer, the process is continued
with its completer. As is the case with related synchronization
components such as [`Phaser`](Phaser.md "class in java.util.concurrent") and [`Semaphore`](Semaphore.md "class in java.util.concurrent"), these methods
...
A concrete CountedCompleter class must define method [`compute()`](#compute()), that should in most cases (as illustrated below), invoke
`tryComplete()` once before returning. The class may also
optionally override method [`onCompletion(CountedCompleter)`](#onCompletion(java.util.concurrent.CountedCompleter))
to perform an action upon normal completion, and method
[`onExceptionalCompletion(Throwable, CountedCompleter)`](#onExceptionalCompletion(java.lang.Throwable,java.util.concurrent.CountedCompleter)) to
...
you should override method [`getRawResult()`](#getRawResult()) to provide a
result from `join(), invoke()`, and related methods. In
general, this method should return the value of a field (or a
function of one or more fields) of the CountedCompleter object that
holds the result upon completion. Method [`setRawResult(T)`](#setRawResult(T)) by
default plays no role in CountedCompleters. It is possible, but
rarely applicable, to override this method to maintain other
objects or fields holding result data.

A CountedCompleter that does not itself have a completer (i.e.,
one for which [`getCompleter()`](#getCompleter()) returns `null`) can be
used as a regular ForkJoinTask with this added functionality.
However, any completer that in turn has another completer serves
only as an internal helper for other computations, so its own task
status (as reported in methods such as [`ForkJoinTask.isDone()`](ForkJoinTask.md#isDone()))
is arbitrary; this status changes only upon explicit invocations of
[`complete(T)`](#complete(T)), [`ForkJoinTask.cancel(boolean)`](ForkJoinTask.md#cancel(boolean)),
[`ForkJoinTask.completeExceptionally(Throwable)`](ForkJoinTask.md#completeExceptionally(java.lang.Throwable)) or upon
...
be arranged in trees similar to those often used with [`RecursiveAction`](RecursiveAction.md "class in java.util.concurrent")s, although the constructions involved in setting
...
implicitly using the [`ForkJoinPool.commonPool()`](ForkJoinPool.md#commonPool())). It is
...
in this tree implements an [`onCompletion(CountedCompleter)`](#onCompletion(java.util.concurrent.CountedCompleter)) method,
`tryComplete` can be replaced with [`propagateCompletion()`](#propagateCompletion()).
...
report a result in an [`AtomicReference`](atomic/AtomicReference.md "class in java.util.concurrent.atomic") as
soon as one is found. The others can poll the result to avoid
unnecessary work. (You could additionally [cancel](ForkJoinTask.md#cancel(boolean)) other tasks, but it is usually simpler and more efficient
...
in method [`onCompletion(CountedCompleter)`](#onCompletion(java.util.concurrent.CountedCompleter)). As illustrated in the following
...
methods [`firstComplete()`](#firstComplete()) and [`nextComplete()`](#nextComplete()) to create
...
See Also:
:   * [Serialized Form](../../../../serialized-form.md#java.util.concurrent.CountedCompleter)
...
* ## Method Summary
  ...
  [`onCompletion(CountedCompleter)`](#onCompletion(java.util.concurrent.CountedCompleter)), marks this task as
  complete and further triggers [`tryComplete()`](#tryComplete()) on this
  ...
  If this task does not have a completer, invokes [`ForkJoinTask.quietlyComplete()`](ForkJoinTask.md#quietlyComplete()) and returns `null`.

  `void`

  `onCompletion(CountedCompleter<?> caller)`

  Performs an action when method [`tryComplete()`](#tryComplete()) is invoked
  and the pending count is zero, or when the unconditional
  method [`complete(T)`](#complete(T)) is invoked.
  ...
  Performs an action when method [`ForkJoinTask.completeExceptionally(Throwable)`](ForkJoinTask.md#completeExceptionally(java.lang.Throwable)) is invoked or method [`compute()`](#compute()) throws an exception, and this task has not already
  ...
  Equivalent to [`tryComplete()`](#tryComplete()) but does not invoke [`onCompletion(CountedCompleter)`](#onCompletion(java.util.concurrent.CountedCompleter)) along the completion path:
  ...
  If the pending count is nonzero, decrements the count;
  otherwise invokes [`onCompletion(CountedCompleter)`](#onCompletion(java.util.concurrent.CountedCompleter))
...
* ## Constructor Details
  ...
  + ### CountedCompleter
    ...
    protected CountedCompleter([CountedCompleter](CountedCompleter.md "class in java.util.concurrent")<?> completer,
    int initialPendingCount)
...
* ## Method Details
  ...
  + ### onCompletion
    ...
    public void onCompletion([CountedCompleter](CountedCompleter.md "class in java.util.concurrent")<?> caller)

    Performs an action when method [`tryComplete()`](#tryComplete()) is invoked
    and the pending count is zero, or when the unconditional
    method [`complete(T)`](#complete(T)) is invoked. By default, this method
  ...
  + ### onExceptionalCompletion
    ...
    public boolean onExceptionalCompletion([Throwable](../../lang/Throwable.md "class in java.lang") ex,
    [CountedCompleter](CountedCompleter.md "class in java.util.concurrent")<?> caller)

    Performs an action when method [`ForkJoinTask.completeExceptionally(Throwable)`](ForkJoinTask.md#completeExceptionally(java.lang.Throwable)) is invoked or method [`compute()`](#compute()) throws an exception, and this task has not already
    otherwise completed normally. On entry to this method, this task
    [`ForkJoinTask.isCompletedAbnormally()`](ForkJoinTask.md#isCompletedAbnormally()). The return value
  ...
  + ### getCompleter
    ...
    public final [CountedCompleter](CountedCompleter.md "class in java.util.concurrent")<?> getCompleter()
  ...
  + ### getRoot
    ...
    public final [CountedCompleter](CountedCompleter.md "class in java.util.concurrent")<?> getRoot()
  ...
  + ### complete
    ...
    public void complete([T](CountedCompleter.md "type parameter in CountedCompleter") rawResult)

    Regardless of pending count, invokes
    [`onCompletion(CountedCompleter)`](#onCompletion(java.util.concurrent.CountedCompleter)), marks this task as
    complete and further triggers [`tryComplete()`](#tryComplete()) on this
    task's completer, if one exists. The given rawResult is
    used as an argument to [`setRawResult(T)`](#setRawResult(T)) before invoking
    [`onCompletion(CountedCompleter)`](#onCompletion(java.util.concurrent.CountedCompleter)) or marking this task
    ...
    more simply using [`quietlyCompleteRoot()`](#quietlyCompleteRoot()).
  ...
  + ### firstComplete
    ...
    public final [CountedCompleter](CountedCompleter.md "class in java.util.concurrent")<?> firstComplete()

    If this task's pending count is zero, returns this task;
    otherwise decrements its pending count and returns `null`.
    This method is designed to be used with [`nextComplete()`](#nextComplete()) in
  ...
  + ### nextComplete
    ...
    public final [CountedCompleter](CountedCompleter.md "class in java.util.concurrent")<?> nextComplete()

    If this task does not have a completer, invokes [`ForkJoinTask.quietlyComplete()`](ForkJoinTask.md#quietlyComplete()) and returns `null`. Or, if
  ...
  + ### getRawResult
    ...
    public [T](CountedCompleter.md "type parameter in CountedCompleter") getRawResult()
  ...
  + ### setRawResult
    ...
    protected void setRawResult([T](CountedCompleter.md "type parameter in CountedCompleter") t)
