...
To obtain a `Condition` instance for a particular [`Lock`](Lock.md "interface in java.util.concurrent.locks")
instance use its [`newCondition()`](Lock.md#newCondition()) method.
...
[`Condition`](Condition.md "interface in java.util.concurrent.locks") instances.
...
(The [`ArrayBlockingQueue`](../ArrayBlockingQueue.md "class in java.util.concurrent") class provides
...
and can have their own monitor [`wait`](../../../lang/Object.md#wait()) and
[`notify`](../../../lang/Object.md#notify()) methods invoked.
Acquiring the monitor lock of a `Condition` instance, or using its
monitor methods, has no specified relationship with acquiring the
[`Lock`](Lock.md "interface in java.util.concurrent.locks") associated with that `Condition` or the use of its
...
will result in a [`NullPointerException`](../../../lang/NullPointerException.md "class in java.lang") being thrown.
...
* ## Method Details
  ...
  + ### await
    ...
    - Some other thread invokes the [`signal()`](#signal()) method for this
      `Condition` and the current thread happens to be chosen as the
      thread to be awakened; or- Some other thread invokes the [`signalAll()`](#signalAll()) method for this
        `Condition`; or- Some other thread [interrupts](../../../lang/Thread.md#interrupt()) the
          current thread, and interruption of thread suspension is supported; or- A "*spurious wakeup*" occurs.
    ...
    - has its interrupted status set on entry to this method; or- is [interrupted](../../../lang/Thread.md#interrupt()) while waiting
        and interruption of thread suspension is supported,then [`InterruptedException`](../../../lang/InterruptedException.md "class in java.lang") is thrown and the current thread's
    ...
    **Implementation Considerations**
    ...
    thrown (such as [`IllegalMonitorStateException`](../../../lang/IllegalMonitorStateException.md "class in java.lang")) and the
  ...
  + ### awaitUninterruptibly
    ...
    - Some other thread invokes the [`signal()`](#signal()) method for this
      `Condition` and the current thread happens to be chosen as the
      thread to be awakened; or- Some other thread invokes the [`signalAll()`](#signalAll()) method for this
        `Condition`; or- A "*spurious wakeup*" occurs.
    ...
    this method, or it is [interrupted](../../../lang/Thread.md#interrupt())
  ...
  + ### awaitNanos
    ...
    - Some other thread invokes the [`signal()`](#signal()) method for this
      ...
      thread to be awakened; or- Some other thread invokes the [`signalAll()`](#signalAll()) method for this
        `Condition`; or- Some other thread [interrupts](../../../lang/Thread.md#interrupt()) the
          current thread, and interruption of thread suspension is supported; or- The specified waiting time elapses; or- A "*spurious wakeup*" occurs.
  ...
  + ### awaitUntil
    ...
    boolean awaitUntil([Date](../../Date.md "class in java.util") deadline)
    throws [InterruptedException](../../../lang/InterruptedException.md "class in java.lang")
    ...
    - Some other thread invokes the [`signal()`](#signal()) method for this
      ...
      thread to be awakened; or- Some other thread invokes the [`signalAll()`](#signalAll()) method for this
        `Condition`; or- Some other thread [interrupts](../../../lang/Thread.md#interrupt()) the
          current thread, and interruption of thread suspension is supported; or- The specified deadline elapses; or- A "*spurious wakeup*" occurs.
  ...
  + ### signal
    ...
    **Implementation Considerations**
    ...
    not held. Typically, an exception such as [`IllegalMonitorStateException`](../../../lang/IllegalMonitorStateException.md "class in java.lang") will be thrown.
  + ### signalAll
