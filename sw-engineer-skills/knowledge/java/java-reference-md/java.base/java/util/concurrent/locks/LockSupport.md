...
(in the sense of the [`Semaphore`](../Semaphore.md "class in java.util.concurrent") class). A call to `park` will return immediately
...
access blockers using method [`getBlocker(Thread)`](#getBlocker(java.lang.Thread)).)
...
* ## Method Summary
  ...
  Sets the object to be returned by invocations of [`getBlocker`](#getBlocker(java.lang.Thread)) for the current thread.
...
* ## Method Details
  ...
  + ### setCurrentBlocker
    ...
    public static void setCurrentBlocker([Object](../../../lang/Object.md "class in java.lang") blocker)

    Sets the object to be returned by invocations of [`getBlocker`](#getBlocker(java.lang.Thread)) for the current thread. This method may
    be used before invoking the no-argument version of [`park()`](#park()) from non-public objects, allowing
  ...
  + ### unpark
    ...
    public static void unpark([Thread](../../../lang/Thread.md "class in java.lang") thread)
  ...
  + ### park
    ...
    public static void park([Object](../../../lang/Object.md "class in java.lang") blocker)
    ...
    - Some other thread invokes [`unpark`](#unpark(java.lang.Thread)) with the
      current thread as the target; or- Some other thread [interrupts](../../../lang/Thread.md#interrupt())
  ...
  + ### parkNanos
    ...
    public static void parkNanos([Object](../../../lang/Object.md "class in java.lang") blocker,
    long nanos)
    ...
    - Some other thread invokes [`unpark`](#unpark(java.lang.Thread)) with the
      current thread as the target; or- Some other thread [interrupts](../../../lang/Thread.md#interrupt())
        the current thread; or- The specified waiting time elapses; or- The call spuriously (that is, for no reason) returns.
  ...
  + ### parkUntil
    ...
    public static void parkUntil([Object](../../../lang/Object.md "class in java.lang") blocker,
    long deadline)
    ...
    things happens:
    - Some other thread invokes [`unpark`](#unpark(java.lang.Thread)) with the
      current thread as the target; or- Some other thread [interrupts](../../../lang/Thread.md#interrupt()) the
        current thread; or- The specified deadline passes; or- The call spuriously (that is, for no reason) returns.
  ...
  + ### getBlocker
    ...
    public static [Object](../../../lang/Object.md "class in java.lang") getBlocker([Thread](../../../lang/Thread.md "class in java.lang") t)
  ...
  + ### parkUntil
    ...
    - Some other thread invokes [`unpark`](#unpark(java.lang.Thread)) with the
      current thread as the target; or- Some other thread [interrupts](../../../lang/Thread.md#interrupt())
        the current thread; or- The specified deadline passes; or- The call spuriously (that is, for no reason) returns.
