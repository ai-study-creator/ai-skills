...
public non-sealed class UnknownFormatFlagsException
...
See Also:
:   * [Serialized Form](../../../serialized-form.md#java.util.UnknownFormatFlagsException)
...
* ## Constructor Details
  ...
  + ### UnknownFormatFlagsException
    ...
    public UnknownFormatFlagsException([String](../lang/String.md "class in java.lang") f)

    Constructs an instance of this class with the specified flags.

    Parameters:
    :   `f` - The set of format flags which contain an unknown flag
* ## Method Details
