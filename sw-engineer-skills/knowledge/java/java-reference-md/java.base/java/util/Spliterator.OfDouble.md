...
extends [Spliterator.OfPrimitive](Spliterator.OfPrimitive.md "interface in java.util")<[Double](../lang/Double.md "class in java.lang"),[DoubleConsumer](function/DoubleConsumer.md "interface in java.util.function"),[Spliterator.OfDouble](Spliterator.OfDouble.md "interface in java.util")>
...
* ## Method Details
  ...
  + ### trySplit
    ...
    [Spliterator.OfDouble](Spliterator.OfDouble.md "interface in java.util") trySplit()
  ...
  + ### tryAdvance
    ...
    boolean tryAdvance([DoubleConsumer](function/DoubleConsumer.md "interface in java.util.function") action)
  ...
  + ### tryAdvance
    ...
    default boolean tryAdvance([Consumer](function/Consumer.md "interface in java.util.function")<? super [Double](../lang/Double.md "class in java.lang")> action)
