...
a [`Matcher`](Matcher.md "class in java.util.regex") object that can match arbitrary [character sequences](../../lang/CharSequence.md "interface in java.lang") against the regular
...
A [`matches`](#matches(java.lang.String,java.lang.CharSequence)) method is defined by this class as a
...
concurrent threads. Instances of the [`Matcher`](Matcher.md "class in java.util.regex") class are not safe for
such use.
...
| `\x`*{h...h}* | The character with hexadecimal value `0x`*h...h* ([`Character.MIN_CODE_POINT`](../../lang/Character.md#MIN_CODE_POINT)  <= `0x`*h...h* <=  [`Character.MAX_CODE_POINT`](../../lang/Character.md#MAX_CODE_POINT)) |
...
| `\d` | A digit: `[0-9]` if [\* UNICODE\_CHARACTER\_CLASS](#UNICODE_CHARACTER_CLASS) is not set. See [Unicode Support](#unicodesupport). |
| `\D` | A non-digit: `[^0-9]` |
| `\h` | A horizontal whitespace character: `[ \t\xA0\u1680\u180e\u2000-\u200a\u202f\u205f\u3000]` |
| `\H` | A non-horizontal whitespace character: `[^\h]` |
| `\s` | A whitespace character: `[ \t\n\x0B\f\r]` if  [UNICODE\_CHARACTER\_CLASS](#UNICODE_CHARACTER_CLASS) is not set. See [Unicode Support](#unicodesupport). |
| `\S` | A non-whitespace character: `[^\s]` |
| `\v` | A vertical whitespace character: `[\n\x0B\f\r\x85\u2028\u2029]` |
| `\V` | A non-vertical whitespace character: `[^\v]` |
| `\w` | A word character: `[a-zA-Z_0-9]` if [UNICODE\_CHARACTER\_CLASS](#UNICODE_CHARACTER_CLASS) is not set. See [Unicode Support](#unicodesupport). |
...
| *XY* | *X* followed by *Y* |
| *X*`|`*Y* | Either *X* or *Y* |
| `(`*X*`)` | X, as a [capturing group](#cg) |
| Back references | |
| `\`*n* | Whatever the *n*th [capturing group](#cg) matched |
| `\`*k*<*name*> | Whatever the [named-capturing group](#groupname) "name" matched |
| Quotation | |
...
| `(?idmsuxU-idmsuxU)` | Nothing, but turns match flags [i](#CASE_INSENSITIVE) [d](#UNIX_LINES) [m](#MULTILINE) [s](#DOTALL) [u](#UNICODE_CASE) [x](#COMMENTS) [U](#UNICODE_CHARACTER_CLASS) on - off |
| `(?idmsuxU-idmsuxU:`*X*`)` | *X*, as a [non-capturing group](#cg) with the given flags [i](#CASE_INSENSITIVE) [d](#UNIX_LINES) [m](#MULTILINE) [s](#DOTALL) [u](#UNICODE_CASE) [x](#COMMENTS) [U](#UNICODE_CHARACTER_CLASS) on - off |
...
as either Unicode escapes (section ) or other character escapes (section ).
...
If [`UNIX_LINES`](#UNIX_LINES) mode is activated, then the only line terminators
recognized are newline characters.

The regular expression `.` matches any character except a line
terminator unless the [`DOTALL`](#DOTALL) flag is specified.

If [`MULTILINE`](#MULTILINE) mode is not activated, the regular expression
...
If [`MULTILINE`](#MULTILINE) mode is activated then
`^` matches at the beginning of input and after any line terminator
except at the end of input. When in [`MULTILINE`](#MULTILINE) mode `$`
...
Standard #18: Unicode Regular Expressions*](http://www.unicode.org/reports/tr18/), plus RL2.1
Canonical Equivalents and RL2.2 Extended Grapheme Clusters.

**Unicode escape sequences** such as `\u2014` in Java source code
are processed as described in section of
The Java Language Specification.
...
[`Character.codePointOf(name)`](../../lang/Character.md#codePointOf(java.lang.String)).

[**Unicode extended grapheme clusters**](http://www.unicode.org/reports/tr18/#Default_Grapheme_Clusters) are supported by the grapheme
...
[`UnicodeScript.forName`](../../lang/Character.UnicodeScript.md#forName(java.lang.String)).
...
accepted and defined by
[`UnicodeBlock.forName`](../../lang/Character.UnicodeBlock.md#forName(java.lang.String)).
...
[*The Unicode Standard*](http://www.unicode.org/standard/standard.html) in the version specified by the
[`Character`](../../lang/Character.md "class in java.lang") class. The category names are those
...
* Alphabetic* Ideographic* Letter* Lowercase* Uppercase* Titlecase* Punctuation* Control* White\_Space* Digit* Hex\_Digit* Join\_Control* Noncharacter\_Code\_Point* Assigned* Emoji* Emoji\_Presentation* Emoji\_Modifier* Emoji\_Modifier\_Base* Emoji\_Component* Extended\_Pictographic
...
Unicode Regular Expressions*](http://www.unicode.org/reports/tr18/), when [`UNICODE_CHARACTER_CLASS`](#UNICODE_CHARACTER_CLASS) flag is specified.
...
* The backreference constructs, `\g{`*n*`}` for
  the *n*th[capturing group](#cg) and
  `\g{`*name*`}` for
  [named-capturing group](#groupname).
...
* Perl uses the `g` flag to request a match that resumes
  ...
  by the [`Matcher`](Matcher.md "class in java.util.regex") class: Repeated invocations of the [`find`](Matcher.md#find()) method will resume where the last match left off,
...
* *Free-spacing mode* in Perl (called *comments
  ...
  expression (or by the [`COMMENTS`](#COMMENTS) flag when compiling
...
constructs, please see [*Mastering Regular Expressions, 3rd Edition*, Jeffrey E. F. Friedl,
...
See Also:
:   * [`String.split(String, int)`](../../lang/String.md#split(java.lang.String,int))
    * [`String.split(String)`](../../lang/String.md#split(java.lang.String))
    * [Serialized Form](../../../../serialized-form.md#java.util.regex.Pattern)
...
* ## Method Summary
  ...
  `splitWithDelimiters(CharSequence input,
  int limit)`
...
* ## Field Details
  ...
  + ### UNIX\_LINES
    ...
    public static final int UNIX\_LINES
    ...
    See Also:
    :   - [Constant Field Values](../../../../constant-values.md#java.util.regex.Pattern.UNIX_LINES)
  + ### CASE\_INSENSITIVE

    public static final int CASE\_INSENSITIVE

    Enables case-insensitive matching.

    By default, case-insensitive matching assumes that only characters
    in the US-ASCII charset are being matched. Unicode-aware
    case-insensitive matching can be enabled by specifying the [`UNICODE_CASE`](#UNICODE_CASE) flag in conjunction with this flag.
    ...
    See Also:
    :   - [Constant Field Values](../../../../constant-values.md#java.util.regex.Pattern.CASE_INSENSITIVE)
  + ### COMMENTS
    ...
    See Also:
    :   - [Constant Field Values](../../../../constant-values.md#java.util.regex.Pattern.COMMENTS)
  + ### MULTILINE
    ...
    See Also:
    :   - [Constant Field Values](../../../../constant-values.md#java.util.regex.Pattern.MULTILINE)
  + ### LITERAL
    ...
    The flags CASE\_INSENSITIVE and UNICODE\_CASE retain their impact on
    ...
    See Also:
    :   - [Constant Field Values](../../../../constant-values.md#java.util.regex.Pattern.LITERAL)
  + ### DOTALL
    ...
    See Also:
    :   - [Constant Field Values](../../../../constant-values.md#java.util.regex.Pattern.DOTALL)
  + ### UNICODE\_CASE

    public static final int UNICODE\_CASE

    Enables Unicode-aware case folding.

    When this flag is specified then case-insensitive matching, when
    enabled by the [`CASE_INSENSITIVE`](#CASE_INSENSITIVE) flag, is done in a manner
    ...
    See Also:
    :   - [Constant Field Values](../../../../constant-values.md#java.util.regex.Pattern.UNICODE_CASE)
  + ### CANON\_EQ

    public static final int CANON\_EQ
    ...
    See Also:
    :   - [Constant Field Values](../../../../constant-values.md#java.util.regex.Pattern.CANON_EQ)
  + ### UNICODE\_CHARACTER\_CLASS

    public static final int UNICODE\_CHARACTER\_CLASS
    ...
    *Predefined character classes* and *POSIX character classes*
    ...
    [*Unicode Technical
    Standard #18: Unicode Regular Expressions*](http://www.unicode.org/reports/tr18/)
    *Annex C: Compatibility Properties*.

    The UNICODE\_CHARACTER\_CLASS mode can also be enabled via the embedded
    flag expression `(?U)`.

    The flag implies UNICODE\_CASE, that is, it enables Unicode-aware case
    folding.
    ...
    See Also:
    :   - [Constant Field Values](../../../../constant-values.md#java.util.regex.Pattern.UNICODE_CHARACTER_CLASS)
...
* ## Method Details
  ...
  + ### compile
    ...
    public static [Pattern](Pattern.md "class in java.util.regex") compile([String](../../lang/String.md "class in java.lang") regex)
  ...
  + ### compile
    ...
    Setting [`CANON_EQ`](#CANON_EQ) among the flags may impose a moderate risk
    of memory exhaustion.

    Parameters:
    :   `regex` - The expression to be compiled
    :   `flags` - Match flags, a bit mask that may include
        [`CASE_INSENSITIVE`](#CASE_INSENSITIVE), [`MULTILINE`](#MULTILINE), [`DOTALL`](#DOTALL),
        [`UNICODE_CASE`](#UNICODE_CASE), [`CANON_EQ`](#CANON_EQ), [`UNIX_LINES`](#UNIX_LINES),
        [`LITERAL`](#LITERAL), [`UNICODE_CHARACTER_CLASS`](#UNICODE_CHARACTER_CLASS)
  ...
  + ### pattern
    ...
    public [String](../../lang/String.md "class in java.lang") pattern()
  ...
  + ### matcher
    ...
    public [Matcher](Matcher.md "class in java.util.regex") matcher([CharSequence](../../lang/CharSequence.md "interface in java.lang") input)
  ...
  + ### matches
    ...
    public static boolean matches([String](../../lang/String.md "class in java.lang") regex,
    [CharSequence](../../lang/CharSequence.md "interface in java.lang") input)
  ...
  + ### split
    ...
    public [String](../../lang/String.md "class in java.lang")[] split([CharSequence](../../lang/CharSequence.md "interface in java.lang") input,
    int limit)
  ...
  + ### splitWithDelimiters
    ...
    public [String](../../lang/String.md "class in java.lang")[] splitWithDelimiters([CharSequence](../../lang/CharSequence.md "interface in java.lang") input,
    int limit)
  ...
  + ### split
    ...
    This method works as if by invoking the two-argument [`split`](#split(java.lang.CharSequence,int)) method with the given input
  ...
  + ### quote
    ...
    public static [String](../../lang/String.md "class in java.lang") quote([String](../../lang/String.md "class in java.lang") s)
  ...
  + ### asPredicate
    ...
    public [Predicate](../function/Predicate.md "interface in java.util.function")<[String](../../lang/String.md "class in java.lang")> asPredicate()
    ...
    See Also:
    :   - [`Matcher.find()`](Matcher.md#find())
  + ### asMatchPredicate

    public [Predicate](../function/Predicate.md "interface in java.util.function")<[String](../../lang/String.md "class in java.lang")> asMatchPredicate()
    ...
    See Also:
    :   - [`Matcher.matches()`](Matcher.md#matches())
  + ### splitAsStream

    public [Stream](../stream/Stream.md "interface in java.util.stream")<[String](../../lang/String.md "class in java.lang")> splitAsStream([CharSequence](../../lang/CharSequence.md "interface in java.lang") input)
    ...
    See Also:
    :   - [`split(CharSequence)`](#split(java.lang.CharSequence))