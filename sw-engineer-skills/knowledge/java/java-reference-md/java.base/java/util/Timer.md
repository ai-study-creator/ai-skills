...
one of the concurrency utilities therein is the [`ScheduledThreadPoolExecutor`](concurrent/ScheduledThreadPoolExecutor.md "class in java.util.concurrent") which is a thread pool for repeatedly
...
:   * [`TimerTask`](TimerTask.md "class in java.util")
    * [`Object.wait(long)`](../lang/Object.md#wait(long))
...
* ## Constructor Summary
  ...
  [run as a daemon](../lang/Thread.md#setDaemon(boolean)).
...
* ## Constructor Details
  ...
  + ### Timer
    ...
    public Timer([String](../lang/String.md "class in java.lang") name)
...
* ## Method Details
  ...
  + ### schedule
    ...
    public void schedule([TimerTask](TimerTask.md "class in java.util") task,
    long delay)
  ...
  + ### schedule
    ...
    public void schedule([TimerTask](TimerTask.md "class in java.util") task,
    [Date](Date.md "class in java.util") time)
  ...
  + ### schedule
    ...
    public void schedule([TimerTask](TimerTask.md "class in java.util") task,
    [Date](Date.md "class in java.util") firstTime,
    long period)
  ...
  + ### scheduleAtFixedRate
    ...
    public void scheduleAtFixedRate([TimerTask](TimerTask.md "class in java.util") task,
    long delay,
    long period)
