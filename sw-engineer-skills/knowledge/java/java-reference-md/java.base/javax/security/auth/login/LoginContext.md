...
1. `Subject`
   * If the constructor has a Subject
     ...
     Subject object.* If the caller specifies a `null` Subject
       and a `null` value is permitted,
       the LoginContext instantiates a new Subject.* If the constructor does **not** have a Subject
         input parameter, the LoginContext instantiates a new Subject.- `Configuration`
     * If the constructor has a Configuration
       ...
       then a `LoginException` is thrown.* When LoginContext uses the installed Configuration, the caller
         ...
         the callers of the LoginContext will not require those permissions.* When LoginContext uses a caller-specified Configuration, the caller
           ...
           that the modules may perform.- `CallbackHandler`
       * If the constructor has a CallbackHandler
         input parameter, the LoginContext uses the caller-specified
         CallbackHandler object.* If the constructor does **not** have a CallbackHandler
           input parameter, or if the caller specifies a `null`
           ...
           modules have alternative means for authenticating the user.* When the LoginContext uses the installed Configuration (instead of
...
See Also:
:   * [`Security`](../../../../java/security/Security.md "class in java.security")
    * [`AuthPermission`](../AuthPermission.md "class in javax.security.auth")
    * [`Subject`](../Subject.md "class in javax.security.auth")
    * [`CallbackHandler`](../callback/CallbackHandler.md "interface in javax.security.auth.callback")
    * [`Configuration`](Configuration.md "class in javax.security.auth.login")
    * [`LoginModule`](../spi/LoginModule.md "interface in javax.security.auth.spi")
...
* ## Constructor Details
  ...
  + ### LoginContext
    ...
    public LoginContext([String](../../../../java/lang/String.md "class in java.lang") name)
    throws [LoginException](LoginException.md "class in javax.security.auth.login")
  ...
  + ### LoginContext
    ...
    public LoginContext([String](../../../../java/lang/String.md "class in java.lang") name,
    [Subject](../Subject.md "class in javax.security.auth") subject)
    throws [LoginException](LoginException.md "class in javax.security.auth.login")
  ...
  + ### LoginContext
    ...
    public LoginContext([String](../../../../java/lang/String.md "class in java.lang") name,
    [CallbackHandler](../callback/CallbackHandler.md "interface in javax.security.auth.callback") callbackHandler)
    throws [LoginException](LoginException.md "class in javax.security.auth.login")
  ...
  + ### LoginContext
    ...
    [Subject](../Subject.md "class in javax.security.auth") subject,
    [CallbackHandler](../callback/CallbackHandler.md "interface in javax.security.auth.callback") callbackHandler,
    [Configuration](Configuration.md "class in javax.security.auth.login") config)
    throws [LoginException](LoginException.md "class in javax.security.auth.login")
