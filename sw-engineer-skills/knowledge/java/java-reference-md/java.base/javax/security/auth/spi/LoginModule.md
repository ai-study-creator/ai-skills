...
Package [javax.security.auth.spi](package-summary.md)
...
See Also:
:   * [`LoginContext`](../login/LoginContext.md "class in javax.security.auth.login")
    * [`Configuration`](../login/Configuration.md "class in javax.security.auth.login")
...
* ## Method Details
  ...
  + ### initialize
    ...
    void initialize([Subject](../Subject.md "class in javax.security.auth") subject,
    [CallbackHandler](../callback/CallbackHandler.md "interface in javax.security.auth.callback") callbackHandler,
    [Map](../../../../java/util/Map.md "interface in java.util")<[String](../../../../java/lang/String.md "class in java.lang"),?> sharedState,
  ...
  + ### login
    ...
    boolean login()
    throws [LoginException](../login/LoginException.md "class in javax.security.auth.login")
    ...
    Returns:
    :   `true` if the authentication succeeded, or `false`
  ...
  + ### commit
    ...
    Returns:
    :   `true` if this method succeeded, or `false`
        if this `LoginModule` should be ignored.
