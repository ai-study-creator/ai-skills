...
* ## Method Summary
  ...
  current context have been handled by [`declarePrefix()`](#declarePrefix(java.lang.String,java.lang.String)).
  ...
  by [`processName()`](#processName(java.lang.String,java.lang.String%5B%5D,boolean)).
...
* ## Field Details
  ...
  + ### XMLNS
    ...
    public static final [String](../../../../../java.base/java/lang/String.md "class in java.lang") XMLNS
    ...
    See Also:
    :   - [Constant Field Values](../../../../../constant-values.md#org.xml.sax.helpers.NamespaceSupport.XMLNS)
  + ### NSDECL

    public static final [String](../../../../../java.base/java/lang/String.md "class in java.lang") NSDECL
    ...
    *xmlns* and *xmlns:\** attributes, which are used to
    ...
    See Also:
    :   - [`setNamespaceDeclUris(boolean)`](#setNamespaceDeclUris(boolean))
        - [`isNamespaceDeclUris()`](#isNamespaceDeclUris())
        - [Constant Field Values](../../../../../constant-values.md#org.xml.sax.helpers.NamespaceSupport.NSDECL)
* ## Constructor Details
...
* ## Method Details
  ...
  + ### declarePrefix
    ...
    public boolean declarePrefix([String](../../../../../java.base/java/lang/String.md "class in java.lang") prefix,
    ...
    then a second pass using [`processName()`](#processName(java.lang.String,java.lang.String%5B%5D,boolean)) to
    ...
    Note that there is an asymmetry in this library: [`getPrefix`](#getPrefix(java.lang.String)) will not return the "" prefix,
    even if you have declared a default element namespace.
    To check for a default namespace,
    you have to look it up explicitly using [`getURI`](#getURI(java.lang.String)).
    ...
    See Also:
    :   - [`processName(java.lang.String, java.lang.String[], boolean)`](#processName(java.lang.String,java.lang.String%5B%5D,boolean))
        - [`getURI(java.lang.String)`](#getURI(java.lang.String))
        - [`getPrefix(java.lang.String)`](#getPrefix(java.lang.String))
  + ### processName

    public [String](../../../../../java.base/java/lang/String.md "class in java.lang")[] processName([String](../../../../../java.base/java/lang/String.md "class in java.lang") qName,
    [String](../../../../../java.base/java/lang/String.md "class in java.lang")[] parts,
    boolean isAttribute)
    ...
    See Also:
    :   - [`declarePrefix(java.lang.String, java.lang.String)`](#declarePrefix(java.lang.String,java.lang.String))
        - [`String.intern()`](../../../../../java.base/java/lang/String.md#intern())
  + ### getURI

    public [String](../../../../../java.base/java/lang/String.md "class in java.lang") getURI([String](../../../../../java.base/java/lang/String.md "class in java.lang") prefix)
  ...
  + ### getPrefixes
    ...
    public [Enumeration](../../../../../java.base/java/util/Enumeration.md "interface in java.util")<[String](../../../../../java.base/java/lang/String.md "class in java.lang")> getPrefixes()
    ...
    **Note:** if there is a default prefix, it will not be
    ...
    using the [`getURI`](#getURI(java.lang.String)) with an argument of "".
  ...
  + ### getPrefix
    ...
    public [String](../../../../../java.base/java/lang/String.md "class in java.lang") getPrefix([String](../../../../../java.base/java/lang/String.md "class in java.lang") uri)

    Return one of the prefixes mapped to a Namespace URI.

    If more than one prefix is currently mapped to the same
    URI, this method will make an arbitrary selection; if you
    want all of the prefixes, use the [`getPrefixes()`](#getPrefixes())
    method instead.

    **Note:** this will never return the empty (default) prefix;
    to check for a default prefix, use the [`getURI`](#getURI(java.lang.String))
    ...
    See Also:
    :   - [`getPrefixes(java.lang.String)`](#getPrefixes(java.lang.String))
        - [`getURI(java.lang.String)`](#getURI(java.lang.String))
  + ### getPrefixes

    public [Enumeration](../../../../../java.base/java/util/Enumeration.md "interface in java.util")<[String](../../../../../java.base/java/lang/String.md "class in java.lang")> getPrefixes([String](../../../../../java.base/java/lang/String.md "class in java.lang") uri)
    ...
    which one you get, use the [`getPrefix`](#getPrefix(java.lang.String))
    method instead.

    **Note:** the empty (default) prefix is *never* included
    in this enumeration; to check for the presence of a default
    Namespace, use the [`getURI`](#getURI(java.lang.String)) method with an
    argument of "".
  ...
  + ### getDeclaredPrefixes
    ...
    public [Enumeration](../../../../../java.base/java/util/Enumeration.md "interface in java.util")<[String](../../../../../java.base/java/lang/String.md "class in java.lang")> getDeclaredPrefixes()

    Return an enumeration of all prefixes declared in this context.

    The empty (default) prefix will be included in this
    enumeration; note that this behaviour differs from that of
    [`getPrefix(java.lang.String)`](#getPrefix(java.lang.String)) and [`getPrefixes()`](#getPrefixes()).
  ...
  + ### setNamespaceDeclUris
    ...
    Controls whether namespace declaration attributes are placed
    into the [`NSDECL`](#NSDECL) namespace
    by [`processName()`](#processName(java.lang.String,java.lang.String%5B%5D,boolean)). This may only be
    changed before any contexts have been pushed.

    Parameters:
    :   `value` - a flag indicating whether namespace declaration attributes
        are placed into the [`NSDECL`](#NSDECL) namespace
