...
objects are also used in [[DOM Level 3 Load and Save](http://www.w3.org/TR/2004/REC-DOM-Level-3-LS-20040407)]
...
SAX2 [[SAX](http://www.saxproject.org/)].

The following list of parameters defined in the DOM:

`"canonical-form"`
:   `true`
    :   [*optional*] Canonicalize the document according to the rules specified in [[Canonical XML](http://www.w3.org/TR/2001/REC-xml-c14n-20010315)],
...
:   `true`
    :   [*optional*] Check if the characters in the document are [fully
        normalized](http://www.w3.org/TR/2004/REC-xml11-20040204/#dt-fullnorm), as defined in appendix B of [[XML 1.1](http://www.w3.org/TR/2004/REC-xml11-20040204/)]. When a
...
:   `true`
    :   [*optional*] Expose schema normalized values in the tree, such as [XML
        Schema normalized values](http://www.w3.org/TR/2001/REC-xmlschema-1-20010502/#key-nv) in the case of XML Schema. Since this parameter requires to have schema
        ...
        **Note:** Since the document contains the result of the XML 1.0
        ...
        normalization as defined in section 3.3.3 of [[XML 1.0](http://www.w3.org/TR/2004/REC-xml-20040204)] and is only
...
:   `true`
    ...
    :   [*optional*] Discard all `Text` nodes that contain whitespaces in element
        content, as described in [[element content whitespace]](http://www.w3.org/TR/2004/REC-xml-infoset-20040204#infoitem.character). The implementation is expected to use the attribute
...
:   `true`
    ...
    :   [*required*] Remove all `EntityReference` nodes from the document,
        ...
        nodes are normalized, as defined in `Node.normalize`. Only [unexpanded entity references](http://www.w3.org/TR/2004/REC-xml-infoset-20040204/#infoitem.rse) are kept in the document.
...
`"infoset"`
:   `true`
    :   [*required*]Keep in the document the information defined in the XML Information Set [[XML Information Set](http://www.w3.org/TR/2004/REC-xml-infoset-20040204/)]
...
:   This parameter has no effect if the
    ...
    :   [*required*] (*default*) Include namespace declaration attributes, specified or defaulted from
        ...
        in [[XML Namespaces](http://www.w3.org/TR/1999/REC-xml-names-19990114/)]
...
:   `true`
    :   [*optional*] [Fully
        normalized](http://www.w3.org/TR/2004/REC-xml11-20040204/#dt-fullnorm) the characters in the document as defined in appendix B of [[XML 1.1](http://www.w3.org/TR/2004/REC-xml11-20040204/)].
...
:   [*optional*] Represent a `DOMString` object containing a list of URIs,
    ...
    production S](http://www.w3.org/TR/2004/REC-xml-20040204#NT-S) defined in section 2.3 [[XML 1.0](http://www.w3.org/TR/2004/REC-xml-20040204)]), that
...
:   [*optional*] Represent a `DOMString` object containing an absolute URI
    ...
    **Note:** For XML Schema [[XML Schema Part 1](http://www.w3.org/TR/2001/REC-xmlschema-1-20010502/)]
    , applications must use the value
    `"http://www.w3.org/2001/XMLSchema"`. For XML DTD [[XML 1.0](http://www.w3.org/TR/2004/REC-xml-20040204)],
    applications must use the value
...
:   `true`
    :   [*optional*] Require the validation against a schema (i.e. XML schema, DTD, any
        ...
        normalized as defined by [[XML 1.0](http://www.w3.org/TR/2004/REC-xml-20040204)]. If
...
"LS" defined in [[DOM Level 3 Load and Save](http://www.w3.org/TR/2004/REC-DOM-Level-3-LS-20040407)]
...
* ## Method Details
  ...
  + ### setParameter
    ...
    void setParameter([String](../../../../java.base/java/lang/String.md "class in java.lang") name,
    ...
    :   `value` - The new value or `null` if the user wishes to
    ...
    Throws:
    :   `DOMException` - NOT\_FOUND\_ERR: Raised when the parameter name is not recognized.
          
         NOT\_SUPPORTED\_ERR: Raised when the parameter name is recognized
        but the requested value cannot be set.
          
         TYPE\_MISMATCH\_ERR: Raised if the value type for this parameter
        name is incompatible with the expected value type.
  + ### getParameter

    [Object](../../../../java.base/java/lang/Object.md "class in java.lang") getParameter([String](../../../../java.base/java/lang/String.md "class in java.lang") name)
    throws [DOMException](DOMException.md "class in org.w3c.dom")
  ...
  + ### canSetParameter
    ...
    boolean canSetParameter([String](../../../../java.base/java/lang/String.md "class in java.lang") name,
    [Object](../../../../java.base/java/lang/Object.md "class in java.lang") value)
    ...
    :   `value` - An object. if `null`, the returned value is
        `true`.
  ...
  + ### getParameterNames
    ...
    [DOMStringList](DOMStringList.md "interface in org.w3c.dom") getParameterNames()
