...
* ## Field Details
  ...
  + ### CAPTURING\_PHASE
    ...
    static final short CAPTURING\_PHASE

    The current event phase is the capturing phase.

    See Also:
    :   - [Constant Field Values](../../../../../constant-values.md#org.w3c.dom.events.Event.CAPTURING_PHASE)
  + ### AT\_TARGET

    static final short AT\_TARGET

    The event is currently being evaluated at the target
    `EventTarget`.

    See Also:
    :   - [Constant Field Values](../../../../../constant-values.md#org.w3c.dom.events.Event.AT_TARGET)
  + ### BUBBLING\_PHASE

    static final short BUBBLING\_PHASE

    The current event phase is the bubbling phase.

    See Also:
    :   - [Constant Field Values](../../../../../constant-values.md#org.w3c.dom.events.Event.BUBBLING_PHASE)
* ## Method Details
  ...
  + ### getTarget
    ...
    [EventTarget](EventTarget.md "interface in org.w3c.dom.events") getTarget()

    Used to indicate the `EventTarget` to which the event was
    originally dispatched.
  + ### getCurrentTarget

    [EventTarget](EventTarget.md "interface in org.w3c.dom.events") getCurrentTarget()
  ...
  + ### initEvent
    ...
    void initEvent([String](../../../../../java.base/java/lang/String.md "class in java.lang") eventTypeArg,
    boolean canBubbleArg,
    boolean cancelableArg)
