...
* ## Method Details
  ...
  + ### addEventListener
    ...
    void addEventListener([String](../../../../../java.base/java/lang/String.md "class in java.lang") type,
    [EventListener](EventListener.md "interface in org.w3c.dom.events") listener,
    boolean useCapture)
    ...
    later stage of event flow, such as the bubbling phase.
     ...
     If multiple identical `EventListener`s are registered
  ...
  + ### removeEventListener
    ...
    void removeEventListener([String](../../../../../java.base/java/lang/String.md "class in java.lang") type,
    [EventListener](EventListener.md "interface in org.w3c.dom.events") listener,
    boolean useCapture)
    ...
    `EventTarget` while it is processing an event, it will not
    be triggered by the current actions. `EventListener`s can
  ...
  + ### dispatchEvent
    ...
    boolean dispatchEvent([Event](Event.md "interface in org.w3c.dom.events") evt)
    throws [EventException](EventException.md "class in org.w3c.dom.events")
    ...
    Throws:
    :   `EventException` - UNSPECIFIED\_EVENT\_TYPE\_ERR: Raised if the `Event`'s type
