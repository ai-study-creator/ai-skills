...
and represents the textual content (termed [character data](http://www.w3.org/TR/2004/REC-xml-20040204#syntax) in XML) of an `Element` or `Attr`. If there is no
...
* ## Method Summary
  ...
  Returns whether this text node contains [element content whitespace](http://www.w3.org/TR/2004/REC-xml-infoset-20040204#infoitem.character), often abusively called "ignorable whitespace".
...
* ## Method Details
  ...
  + ### splitText
    ...
    [Text](Text.md "interface in org.w3c.dom") splitText(int offset)
    ...
    Throws:
    :   `DOMException` - INDEX\_SIZE\_ERR: Raised if the specified offset is negative or greater
  ...
  + ### isElementContentWhitespace
    ...
    Returns whether this text node contains [element content whitespace](http://www.w3.org/TR/2004/REC-xml-infoset-20040204#infoitem.character), often abusively called "ignorable whitespace". The text node is
  ...
  + ### getWholeText
    ...
    [String](../../../../java.base/java/lang/String.md "class in java.lang") getWholeText()
  ...
  + ### replaceWholeText
    ...
    [Text](Text.md "interface in org.w3c.dom") replaceWholeText([String](../../../../java.base/java/lang/String.md "class in java.lang") content)
    throws [DOMException](DOMException.md "class in org.w3c.dom")
    ...
    *Figure: barTextNode.replaceWholeText("yo") modifies the
    ...
    Throws:
    :   `DOMException` - NO\_MODIFICATION\_ALLOWED\_ERR: Raised if one of the `Text`
