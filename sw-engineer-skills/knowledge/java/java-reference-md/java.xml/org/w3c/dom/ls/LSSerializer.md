...
, Appendix B. [[DOM Level 2 Core](http://www.w3.org/TR/2000/REC-DOM-Level-2-Core-20001113)]
...
* `CDATAsections` containing content characters that cannot be
  ...
  "[split-cdata-sections](https://www.w3.org/TR/2004/REC-DOM-Level-3-Core-20040407/core.html#parameter-split-cdata-sections)"
  ...
  "[well-formed](https://www.w3.org/TR/2004/REC-DOM-Level-3-Core-20040407/core.html#parameter-well-formed)"
...
"[normalize-characters](https://www.w3.org/TR/2004/REC-DOM-Level-3-Core-20040407/core.html#parameter-normalize-characters)"
on `LSSerializer` to true, character normalization is
performed according to the definition of
[fully
normalized](http://www.w3.org/TR/2004/REC-xml11-20040204/#dt-fullnorm) characters included in appendix E of
[[XML 1.1](http://www.w3.org/TR/2004/REC-xml11-20040204/)] on all
...
* ## Method Details
  ...
  + ### getDomConfig
    ...
    :   `true`
        :   [*optional*] Writes the document according to the rules specified in
            ...
            "[canonical-form](https://www.w3.org/TR/2004/REC-DOM-Level-3-Core-20040407/core.html#parameter-canonical-form)"
            [[DOM Level 3 Core](http://www.w3.org/TR/2004/REC-DOM-Level-3-Core-20040407)]
    ...
    :   This parameter is equivalent to
        ...
        support [fully
        normalizing](http://www.w3.org/TR/2004/REC-xml11-20040204/#dt-fullnorm) the characters in the document according to appendix E of
        [[XML 1.1](http://www.w3.org/TR/2004/REC-xml11-20040204/)], this
    ...
    :   `true`
        ...
        :   [*required*] Do not serialize the XML and text declarations. Report a
            ...
            [[XML 1.0](http://www.w3.org/TR/2004/REC-xml-20040204)], or an
            encoding would be needed to be able to re-parse the serialized data).
  + ### getNewLine

    [String](../../../../../java.base/java/lang/String.md "class in java.lang") getNewLine()
    ...
    "End-of-Line Handling" in [[XML 1.0](http://www.w3.org/TR/2004/REC-xml-20040204)],
    if the serialized content is XML 1.0 or section 2.11, "End-of-Line Handling"
    in [[XML 1.1](http://www.w3.org/TR/2004/REC-xml11-20040204/)], if the
  ...
  + ### setNewLine
    ...
    void setNewLine([String](../../../../../java.base/java/lang/String.md "class in java.lang") newLine)
  ...
  + ### getFilter
    ...
    [LSSerializerFilter](LSSerializerFilter.md "interface in org.w3c.dom.ls") getFilter()
    ...
    "[cdata-sections](https://www.w3.org/TR/2004/REC-DOM-Level-3-Core-20040407/core.html#parameter-cdata-sections)"
    is set to `false`.
  + ### setFilter

    void setFilter([LSSerializerFilter](LSSerializerFilter.md "interface in org.w3c.dom.ls") filter)
  ...
  + ### write
    ...
    boolean write([Node](../Node.md "interface in org.w3c.dom") nodeArg,
    [LSOutput](LSOutput.md "interface in org.w3c.dom.ls") destination)
    throws [LSException](LSException.md "class in org.w3c.dom.ls")
    ...
    Throws:
    :   `LSException` - SERIALIZE\_ERR: Raised if the `LSSerializer` was unable to
  ...
  + ### writeToURI
    ...
    boolean writeToURI([Node](../Node.md "interface in org.w3c.dom") nodeArg,
  ...
  + ### writeToString
    ...
    [String](../../../../../java.base/java/lang/String.md "class in java.lang") writeToString([Node](../Node.md "interface in org.w3c.dom") nodeArg)
    ...
    Throws:
    :   `DOMException` - DOMSTRING\_SIZE\_ERR: Raised if the resulting string is too long to
        fit in a `DOMString`.
    :   `LSException` - SERIALIZE\_ERR: Raised if the `LSSerializer` was unable to
        serialize the node. DOM applications should attach a
        `DOMErrorHandler` using the parameter
