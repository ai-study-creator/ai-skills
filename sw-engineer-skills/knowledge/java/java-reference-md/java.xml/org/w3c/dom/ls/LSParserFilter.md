...
* ## Field Details
  ...
  + ### FILTER\_ACCEPT
    ...
    See Also:
    :   - [Constant Field Values](../../../../../constant-values.md#org.w3c.dom.ls.LSParserFilter.FILTER_ACCEPT)
  + ### FILTER\_REJECT
    ...
    See Also:
    :   - [Constant Field Values](../../../../../constant-values.md#org.w3c.dom.ls.LSParserFilter.FILTER_REJECT)
  + ### FILTER\_SKIP
    ...
    See Also:
    :   - [Constant Field Values](../../../../../constant-values.md#org.w3c.dom.ls.LSParserFilter.FILTER_SKIP)
  + ### FILTER\_INTERRUPT

    static final short FILTER\_INTERRUPT

    Interrupt the normal processing of the document.

    See Also:
    :   - [Constant Field Values](../../../../../constant-values.md#org.w3c.dom.ls.LSParserFilter.FILTER_INTERRUPT)
* ## Method Details

  + ### startElement

    short startElement([Element](../Element.md "interface in org.w3c.dom") elementArg)
    ...
    :   - `FILTER_ACCEPT` if the `Element` should
        ...
        - `FILTER_INTERRUPT` if the filter wants to stop the
          ...
          XML well-formed. The `Element` is rejected.Returning
        any other values will result in unspecified behavior.
  + ### acceptNode

    short acceptNode([Node](../Node.md "interface in org.w3c.dom") nodeArg)
