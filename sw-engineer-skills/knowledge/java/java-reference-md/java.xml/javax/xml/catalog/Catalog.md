...
* ## Method Summary
  ...
  input list) when the Catalog object is created by the [`CatalogManager`](CatalogManager.md "class in javax.xml.catalog").
...
* ## Method Details
  ...
  + ### matchSystem
    ...
    [String](../../../../java.base/java/lang/String.md "class in java.lang") matchSystem([String](../../../../java.base/java/lang/String.md "class in java.lang") systemId)
  ...
  + ### matchPublic
    ...
    [String](../../../../java.base/java/lang/String.md "class in java.lang") matchPublic([String](../../../../java.base/java/lang/String.md "class in java.lang") publicId)
    ...
    Refer to the description about [Feature PREFER in the table Catalog Features](CatalogFeatures.md#PREFER) in class
    [`CatalogFeatures`](CatalogFeatures.md "class in javax.xml.catalog"). Public entries are only considered if the
  ...
  + ### matchURI
    ...
    [String](../../../../java.base/java/lang/String.md "class in java.lang") matchURI([String](../../../../java.base/java/lang/String.md "class in java.lang") uri)
  ...
  + ### catalogs
    ...
    [Stream](../../../../java.base/java/util/stream/Stream.md "interface in java.util.stream")<[Catalog](Catalog.md "interface in javax.xml.catalog")> catalogs()
