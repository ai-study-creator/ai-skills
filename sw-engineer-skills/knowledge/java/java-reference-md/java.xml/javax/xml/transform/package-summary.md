...
achieves this by defining [`Source`](Source.md "interface in javax.xml.transform") and
[`Result`](Result.md "interface in javax.xml.transform") interfaces.
...
[`javax.xml.transform.sax`](sax/package-summary.md), [`javax.xml.transform.dom`](dom/package-summary.md),
[`javax.xml.transform.stax`](stax/package-summary.md), and [`javax.xml.transform.stream`](stream/package-summary.md).

## Creating Objects

The API allows a concrete [`TransformerFactory`](TransformerFactory.md "class in javax.xml.transform")
object to be created from the static function
[`TransformerFactory.newInstance()`](TransformerFactory.md#newInstance()).

## Specification of Inputs and Outputs

This API defines two interface objects called [`Source`](Source.md "interface in javax.xml.transform")
and [`Result`](Result.md "interface in javax.xml.transform"). In order to pass Source and Result
...
[`StreamSource`](stream/StreamSource.md "class in javax.xml.transform.stream") and
[`StreamResult`](stream/StreamResult.md "class in javax.xml.transform.stream"),
[`StAXSource`](stax/StAXSource.md "class in javax.xml.transform.stax") and
[`StAXResult`](stax/StAXResult.md "class in javax.xml.transform.stax"), and
[`SAXSource`](sax/SAXSource.md "class in javax.xml.transform.sax") and
[`SAXResult`](sax/SAXResult.md "class in javax.xml.transform.sax"), and
[`DOMSource`](dom/DOMSource.md "class in javax.xml.transform.dom") and
[`DOMResult`](dom/DOMResult.md "class in javax.xml.transform.dom"). Each of these objects defines a
FEATURE string (which is in the form of a URL), which can be passed into
[`TransformerFactory.getFeature(java.lang.String)`](TransformerFactory.md#getFeature(java.lang.String)) to see if the given
...
[Namespaces](http://www.w3.org/TR/REC-xml-names) present something
...
a property or a parameter on a [`Transformer`](Transformer.md "class in javax.xml.transform") object,
...
[`Transformer.setOutputProperties(java.util.Properties)`](Transformer.md#setOutputProperties(java.util.Properties)) and the
[`Transformer.setOutputProperty(java.lang.String, java.lang.String)`](Transformer.md#setOutputProperty(java.lang.String,java.lang.String)) methods.
...
specification for xsl:output attributes](http://www.w3.org/TR/xslt#output) can be referenced from the
[`OutputKeys`](OutputKeys.md "class in javax.xml.transform") class. Other strings can be
specified as well.
If the transformer does not recognize an output key, a
[`IllegalArgumentException`](../../../../java.base/java/lang/IllegalArgumentException.md "class in java.lang") is thrown, unless the key name
is [namespace qualified](#qname-delimiter). Output key names
...
source to a result, then [`TransformerFactory`](TransformerFactory.md "class in javax.xml.transform")
provides a
[`TransformerFactory.newTransformer()`](TransformerFactory.md#newTransformer()) method
...
[`TransformerFactoryConfigurationError`](TransformerFactoryConfigurationError.md "class in javax.xml.transform") is parallel to
the [`FactoryConfigurationError`](../parsers/FactoryConfigurationError.md "class in javax.xml.parsers"), and is thrown
...
A [`TransformerConfigurationException`](TransformerConfigurationException.md "class in javax.xml.transform")
...
[`TransformerFactory.newTransformer(javax.xml.transform.Source)`](TransformerFactory.md#newTransformer(javax.xml.transform.Source)) is
called.

[`TransformerException`](TransformerException.md "class in javax.xml.transform") is a general
...
[`TransformerException.printStackTrace()`](TransformerException.md#printStackTrace())
...
[`SourceLocator`](SourceLocator.md "interface in javax.xml.transform") object which indicates where
in the source tree or transformation instructions the error occurred.
[`TransformerException.getMessageAndLocation()`](TransformerException.md#getMessageAndLocation())
may be called to get an error message with location info, and
[`TransformerException.getLocationAsString()`](TransformerException.md#getLocationAsString())
may be called to get just the location string.

Transformation warnings and errors are sent to an
[`ErrorListener`](ErrorListener.md "interface in javax.xml.transform"), at which point the application may
decide to report the error or warning, and may decide to throw an
`Exception` for a non-fatal error. The `ErrorListener`
may be set via [`TransformerFactory.setErrorListener(javax.xml.transform.ErrorListener)`](TransformerFactory.md#setErrorListener(javax.xml.transform.ErrorListener))
for reporting errors that have to do with syntax errors in the transformation
instructions, or via [`Transformer.setErrorListener(javax.xml.transform.ErrorListener)`](Transformer.md#setErrorListener(javax.xml.transform.ErrorListener))
...
[`URIResolver`](URIResolver.md "interface in javax.xml.transform") interface, with its one method,
[`URIResolver.resolve(java.lang.String, java.lang.String)`](URIResolver.md#resolve(java.lang.String,java.lang.String)), and use this class to
set the URI resolution for the transformation instructions or transformation
with [`TransformerFactory.setURIResolver(javax.xml.transform.URIResolver)`](TransformerFactory.md#setURIResolver(javax.xml.transform.URIResolver)) or
[`Transformer.setURIResolver(javax.xml.transform.URIResolver)`](Transformer.md#setURIResolver(javax.xml.transform.URIResolver)). The
...
The returned [`Source`](Source.md "interface in javax.xml.transform") object must be usable by
...
* All Classes and InterfacesInterfacesClassesException Classes
  ...
  [ErrorListener](ErrorListener.md "interface in javax.xml.transform")
  ...
  [Result](Result.md "interface in javax.xml.transform")

  An object that implements this interface contains the information
  needed to build a transformation result tree.

  [Source](Source.md "interface in javax.xml.transform")

  An object that implements this interface contains the information
  needed to act as source input (XML source or transformation instructions).

  [SourceLocator](SourceLocator.md "interface in javax.xml.transform")

  This interface is primarily for the purposes of reporting where
  an error occurred in the XML source or transformation instructions.

  [Templates](Templates.md "interface in javax.xml.transform")

  An object that implements this interface is the runtime representation of processed
  transformation instructions.

  [Transformer](Transformer.md "class in javax.xml.transform")

  An instance of this abstract class can transform a
  source tree into a result tree.

  [TransformerConfigurationException](TransformerConfigurationException.md "class in javax.xml.transform")
  ...
  [TransformerFactory](TransformerFactory.md "class in javax.xml.transform")
  ...
  [TransformerFactoryConfigurationError](TransformerFactoryConfigurationError.md "class in javax.xml.transform")

  Thrown when a problem with configuration with the Transformer Factories
  exists.

  [URIResolver](URIResolver.md "interface in javax.xml.transform")
