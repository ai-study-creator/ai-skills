...
See Also:
:   * [section 16 of the XSL Transformations (XSLT) W3C Recommendation](http://www.w3.org/TR/xslt#output)
...
* ## Field Details
  ...
  + ### METHOD
    ...
    public static final [String](../../../../java.base/java/lang/String.md "class in java.lang") METHOD
    ...
    then [`Transformer.setOutputProperty(java.lang.String, java.lang.String)`](Transformer.md#setOutputProperty(java.lang.String,java.lang.String))
    or [`Transformer.setOutputProperties(java.util.Properties)`](Transformer.md#setOutputProperties(java.util.Properties)) will
    throw a [`IllegalArgumentException`](../../../../java.base/java/lang/IllegalArgumentException.md "class in java.lang").

    See Also:
    :   - [section 16 of the XSL Transformations (XSLT) W3C Recommendation](http://www.w3.org/TR/xslt#output)
        - [Constant Field Values](../../../../constant-values.md#javax.xml.transform.OutputKeys.METHOD)
  + ### VERSION

    public static final [String](../../../../java.base/java/lang/String.md "class in java.lang") VERSION
    ...
    See Also:
    :   - [section 16 of the XSL Transformations (XSLT) W3C Recommendation](http://www.w3.org/TR/xslt#output)
        - [Constant Field Values](../../../../constant-values.md#javax.xml.transform.OutputKeys.VERSION)
  + ### ENCODING

    public static final [String](../../../../java.base/java/lang/String.md "class in java.lang") ENCODING
    ...
    [[RFC2278]](http://www.ietf.org/rfc/rfc2278.txt)
    or start with `X-`.

    See Also:
    :   - [section 16 of the XSL Transformations (XSLT) W3C Recommendation](http://www.w3.org/TR/xslt#output)
        - [Constant Field Values](../../../../constant-values.md#javax.xml.transform.OutputKeys.ENCODING)
  + ### OMIT\_XML\_DECLARATION

    public static final [String](../../../../java.base/java/lang/String.md "class in java.lang") OMIT\_XML\_DECLARATION
    ...
    See Also:
    :   - [section 16 of the XSL Transformations (XSLT) W3C Recommendation](http://www.w3.org/TR/xslt#output)
        - [Constant Field Values](../../../../constant-values.md#javax.xml.transform.OutputKeys.OMIT_XML_DECLARATION)
  + ### STANDALONE

    public static final [String](../../../../java.base/java/lang/String.md "class in java.lang") STANDALONE
    ...
    See Also:
    :   - [section 16 of the XSL Transformations (XSLT) W3C Recommendation](http://www.w3.org/TR/xslt#output)
        - [Constant Field Values](../../../../constant-values.md#javax.xml.transform.OutputKeys.STANDALONE)
  + ### DOCTYPE\_PUBLIC

    public static final [String](../../../../java.base/java/lang/String.md "class in java.lang") DOCTYPE\_PUBLIC

    doctype-public = string.

    See the documentation for the [`DOCTYPE_SYSTEM`](#DOCTYPE_SYSTEM) property
    for a description of what the value of the key should be.

    See Also:
    :   - [section 16 of the XSL Transformations (XSLT) W3C Recommendation](http://www.w3.org/TR/xslt#output)
        - [Constant Field Values](../../../../constant-values.md#javax.xml.transform.OutputKeys.DOCTYPE_PUBLIC)
  + ### DOCTYPE\_SYSTEM

    public static final [String](../../../../java.base/java/lang/String.md "class in java.lang") DOCTYPE\_SYSTEM
    ...
    See Also:
    :   - [section 16 of the XSL Transformations (XSLT) W3C Recommendation](http://www.w3.org/TR/xslt#output)
        - [Constant Field Values](../../../../constant-values.md#javax.xml.transform.OutputKeys.DOCTYPE_SYSTEM)
  + ### CDATA\_SECTION\_ELEMENTS

    public static final [String](../../../../java.base/java/lang/String.md "class in java.lang") CDATA\_SECTION\_ELEMENTS
    ...
    See Also:
    :   - [section 16 of the XSL Transformations (XSLT) W3C Recommendation.](http://www.w3.org/TR/xslt#output)
        - [Constant Field Values](../../../../constant-values.md#javax.xml.transform.OutputKeys.CDATA_SECTION_ELEMENTS)
  + ### INDENT

    public static final [String](../../../../java.base/java/lang/String.md "class in java.lang") INDENT
    ...
    See Also:
    :   - [section 16 of the XSL Transformations (XSLT) W3C Recommendation](http://www.w3.org/TR/xslt#output)
        - [Constant Field Values](../../../../constant-values.md#javax.xml.transform.OutputKeys.INDENT)
  + ### MEDIA\_TYPE

    public static final [String](../../../../java.base/java/lang/String.md "class in java.lang") MEDIA\_TYPE
    ...
    See Also:
    :   - [s
          ection 16 of the XSL Transformations (XSLT) W3C Recommendation](http://www.w3.org/TR/xslt#output)
        - [Constant Field Values](../../../../constant-values.md#javax.xml.transform.OutputKeys.MEDIA_TYPE)