...
1. When a JVM is launched in a way that indicates an agent
   class. In that case an `Instrumentation` instance
   is passed to the `premain` method of the agent class.
2. When a JVM provides a mechanism to start agents sometime
...
[package specification](package-summary.md).
...
* ## Method Summary
  ...
  via [`ClassLoader::loadClass`](../../../../java.base/java/lang/ClassLoader.md#loadClass(java.lang.String,boolean)),
  [`Class::forName`](../../../../java.base/java/lang/Class.md#forName(java.lang.String)) and bytecode linkage.
  ...
  [retransformation](#retransformClasses(java.lang.Class...))
  or [redefinition](#redefineClasses(java.lang.instrument.ClassDefinition...)).

  `boolean`

  `isModifiableModule(Module module)`

  Tests whether a module can be modified with [`redefineModule`](#redefineModule(java.lang.Module,java.util.Set,java.util.Map,java.util.Map,java.util.Set,java.util.Map)).
  ...
  [setting a native method prefix](#setNativeMethodPrefix(java.lang.instrument.ClassFileTransformer,java.lang.String)).
...
* ## Method Details
  ...
  + ### addTransformer
    ...
    void addTransformer([ClassFileTransformer](ClassFileTransformer.md "interface in java.lang.instrument") transformer,
    boolean canRetransform)
    ...
    [redefined](#redefineClasses(java.lang.instrument.ClassDefinition...)). and if `canRetransform` is true,
    when they are [retransformed](#retransformClasses(java.lang.Class...)).
    [`ClassFileTransformer`](ClassFileTransformer.md "interface in java.lang.instrument") defines the order of transform calls.
    ...
    [class specification](Instrumentation.md "interface in java.lang.instrument").
    ...
    :   `UnsupportedOperationException` - if `canRetransform`
        is true and the current configuration of the JVM does not allow
        retransformation ([`isRetransformClassesSupported()`](#isRetransformClassesSupported()) is false)
  ...
  + ### addTransformer
    ...
    See Also:
    :   - [`addTransformer(ClassFileTransformer,boolean)`](#addTransformer(java.lang.instrument.ClassFileTransformer,boolean))
  + ### removeTransformer

    boolean removeTransformer([ClassFileTransformer](ClassFileTransformer.md "interface in java.lang.instrument") transformer)
  ...
  + ### isRetransformClassesSupported
    ...
    [package specification](package-summary.md)) and the JVM supports
    this capability.
    ...
    See Also:
    :   - [`retransformClasses(java.lang.Class<?>...)`](#retransformClasses(java.lang.Class...))
  + ### retransformClasses

    void retransformClasses([Class](../../../../java.base/java/lang/Class.md "class in java.lang")<?>... classes)
    throws [UnmodifiableClassException](UnmodifiableClassException.md "class in java.lang.instrument")
    ...
    [redefined](#redefineClasses(java.lang.instrument.ClassDefinition...)),
    the initial class file bytes can be transformed with the
    [`ClassFileTransformer`](ClassFileTransformer.md "interface in java.lang.instrument").
    ...
    - for each transformer that was added with `canRetransform`
      ...
      [`transform`](ClassFileTransformer.md#transform(java.lang.Module,java.lang.ClassLoader,java.lang.String,java.lang.Class,java.security.ProtectionDomain,byte%5B%5D)) during the last class load or redefine are
    ...
    - for each transformer that was added with `canRetransform`
      true, the
      [`transform`](ClassFileTransformer.md#transform(java.lang.Module,java.lang.ClassLoader,java.lang.String,java.lang.Class,java.security.ProtectionDomain,byte%5B%5D)) method is called in these transformers
    - the transformed class file bytes are installed as the new
      definition of the class

    The order of transformation is described in [`ClassFileTransformer`](ClassFileTransformer.md "interface in java.lang.instrument").
    This same order is used in the automatic reapplication of
    retransformation incapable transforms.

    The initial class file bytes represent the bytes passed to
    [`ClassLoader.defineClass`](../../../../java.base/java/lang/ClassLoader.md#defineClass(byte%5B%5D,int,int)) or
    [`redefineClasses`](#redefineClasses(java.lang.instrument.ClassDefinition...))
    ...
    [JVM TI RetransformClasses](../../../../../specs/jvmti.md#RetransformClasses).
    ...
    :   `UnmodifiableClassException` - if a specified class cannot be modified
        ([`isModifiableClass(java.lang.Class<?>)`](#isModifiableClass(java.lang.Class)) would return `false`)
    :   `UnsupportedOperationException` - if the current configuration of the JVM does not allow
        retransformation ([`isRetransformClassesSupported()`](#isRetransformClassesSupported()) is false) or the retransformation attempted
    ...
    :   `NullPointerException` - if the supplied classes array or any of its components
        is `null`.
    ...
    :   - [`isRetransformClassesSupported()`](#isRetransformClassesSupported())
        - [`addTransformer(java.lang.instrument.ClassFileTransformer, boolean)`](#addTransformer(java.lang.instrument.ClassFileTransformer,boolean))
        - [`ClassFileTransformer`](ClassFileTransformer.md "interface in java.lang.instrument")
  + ### isRedefineClassesSupported
    ...
    See Also:
    :   - [`redefineClasses(java.lang.instrument.ClassDefinition...)`](#redefineClasses(java.lang.instrument.ClassDefinition...))
  + ### redefineClasses

    void redefineClasses([ClassDefinition](ClassDefinition.md "class in java.lang.instrument")... definitions)
    throws [ClassNotFoundException](../../../../java.base/java/lang/ClassNotFoundException.md "class in java.lang"),
    [UnmodifiableClassException](UnmodifiableClassException.md "class in java.lang.instrument")
    ...
    [`retransformClasses`](#retransformClasses(java.lang.Class...))
    should be used.
    ...
    The supported class file changes are described in
    [JVM TI RedefineClasses](../../../../../specs/jvmti.md#RedefineClasses).
    The class file bytes are not checked, verified and installed
    until after the transformations have been applied, if the resultant bytes are in
    error this method will throw an exception.
    ...
    :   `UnmodifiableClassException` - if a specified class cannot be modified
        ([`isModifiableClass(java.lang.Class<?>)`](#isModifiableClass(java.lang.Class)) would return `false`)
    :   `UnsupportedOperationException` - if the current configuration of the JVM does not allow
        redefinition ([`isRedefineClassesSupported()`](#isRedefineClassesSupported()) is false) or the redefinition attempted
        to make unsupported changes
    :   `ClassFormatError` - if the data did not contain a valid class
    :   `NoClassDefFoundError` - if the name in the class file is not equal to the name of the class
    :   `UnsupportedClassVersionError` - if the class file version numbers are not supported
    :   `ClassCircularityError` - if the new classes contain a circularity
    :   `LinkageError` - if a linkage error occurs
    :   `NullPointerException` - if the supplied definitions array or any of its components
        is `null`
    :   `ClassNotFoundException` - Can never be thrown (present for compatibility reasons only)

    See Also:
    :   - [`isRedefineClassesSupported()`](#isRedefineClassesSupported())
        - [`addTransformer(java.lang.instrument.ClassFileTransformer, boolean)`](#addTransformer(java.lang.instrument.ClassFileTransformer,boolean))
        - [`ClassFileTransformer`](ClassFileTransformer.md "interface in java.lang.instrument")
  + ### isModifiableClass

    boolean isModifiableClass([Class](../../../../java.base/java/lang/Class.md "class in java.lang")<?> theClass)
    ...
    For a class to be retransformed, [`isRetransformClassesSupported()`](#isRetransformClassesSupported()) must also be true.
    But the value of `isRetransformClassesSupported()` does not influence the value
    returned by this function.
    For a class to be redefined, [`isRedefineClassesSupported()`](#isRedefineClassesSupported()) must also be true.
  ...
  + ### getAllLoadedClasses
    ...
    [Class](../../../../java.base/java/lang/Class.md "class in java.lang")[] getAllLoadedClasses()

    Returns an array of all classes currently loaded by the JVM.
    The returned array includes all classes and interfaces, including
    [hidden classes or interfaces](../../../../java.base/java/lang/Class.md#isHidden()), and array classes
    of all types.
  ...
  + ### getInitiatedClasses
    ...
    [Class](../../../../java.base/java/lang/Class.md "class in java.lang")[] getInitiatedClasses([ClassLoader](../../../../java.base/java/lang/ClassLoader.md "class in java.lang") loader)
    ...
    The returned array does not include [hidden classes or interfaces](../../../../java.base/java/lang/Class.md#isHidden()) or array classes whose
    [element type](../../../../java.base/java/lang/Class.md#componentType()) is a
    [hidden class or interface](../../../../java.base/java/lang/Class.md#isHidden()).
    ...
    Returns:
    :   an array containing all classes which `loader` can find by name;
        zero-length if there are none
  + ### getObjectSize

    long getObjectSize([Object](../../../../java.base/java/lang/Object.md "class in java.lang") objectToSize)
  ...
  + ### appendToBootstrapClassLoaderSearch
    ...
    void appendToBootstrapClassLoaderSearch([JarFile](../../../../java.base/java/util/jar/JarFile.md "class in java.util.jar") jarfile)

    Specifies a JAR file with instrumentation classes to be defined by the
    bootstrap class loader.

    When the virtual machine's built-in class loader, known as the "bootstrap
    class loader", unsuccessfully searches for a class, the entries in the [`JAR file`](../../../../java.base/java/util/jar/JarFile.md "class in java.util.jar") will be searched as well.
    ...
    See Also:
    :   - [`appendToSystemClassLoaderSearch(java.util.jar.JarFile)`](#appendToSystemClassLoaderSearch(java.util.jar.JarFile))
        - [`ClassLoader`](../../../../java.base/java/lang/ClassLoader.md "class in java.lang")
        - [`JarFile`](../../../../java.base/java/util/jar/JarFile.md "class in java.util.jar")
  + ### appendToSystemClassLoaderSearch

    void appendToSystemClassLoaderSearch([JarFile](../../../../java.base/java/util/jar/JarFile.md "class in java.util.jar") jarfile)

    Specifies a JAR file with instrumentation classes to be defined by the
    system class loader.
    When the system class loader for delegation (see
    [`getSystemClassLoader()`](../../../../java.base/java/lang/ClassLoader.md#getSystemClassLoader()))
    unsuccessfully searches for a class, the entries in the [`JarFile`](../../../../java.base/java/util/jar/JarFile.md "class in java.util.jar") will be searched as well.
    ...
    [`appendToBootstrapClassLoaderSearch`](#appendToBootstrapClassLoaderSearch(java.util.jar.JarFile))).
    ...
    the JAR file is obtained by invoking the [`getName()`](../../../../java.base/java/util/zip/ZipFile.md#getName()) method on the `jarfile` and this is provided as the
    ...
    [`system property`](../../../../java.base/java/lang/System.md#getProperties()).
    ...
    See Also:
    :   - [`appendToBootstrapClassLoaderSearch(java.util.jar.JarFile)`](#appendToBootstrapClassLoaderSearch(java.util.jar.JarFile))
        - [`ClassLoader.getSystemClassLoader()`](../../../../java.base/java/lang/ClassLoader.md#getSystemClassLoader())
        - [`JarFile`](../../../../java.base/java/util/jar/JarFile.md "class in java.util.jar")
  + ### isNativeMethodPrefixSupported
    ...
    See Also:
    :   - [`setNativeMethodPrefix(java.lang.instrument.ClassFileTransformer, java.lang.String)`](#setNativeMethodPrefix(java.lang.instrument.ClassFileTransformer,java.lang.String))
  + ### setNativeMethodPrefix

    void setNativeMethodPrefix([ClassFileTransformer](ClassFileTransformer.md "interface in java.lang.instrument") transformer,
    ...
    method with the appended prefix "wrapped\_". Note that
    "wrapped\_" would be a poor choice of prefix since it
    ...
    (see [`addTransformer`](#addTransformer(java.lang.instrument.ClassFileTransformer,boolean))).
    ...
    :   `prefix` - The prefix to apply to wrapped native methods when
        ...
        is either `null` or the empty string, then
        failed native method resolutions are not retried for
        this transformer.

    Throws:
    :   `NullPointerException` - if passed a `null` transformer.
    :   `UnsupportedOperationException` - if the current configuration of
        the JVM does not allow setting a native method prefix
        ([`isNativeMethodPrefixSupported()`](#isNativeMethodPrefixSupported()) is false).
  ...
  + ### redefineModule
    ...
    void redefineModule([Module](../../../../java.base/java/lang/Module.md "class in java.lang") module,
    [Set](../../../../java.base/java/util/Set.md "interface in java.util")<[Module](../../../../java.base/java/lang/Module.md "class in java.lang")> extraReads,
    [Map](../../../../java.base/java/util/Map.md "interface in java.util")<[String](../../../../java.base/java/lang/String.md "class in java.lang"),[Set](../../../../java.base/java/util/Set.md "interface in java.util")<[Module](../../../../java.base/java/lang/Module.md "class in java.lang")>> extraExports,
    [Map](../../../../java.base/java/util/Map.md "interface in java.util")<[String](../../../../java.base/java/lang/String.md "class in java.lang"),[Set](../../../../java.base/java/util/Set.md "interface in java.util")<[Module](../../../../java.base/java/lang/Module.md "class in java.lang")>> extraOpens,
    [Set](../../../../java.base/java/util/Set.md "interface in java.util")<[Class](../../../../java.base/java/lang/Class.md "class in java.lang")<?>> extraUses,
    [Map](../../../../java.base/java/util/Map.md "interface in java.util")<[Class](../../../../java.base/java/lang/Class.md "class in java.lang")<?>,[List](../../../../java.base/java/util/List.md "interface in java.util")<[Class](../../../../java.base/java/lang/Class.md "class in java.lang")<?>>> extraProvides)
    ...
    Throws:
    :   `IllegalArgumentException` - If `extraExports` or `extraOpens` contains a key
        that is not a package in the module; if `extraExports` or
        `extraOpens` maps a key to an empty set; if a value in the
        `extraProvides` map contains a service provider type that
        is not a member of the module or an implementation of the service;
        or `extraProvides` maps a key to an empty list
    :   `UnmodifiableModuleException` - if the module cannot be modified
    :   `NullPointerException` - if any of the arguments are `null` or
        any of the Sets or Maps contains a `null` key or value

    Since:
    :   9

    See Also:
    :   - [`isModifiableModule(Module)`](#isModifiableModule(java.lang.Module))
  + ### isModifiableModule

    boolean isModifiableModule([Module](../../../../java.base/java/lang/Module.md "class in java.lang") module)

    Tests whether a module can be modified with [`redefineModule`](#redefineModule(java.lang.Module,java.util.Set,java.util.Map,java.util.Map,java.util.Set,java.util.Map)). If a module is modifiable then this method returns
