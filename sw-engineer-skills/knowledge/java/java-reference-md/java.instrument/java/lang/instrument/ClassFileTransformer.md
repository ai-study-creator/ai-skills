...
interface using the [`addTransformer`](Instrumentation.md#addTransformer(java.lang.instrument.ClassFileTransformer,boolean))
method so that the transformer's [`transform`](#transform(java.lang.Module,java.lang.ClassLoader,java.lang.String,java.lang.Class,java.security.ProtectionDomain,byte%5B%5D)) method is invoked when classes are loaded,
[`redefined`](Instrumentation.md#redefineClasses(java.lang.instrument.ClassDefinition...)), or
[`retransformed`](Instrumentation.md#retransformClasses(java.lang.Class...)). The implementation
...
parameter of
[`Instrumentation.addTransformer(ClassFileTransformer,boolean)`](Instrumentation.md#addTransformer(java.lang.instrument.ClassFileTransformer,boolean)):
...
* *retransformation incapable* transformers that were added with
  ...
  [`Instrumentation.addTransformer(ClassFileTransformer)`](Instrumentation.md#addTransformer(java.lang.instrument.ClassFileTransformer))

Once a transformer has been registered with
[`addTransformer`](Instrumentation.md#addTransformer(java.lang.instrument.ClassFileTransformer,boolean)),
the transformer will be called for every new class definition and every class redefinition.
Retransformation capable transformers will also be called on every class retransformation.
The request for a new class definition is made with
[`ClassLoader.defineClass`](../../../../java.base/java/lang/ClassLoader.md#defineClass(byte%5B%5D,int,int))
...
[`Instrumentation.retransformClasses`](Instrumentation.md#retransformClasses(java.lang.Class...))
or its native equivalents.
...
* ## Method Details
  ...
  + ### transform
    ...
    default byte[] transform([ClassLoader](../../../../java.base/java/lang/ClassLoader.md "class in java.lang") loader,
    [String](../../../../java.base/java/lang/String.md "class in java.lang") className,
    [Class](../../../../java.base/java/lang/Class.md "class in java.lang")<?> classBeingRedefined,
    [ProtectionDomain](../../../../java.base/java/security/ProtectionDomain.md "class in java.security") protectionDomain,
    byte[] classfileBuffer)
    throws [IllegalClassFormatException](IllegalClassFormatException.md "class in java.lang.instrument")

    Transforms the given class file and returns a new replacement class file.
    This method is invoked when the [`Module`](../../../../java.base/java/lang/Module.md "class in java.lang") bearing [`transform`](#transform(java.lang.Module,java.lang.ClassLoader,java.lang.String,java.lang.Class,java.security.ProtectionDomain,byte%5B%5D)) is not overridden.
  ...
  + ### transform
    ...
    default byte[] transform([Module](../../../../java.base/java/lang/Module.md "class in java.lang") module,
