...
through one of the `createName` methods that exist in the [`GSSManager`](GSSManager.md "class in org.ietf.jgss") class. Conceptually a GSSName contains many
...
identified with [`Oid's`](Oid.md "class in org.ietf.jgss") and some standard types
...
a [`ServicePermission`](../../../javax/security/auth/kerberos/ServicePermission.md "class in javax.security.auth.kerberos")
...
[`createName("user", NT_USER_NAME)`](GSSManager.md#createName(java.lang.String,org.ietf.jgss.Oid))
...
Otherwise, the creation will throw a [`GSSException`](GSSException.md "class in org.ietf.jgss") containing the
`GSSException.FAILURE` error code.
...
See Also:
:   * [`export()`](#export())
    * [`equals(GSSName)`](#equals(org.ietf.jgss.GSSName))
    * [`GSSManager.createName(String, Oid)`](GSSManager.md#createName(java.lang.String,org.ietf.jgss.Oid))
    * [`GSSManager.createName(String, Oid, Oid)`](GSSManager.md#createName(java.lang.String,org.ietf.jgss.Oid,org.ietf.jgss.Oid))
    * [`GSSManager.createName(byte[], Oid)`](GSSManager.md#createName(byte%5B%5D,org.ietf.jgss.Oid))
...
* ## Method Summary
  ...
  representation of this name that can be obtained from the `toString` method.
...
* ## Field Details
  ...
  + ### NT\_HOSTBASED\_SERVICE

    static final [Oid](Oid.md "class in org.ietf.jgss") NT\_HOSTBASED\_SERVICE
  ...
  + ### NT\_USER\_NAME
    ...
    static final [Oid](Oid.md "class in org.ietf.jgss") NT\_USER\_NAME
  ...
  + ### NT\_MACHINE\_UID\_NAME

    static final [Oid](Oid.md "class in org.ietf.jgss") NT\_MACHINE\_UID\_NAME
  ...
  + ### NT\_STRING\_UID\_NAME

    static final [Oid](Oid.md "class in org.ietf.jgss") NT\_STRING\_UID\_NAME
  ...
  + ### NT\_ANONYMOUS
    ...
    static final [Oid](Oid.md "class in org.ietf.jgss") NT\_ANONYMOUS
  ...
  + ### NT\_EXPORT\_NAME
    ...
    static final [Oid](Oid.md "class in org.ietf.jgss") NT\_EXPORT\_NAME
...
* ## Method Details
  ...
  + ### equals
    ...
    boolean equals([GSSName](GSSName.md "interface in org.ietf.jgss") another)
  ...
  + ### equals
    ...
    Compares this `GSSName` object to another Object that might be a
    `GSSName`. The behaviour is exactly the same as in [`equals`](#equals(org.ietf.jgss.GSSName)) except that no GSSException is thrown;
    ...
    Returns:
    :   true if the object to compare to is also a `GSSName` and the two
  ...
  + ### canonicalize
    ...
    [GSSName](GSSName.md "interface in org.ietf.jgss") canonicalize([Oid](Oid.md "class in org.ietf.jgss") mech)
    throws [GSSException](GSSException.md "class in org.ietf.jgss")
    ...
    Returns:
    :   a `GSSName` that contains just one primitive
  ...
  + ### export
    ...
    GSSException with the NAME\_NOT\_MN status code. If an implementation
    ...
    method [`GSSManager.createName`](GSSManager.md#createName(byte%5B%5D,org.ietf.jgss.Oid)) and specifying the NT\_EXPORT\_NAME as the name
  ...
  + ### toString
    ...
    string, use the [`getStringNameType`](#getStringNameType())
    method.
  ...
  + ### getStringNameType
    ...
    [Oid](Oid.md "class in org.ietf.jgss") getStringNameType()
    throws [GSSException](GSSException.md "class in org.ietf.jgss")
