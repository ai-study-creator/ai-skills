...
* [`loadClass(URL,String)`](#loadClass(java.net.URL,java.lang.String))* [`loadClass(String,String)`](#loadClass(java.lang.String,java.lang.String))* [`loadClass(String,String,ClassLoader)`](#loadClass(java.lang.String,java.lang.String,java.lang.ClassLoader))* [`loadProxyClass(String,String[],ClassLoader)`](#loadProxyClass(java.lang.String,java.lang.String%5B%5D,java.lang.ClassLoader))* [`getClassLoader(String)`](#getClassLoader(java.lang.String))* [`getClassAnnotation(Class)`](#getClassAnnotation(java.lang.Class))

is provided by an instance of [`RMIClassLoaderSpi`](RMIClassLoaderSpi.md "class in java.rmi.server"), the
...
* If the system property
  ...
  instance will be the value returned by an invocation of the [`getDefaultProviderInstance()`](#getDefaultProviderInstance()) method, and for any other value, if
  a class named with the value of the property can be loaded by the
  system class loader (see [`ClassLoader.getSystemClassLoader()`](../../../../java.base/java/lang/ClassLoader.md#getSystemClassLoader()))
  and that class is assignable to [`RMIClassLoaderSpi`](RMIClassLoaderSpi.md "class in java.rmi.server") and has a
  ...
  obtain a provider instance.* If a resource named
    ...
    class loader and that class is assignable to [`RMIClassLoaderSpi`](RMIClassLoaderSpi.md "class in java.rmi.server") and has a public no-argument constructor, then
    ...
    the failure to obtain a provider instance.* Otherwise, the provider instance will be the value returned by
      an invocation of the [`getDefaultProviderInstance()`](#getDefaultProviderInstance()) method.
...
* ## Method Summary
  ...
  for the service provider interface [`RMIClassLoaderSpi`](RMIClassLoaderSpi.md "class in java.rmi.server").
...
* ## Method Details
  ...
  + ### loadClass
    ...
    public static [Class](../../../../java.base/java/lang/Class.md "class in java.lang")<?> loadClass([String](../../../../java.base/java/lang/String.md "class in java.lang") name)
    ...
    This method delegates to [`loadClass(String,String)`](#loadClass(java.lang.String,java.lang.String)),
    ...
    See Also:
    :   - [`loadClass(String,String)`](#loadClass(java.lang.String,java.lang.String))
  + ### loadClass

    public static [Class](../../../../java.base/java/lang/Class.md "class in java.lang")<?> loadClass([URL](../../../../java.base/java/net/URL.md "class in java.net") codebase,
    ...
    will behave the same as [`loadClass(String,String)`](#loadClass(java.lang.String,java.lang.String)) with a
    `null` `codebase` and the given class name.

    This method delegates to the
    [`RMIClassLoaderSpi.loadClass(String,String,ClassLoader)`](RMIClassLoaderSpi.md#loadClass(java.lang.String,java.lang.String,java.lang.ClassLoader))
    method of the provider instance, passing the result of invoking
    [`URL.toString()`](../../../../java.base/java/net/URL.md#toString()) on the given URL (or `null` if
  ...
  + ### loadClass
    ...
    public static [Class](../../../../java.base/java/lang/Class.md "class in java.lang")<?> loadClass([String](../../../../java.base/java/lang/String.md "class in java.lang") codebase,
    [String](../../../../java.base/java/lang/String.md "class in java.lang") name)
    throws [MalformedURLException](../../../../java.base/java/net/MalformedURLException.md "class in java.net"),
    [ClassNotFoundException](../../../../java.base/java/lang/ClassNotFoundException.md "class in java.lang")
  ...
  + ### loadProxyClass
    ...
    public static [Class](../../../../java.base/java/lang/Class.md "class in java.lang")<?> loadProxyClass([String](../../../../java.base/java/lang/String.md "class in java.lang") codebase,
    ...
    the [`loadClass(String,String)`](#loadClass(java.lang.String,java.lang.String)) method using the given
    `codebase`.

    This method delegates to the
    [`RMIClassLoaderSpi.loadProxyClass(String,String[],ClassLoader)`](RMIClassLoaderSpi.md#loadProxyClass(java.lang.String,java.lang.String%5B%5D,java.lang.ClassLoader))
    method of the provider instance, passing `codebase`
  ...
  + ### getClassLoader
    ...
    public static [ClassLoader](../../../../java.base/java/lang/ClassLoader.md "class in java.lang") getClassLoader([String](../../../../java.base/java/lang/String.md "class in java.lang") codebase)
    throws [MalformedURLException](../../../../java.base/java/net/MalformedURLException.md "class in java.net"),
    ...
    [`loadClass(String,String)`](#loadClass(java.lang.String,java.lang.String)) method would use to load classes
    for the same `codebase` argument.

    This method delegates to the
    [`RMIClassLoaderSpi.getClassLoader(String)`](RMIClassLoaderSpi.md#getClassLoader(java.lang.String)) method
  ...
  + ### getClassAnnotation
    ...
    public static [String](../../../../java.base/java/lang/String.md "class in java.lang") getClassAnnotation([Class](../../../../java.base/java/lang/Class.md "class in java.lang")<?> cl)
    ...
    This method delegates to the
    [`RMIClassLoaderSpi.getClassAnnotation(Class)`](RMIClassLoaderSpi.md#getClassAnnotation(java.lang.Class)) method
  ...
  + ### getDefaultProviderInstance
    ...
    public static [RMIClassLoaderSpi](RMIClassLoaderSpi.md "class in java.rmi.server") getDefaultProviderInstance()
    ...
    methods
    - [`loadClass(URL,String)`](#loadClass(java.net.URL,java.lang.String))- [`loadClass(String,String)`](#loadClass(java.lang.String,java.lang.String))- [`loadClass(String,String,ClassLoader)`](#loadClass(java.lang.String,java.lang.String,java.lang.ClassLoader))- [`loadProxyClass(String,String[],ClassLoader)`](#loadProxyClass(java.lang.String,java.lang.String%5B%5D,java.lang.ClassLoader))- [`getClassLoader(String)`](#getClassLoader(java.lang.String))- [`getClassAnnotation(Class)`](#getClassAnnotation(java.lang.Class))will use the canonical instance of the default provider
    ...
    [`RMIClassLoaderSpi`](RMIClassLoaderSpi.md "class in java.rmi.server") as follows:
    > The **[`getClassAnnotation`](RMIClassLoaderSpi.md#getClassAnnotation(java.lang.Class))** method returns a `String`
    ...
    >   [`ClassLoader.getSystemClassLoader()`](../../../../java.base/java/lang/ClassLoader.md#getSystemClassLoader())), a parent of the
    ...
    >   `null` is returned if that property is not set.- Otherwise, if the class loader is an instance of
    ...
    >     `null` is returned if that property is not set.- Finally, if the class loader is not an instance of
    ...
    > [`Thread.getContextClassLoader()`](../../../../java.base/java/lang/Thread.md#getContextClassLoader())). When there is a
    > security manager, this provider maintains an internal table of
    > class loader instances (which are at least instances of [`URLClassLoader`](../../../../java.base/java/net/URLClassLoader.md "class in java.net")) keyed by the pair of their parent
    ...
    >
    > The **[`getClassLoader`](RMIClassLoaderSpi.md#getClassLoader(java.lang.String))** method returns the codebase loader for the
    ...
    >
    > The **[`loadClass`](RMIClassLoaderSpi.md#loadClass(java.lang.String,java.lang.String,java.lang.ClassLoader))** method attempts to load the class with the
    ...
    >
    > The **[`loadProxyClass`](RMIClassLoaderSpi.md#loadProxyClass(java.lang.String,java.lang.String%5B%5D,java.lang.ClassLoader))** method attempts to return a dynamic proxy
    ...
    > >   [`Proxy.getProxyClass`](../../../../java.base/java/lang/reflect/Proxy.md#getProxyClass(java.lang.ClassLoader,java.lang.Class...))) for the resolved interfaces defined in
    ...
    > >   exception is thrown, that exception is thrown to the caller.- if all of the non-`public` resolved interfaces
    > >     are defined in the same class loader, then it attempts to
    > >     obtain a dynamic proxy class for the resolved interfaces
    > >     defined in that loader.- otherwise, a `LinkageError` is thrown (because a
    ...
    > >   method throws a `ClassNotFoundException`.- if all of the non-`public` resolved interfaces
    > >     are defined in the same class loader, then it attempts to
    > >     obtain a dynamic proxy class for the resolved interfaces
    > >     defined in that loader.- otherwise, a `LinkageError` is thrown (because a
    > >       class that implements all of the specified interfaces cannot be
  ...
  + ### getSecurityContext
    ...
    [@Deprecated](../../../../java.base/java/lang/Deprecated.md "annotation interface in java.lang")
    public static [Object](../../../../java.base/java/lang/Object.md "class in java.lang") getSecurityContext([ClassLoader](../../../../java.base/java/lang/ClassLoader.md "class in java.lang") loader)
    ...
    See Also:
    :   - [`SecurityManager.getSecurityContext()`](../../../../java.base/java/lang/SecurityManager.md#getSecurityContext())