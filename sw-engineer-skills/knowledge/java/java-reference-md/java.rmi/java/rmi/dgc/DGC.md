...
* ## Method Details
  ...
  + ### dirty
    ...
    [Lease](Lease.md "class in java.rmi.dgc") dirty([ObjID](../server/ObjID.md "class in java.rmi.server")[] ids,
    long sequenceNum,
    [Lease](Lease.md "class in java.rmi.dgc") lease)
  ...
  + ### clean
    ...
    void clean([ObjID](../server/ObjID.md "class in java.rmi.server")[] ids,
    long sequenceNum,
    [VMID](VMID.md "class in java.rmi.dgc") vmid,
    boolean strong)
    throws [RemoteException](../RemoteException.md "class in java.rmi")
