...
of the [`Descriptor`](../Descriptor.md "interface in javax.management") for an attribute or
...
* ## Method Details
  ...
  + ### toCompositeData
    ...
    [CompositeData](CompositeData.md "interface in javax.management.openmbean") toCompositeData([CompositeType](CompositeType.md "class in javax.management.openmbean") ct)

    Return a `CompositeData` corresponding to the values in
    this object. The returned value should usually be an instance of
    [`CompositeDataSupport`](CompositeDataSupport.md "class in javax.management.openmbean"), or a class that serializes as a
    ...
    Parameters:
    :   `ct` - The expected `CompositeType` of the returned
        value. If the returned value is `cd`, then
        `cd.getCompositeType().equals(ct)` should be true.
        Typically this will be because `cd` is a
        [`CompositeDataSupport`](CompositeDataSupport.md "class in javax.management.openmbean") constructed with `ct` as its
        `CompositeType`.
