...
approximated by using [`MBeanServerFactory.findMBeanServer(java.lang.String)`](MBeanServerFactory.md#findMBeanServer(java.lang.String)) to
find all known MBean servers, and consulting the [`ClassLoaderRepository`](loading/ClassLoaderRepository.md "interface in javax.management.loading") of each one. It is strongly recommended
...
* ## Constructor Summary
  ...
  Constructs an `DefaultLoaderRepository`.
* ## Method Summary
