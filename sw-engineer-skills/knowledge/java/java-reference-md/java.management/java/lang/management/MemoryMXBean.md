...
the [`ManagementFactory.getMemoryMXBean()`](ManagementFactory.md#getMemoryMXBean()) method or
...
> [`java.lang:type=Memory`](ManagementFactory.md#MEMORY_MXBEAN_NAME)
...
[`memory managers`](MemoryManagerMXBean.md "interface in java.lang.management") are the abstract entities
...
Details are specified in the [`MemoryPoolMXBean`](MemoryPoolMXBean.md "interface in java.lang.management") interface.
...
that emits two types of memory [`notifications`](../../../javax/management/Notification.md "class in javax.management") if any one of the memory pools
supports a [usage threshold](MemoryPoolMXBean.md#UsageThreshold)
or a [collection usage
threshold](MemoryPoolMXBean.md#CollectionThreshold) which can be determined by calling the
[`MemoryPoolMXBean.isUsageThresholdSupported()`](MemoryPoolMXBean.md#isUsageThresholdSupported()) and
[`MemoryPoolMXBean.isCollectionUsageThresholdSupported()`](MemoryPoolMXBean.md#isCollectionUsageThresholdSupported()) methods.

* [`usage threshold exceeded notification`](MemoryNotificationInfo.md#MEMORY_THRESHOLD_EXCEEDED) - for notifying that
  the memory usage of a memory pool is increased and has reached
  or exceeded its
   [usage threshold](MemoryPoolMXBean.md#UsageThreshold) value.
* [`collection usage threshold exceeded notification`](MemoryNotificationInfo.md#MEMORY_COLLECTION_THRESHOLD_EXCEEDED) - for notifying that
  the memory usage of a memory pool is greater than or equal to its
  [collection usage threshold](MemoryPoolMXBean.md#CollectionThreshold) after the Java virtual machine
  has expended effort in recycling unused objects in that
  memory pool.

The notification emitted is a [`Notification`](../../../javax/management/Notification.md "class in javax.management")
instance whose [`user data`](../../../javax/management/Notification.md#setUserData(java.lang.Object)) is set to a [`CompositeData`](../../../javax/management/openmbean/CompositeData.md "interface in javax.management.openmbean")
that represents a [`MemoryNotificationInfo`](MemoryNotificationInfo.md "class in java.lang.management") object
...
as described in [`MemoryNotificationInfo`](MemoryNotificationInfo.md#from(javax.management.openmbean.CompositeData)).
...
[`ManagementFactory.getMemoryMXBean()`](ManagementFactory.md#getMemoryMXBean()) implements
the [`NotificationEmitter`](../../../javax/management/NotificationEmitter.md "interface in javax.management")
...
* ## Method Details
  ...
  + ### getObjectPendingFinalizationCount
    ...
    [@Deprecated](../../../../java.base/java/lang/Deprecated.md "annotation interface in java.lang")([since](../../../../java.base/java/lang/Deprecated.md#since())="18")
  ...
  + ### getHeapMemoryUsage
    ...
    [MemoryUsage](MemoryUsage.md "class in java.lang.management") getHeapMemoryUsage()
    ...
    **MBeanServer access**:  
    ...
    Returns:
    :   a [`MemoryUsage`](MemoryUsage.md "class in java.lang.management") object representing
        the heap memory usage.
  + ### getNonHeapMemoryUsage

    [MemoryUsage](MemoryUsage.md "class in java.lang.management") getNonHeapMemoryUsage()
  ...
  + ### gc
    ...
    See Also:
    :   - [`System.gc()`](../../../../java.base/java/lang/System.md#gc())