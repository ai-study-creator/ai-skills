...
extends [Context](../Context.md "interface in javax.naming")
...
* ## Field Details
  ...
  + ### ADD\_ATTRIBUTE
    ...
    static final int ADD\_ATTRIBUTE
    ...
    :   - [`ModificationItem`](ModificationItem.md "class in javax.naming.directory")
        - [`modifyAttributes(javax.naming.Name, int, javax.naming.directory.Attributes)`](#modifyAttributes(javax.naming.Name,int,javax.naming.directory.Attributes))
        - [Constant Field Values](../../../../constant-values.md#javax.naming.directory.DirContext.ADD_ATTRIBUTE)
  + ### REPLACE\_ATTRIBUTE

    static final int REPLACE\_ATTRIBUTE
    ...
    :   - [`ModificationItem`](ModificationItem.md "class in javax.naming.directory")
        - [`modifyAttributes(javax.naming.Name, int, javax.naming.directory.Attributes)`](#modifyAttributes(javax.naming.Name,int,javax.naming.directory.Attributes))
        - [Constant Field Values](../../../../constant-values.md#javax.naming.directory.DirContext.REPLACE_ATTRIBUTE)
  + ### REMOVE\_ATTRIBUTE

    static final int REMOVE\_ATTRIBUTE
    ...
    :   - [`ModificationItem`](ModificationItem.md "class in javax.naming.directory")
        - [`modifyAttributes(javax.naming.Name, int, javax.naming.directory.Attributes)`](#modifyAttributes(javax.naming.Name,int,javax.naming.directory.Attributes))
        - [Constant Field Values](../../../../constant-values.md#javax.naming.directory.DirContext.REMOVE_ATTRIBUTE)
* ## Method Details

  + ### getAttributes

    [Attributes](Attributes.md "interface in javax.naming.directory") getAttributes([Name](../Name.md "interface in javax.naming") name)
    ...
    See Also:
    :   - [`getAttributes(String)`](#getAttributes(java.lang.String))
        - [`getAttributes(Name, String[])`](#getAttributes(javax.naming.Name,java.lang.String%5B%5D))
  + ### getAttributes

    [Attributes](Attributes.md "interface in javax.naming.directory") getAttributes([String](../../../../java.base/java/lang/String.md "class in java.lang") name)
    throws [NamingException](../NamingException.md "class in javax.naming")

    Retrieves all of the attributes associated with a named object.
    See [`getAttributes(Name)`](#getAttributes(javax.naming.Name)) for details.
  ...
  + ### getAttributes
    ...
    Retrieves selected attributes associated with a named object.
    See [`getAttributes(Name, String[])`](#getAttributes(javax.naming.Name,java.lang.String%5B%5D)) for details.
  ...
  + ### modifyAttributes
    ...
    void modifyAttributes([Name](../Name.md "interface in javax.naming") name,
    int mod\_op,
    ...
    See Also:
    :   - [`modifyAttributes(Name, ModificationItem[])`](#modifyAttributes(javax.naming.Name,javax.naming.directory.ModificationItem%5B%5D))
  + ### modifyAttributes

    void modifyAttributes([String](../../../../java.base/java/lang/String.md "class in java.lang") name,
    int mod\_op,
    [Attributes](Attributes.md "interface in javax.naming.directory") attrs)
    throws [NamingException](../NamingException.md "class in javax.naming")

    Modifies the attributes associated with a named object.
    See [`modifyAttributes(Name, int, Attributes)`](#modifyAttributes(javax.naming.Name,int,javax.naming.directory.Attributes)) for details.
  ...
  + ### modifyAttributes
    ...
    See Also:
    :   - [`modifyAttributes(Name, int, Attributes)`](#modifyAttributes(javax.naming.Name,int,javax.naming.directory.Attributes))
        - [`ModificationItem`](ModificationItem.md "class in javax.naming.directory")
  + ### modifyAttributes
    ...
    Modifies the attributes associated with a named object using
    an ordered list of modifications.
    See [`modifyAttributes(Name, ModificationItem[])`](#modifyAttributes(javax.naming.Name,javax.naming.directory.ModificationItem%5B%5D)) for details.
  ...
  + ### bind
    ...
    :   - [`Context.bind(Name, Object)`](../Context.md#bind(javax.naming.Name,java.lang.Object))
        - [`rebind(Name, Object, Attributes)`](#rebind(javax.naming.Name,java.lang.Object,javax.naming.directory.Attributes))
  + ### bind
    ...
    Binds a name to an object, along with associated attributes.
    See [`bind(Name, Object, Attributes)`](#bind(javax.naming.Name,java.lang.Object,javax.naming.directory.Attributes)) for details.
  ...
  + ### rebind
    ...
    See Also:
    :   - [`Context.bind(Name, Object)`](../Context.md#bind(javax.naming.Name,java.lang.Object))
        - [`bind(Name, Object, Attributes)`](#bind(javax.naming.Name,java.lang.Object,javax.naming.directory.Attributes))
  + ### rebind
    ...
    Binds a name to an object, along with associated attributes,
    overwriting any existing binding.
    See [`rebind(Name, Object, Attributes)`](#rebind(javax.naming.Name,java.lang.Object,javax.naming.directory.Attributes)) for details.
  ...
  + ### createSubcontext
    ...
    [DirContext](DirContext.md "interface in javax.naming.directory") createSubcontext([Name](../Name.md "interface in javax.naming") name,
    [Attributes](Attributes.md "interface in javax.naming.directory") attrs)
    throws [NamingException](../NamingException.md "class in javax.naming")
  ...
  + ### createSubcontext
    ...
    [DirContext](DirContext.md "interface in javax.naming.directory") createSubcontext([String](../../../../java.base/java/lang/String.md "class in java.lang") name,
    [Attributes](Attributes.md "interface in javax.naming.directory") attrs)
    throws [NamingException](../NamingException.md "class in javax.naming")

    Creates and binds a new context, along with associated attributes.
    See [`createSubcontext(Name, Attributes)`](#createSubcontext(javax.naming.Name,javax.naming.directory.Attributes)) for details.
  ...
  + ### getSchema
    ...
    [DirContext](DirContext.md "interface in javax.naming.directory") getSchema([Name](../Name.md "interface in javax.naming") name)
    throws [NamingException](../NamingException.md "class in javax.naming")
  ...
  + ### getSchema
    ...
    [DirContext](DirContext.md "interface in javax.naming.directory") getSchema([String](../../../../java.base/java/lang/String.md "class in java.lang") name)
    throws [NamingException](../NamingException.md "class in javax.naming")

    Retrieves the schema associated with the named object.
    See [`getSchema(Name)`](#getSchema(javax.naming.Name)) for details.
  ...
  + ### getSchemaClassDefinition
    ...
    [DirContext](DirContext.md "interface in javax.naming.directory") getSchemaClassDefinition([Name](../Name.md "interface in javax.naming") name)
    throws [NamingException](../NamingException.md "class in javax.naming")
  ...
  + ### getSchemaClassDefinition
    ...
    [DirContext](DirContext.md "interface in javax.naming.directory") getSchemaClassDefinition([String](../../../../java.base/java/lang/String.md "class in java.lang") name)
    throws [NamingException](../NamingException.md "class in javax.naming")

    Retrieves a context containing the schema objects of the
    named object's class definitions.
    See [`getSchemaClassDefinition(Name)`](#getSchemaClassDefinition(javax.naming.Name)) for details.
  ...
  + ### search
    ...
    [NamingEnumeration](../NamingEnumeration.md "interface in javax.naming")<[SearchResult](SearchResult.md "class in javax.naming.directory")> search([Name](../Name.md "interface in javax.naming") name,
    ...
    *A*1 without affecting the comparison. It
    ...
    :   - [`SearchControls`](SearchControls.md "class in javax.naming.directory")
        ...
        - [`search(Name, String, Object[], SearchControls)`](#search(javax.naming.Name,java.lang.String,java.lang.Object%5B%5D,javax.naming.directory.SearchControls))
  + ### search

    [NamingEnumeration](../NamingEnumeration.md "interface in javax.naming")<[SearchResult](SearchResult.md "class in javax.naming.directory")> search([String](../../../../java.base/java/lang/String.md "class in java.lang") name,
    [Attributes](Attributes.md "interface in javax.naming.directory") matchingAttributes,
    [String](../../../../java.base/java/lang/String.md "class in java.lang")[] attributesToReturn)
    throws [NamingException](../NamingException.md "class in javax.naming")
    ...
    Searches in a single context for objects that contain a
    specified set of attributes, and retrieves selected attributes.
    See [`search(Name, Attributes, String[])`](#search(javax.naming.Name,javax.naming.directory.Attributes,java.lang.String%5B%5D)) for details.
  ...
  + ### search
    ...
    See [`search(Name, Attributes, String[])`](#search(javax.naming.Name,javax.naming.directory.Attributes,java.lang.String%5B%5D)) for a full description.
    ...
    See Also:
    :   - [`search(Name, Attributes, String[])`](#search(javax.naming.Name,javax.naming.directory.Attributes,java.lang.String%5B%5D))
  + ### search
    ...
    Searches in a single context for objects that contain a
    specified set of attributes.
    See [`search(Name, Attributes)`](#search(javax.naming.Name,javax.naming.directory.Attributes)) for details.
  ...
  + ### search
    ...
    given search filter. Performs the search as specified by
    the search controls.
    See [`search(Name, String, SearchControls)`](#search(javax.naming.Name,java.lang.String,javax.naming.directory.SearchControls)) for details.
  ...
  + ### search
    ...
    given search filter. Performs the search as specified by
    the search controls.
    See [`search(Name, String, Object[], SearchControls)`](#search(javax.naming.Name,java.lang.String,java.lang.Object%5B%5D,javax.naming.directory.SearchControls)) for details.
