...
:   * [`RefAddr`](RefAddr.md "class in javax.naming")
    ...
    * [Serialized Form](../../../serialized-form.md#javax.naming.BinaryRefAddr)
...
* ## Constructor Details
  ...
  + ### BinaryRefAddr
    ...
    public BinaryRefAddr([String](../../../java.base/java/lang/String.md "class in java.lang") addrType,
    byte[] src)
...
* ## Method Details
  ...
  + ### equals
    ...
    See Also:
    :   - [`RefAddr.getContent()`](RefAddr.md#getContent())
        - [`RefAddr.getType()`](RefAddr.md#getType())
  + ### hashCode
