...
* ## Field Details
  ...
  + ### CPE
    ...
    public static final [String](../../../../java.base/java/lang/String.md "class in java.lang") CPE
    ...
    See Also:
    :   - [`getContinuationContext(javax.naming.CannotProceedException)`](#getContinuationContext(javax.naming.CannotProceedException))
        - [Constant Field Values](../../../../constant-values.md#javax.naming.spi.NamingManager.CPE)
* ## Method Details

  + ### setObjectFactoryBuilder

    public static void setObjectFactoryBuilder([ObjectFactoryBuilder](ObjectFactoryBuilder.md "interface in javax.naming.spi") builder)
    ...
    See Also:
    :   - [`getObjectInstance(java.lang.Object, javax.naming.Name, javax.naming.Context, java.util.Hashtable<?, ?>)`](#getObjectInstance(java.lang.Object,javax.naming.Name,javax.naming.Context,java.util.Hashtable))
  ...
  + ### getObjectInstance
    ...
    1. If `refInfo` is a `Reference`
       ...
       it is passed up to the caller.+ If `refInfo` is a `Reference` or
    ...
    See Also:
    :   - [`getURLContext(java.lang.String, java.util.Hashtable<?, ?>)`](#getURLContext(java.lang.String,java.util.Hashtable))
        - [`ObjectFactory`](ObjectFactory.md "interface in javax.naming.spi")
        - [`ObjectFactory.getObjectInstance(java.lang.Object, javax.naming.Name, javax.naming.Context, java.util.Hashtable<?, ?>)`](ObjectFactory.md#getObjectInstance(java.lang.Object,javax.naming.Name,javax.naming.Context,java.util.Hashtable))
  + ### getURLContext

    public static [Context](../Context.md "interface in javax.naming") getURLContext([String](../../../../java.base/java/lang/String.md "class in java.lang") scheme,
    [Hashtable](../../../../java.base/java/util/Hashtable.md "class in java.util")<?,?> environment)
    throws [NamingException](../NamingException.md "class in javax.naming")
    ...
    has the naming convention *scheme-id*URLContextFactory
    ...
    - com.widget.ldap.ldapURLContextFactory- com.wiz.jndi.ldap.ldapURLContextFactory- com.sun.jndi.url.ldap.ldapURLContextFactoryIf none of the package prefixes work, null is returned.
  ...
  + ### getInitialContext
    ...
    public static [Context](../Context.md "interface in javax.naming") getInitialContext([Hashtable](../../../../java.base/java/util/Hashtable.md "class in java.util")<?,?> env)
    throws [NamingException](../NamingException.md "class in javax.naming")
    ...
    - Otherwise, the class specified in the
      ...
      is used
      * First, the [ServiceLoader](../../../../java.base/java/util/ServiceLoader.md "class in java.util")
  ...
  + ### setInitialContextFactoryBuilder
    ...
    public static void setInitialContextFactoryBuilder([InitialContextFactoryBuilder](InitialContextFactoryBuilder.md "interface in javax.naming.spi") builder)
    throws [NamingException](../NamingException.md "class in javax.naming")
    ...
    See Also:
    :   - [`hasInitialContextFactoryBuilder()`](#hasInitialContextFactoryBuilder())
        - [`SecurityManager.checkSetFactory()`](../../../../java.base/java/lang/SecurityManager.md#checkSetFactory())
  + ### hasInitialContextFactoryBuilder
    ...
    See Also:
    :   - [`setInitialContextFactoryBuilder(javax.naming.spi.InitialContextFactoryBuilder)`](#setInitialContextFactoryBuilder(javax.naming.spi.InitialContextFactoryBuilder))
  + ### getContinuationContext

    public static [Context](../Context.md "interface in javax.naming") getContinuationContext([CannotProceedException](../CannotProceedException.md "class in javax.naming") cpe)
    throws [NamingException](../NamingException.md "class in javax.naming")
    ...
    the value of the property [`CPE`](#CPE)
  ...
  + ### getStateToBind
    ...
    public static [Object](../../../../java.base/java/lang/Object.md "class in java.lang") getStateToBind([Object](../../../../java.base/java/lang/Object.md "class in java.lang") obj,
    [Name](../Name.md "interface in javax.naming") name,
    [Context](../Context.md "interface in javax.naming") nameCtx,
    [Hashtable](../../../../java.base/java/util/Hashtable.md "class in java.util")<?,?> environment)
    throws [NamingException](../NamingException.md "class in javax.naming")
    ...
    :   - [`StateFactory`](StateFactory.md "interface in javax.naming.spi")
        - [`StateFactory.getStateToBind(java.lang.Object, javax.naming.Name, javax.naming.Context, java.util.Hashtable<?, ?>)`](StateFactory.md#getStateToBind(java.lang.Object,javax.naming.Name,javax.naming.Context,java.util.Hashtable))
