...
extends [StateFactory](StateFactory.md "interface in javax.naming.spi")
...
* ## Method Summary
  ...
  ### Methods inherited from interface javax.naming.spi.[StateFactory](StateFactory.md "interface in javax.naming.spi")
...
* ## Method Details
  ...
  + ### getStateToBind
    ...
    [DirStateFactory.Result](DirStateFactory.Result.md "class in javax.naming.spi") getStateToBind([Object](../../../../java.base/java/lang/Object.md "class in java.lang") obj,
    ...
    [Attributes](../directory/Attributes.md "interface in javax.naming.directory") inAttrs)
    ...
    Returns:
    :   A `Result` containing the object's state for binding
