...
* ## Method Details
  ...
  + ### getObjectInstance
    ...
    1. If `obj` is null, create a context for resolving URLs of the
       ...
       "ldap://ldap.umich.edu/o=umich,c=us".+ If `obj` is a URL string, create an object (typically a context)
         ...
         relative to that context.+ If `obj` is an array of URL strings, the assumption is that the
           ...
           URL case. It is the object named by the URLs.+ If `obj` is of any other type, the behavior of
