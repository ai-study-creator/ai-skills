...
extends [Enumeration](../../../java.base/java/util/Enumeration.md "interface in java.util")<T>
...
:   * [`Context.list(javax.naming.Name)`](Context.md#list(javax.naming.Name))
    * [`Context.listBindings(javax.naming.Name)`](Context.md#listBindings(javax.naming.Name))
    * [`DirContext.search(javax.naming.Name, javax.naming.directory.Attributes, java.lang.String[])`](directory/DirContext.md#search(javax.naming.Name,javax.naming.directory.Attributes,java.lang.String%5B%5D))
    * [`Attributes.getAll()`](directory/Attributes.md#getAll())
    * [`Attributes.getIDs()`](directory/Attributes.md#getIDs())
    * [`Attribute.getAll()`](directory/Attribute.md#getAll())
...
* ## Method Summary
  ...
  ### Methods inherited from interface java.util.[Enumeration](../../../java.base/java/util/Enumeration.md "interface in java.util")
...
* ## Method Details
  ...
  + ### next
    ...
    [T](NamingEnumeration.md "type parameter in NamingEnumeration") next()
    ...
    See Also:
    :   - [`Enumeration.nextElement()`](../../../java.base/java/util/Enumeration.md#nextElement())
  + ### hasMore
    ...
    See Also:
    :   - [`Enumeration.hasMoreElements()`](../../../java.base/java/util/Enumeration.md#hasMoreElements())
  + ### close
