...
* It is removed using `removeNamingListener()`.* An exception is thrown while collecting information about the events.
    That is, when the listener receives a `NamingExceptionEvent`.* `Context.close()` is invoked on the `EventContext`
...
* ## Field Details
  ...
  + ### OBJECT\_SCOPE
    ...
    static final int OBJECT\_SCOPE
    ...
    See Also:
    :   - [Constant Field Values](../../../../constant-values.md#javax.naming.event.EventContext.OBJECT_SCOPE)
  + ### ONELEVEL\_SCOPE

    static final int ONELEVEL\_SCOPE
    ...
    See Also:
    :   - [Constant Field Values](../../../../constant-values.md#javax.naming.event.EventContext.ONELEVEL_SCOPE)
  + ### SUBTREE\_SCOPE

    static final int SUBTREE\_SCOPE
    ...
    See Also:
    :   - [Constant Field Values](../../../../constant-values.md#javax.naming.event.EventContext.SUBTREE_SCOPE)
* ## Method Details
  ...
  + ### addNamingListener
    ...
    :   `scope` - One of `OBJECT_SCOPE`, `ONELEVEL_SCOPE`, or
        `SUBTREE_SCOPE`.
    ...
    See Also:
    :   - [`removeNamingListener(javax.naming.event.NamingListener)`](#removeNamingListener(javax.naming.event.NamingListener))
  + ### addNamingListener
  ...
  + ### removeNamingListener
    ...
    void removeNamingListener([NamingListener](NamingListener.md "interface in javax.naming.event") l)
    throws [NamingException](../NamingException.md "class in javax.naming")
    ...
    See Also:
    :   - [`addNamingListener(javax.naming.Name, int, javax.naming.event.NamingListener)`](#addNamingListener(javax.naming.Name,int,javax.naming.event.NamingListener))
  + ### targetMustExist
