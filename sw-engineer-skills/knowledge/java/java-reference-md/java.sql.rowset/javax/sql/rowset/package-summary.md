...
* [1.0 Package Specification](#pkgspec)* [2.0 Standard RowSet Definitions](#stdrowset)* [3.0 Implementer's Guide](#impl)* [4.0 Related Specifications](#relspec)* [5.0 Related Documentation](#reldocs)

### 1.0 Package Specification

This package specifies five standard JDBC `RowSet` interfaces.
All five extend the
[`RowSet`](../../../../java.sql/javax/sql/RowSet.md "interface in javax.sql") interface described in the JDBC 3.0
...
* [**`JdbcRowSet`**](JdbcRowSet.md) - A wrapper around
  ...
  **must** continually maintain its connection to its data source using a JDBC
  ...
  data structure as defined in the JDBC 3.0 specification.* [**`CachedRowSet`**](CachedRowSet.md)
    ...
    **must** use the `SyncFactory` to manage and obtain pluggable
    ...
    Further details on this mechanism are discussed in the [`javax.sql.rowset.spi`](spi/package-summary.md) package
    specification.* [**`WebRowSet`**](WebRowSet.md) - A
      `WebRowSet` object is an extension of `CachedRowSet`
      that can read and write a `RowSet` object in a well formed XML format.
      This class calls an [`XmlReader`](spi/XmlReader.md) object
      (an extension of the [`RowSetReader`](../../../../java.sql/javax/sql/RowSetReader.md "interface in javax.sql")
      interface) to read a rowset in XML format. It calls an
      [`XmlWriter`](spi/XmlWriter.md) object (an extension of the
      [`RowSetWriter`](../../../../java.sql/javax/sql/RowSetWriter.md "interface in javax.sql") interface)
      ...
      [`http://xmlns.jcp.org/xml/ns//jdbc/webrowset.xsd`](http://xmlns.jcp.org/xml/ns//jdbc/webrowset.xsd).* [**`FilteredRowSet`**](FilteredRowSet.md) - A
        ...
        an implementation of the [`Predicate`](Predicate.md "interface in javax.sql.rowset")
        ...
        implemented.* [**`JoinRowSet`**](JoinRowSet.md) - The `JoinRowSet`
          ...
          objects can be added to a `JoinRowSet` object provided the `RowSet`objects
...
with the terms of the [Java Community Process](http://www.jcp.org), a
...
should also consult the *Implementer's Guide* in the [javax.sql.rowset.spi](spi/package-summary.md) package for guidelines
on [`SyncProvider`](spi/SyncProvider.md) implementations.
...
* **3.2 Role of the `BaseRowSet` Class**
  ...
  [`BaseRowSet`](BaseRowSet.md "class in javax.sql.rowset") abstract class. For example, a
  ...
  * **3.3 Connected RowSet Requirements**
    ...
    `ResultSet` implementation.* **3.4 Disconnected RowSet Requirements**
      ...
      **should** delegate
      ...
      extraneous references remain on the `Connection` object.* **3.5 Role of RowSetMetaDataImpl**

        The `RowsetMetaDataImpl` class is a utility class that provides an implementation of the
        [`RowSetMetaData`](../../../../java.sql/javax/sql/RowSetMetaData.md "interface in javax.sql") interface, supplying standard setter
        ...
        implementation but are not required to do so.* **3.6 RowSetWarning Class**

          The `RowSetWarning` class provides warnings that can be set
          on `RowSet` implementations.
          Similar to [`SQLWarning`](../../../../java.sql/java/sql/SQLWarning.md "class in java.sql") objects,
          ...
          on it, and so on until there are no more warnings.* **3.7 The Joinable Interface**
...
* [JDBC 4.3 Specification](https://jcp.org/en/jsr/detail?id=221)* [XML Schema](http://www.w3.org/XML/Schema)
...
* Related Packages
  ...
  [javax.sql](../../../../java.sql/javax/sql/package-summary.md)

  Provides the API for server side data source access and processing from
  the Java programming language.

  [java.sql.rowset](../../../module-summary.md)
  ...
  [javax.sql.rowset.spi](spi/package-summary.md)
...
* All Classes and InterfacesInterfacesClassesException Classes
  ...
  [BaseRowSet](BaseRowSet.md "class in javax.sql.rowset")
  ...
  [Joinable](Joinable.md "interface in javax.sql.rowset")
  ...
  [Predicate](Predicate.md "interface in javax.sql.rowset")

  The standard interface that provides the framework for all
  `FilteredRowSet` objects to describe their filters.

  [RowSetFactory](RowSetFactory.md "interface in javax.sql.rowset")
  ...
  [RowSetMetaDataImpl](RowSetMetaDataImpl.md "class in javax.sql.rowset")

  Provides implementations for the methods that set and get
  metadata information about a `RowSet` object's columns.

  [RowSetProvider](RowSetProvider.md "class in javax.sql.rowset")
  ...
  [WebRowSet](WebRowSet.md "interface in javax.sql.rowset")
