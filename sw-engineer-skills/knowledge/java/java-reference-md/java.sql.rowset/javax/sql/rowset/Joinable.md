...
* ## Method Details
  ...
  + ### setMatchColumn
    ...
    See Also:
    :   - [`setMatchColumn(int[])`](#setMatchColumn(int%5B%5D))
        - [`unsetMatchColumn(int)`](#unsetMatchColumn(int))
  + ### setMatchColumn
    ...
    See Also:
    :   - [`setMatchColumn(int[])`](#setMatchColumn(int%5B%5D))
        - [`unsetMatchColumn(int[])`](#unsetMatchColumn(int%5B%5D))
  + ### setMatchColumn

    void setMatchColumn([String](../../../../java.base/java/lang/String.md "class in java.lang") columnName)
    throws [SQLException](../../../../java.sql/java/sql/SQLException.md "class in java.sql")
  ...
  + ### setMatchColumn
    ...
    void setMatchColumn([String](../../../../java.base/java/lang/String.md "class in java.lang")[] columnNames)
    throws [SQLException](../../../../java.sql/java/sql/SQLException.md "class in java.sql")
  ...
  + ### getMatchColumnIndexes
    ...
    Returns:
    :   an `int` array identifying the indexes of the columns
        that were set as the match columns for this `RowSet` object

    Throws:
    :   `SQLException` - if no match column has been set

    See Also:
    :   - [`setMatchColumn(int)`](#setMatchColumn(int))
        - [`unsetMatchColumn(int)`](#unsetMatchColumn(int))
  + ### getMatchColumnNames

    [String](../../../../java.base/java/lang/String.md "class in java.lang")[] getMatchColumnNames()
    throws [SQLException](../../../../java.sql/java/sql/SQLException.md "class in java.sql")
    ...
    Returns:
    :   an array of `String` objects giving the names of the columns
        set as the match columns for this `RowSet` object
  ...
  + ### unsetMatchColumn
    ...
    Parameters:
    :   `columnIdxes` - an array of `int` that identifies the indexes
  ...
  + ### unsetMatchColumn
    ...
    void unsetMatchColumn([String](../../../../java.base/java/lang/String.md "class in java.lang") columnName)
    throws [SQLException](../../../../java.sql/java/sql/SQLException.md "class in java.sql")
  ...
  + ### unsetMatchColumn
    ...
    Parameters:
    :   `columnName` - an array of `String` objects giving the names of
