...
extends [RowSet](../../../../java.sql/javax/sql/RowSet.md "interface in javax.sql"), [Joinable](Joinable.md "interface in javax.sql.rowset")
...
* *It includes `setter` methods:* A `RowSet`
  ...
  different `ResultSet` object.* *It contains fewer `getter` methods:* Some
...
* ## Field Details
  ...
  + ### COMMIT\_ON\_ACCEPT\_CHANGES

    [@Deprecated](../../../../java.base/java/lang/Deprecated.md "annotation interface in java.lang")
    static final boolean COMMIT\_ON\_ACCEPT\_CHANGES
    ...
    :   - [`commit()`](#commit())
        - [`rollback()`](#rollback())
        - [Constant Field Values](../../../../constant-values.md#javax.sql.rowset.CachedRowSet.COMMIT_ON_ACCEPT_CHANGES)
* ## Method Details

  + ### populate

    void populate([ResultSet](../../../../java.sql/java/sql/ResultSet.md "interface in java.sql") data)
    ...
    See Also:
    :   - [`execute(java.sql.Connection)`](#execute(java.sql.Connection))
        - [`ResultSet`](../../../../java.sql/java/sql/ResultSet.md "interface in java.sql")
        - [`ResultSetMetaData`](../../../../java.sql/java/sql/ResultSetMetaData.md "interface in java.sql")
  + ### execute

    void execute([Connection](../../../../java.sql/java/sql/Connection.md "interface in java.sql") conn)
    throws [SQLException](../../../../java.sql/java/sql/SQLException.md "class in java.sql")
    ...
    See Also:
    :   - [`populate(java.sql.ResultSet)`](#populate(java.sql.ResultSet))
        - [`Connection`](../../../../java.sql/java/sql/Connection.md "interface in java.sql")
  + ### acceptChanges

    void acceptChanges()
    throws [SyncProviderException](spi/SyncProviderException.md "class in javax.sql.rowset.spi")
    ...
    See Also:
    :   - [`acceptChanges(java.sql.Connection)`](#acceptChanges(java.sql.Connection))
        - [`RowSetWriter`](../../../../java.sql/javax/sql/RowSetWriter.md "interface in javax.sql")
        ...
        - [`SyncProviderException`](spi/SyncProviderException.md "class in javax.sql.rowset.spi")
        - [`SyncResolver`](spi/SyncResolver.md "interface in javax.sql.rowset.spi")
  + ### acceptChanges

    void acceptChanges([Connection](../../../../java.sql/java/sql/Connection.md "interface in java.sql") con)
    throws [SyncProviderException](spi/SyncProviderException.md "class in javax.sql.rowset.spi")
  ...
  + ### restoreOriginal
    ...
    See Also:
    :   - [`RowSetListener.rowSetChanged(javax.sql.RowSetEvent)`](../../../../java.sql/javax/sql/RowSetListener.md#rowSetChanged(javax.sql.RowSetEvent))
  + ### release
    ...
    See Also:
    :   - [`RowSetListener.rowSetChanged(javax.sql.RowSetEvent)`](../../../../java.sql/javax/sql/RowSetListener.md#rowSetChanged(javax.sql.RowSetEvent))
        - [`ResultSet.close()`](../../../../java.sql/java/sql/ResultSet.md#close())
  + ### undoDelete
    ...
    :   - [`undoInsert()`](#undoInsert())
        - [`ResultSet.cancelRowUpdates()`](../../../../java.sql/java/sql/ResultSet.md#cancelRowUpdates())
  + ### undoInsert
  ...
  + ### columnUpdated
    ...
    Returns:
    :   `true` if the designated column has been visibly updated;
        `false` otherwise
    ...
    See Also:
    :   - [`DatabaseMetaData.updatesAreDetected(int)`](../../../../java.sql/java/sql/DatabaseMetaData.md#updatesAreDetected(int))
  + ### columnUpdated

    boolean columnUpdated([String](../../../../java.base/java/lang/String.md "class in java.lang") columnName)
    throws [SQLException](../../../../java.sql/java/sql/SQLException.md "class in java.sql")
    ...
    Parameters:
    :   `columnName` - a `String` object giving the name of the
        column to be checked for updates

    Returns:
    :   `true` if the column has been visibly updated;
        `false` otherwise
  ...
  + ### toCollection
    ...
    [Collection](../../../../java.base/java/util/Collection.md "interface in java.util")<?> toCollection()
    throws [SQLException](../../../../java.sql/java/sql/SQLException.md "class in java.sql")
    ...
    Returns:
    :   a `Collection` object that contains the values in
        each row in this `CachedRowSet` object

    Throws:
    :   `SQLException` - if an error occurs generating the collection

    See Also:
    :   - [`toCollection(int)`](#toCollection(int))
        - [`toCollection(String)`](#toCollection(java.lang.String))
  + ### toCollection

    [Collection](../../../../java.base/java/util/Collection.md "interface in java.util")<?> toCollection(int column)
    throws [SQLException](../../../../java.sql/java/sql/SQLException.md "class in java.sql")
    ...
    Returns:
    :   a `Collection` object that contains the values
  ...
  + ### toCollection
    ...
    [Collection](../../../../java.base/java/util/Collection.md "interface in java.util")<?> toCollection([String](../../../../java.base/java/lang/String.md "class in java.lang") column)
    throws [SQLException](../../../../java.sql/java/sql/SQLException.md "class in java.sql")
  ...
  + ### getSyncProvider
    ...
    [SyncProvider](spi/SyncProvider.md "class in javax.sql.rowset.spi") getSyncProvider()
    throws [SQLException](../../../../java.sql/java/sql/SQLException.md "class in java.sql")
    ...
    Returns:
    :   the `SyncProvider` object that was set when the rowset
    ...
    See Also:
    :   - [`setSyncProvider(java.lang.String)`](#setSyncProvider(java.lang.String))
  + ### setSyncProvider

    void setSyncProvider([String](../../../../java.base/java/lang/String.md "class in java.lang") provider)
    throws [SQLException](../../../../java.sql/java/sql/SQLException.md "class in java.sql")
  ...
  + ### setMetaData
    ...
    void setMetaData([RowSetMetaData](../../../../java.sql/javax/sql/RowSetMetaData.md "interface in javax.sql") md)
    throws [SQLException](../../../../java.sql/java/sql/SQLException.md "class in java.sql")
    ...
    Parameters:
    :   `md` - a `RowSetMetaData` object containing
  ...
  + ### getOriginal
    ...
    [ResultSet](../../../../java.sql/java/sql/ResultSet.md "interface in java.sql") getOriginal()
    throws [SQLException](../../../../java.sql/java/sql/SQLException.md "class in java.sql")
    ...
    Returns:
    :   a `ResultSet` object that contains the original value for
        this `CachedRowSet` object
  ...
  + ### getOriginalRow
    ...
    [ResultSet](../../../../java.sql/java/sql/ResultSet.md "interface in java.sql") getOriginalRow()
    throws [SQLException](../../../../java.sql/java/sql/SQLException.md "class in java.sql")
  ...
  + ### getTableName
    ...
    [String](../../../../java.base/java/lang/String.md "class in java.lang") getTableName()
    throws [SQLException](../../../../java.sql/java/sql/SQLException.md "class in java.sql")
    ...
    Returns:
    :   a `String` object giving the name of the table that is the
        source of data for this `CachedRowSet` object or `null`
        if no name has been set for the table

    Throws:
    :   `SQLException` - if an error is encountered returning the table name

    See Also:
    :   - [`ResultSetMetaData.getTableName(int)`](../../../../java.sql/java/sql/ResultSetMetaData.md#getTableName(int))
  + ### setTableName

    void setTableName([String](../../../../java.base/java/lang/String.md "class in java.lang") tabName)
    throws [SQLException](../../../../java.sql/java/sql/SQLException.md "class in java.sql")
    ...
    See Also:
    :   - [`RowSetMetaData.setTableName(int, java.lang.String)`](../../../../java.sql/javax/sql/RowSetMetaData.md#setTableName(int,java.lang.String))
        - [`RowSetWriter`](../../../../java.sql/javax/sql/RowSetWriter.md "interface in javax.sql")
        - [`SyncProvider`](spi/SyncProvider.md "class in javax.sql.rowset.spi")
  + ### getKeyColumns
    ...
    Throws:
    :   `SQLException` - if this `CachedRowSet` object is empty

    See Also:
    :   - [`setKeyColumns(int[])`](#setKeyColumns(int%5B%5D))
        - [`Joinable.getMatchColumnIndexes()`](Joinable.md#getMatchColumnIndexes())
        - [`Joinable.getMatchColumnNames()`](Joinable.md#getMatchColumnNames())
  + ### setKeyColumns
    ...
    :   - [`getKeyColumns()`](#getKeyColumns())
        - [`Joinable.setMatchColumn(String)`](Joinable.md#setMatchColumn(java.lang.String))
        - [`Joinable.setMatchColumn(int)`](Joinable.md#setMatchColumn(int))
  + ### createShared

    [RowSet](../../../../java.sql/javax/sql/RowSet.md "interface in javax.sql") createShared()
    throws [SQLException](../../../../java.sql/java/sql/SQLException.md "class in java.sql")
    ...
    Returns:
    :   a new shared `RowSet` object that has the same properties
    ...
    See Also:
    :   - [`RowSetEvent`](../../../../java.sql/javax/sql/RowSetEvent.md "class in javax.sql")
        - [`RowSetListener`](../../../../java.sql/javax/sql/RowSetListener.md "interface in javax.sql")
  + ### createCopy

    [CachedRowSet](CachedRowSet.md "interface in javax.sql.rowset") createCopy()
    throws [SQLException](../../../../java.sql/java/sql/SQLException.md "class in java.sql")
    ...
    Returns:
    :   a new `RowSet` object that is a deep copy
    ...
    :   - [`createShared()`](#createShared())
        - [`createCopySchema()`](#createCopySchema())
        - [`createCopyNoConstraints()`](#createCopyNoConstraints())
        - [`RowSetEvent`](../../../../java.sql/javax/sql/RowSetEvent.md "class in javax.sql")
        - [`RowSetListener`](../../../../java.sql/javax/sql/RowSetListener.md "interface in javax.sql")
  + ### createCopySchema

    [CachedRowSet](CachedRowSet.md "interface in javax.sql.rowset") createCopySchema()
    throws [SQLException](../../../../java.sql/java/sql/SQLException.md "class in java.sql")
    ...
    Returns:
    :   An empty copy of this `CachedRowSet` object
  ...
  + ### createCopyNoConstraints
    ...
    [CachedRowSet](CachedRowSet.md "interface in javax.sql.rowset") createCopyNoConstraints()
    throws [SQLException](../../../../java.sql/java/sql/SQLException.md "class in java.sql")
    ...
    Returns:
    :   a new `CachedRowSet` object that is a deep copy
        of this `CachedRowSet` object and is
        completely independent of this `CachedRowSet` object
  ...
  + ### getRowSetWarnings
    ...
    [RowSetWarning](RowSetWarning.md "class in javax.sql.rowset") getRowSetWarnings()
    throws [SQLException](../../../../java.sql/java/sql/SQLException.md "class in java.sql")
    ...
    Returns:
    :   RowSetWarning the first `RowSetWarning`
        object reported or null if there are none

    Throws:
    :   `SQLException` - if this method is called on a closed RowSet

    See Also:
    :   - [`RowSetWarning`](RowSetWarning.md "class in javax.sql.rowset")
  + ### getShowDeleted
  ...
  + ### commit
    ...
    See Also:
    :   - [`Connection.setAutoCommit(boolean)`](../../../../java.sql/java/sql/Connection.md#setAutoCommit(boolean))
  + ### rollback
  ...
  + ### rowSetPopulated
    ...
    void rowSetPopulated([RowSetEvent](../../../../java.sql/javax/sql/RowSetEvent.md "class in javax.sql") event,
    int numRows)
    throws [SQLException](../../../../java.sql/java/sql/SQLException.md "class in java.sql")
  ...
  + ### populate
    ...
    void populate([ResultSet](../../../../java.sql/java/sql/ResultSet.md "interface in java.sql") rs,
    int startRow)
    throws [SQLException](../../../../java.sql/java/sql/SQLException.md "class in java.sql")
    ...
    Parameters:
    :   `rs` - the `ResultSet` object containing the data
        to be read into this `CachedRowSet` object
    ...
    See Also:
    :   - [`execute(java.sql.Connection)`](#execute(java.sql.Connection))
        - [`populate(ResultSet)`](#populate(java.sql.ResultSet))
        - [`ResultSet`](../../../../java.sql/java/sql/ResultSet.md "interface in java.sql")
        - [`ResultSetMetaData`](../../../../java.sql/java/sql/ResultSetMetaData.md "interface in java.sql")
  + ### setPageSize
  ...
  + ### previousPage
    ...
    Returns:
    :   true if the previous page is successfully retrieved; false if this
        is the first page.
