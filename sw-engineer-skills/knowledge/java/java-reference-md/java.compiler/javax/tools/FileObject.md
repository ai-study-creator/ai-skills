...
* ## Method Details
  ...
  + ### toUri
    ...
    [URI](../../../java.base/java/net/URI.md "class in java.net") toUri()
  ...
  + ### getName
    ...
    the command line, this method should return `"BobsApp\Test.java"` whereas the [toUri](#toUri())
  ...
  + ### openInputStream
    ...
    [InputStream](../../../java.base/java/io/InputStream.md "class in java.io") openInputStream()
  ...
  + ### openOutputStream
    ...
    [OutputStream](../../../java.base/java/io/OutputStream.md "class in java.io") openOutputStream()
    throws [IOException](../../../java.base/java/io/IOException.md "class in java.io")
  ...
  + ### openReader
    ...
    [Reader](../../../java.base/java/io/Reader.md "class in java.io") openReader(boolean ignoreEncodingErrors)
    throws [IOException](../../../java.base/java/io/IOException.md "class in java.io")
  ...
  + ### getCharContent
    ...
    [CharSequence](../../../java.base/java/lang/CharSequence.md "interface in java.lang") getCharContent(boolean ignoreEncodingErrors)
    throws [IOException](../../../java.base/java/io/IOException.md "class in java.io")
  ...
  + ### openWriter
    ...
    [Writer](../../../java.base/java/io/Writer.md "class in java.io") openWriter()
    throws [IOException](../../../java.base/java/io/IOException.md "class in java.io")
