...
extends [Closeable](../../../java.base/java/io/Closeable.md "interface in java.io"), [Flushable](../../../java.base/java/io/Flushable.md "interface in java.io"), [OptionChecker](OptionChecker.md "interface in javax.tools")
...
such files should take care to preserve case by using [`File.getCanonicalFile()`](../../../java.base/java/io/File.md#getCanonicalFile()) or similar means. If the system is
...
match the "path-rootless" rule of [RFC 3986](http://www.ietf.org/rfc/rfc3986.txt),
...
is that a trivial implementation of output to a [JarOutputStream](../../../java.base/java/util/jar/JarOutputStream.md "class in java.util.jar") is not a sufficient implementation.
...
* ## Method Summary
  ...
  name](#relative_name) in the specified package in the given package-oriented location.
  ...
  representing the specified [relative
  name](#relative_name) in the specified package in the given location.
...
* ## Method Details
  ...
  + ### getClassLoader
    ...
    [ClassLoader](../../../java.base/java/lang/ClassLoader.md "class in java.lang") getClassLoader([JavaFileManager.Location](JavaFileManager.Location.md "interface in javax.tools") location)
    ...
    :   `IllegalStateException` - if [`close()`](#close()) has been called
        and this file manager cannot be reopened
    :   `IllegalArgumentException` - if the location is a module-oriented location
  + ### list

    [Iterable](../../../java.base/java/lang/Iterable.md "interface in java.lang")<[JavaFileObject](JavaFileObject.md "interface in javax.tools")> list([JavaFileManager.Location](JavaFileManager.Location.md "interface in javax.tools") location,
    ...
    Throws:
    :   `IOException` - if an I/O error occurred, or if [`close()`](#close()) has been called and this file manager cannot be
        reopened
    :   `IllegalArgumentException` - if the location is a module-oriented location
    :   `IllegalStateException` - if [`close()`](#close()) has been called
        and this file manager cannot be reopened
  + ### inferBinaryName
    ...
    [String](../../../java.base/java/lang/String.md "class in java.lang") inferBinaryName([JavaFileManager.Location](JavaFileManager.Location.md "interface in javax.tools") location,
  ...
  + ### handleOption
    ...
    boolean handleOption([String](../../../java.base/java/lang/String.md "class in java.lang") current,
  ...
  + ### hasLocation
    ...
    boolean hasLocation([JavaFileManager.Location](JavaFileManager.Location.md "interface in javax.tools") location)
  ...
  + ### getJavaFileForInput
    ...
    [JavaFileObject](JavaFileObject.md "interface in javax.tools") getJavaFileForInput([JavaFileManager.Location](JavaFileManager.Location.md "interface in javax.tools") location,
  ...
  + ### getJavaFileForOutput
    ...
    [JavaFileObject](JavaFileObject.md "interface in javax.tools") getJavaFileForOutput([JavaFileManager.Location](JavaFileManager.Location.md "interface in javax.tools") location,
    [String](../../../java.base/java/lang/String.md "class in java.lang") className,
    [JavaFileObject.Kind](JavaFileObject.Kind.md "enum class in javax.tools") kind,
    ...
    :   `IOException` - if an I/O error occurred, or if [`close()`](#close()) has been called and this file manager cannot be
        reopened
    :   `IllegalStateException` - [`close()`](#close()) has been called
        and this file manager cannot be reopened
  + ### getJavaFileForOutputForOriginatingFiles

    default [JavaFileObject](JavaFileObject.md "interface in javax.tools") getJavaFileForOutputForOriginatingFiles([JavaFileManager.Location](JavaFileManager.Location.md "interface in javax.tools") location,
    [String](../../../java.base/java/lang/String.md "class in java.lang") className,
    [JavaFileObject.Kind](JavaFileObject.Kind.md "enum class in javax.tools") kind,
  ...
  + ### getFileForInput
    ...
    [FileObject](FileObject.md "interface in javax.tools") getFileForInput([JavaFileManager.Location](JavaFileManager.Location.md "interface in javax.tools") location,
    [String](../../../java.base/java/lang/String.md "class in java.lang") packageName,
  ...
  + ### getFileForOutput
    ...
    [FileObject](FileObject.md "interface in javax.tools") getFileForOutput([JavaFileManager.Location](JavaFileManager.Location.md "interface in javax.tools") location,
    [String](../../../java.base/java/lang/String.md "class in java.lang") packageName,
    [String](../../../java.base/java/lang/String.md "class in java.lang") relativeName,
    [FileObject](FileObject.md "interface in javax.tools") sibling)
    throws [IOException](../../../java.base/java/io/IOException.md "class in java.io")
    ...
    Informally, the file object returned by this method is
    located in the concatenation of the location, package name, and
    relative name or next to the sibling argument. See [`getFileForInput`](#getFileForInput(javax.tools.JavaFileManager.Location,java.lang.String,java.lang.String)) for an example.
  ...
  + ### getFileForOutputForOriginatingFiles
    ...
    default [FileObject](FileObject.md "interface in javax.tools") getFileForOutputForOriginatingFiles([JavaFileManager.Location](JavaFileManager.Location.md "interface in javax.tools") location,
    [String](../../../java.base/java/lang/String.md "class in java.lang") packageName,
    [String](../../../java.base/java/lang/String.md "class in java.lang") relativeName,
    [FileObject](FileObject.md "interface in javax.tools")... originatingFiles)
    throws [IOException](../../../java.base/java/io/IOException.md "class in java.io")
    ...
    See [`getFileForInput`](#getFileForInput(javax.tools.JavaFileManager.Location,java.lang.String,java.lang.String)) for an example.
  ...
  + ### getLocationForModule
    ...
    default [JavaFileManager.Location](JavaFileManager.Location.md "interface in javax.tools") getLocationForModule([JavaFileManager.Location](JavaFileManager.Location.md "interface in javax.tools") location,
    ...
    :   `IllegalArgumentException` - if the location is neither an output location nor a
  ...
  + ### getServiceLoader
    ...
    default <S> [ServiceLoader](../../../java.base/java/util/ServiceLoader.md "class in java.util")<S> getServiceLoader([JavaFileManager.Location](JavaFileManager.Location.md "interface in javax.tools") location,
  ...
  + ### inferModuleName
    ...
    default [String](../../../java.base/java/lang/String.md "class in java.lang") inferModuleName([JavaFileManager.Location](JavaFileManager.Location.md "interface in javax.tools") location)
    throws [IOException](../../../java.base/java/io/IOException.md "class in java.io")
  ...
  + ### contains
    ...
    default boolean contains([JavaFileManager.Location](JavaFileManager.Location.md "interface in javax.tools") location,
    ...
    calls would return the [`same`](#isSameFile(javax.tools.FileObject,javax.tools.FileObject)) file object:
