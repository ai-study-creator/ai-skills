...
standard file manager can be obtained by calling [getStandardFileManager](#getStandardFileManager(javax.tools.DiagnosticListener,java.util.Locale,java.nio.charset.Charset)).
...
standard file manager such as the one returned by [getStandardFileManager](#getStandardFileManager(javax.tools.DiagnosticListener,java.util.Locale,java.nio.charset.Charset)).
...
specifications are defined in the [Tool](Tool.md "interface in javax.tools") interface.
Additionally, an instance of this interface supporting [`SourceVersion.RELEASE_6`](../lang/model/SourceVersion.md#RELEASE_6)
or higher must also support [annotation processing](../annotation/processing/package-summary.md).

The compiler relies on two services: [diagnostic listener](DiagnosticListener.md "interface in javax.tools") and [file manager](JavaFileManager.md "interface in javax.tools"). Although most classes and
interfaces in this package defines an API for compilers (and
tools in general) the interfaces [DiagnosticListener](DiagnosticListener.md "interface in javax.tools"),
[JavaFileManager](JavaFileManager.md "interface in javax.tools"), [FileObject](FileObject.md "interface in javax.tools"), and
[JavaFileObject](JavaFileObject.md "interface in javax.tools") are not intended to be used in
...
:   Every compiler which implements this interface provides a
    standard file manager for operating on regular [files](../../../java.base/java/io/File.md "class in java.io"). The StandardJavaFileManager interface
...
[`DiagnosticCollector`](DiagnosticCollector.md "class in javax.tools")
...
[`ForwardingJavaFileManager`](ForwardingJavaFileManager.md "class in javax.tools"), [`ForwardingFileObject`](ForwardingFileObject.md "class in javax.tools"), and [`ForwardingJavaFileObject`](ForwardingJavaFileObject.md "class in javax.tools")
:   Subclassing is not available for overriding the behavior of a
    ...
    log all calls to [JavaFileManager.flush()](JavaFileManager.md#flush()):
...
See Also:
:   * [`DiagnosticListener`](DiagnosticListener.md "interface in javax.tools")
    * [`Diagnostic`](Diagnostic.md "interface in javax.tools")
...
* ## Method Details
  ...
  + ### getTask
    ...
    [JavaCompiler.CompilationTask](JavaCompiler.CompilationTask.md "interface in javax.tools") getTask([Writer](../../../java.base/java/io/Writer.md "class in java.io") out,
    ...
    [Iterable](../../../java.base/java/lang/Iterable.md "interface in java.lang")<[String](../../../java.base/java/lang/String.md "class in java.lang")> classes,
    ...
    locations defined in [`StandardLocation`](StandardLocation.md "enum class in javax.tools").
    ...
    :   `diagnosticListener` - a diagnostic listener; if `null` use the compiler's default method for reporting
        diagnostics
    :   `options` - compiler options, `null` means no options
    :   `classes` - names of classes to be processed by annotation
        processing, `null` means no class names
    ...
    :   `RuntimeException` - if an unrecoverable error
        ...
        user code.
    :   `IllegalArgumentException` - if any of the options are invalid,
