...
* ## Method Details
  ...
  + ### unwrap
    ...
    <T> T unwrap([Class](../../../java.base/java/lang/Class.md "class in java.lang")<T> iface)
  ...
  + ### isWrapperFor
    ...
    boolean isWrapperFor([Class](../../../java.base/java/lang/Class.md "class in java.lang")<?> iface)
    throws [SQLException](SQLException.md "class in java.sql")
