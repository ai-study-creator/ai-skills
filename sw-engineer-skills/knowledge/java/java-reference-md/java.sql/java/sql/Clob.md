...
* ## Method Summary
  ...
  This method releases the resources that the `Clob` object
  holds.
  ...
  Returns a `Reader` object that contains
...
* ## Method Details
  ...
  + ### getSubString
    ...
    [String](../../../java.base/java/lang/String.md "class in java.lang") getSubString(long pos,
    int length)
    throws [SQLException](SQLException.md "class in java.sql")
  ...
  + ### getCharacterStream
    ...
    See Also:
    :   - [`setCharacterStream(long)`](#setCharacterStream(long))
  + ### getAsciiStream

    [InputStream](../../../java.base/java/io/InputStream.md "class in java.io") getAsciiStream()
    throws [SQLException](SQLException.md "class in java.sql")
    ...
    See Also:
    :   - [`setAsciiStream(long)`](#setAsciiStream(long))
  + ### position

    long position([String](../../../java.base/java/lang/String.md "class in java.lang") searchstr,
    long start)
    throws [SQLException](SQLException.md "class in java.sql")
  ...
  + ### position
    ...
    long position([Clob](Clob.md "interface in java.sql") searchstr,
    long start)
    throws [SQLException](SQLException.md "class in java.sql")
  ...
  + ### setAsciiStream
    ...
    [OutputStream](../../../java.base/java/io/OutputStream.md "class in java.io") setAsciiStream(long pos)
    throws [SQLException](SQLException.md "class in java.sql")
  ...
  + ### setCharacterStream
    ...
    [Writer](../../../java.base/java/io/Writer.md "class in java.io") setCharacterStream(long pos)
    throws [SQLException](SQLException.md "class in java.sql")
  ...
  + ### getCharacterStream
    ...
    [Reader](../../../java.base/java/io/Reader.md "class in java.io") getCharacterStream(long pos,
    long length)
    throws [SQLException](SQLException.md "class in java.sql")
    ...
    Returns:
    :   `Reader` through which
        the partial `Clob` value can be read.

    Throws:
    :   `SQLException` - if pos is less than 1;
