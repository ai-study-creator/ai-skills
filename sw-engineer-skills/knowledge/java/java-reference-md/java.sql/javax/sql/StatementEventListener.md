...
* ## Method Details
  ...
  + ### statementClosed
    ...
    void statementClosed([StatementEvent](StatementEvent.md "class in javax.sql") event)
  ...
  + ### statementErrorOccurred
    ...
    void statementErrorOccurred([StatementEvent](StatementEvent.md "class in javax.sql") event)
