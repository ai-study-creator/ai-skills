...
* DIGEST-MD5 ([RFC 2831](http://www.ietf.org/rfc/rfc2831.txt)).
  ...
  mechanism.* Anonymous ([RFC 2245](http://www.ietf.org/rfc/rfc2245.txt)).
    This mechanism is anonymous authentication in which no credentials are
    necessary.* External ([RFC 2222](http://www.ietf.org/rfc/rfc2222.txt)).
      This mechanism obtains authentication information
      from an external source (such as TLS or IPsec).* S/Key ([RFC 2222](http://www.ietf.org/rfc/rfc2222.txt)).
        This mechanism uses the MD4 digest algorithm to exchange data based on
        a shared secret.* GSSAPI ([RFC 2222](http://www.ietf.org/rfc/rfc2222.txt)).
          This mechanism uses the
          [GSSAPI](http://www.ietf.org/rfc/rfc2078.txt)
...
* All Classes and InterfacesInterfacesClassesException Classes
  ...
  [AuthenticationException](AuthenticationException.md "class in javax.security.sasl")
  ...
  [AuthorizeCallback](AuthorizeCallback.md "class in javax.security.sasl")
  ...
  [RealmCallback](RealmCallback.md "class in javax.security.sasl")

  This callback is used by `SaslClient` and `SaslServer`
  to retrieve realm information.

  [RealmChoiceCallback](RealmChoiceCallback.md "class in javax.security.sasl")
  ...
  [SaslClientFactory](SaslClientFactory.md "interface in javax.security.sasl")

  An interface for creating instances of `SaslClient`.

  [SaslException](SaslException.md "class in javax.security.sasl")
